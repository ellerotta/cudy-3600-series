...
LINUX_PROFILE_CONFIG = $(call find_kernel_config, $(PLATFORM_DIR)/$(subst DEVICE_,,$(PROFILE)))
ifneq ($(PLATFORM_DIR),$(PLATFORM_SUBDIR))
  LINUX_SUBTARGET_CONFIG = $(call find_kernel_config,$(PLATFORM_SUBDIR))
  LINUX_PROFILE_CONFIG = $(call find_kernel_config,$(PLATFORM_SUBDIR)/$(subst DEVICE_,,$(PROFILE)))
endif
