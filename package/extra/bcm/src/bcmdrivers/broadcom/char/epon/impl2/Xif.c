...
static bdmf_error_t wrapper_32to16_xif_xpn_idle_pkt_cnt_get(uint32_t *stats_32)
    {
    uint16_t stats_16;
    bdmf_error_t ret;

    ret = ag_drv_xif_xpn_idle_pkt_cnt_get(&stats_16);
    *stats_32 = (uint32_t)stats_16;
    return ret;
    }
#endif
...
#ifdef IDLE_PACKET_TX_SUPPORT
    wrapper_32to16_xif_xpn_idle_pkt_cnt_get,
#endif  
    };
...
U32 XifLatestPktNum (LinkIndex link)
    ...
    ag_drv_xif_port_data__get(6, &packet_num);
    return packet_num;
    }  // XifLatestPktNum
...
#if defined(CONFIG_BCM96888) || defined(CONFIG_BCM96813) || defined(CONFIG_BCM968880) || defined(CONFIG_BCM96837)
    mdelay(1);
#endif
...
////////////////////////////////////////////////////////////////////////////////
//extern
void XifLaserMonRstnSet(BOOL enable)
    {
    bdmf_error_t drv_error = BDMF_ERR_OK;
    bdmf_boolean laserenstatus;
    bdmf_boolean cfglsrmonacthi;
...
BOOL XifLaserMonRstnGet(void)
    ...
    drv_error = ag_drv_xpcstx_tx_laser_monitor_ctl_get(&laserenstatus, &cfglsrmonacthi, &lasermonrstn);
    return (lasermonrstn ? TRUE : FALSE);
    }
...
////////////////////////////////////////////////////////////////////////////////
//extern
void XifXpcsRxInrpStatGet(xpcsrx_rx_int_stat *rx_int_stat)
    {
    bdmf_error_t drv_error = BDMF_ERR_OK;

    drv_error += ag_drv_xpcsrx_rx_int_stat_get(rx_int_stat);
    }
...
void XifInit (U8 txOffTimeOffset, BOOL txOffIdle,
    ...
    ctl.cfgpmcrxencrc8chk = 1;
#ifdef IDLE_PACKET_TX_SUPPORT
    ctl.cfgenidlepktsup = 1;
    ctl.cfgen1stidlepktconvert = 1;
#endif
    drv_error += ag_drv_xif_ctl_set(&ctl);
