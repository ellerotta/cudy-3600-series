...
bdmf_error_t ag_drv_lif_pon_control_set(const lif_pon_control *pon_control)
{
    ...
    if((pon_control->cfp2pmodeadaptiveshortpre >= _1BITS_MAX_VAL_) ||
    ...
    reg_pon_control = RU_FIELD_SET(0, LIF, PON_CONTROL, CFP2PMODEADAPTIVESHORTPRE, reg_pon_control, pon_control->cfp2pmodeadaptiveshortpre);
...
bdmf_error_t ag_drv_lif_pon_control_get(lif_pon_control *pon_control)
{
    ...
    pon_control->cfp2pmodeadaptiveshortpre = RU_FIELD_GET(0, LIF, PON_CONTROL, CFP2PMODEADAPTIVESHORTPRE, reg_pon_control);
...
static int bcm_lif_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case BDMF_pon_control:
    {
        ...
        bdmf_session_print(session, "cfp2pmodeadaptiveshortpre = %u = 0x%x\n", pon_control.cfp2pmodeadaptiveshortpre, pon_control.cfp2pmodeadaptiveshortpre);
