...
#define LifEncryptRxEnable          0x1
#define LifEncryptTxEnable          (0x1<<9)
...
BOOL LifLocked(void)
    ...
    // clear the loss interrupt before reading
    memset((void*)&int_status, 0, sizeof(lif_int_status));
...
////////////////////////////////////////////////////////////////////////////////
//extern
void LifLaserMonRstnSet(BOOL enable)
    {
    bdmf_error_t drv_error = BDMF_ERR_OK;
    bdmf_boolean iopbilaserens1a;
    bdmf_boolean cfglsrmonacthi;
...
BOOL LifLaserMonRstnGet(void)
    ...
    drv_error += ag_drv_lif_lsr_mon_a_ctrl_get(&iopbilaserens1a, &cfglsrmonacthi, &pbilasermonrsta_n_pre);
    return (pbilasermonrsta_n_pre ? TRUE : FALSE);
    }
...
////////////////////////////////////////////////////////////////////////////////
//extern
void LifInrpStatusGet(lif_int_status *int_status)
    {
    bdmf_error_t drv_error = BDMF_ERR_OK;
...
#ifdef AE_AN_ABILITY_SUPPORT
    if(EponGetMacMode() == EPON_MAC_AE_MODE)
        {
        uint16_t cf_lif_p2p_ae_autoneg_config_ability;
        cf_lif_p2p_ae_autoneg_config_ability = 0x20;  /* Full Duplex */
        drv_error += ag_drv_lif_p2p_autoneg_ability_config_reg_set(cf_lif_p2p_ae_autoneg_config_ability);
        }
#endif
...
#if defined(OVERLP_B2B_SUPPORT)
    pon_iop_ctrl.cf_tx_lif_allow_overlp_b2b = 1;
#endif
...
////////////////////////////////////////////////////////////////////////////////
/// \brief  Has the LIF completed auto-negotiation?
///
/// \return
/// TRUE if LIF has completed auto-neg successfully, FALSE otherwise
////////////////////////////////////////////////////////////////////////////////
//extern
BOOL LifAutonegCompleted(void)
{
    ...
    if (!an_complete || an_lp_remote_fault)
        return FALSE;
    else
        return TRUE;
    ...
    // 460 is different than other chips, there is no remote fault indication.
    // Therefore there is a risk can't detect remote fault.
    if (fecrxoutcs & 0x3) 
        return TRUE;
    else
        return FALSE;
