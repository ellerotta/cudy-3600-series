...
bdmf_error_t ag_drv_xif_int_status_set(const xif_int_status *int_status)
{
    ...
    if((int_status->ts1588pktabort >= _1BITS_MAX_VAL_) ||
       (int_status->ts1588twostepff >= _1BITS_MAX_VAL_) ||
       (int_status->secrxrplyprtctabrtint >= _1BITS_MAX_VAL_) ||
    ...
    reg_int_status = RU_FIELD_SET(0, XIF, INT_STATUS, TS1588PKTABORT, reg_int_status, int_status->ts1588pktabort);
    reg_int_status = RU_FIELD_SET(0, XIF, INT_STATUS, TS1588TWOSTEPFF, reg_int_status, int_status->ts1588twostepff);
...
bdmf_error_t ag_drv_xif_int_status_get(xif_int_status *int_status)
{
    ...
    int_status->ts1588pktabort = RU_FIELD_GET(0, XIF, INT_STATUS, TS1588PKTABORT, reg_int_status);
    int_status->ts1588twostepff = RU_FIELD_GET(0, XIF, INT_STATUS, TS1588TWOSTEPFF, reg_int_status);
...
bdmf_error_t ag_drv_xif_int_mask_set(const xif_int_mask *int_mask)
{
    ...
    if((int_mask->mskts1588pktabort >= _1BITS_MAX_VAL_) ||
       (int_mask->mskts1588twostepff >= _1BITS_MAX_VAL_) ||
       (int_mask->msksecrxreplayprotctabort >= _1BITS_MAX_VAL_) ||
    ...
    reg_int_mask = RU_FIELD_SET(0, XIF, INT_MASK, MSKTS1588PKTABORT, reg_int_mask, int_mask->mskts1588pktabort);
    reg_int_mask = RU_FIELD_SET(0, XIF, INT_MASK, MSKTS1588TWOSTEPFF, reg_int_mask, int_mask->mskts1588twostepff);
...
bdmf_error_t ag_drv_xif_int_mask_get(xif_int_mask *int_mask)
{
    ...
    int_mask->mskts1588pktabort = RU_FIELD_GET(0, XIF, INT_MASK, MSKTS1588PKTABORT, reg_int_mask);
    int_mask->mskts1588twostepff = RU_FIELD_GET(0, XIF, INT_MASK, MSKTS1588TWOSTEPFF, reg_int_mask);
...
bdmf_error_t ag_drv_xif_sec_ctl_set(const xif_sec_ctl *sec_ctl)
{
    ...
    if((sec_ctl->cfgkeynum_4_an_3 >= _1BITS_MAX_VAL_) ||
       (sec_ctl->cfgkeynum_4_an_2 >= _1BITS_MAX_VAL_) ||
       (sec_ctl->cfgkeynum_4_an_1 >= _1BITS_MAX_VAL_) ||
       (sec_ctl->cfgkeynum_4_an_0 >= _1BITS_MAX_VAL_) ||
       (sec_ctl->cfgsecrxenshortlen >= _1BITS_MAX_VAL_) ||
    ...
    reg_sec_ctl = RU_FIELD_SET(0, XIF, SEC_CTL, CFGKEYNUM_4_AN_3, reg_sec_ctl, sec_ctl->cfgkeynum_4_an_3);
    reg_sec_ctl = RU_FIELD_SET(0, XIF, SEC_CTL, CFGKEYNUM_4_AN_2, reg_sec_ctl, sec_ctl->cfgkeynum_4_an_2);
    reg_sec_ctl = RU_FIELD_SET(0, XIF, SEC_CTL, CFGKEYNUM_4_AN_1, reg_sec_ctl, sec_ctl->cfgkeynum_4_an_1);
    reg_sec_ctl = RU_FIELD_SET(0, XIF, SEC_CTL, CFGKEYNUM_4_AN_0, reg_sec_ctl, sec_ctl->cfgkeynum_4_an_0);
...
bdmf_error_t ag_drv_xif_sec_ctl_get(xif_sec_ctl *sec_ctl)
{
    ...
    sec_ctl->cfgkeynum_4_an_3 = RU_FIELD_GET(0, XIF, SEC_CTL, CFGKEYNUM_4_AN_3, reg_sec_ctl);
    sec_ctl->cfgkeynum_4_an_2 = RU_FIELD_GET(0, XIF, SEC_CTL, CFGKEYNUM_4_AN_2, reg_sec_ctl);
    sec_ctl->cfgkeynum_4_an_1 = RU_FIELD_GET(0, XIF, SEC_CTL, CFGKEYNUM_4_AN_1, reg_sec_ctl);
    sec_ctl->cfgkeynum_4_an_0 = RU_FIELD_GET(0, XIF, SEC_CTL, CFGKEYNUM_4_AN_0, reg_sec_ctl);
...
{
    uint32_t reg_ctl_2=0;

#ifdef VALIDATE_PARMS
    if((cfgen1588adj4parb4da >= _1BITS_MAX_VAL_) ||
       (cfgentx1588 >= _1BITS_MAX_VAL_) ||
       (cfgdisp2pdnindexmap >= _1BITS_MAX_VAL_) ||
       (cfgdisp2pupindexmap >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_ctl_2 = RU_FIELD_SET(0, XIF, CTL_2, CFGEN1588ADJ4PARB4DA, reg_ctl_2, cfgen1588adj4parb4da);
    reg_ctl_2 = RU_FIELD_SET(0, XIF, CTL_2, CFGENTX1588, reg_ctl_2, cfgentx1588);
    reg_ctl_2 = RU_FIELD_SET(0, XIF, CTL_2, CFGDISP2PDNINDEXMAP, reg_ctl_2, cfgdisp2pdnindexmap);
    reg_ctl_2 = RU_FIELD_SET(0, XIF, CTL_2, CFGDISP2PUPINDEXMAP, reg_ctl_2, cfgdisp2pupindexmap);

    RU_REG_WRITE(0, XIF, CTL_2, reg_ctl_2);
...
bdmf_error_t ag_drv_xif_ctl_2_get(bdmf_boolean *cfgen1588adj4parb4da, bdmf_boolean *cfgentx1588, bdmf_boolean *cfgdisp2pdnindexmap, bdmf_boolean *cfgdisp2pupindexmap)
{
...
#ifdef VALIDATE_PARMS
    if(!cfgen1588adj4parb4da || !cfgentx1588 || !cfgdisp2pdnindexmap || !cfgdisp2pupindexmap)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    ...
    RU_REG_READ(0, XIF, CTL_2, reg_ctl_2);

    *cfgen1588adj4parb4da = RU_FIELD_GET(0, XIF, CTL_2, CFGEN1588ADJ4PARB4DA, reg_ctl_2);
    *cfgentx1588 = RU_FIELD_GET(0, XIF, CTL_2, CFGENTX1588, reg_ctl_2);
    *cfgdisp2pdnindexmap = RU_FIELD_GET(0, XIF, CTL_2, CFGDISP2PDNINDEXMAP, reg_ctl_2);
    *cfgdisp2pupindexmap = RU_FIELD_GET(0, XIF, CTL_2, CFGDISP2PUPINDEXMAP, reg_ctl_2);
...
{
    uint32_t reg_vlan_type_1=0;

#ifdef VALIDATE_PARMS
#endif

    reg_vlan_type_1 = RU_FIELD_SET(0, XIF, VLAN_TYPE_1, CFGVLANTYPE_1, reg_vlan_type_1, cfgvlantype_1);

    RU_REG_WRITE(0, XIF, VLAN_TYPE_1, reg_vlan_type_1);
...
bdmf_error_t ag_drv_xif_vlan_type_1_get(uint16_t *cfgvlantype_1)
{
    ...
    RU_REG_READ(0, XIF, VLAN_TYPE_1, reg_vlan_type_1);

    *cfgvlantype_1 = RU_FIELD_GET(0, XIF, VLAN_TYPE_1, CFGVLANTYPE_1, reg_vlan_type_1);
...
{
    uint32_t reg_p2p_ae_sci_lo_16=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_lo_16 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_LO_16, CFGP2PSCI_LO_16, reg_p2p_ae_sci_lo_16, cfgp2psci_lo_16);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_LO_16, reg_p2p_ae_sci_lo_16);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_lo_16_get(uint32_t *cfgp2psci_lo_16)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_LO_16, reg_p2p_ae_sci_lo_16);

    *cfgp2psci_lo_16 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_LO_16, CFGP2PSCI_LO_16, reg_p2p_ae_sci_lo_16);
...
{
    uint32_t reg_p2p_ae_sci_hi_16=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_hi_16 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_HI_16, CFGP2PSCI_HI_16, reg_p2p_ae_sci_hi_16, cfgp2psci_hi_16);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_HI_16, reg_p2p_ae_sci_hi_16);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_hi_16_get(uint32_t *cfgp2psci_hi_16)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_HI_16, reg_p2p_ae_sci_hi_16);

    *cfgp2psci_hi_16 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_HI_16, CFGP2PSCI_HI_16, reg_p2p_ae_sci_hi_16);
...
{
    uint32_t reg_p2p_ae_sci_lo_17=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_lo_17 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_LO_17, CFGP2PSCI_LO_17, reg_p2p_ae_sci_lo_17, cfgp2psci_lo_17);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_LO_17, reg_p2p_ae_sci_lo_17);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_lo_17_get(uint32_t *cfgp2psci_lo_17)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_LO_17, reg_p2p_ae_sci_lo_17);

    *cfgp2psci_lo_17 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_LO_17, CFGP2PSCI_LO_17, reg_p2p_ae_sci_lo_17);
...
{
    uint32_t reg_p2p_ae_sci_hi_17=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_hi_17 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_HI_17, CFGP2PSCI_HI_17, reg_p2p_ae_sci_hi_17, cfgp2psci_hi_17);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_HI_17, reg_p2p_ae_sci_hi_17);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_hi_17_get(uint32_t *cfgp2psci_hi_17)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_HI_17, reg_p2p_ae_sci_hi_17);

    *cfgp2psci_hi_17 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_HI_17, CFGP2PSCI_HI_17, reg_p2p_ae_sci_hi_17);
...
{
    uint32_t reg_p2p_ae_sci_lo_18=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_lo_18 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_LO_18, CFGP2PSCI_LO_18, reg_p2p_ae_sci_lo_18, cfgp2psci_lo_18);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_LO_18, reg_p2p_ae_sci_lo_18);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_lo_18_get(uint32_t *cfgp2psci_lo_18)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_LO_18, reg_p2p_ae_sci_lo_18);

    *cfgp2psci_lo_18 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_LO_18, CFGP2PSCI_LO_18, reg_p2p_ae_sci_lo_18);
...
{
    uint32_t reg_p2p_ae_sci_hi_18=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_hi_18 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_HI_18, CFGP2PSCI_HI_18, reg_p2p_ae_sci_hi_18, cfgp2psci_hi_18);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_HI_18, reg_p2p_ae_sci_hi_18);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_hi_18_get(uint32_t *cfgp2psci_hi_18)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_HI_18, reg_p2p_ae_sci_hi_18);

    *cfgp2psci_hi_18 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_HI_18, CFGP2PSCI_HI_18, reg_p2p_ae_sci_hi_18);
...
{
    uint32_t reg_p2p_ae_sci_lo_19=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_lo_19 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_LO_19, CFGP2PSCI_LO_19, reg_p2p_ae_sci_lo_19, cfgp2psci_lo_19);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_LO_19, reg_p2p_ae_sci_lo_19);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_lo_19_get(uint32_t *cfgp2psci_lo_19)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_LO_19, reg_p2p_ae_sci_lo_19);

    *cfgp2psci_lo_19 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_LO_19, CFGP2PSCI_LO_19, reg_p2p_ae_sci_lo_19);
...
{
    uint32_t reg_p2p_ae_sci_hi_19=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_hi_19 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_HI_19, CFGP2PSCI_HI_19, reg_p2p_ae_sci_hi_19, cfgp2psci_hi_19);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_HI_19, reg_p2p_ae_sci_hi_19);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_hi_19_get(uint32_t *cfgp2psci_hi_19)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_HI_19, reg_p2p_ae_sci_hi_19);

    *cfgp2psci_hi_19 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_HI_19, CFGP2PSCI_HI_19, reg_p2p_ae_sci_hi_19);
...
{
    uint32_t reg_p2p_ae_sci_lo_20=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_lo_20 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_LO_20, CFGP2PSCI_LO_20, reg_p2p_ae_sci_lo_20, cfgp2psci_lo_20);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_LO_20, reg_p2p_ae_sci_lo_20);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_lo_20_get(uint32_t *cfgp2psci_lo_20)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_LO_20, reg_p2p_ae_sci_lo_20);

    *cfgp2psci_lo_20 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_LO_20, CFGP2PSCI_LO_20, reg_p2p_ae_sci_lo_20);
...
{
    uint32_t reg_p2p_ae_sci_hi_20=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_hi_20 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_HI_20, CFGP2PSCI_HI_20, reg_p2p_ae_sci_hi_20, cfgp2psci_hi_20);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_HI_20, reg_p2p_ae_sci_hi_20);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_hi_20_get(uint32_t *cfgp2psci_hi_20)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_HI_20, reg_p2p_ae_sci_hi_20);

    *cfgp2psci_hi_20 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_HI_20, CFGP2PSCI_HI_20, reg_p2p_ae_sci_hi_20);
...
{
    uint32_t reg_p2p_ae_sci_lo_21=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_lo_21 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_LO_21, CFGP2PSCI_LO_21, reg_p2p_ae_sci_lo_21, cfgp2psci_lo_21);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_LO_21, reg_p2p_ae_sci_lo_21);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_lo_21_get(uint32_t *cfgp2psci_lo_21)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_LO_21, reg_p2p_ae_sci_lo_21);

    *cfgp2psci_lo_21 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_LO_21, CFGP2PSCI_LO_21, reg_p2p_ae_sci_lo_21);
...
{
    uint32_t reg_p2p_ae_sci_hi_21=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_hi_21 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_HI_21, CFGP2PSCI_HI_21, reg_p2p_ae_sci_hi_21, cfgp2psci_hi_21);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_HI_21, reg_p2p_ae_sci_hi_21);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_hi_21_get(uint32_t *cfgp2psci_hi_21)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_HI_21, reg_p2p_ae_sci_hi_21);

    *cfgp2psci_hi_21 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_HI_21, CFGP2PSCI_HI_21, reg_p2p_ae_sci_hi_21);
...
{
    uint32_t reg_p2p_ae_sci_lo_22=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_lo_22 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_LO_22, CFGP2PSCI_LO_22, reg_p2p_ae_sci_lo_22, cfgp2psci_lo_22);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_LO_22, reg_p2p_ae_sci_lo_22);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_lo_22_get(uint32_t *cfgp2psci_lo_22)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_LO_22, reg_p2p_ae_sci_lo_22);

    *cfgp2psci_lo_22 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_LO_22, CFGP2PSCI_LO_22, reg_p2p_ae_sci_lo_22);
...
{
    uint32_t reg_p2p_ae_sci_hi_22=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_hi_22 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_HI_22, CFGP2PSCI_HI_22, reg_p2p_ae_sci_hi_22, cfgp2psci_hi_22);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_HI_22, reg_p2p_ae_sci_hi_22);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_hi_22_get(uint32_t *cfgp2psci_hi_22)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_HI_22, reg_p2p_ae_sci_hi_22);

    *cfgp2psci_hi_22 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_HI_22, CFGP2PSCI_HI_22, reg_p2p_ae_sci_hi_22);
...
{
    uint32_t reg_p2p_ae_sci_lo_23=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_lo_23 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_LO_23, CFGP2PSCI_LO_23, reg_p2p_ae_sci_lo_23, cfgp2psci_lo_23);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_LO_23, reg_p2p_ae_sci_lo_23);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_lo_23_get(uint32_t *cfgp2psci_lo_23)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_LO_23, reg_p2p_ae_sci_lo_23);

    *cfgp2psci_lo_23 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_LO_23, CFGP2PSCI_LO_23, reg_p2p_ae_sci_lo_23);
...
{
    uint32_t reg_p2p_ae_sci_hi_23=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_hi_23 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_HI_23, CFGP2PSCI_HI_23, reg_p2p_ae_sci_hi_23, cfgp2psci_hi_23);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_HI_23, reg_p2p_ae_sci_hi_23);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_hi_23_get(uint32_t *cfgp2psci_hi_23)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_HI_23, reg_p2p_ae_sci_hi_23);

    *cfgp2psci_hi_23 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_HI_23, CFGP2PSCI_HI_23, reg_p2p_ae_sci_hi_23);
...
{
    uint32_t reg_p2p_ae_sci_lo_24=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_lo_24 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_LO_24, CFGP2PSCI_LO_24, reg_p2p_ae_sci_lo_24, cfgp2psci_lo_24);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_LO_24, reg_p2p_ae_sci_lo_24);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_lo_24_get(uint32_t *cfgp2psci_lo_24)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_LO_24, reg_p2p_ae_sci_lo_24);

    *cfgp2psci_lo_24 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_LO_24, CFGP2PSCI_LO_24, reg_p2p_ae_sci_lo_24);
...
{
    uint32_t reg_p2p_ae_sci_hi_24=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_hi_24 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_HI_24, CFGP2PSCI_HI_24, reg_p2p_ae_sci_hi_24, cfgp2psci_hi_24);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_HI_24, reg_p2p_ae_sci_hi_24);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_hi_24_get(uint32_t *cfgp2psci_hi_24)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_HI_24, reg_p2p_ae_sci_hi_24);

    *cfgp2psci_hi_24 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_HI_24, CFGP2PSCI_HI_24, reg_p2p_ae_sci_hi_24);
...
{
    uint32_t reg_p2p_ae_sci_lo_25=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_lo_25 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_LO_25, CFGP2PSCI_LO_25, reg_p2p_ae_sci_lo_25, cfgp2psci_lo_25);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_LO_25, reg_p2p_ae_sci_lo_25);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_lo_25_get(uint32_t *cfgp2psci_lo_25)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_LO_25, reg_p2p_ae_sci_lo_25);

    *cfgp2psci_lo_25 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_LO_25, CFGP2PSCI_LO_25, reg_p2p_ae_sci_lo_25);
...
{
    uint32_t reg_p2p_ae_sci_hi_25=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_hi_25 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_HI_25, CFGP2PSCI_HI_25, reg_p2p_ae_sci_hi_25, cfgp2psci_hi_25);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_HI_25, reg_p2p_ae_sci_hi_25);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_hi_25_get(uint32_t *cfgp2psci_hi_25)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_HI_25, reg_p2p_ae_sci_hi_25);

    *cfgp2psci_hi_25 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_HI_25, CFGP2PSCI_HI_25, reg_p2p_ae_sci_hi_25);
...
{
    uint32_t reg_p2p_ae_sci_lo_26=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_lo_26 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_LO_26, CFGP2PSCI_LO_26, reg_p2p_ae_sci_lo_26, cfgp2psci_lo_26);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_LO_26, reg_p2p_ae_sci_lo_26);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_lo_26_get(uint32_t *cfgp2psci_lo_26)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_LO_26, reg_p2p_ae_sci_lo_26);

    *cfgp2psci_lo_26 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_LO_26, CFGP2PSCI_LO_26, reg_p2p_ae_sci_lo_26);
...
{
    uint32_t reg_p2p_ae_sci_hi_26=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_hi_26 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_HI_26, CFGP2PSCI_HI_26, reg_p2p_ae_sci_hi_26, cfgp2psci_hi_26);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_HI_26, reg_p2p_ae_sci_hi_26);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_hi_26_get(uint32_t *cfgp2psci_hi_26)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_HI_26, reg_p2p_ae_sci_hi_26);

    *cfgp2psci_hi_26 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_HI_26, CFGP2PSCI_HI_26, reg_p2p_ae_sci_hi_26);
...
{
    uint32_t reg_p2p_ae_sci_lo_27=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_lo_27 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_LO_27, CFGP2PSCI_LO_27, reg_p2p_ae_sci_lo_27, cfgp2psci_lo_27);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_LO_27, reg_p2p_ae_sci_lo_27);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_lo_27_get(uint32_t *cfgp2psci_lo_27)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_LO_27, reg_p2p_ae_sci_lo_27);

    *cfgp2psci_lo_27 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_LO_27, CFGP2PSCI_LO_27, reg_p2p_ae_sci_lo_27);
...
{
    uint32_t reg_p2p_ae_sci_hi_27=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_hi_27 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_HI_27, CFGP2PSCI_HI_27, reg_p2p_ae_sci_hi_27, cfgp2psci_hi_27);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_HI_27, reg_p2p_ae_sci_hi_27);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_hi_27_get(uint32_t *cfgp2psci_hi_27)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_HI_27, reg_p2p_ae_sci_hi_27);

    *cfgp2psci_hi_27 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_HI_27, CFGP2PSCI_HI_27, reg_p2p_ae_sci_hi_27);
...
{
    uint32_t reg_p2p_ae_sci_lo_28=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_lo_28 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_LO_28, CFGP2PSCI_LO_28, reg_p2p_ae_sci_lo_28, cfgp2psci_lo_28);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_LO_28, reg_p2p_ae_sci_lo_28);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_lo_28_get(uint32_t *cfgp2psci_lo_28)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_LO_28, reg_p2p_ae_sci_lo_28);

    *cfgp2psci_lo_28 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_LO_28, CFGP2PSCI_LO_28, reg_p2p_ae_sci_lo_28);
...
{
    uint32_t reg_p2p_ae_sci_hi_28=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_hi_28 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_HI_28, CFGP2PSCI_HI_28, reg_p2p_ae_sci_hi_28, cfgp2psci_hi_28);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_HI_28, reg_p2p_ae_sci_hi_28);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_hi_28_get(uint32_t *cfgp2psci_hi_28)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_HI_28, reg_p2p_ae_sci_hi_28);

    *cfgp2psci_hi_28 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_HI_28, CFGP2PSCI_HI_28, reg_p2p_ae_sci_hi_28);
...
{
    uint32_t reg_p2p_ae_sci_lo_29=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_lo_29 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_LO_29, CFGP2PSCI_LO_29, reg_p2p_ae_sci_lo_29, cfgp2psci_lo_29);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_LO_29, reg_p2p_ae_sci_lo_29);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_lo_29_get(uint32_t *cfgp2psci_lo_29)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_LO_29, reg_p2p_ae_sci_lo_29);

    *cfgp2psci_lo_29 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_LO_29, CFGP2PSCI_LO_29, reg_p2p_ae_sci_lo_29);
...
{
    uint32_t reg_p2p_ae_sci_hi_29=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_hi_29 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_HI_29, CFGP2PSCI_HI_29, reg_p2p_ae_sci_hi_29, cfgp2psci_hi_29);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_HI_29, reg_p2p_ae_sci_hi_29);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_hi_29_get(uint32_t *cfgp2psci_hi_29)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_HI_29, reg_p2p_ae_sci_hi_29);

    *cfgp2psci_hi_29 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_HI_29, CFGP2PSCI_HI_29, reg_p2p_ae_sci_hi_29);
...
{
    uint32_t reg_p2p_ae_sci_lo_30=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_lo_30 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_LO_30, CFGP2PSCI_LO_30, reg_p2p_ae_sci_lo_30, cfgp2psci_lo_30);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_LO_30, reg_p2p_ae_sci_lo_30);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_lo_30_get(uint32_t *cfgp2psci_lo_30)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_LO_30, reg_p2p_ae_sci_lo_30);

    *cfgp2psci_lo_30 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_LO_30, CFGP2PSCI_LO_30, reg_p2p_ae_sci_lo_30);
...
{
    uint32_t reg_p2p_ae_sci_hi_30=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_hi_30 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_HI_30, CFGP2PSCI_HI_30, reg_p2p_ae_sci_hi_30, cfgp2psci_hi_30);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_HI_30, reg_p2p_ae_sci_hi_30);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_hi_30_get(uint32_t *cfgp2psci_hi_30)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_HI_30, reg_p2p_ae_sci_hi_30);

    *cfgp2psci_hi_30 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_HI_30, CFGP2PSCI_HI_30, reg_p2p_ae_sci_hi_30);
...
{
    uint32_t reg_p2p_ae_sci_lo_31=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_lo_31 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_LO_31, CFGP2PSCI_LO_31, reg_p2p_ae_sci_lo_31, cfgp2psci_lo_31);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_LO_31, reg_p2p_ae_sci_lo_31);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_lo_31_get(uint32_t *cfgp2psci_lo_31)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_LO_31, reg_p2p_ae_sci_lo_31);

    *cfgp2psci_lo_31 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_LO_31, CFGP2PSCI_LO_31, reg_p2p_ae_sci_lo_31);
...
{
    uint32_t reg_p2p_ae_sci_hi_31=0;

#ifdef VALIDATE_PARMS
#endif

    reg_p2p_ae_sci_hi_31 = RU_FIELD_SET(0, XIF, P2P_AE_SCI_HI_31, CFGP2PSCI_HI_31, reg_p2p_ae_sci_hi_31, cfgp2psci_hi_31);

    RU_REG_WRITE(0, XIF, P2P_AE_SCI_HI_31, reg_p2p_ae_sci_hi_31);
...
bdmf_error_t ag_drv_xif_p2p_ae_sci_hi_31_get(uint32_t *cfgp2psci_hi_31)
{
    ...
    RU_REG_READ(0, XIF, P2P_AE_SCI_HI_31, reg_p2p_ae_sci_hi_31);

    *cfgp2psci_hi_31 = RU_FIELD_GET(0, XIF, P2P_AE_SCI_HI_31, CFGP2PSCI_HI_31, reg_p2p_ae_sci_hi_31);
...
{
    uint32_t reg_up_1588_ts_offset_lo=0;

#ifdef VALIDATE_PARMS
#endif

    reg_up_1588_ts_offset_lo = RU_FIELD_SET(0, XIF, UP_1588_TS_OFFSET_LO, CFGUP1588TSOFFSET_LO, reg_up_1588_ts_offset_lo, cfgup1588tsoffset_lo);

    RU_REG_WRITE(0, XIF, UP_1588_TS_OFFSET_LO, reg_up_1588_ts_offset_lo);
...
bdmf_error_t ag_drv_xif_up_1588_ts_offset_lo_get(uint32_t *cfgup1588tsoffset_lo)
{
    ...
    RU_REG_READ(0, XIF, UP_1588_TS_OFFSET_LO, reg_up_1588_ts_offset_lo);

    *cfgup1588tsoffset_lo = RU_FIELD_GET(0, XIF, UP_1588_TS_OFFSET_LO, CFGUP1588TSOFFSET_LO, reg_up_1588_ts_offset_lo);
...
{
    uint32_t reg_up_1588_ts_offset_hi=0;

#ifdef VALIDATE_PARMS
#endif

    reg_up_1588_ts_offset_hi = RU_FIELD_SET(0, XIF, UP_1588_TS_OFFSET_HI, CFGCMHOFFSET, reg_up_1588_ts_offset_hi, cfgcmhoffset);
    reg_up_1588_ts_offset_hi = RU_FIELD_SET(0, XIF, UP_1588_TS_OFFSET_HI, CFGUP1588TSOFFSET_HI, reg_up_1588_ts_offset_hi, cfgup1588tsoffset_hi);

    RU_REG_WRITE(0, XIF, UP_1588_TS_OFFSET_HI, reg_up_1588_ts_offset_hi);
...
bdmf_error_t ag_drv_xif_up_1588_ts_offset_hi_get(uint8_t *cfgcmhoffset, uint16_t *cfgup1588tsoffset_hi)
{
...
#ifdef VALIDATE_PARMS
    if(!cfgcmhoffset || !cfgup1588tsoffset_hi)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    ...
    RU_REG_READ(0, XIF, UP_1588_TS_OFFSET_HI, reg_up_1588_ts_offset_hi);

    *cfgcmhoffset = RU_FIELD_GET(0, XIF, UP_1588_TS_OFFSET_HI, CFGCMHOFFSET, reg_up_1588_ts_offset_hi);
    *cfgup1588tsoffset_hi = RU_FIELD_GET(0, XIF, UP_1588_TS_OFFSET_HI, CFGUP1588TSOFFSET_HI, reg_up_1588_ts_offset_hi);
...
{
    uint32_t reg_up_1588_two_step_ts_ctl=0;
    ...
    reg_up_1588_two_step_ts_ctl = RU_FIELD_SET(0, XIF, UP_1588_TWO_STEP_TS_CTL, TWOSTEPFFRD, reg_up_1588_two_step_ts_ctl, twostepffrd);
    reg_up_1588_two_step_ts_ctl = RU_FIELD_SET(0, XIF, UP_1588_TWO_STEP_TS_CTL, TWOSTEPFFENTRIES, reg_up_1588_two_step_ts_ctl, twostepffentries);

    RU_REG_WRITE(0, XIF, UP_1588_TWO_STEP_TS_CTL, reg_up_1588_two_step_ts_ctl);
...
bdmf_error_t ag_drv_xif_up_1588_two_step_ts_ctl_get(bdmf_boolean *twostepffrd, uint8_t *twostepffentries)
{
    ...
    RU_REG_READ(0, XIF, UP_1588_TWO_STEP_TS_CTL, reg_up_1588_two_step_ts_ctl);

    *twostepffrd = RU_FIELD_GET(0, XIF, UP_1588_TWO_STEP_TS_CTL, TWOSTEPFFRD, reg_up_1588_two_step_ts_ctl);
    *twostepffentries = RU_FIELD_GET(0, XIF, UP_1588_TWO_STEP_TS_CTL, TWOSTEPFFENTRIES, reg_up_1588_two_step_ts_ctl);
...
{
    uint32_t reg_up_1588_two_step_ts_value_lo=0;
    ...
    RU_REG_READ(0, XIF, UP_1588_TWO_STEP_TS_VALUE_LO, reg_up_1588_two_step_ts_value_lo);

    *twosteptimestamp_lo = RU_FIELD_GET(0, XIF, UP_1588_TWO_STEP_TS_VALUE_LO, TWOSTEPTIMESTAMP_LO, reg_up_1588_two_step_ts_value_lo);
...
{
    uint32_t reg_up_1588_two_step_ts_value_hi=0;
    ...
    RU_REG_READ(0, XIF, UP_1588_TWO_STEP_TS_VALUE_HI, reg_up_1588_two_step_ts_value_hi);

    *twosteptimestamp_hi = RU_FIELD_GET(0, XIF, UP_1588_TWO_STEP_TS_VALUE_HI, TWOSTEPTIMESTAMP_HI, reg_up_1588_two_step_ts_value_hi);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_xif_1588_ts_sync_offset_set(uint8_t cfgtssyncoffset)
{
    uint32_t reg_1588_ts_sync_offset=0;
    ...
    reg_1588_ts_sync_offset = RU_FIELD_SET(0, XIF, 1588_TS_SYNC_OFFSET, CFGTSSYNCOFFSET, reg_1588_ts_sync_offset, cfgtssyncoffset);

    RU_REG_WRITE(0, XIF, 1588_TS_SYNC_OFFSET, reg_1588_ts_sync_offset);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_xif_1588_ts_sync_offset_get(uint8_t *cfgtssyncoffset)
{
    uint32_t reg_1588_ts_sync_offset=0;
    ...
    RU_REG_READ(0, XIF, 1588_TS_SYNC_OFFSET, reg_1588_ts_sync_offset);

    *cfgtssyncoffset = RU_FIELD_GET(0, XIF, 1588_TS_SYNC_OFFSET, CFGTSSYNCOFFSET, reg_1588_ts_sync_offset);
...
{
    uint32_t reg_sec_mpcp_offset=0;

#ifdef VALIDATE_PARMS
#endif

    reg_sec_mpcp_offset = RU_FIELD_SET(0, XIF, SEC_MPCP_OFFSET, CFGSECRXMPCPOFFSET, reg_sec_mpcp_offset, cfgsecrxmpcpoffset);

    RU_REG_WRITE(0, XIF, SEC_MPCP_OFFSET, reg_sec_mpcp_offset);
...
bdmf_error_t ag_drv_xif_sec_mpcp_offset_get(uint32_t *cfgsecrxmpcpoffset)
{
    ...
    RU_REG_READ(0, XIF, SEC_MPCP_OFFSET, reg_sec_mpcp_offset);

    *cfgsecrxmpcpoffset = RU_FIELD_GET(0, XIF, SEC_MPCP_OFFSET, CFGSECRXMPCPOFFSET, reg_sec_mpcp_offset);
...
enum
{
    ...
    BDMF_ctl_2,
    BDMF_vlan_type_1,
    BDMF_p2p_ae_sci_lo_16,
    BDMF_p2p_ae_sci_hi_16,
    BDMF_p2p_ae_sci_lo_17,
    BDMF_p2p_ae_sci_hi_17,
    BDMF_p2p_ae_sci_lo_18,
    BDMF_p2p_ae_sci_hi_18,
    BDMF_p2p_ae_sci_lo_19,
    BDMF_p2p_ae_sci_hi_19,
    BDMF_p2p_ae_sci_lo_20,
    BDMF_p2p_ae_sci_hi_20,
    BDMF_p2p_ae_sci_lo_21,
    BDMF_p2p_ae_sci_hi_21,
    BDMF_p2p_ae_sci_lo_22,
    BDMF_p2p_ae_sci_hi_22,
    BDMF_p2p_ae_sci_lo_23,
    BDMF_p2p_ae_sci_hi_23,
    BDMF_p2p_ae_sci_lo_24,
    BDMF_p2p_ae_sci_hi_24,
    BDMF_p2p_ae_sci_lo_25,
    BDMF_p2p_ae_sci_hi_25,
    BDMF_p2p_ae_sci_lo_26,
    BDMF_p2p_ae_sci_hi_26,
    BDMF_p2p_ae_sci_lo_27,
    BDMF_p2p_ae_sci_hi_27,
    BDMF_p2p_ae_sci_lo_28,
    BDMF_p2p_ae_sci_hi_28,
    BDMF_p2p_ae_sci_lo_29,
    BDMF_p2p_ae_sci_hi_29,
    BDMF_p2p_ae_sci_lo_30,
    BDMF_p2p_ae_sci_hi_30,
    BDMF_p2p_ae_sci_lo_31,
    BDMF_p2p_ae_sci_hi_31,
    BDMF_up_1588_ts_offset_lo,
    BDMF_up_1588_ts_offset_hi,
    BDMF_up_1588_two_step_ts_ctl,
    BDMF_up_1588_two_step_ts_value_lo,
    BDMF_up_1588_two_step_ts_value_hi,
    BDMF_1588_ts_sync_offset,
    BDMF_sec_mpcp_offset,
};
...
typedef enum
{
    ...
    bdmf_address_ctl_2,
    bdmf_address_vlan_type_1,
    bdmf_address_p2p_ae_sci_lo_16,
    bdmf_address_p2p_ae_sci_hi_16,
    bdmf_address_p2p_ae_sci_lo_17,
    bdmf_address_p2p_ae_sci_hi_17,
    bdmf_address_p2p_ae_sci_lo_18,
    bdmf_address_p2p_ae_sci_hi_18,
    bdmf_address_p2p_ae_sci_lo_19,
    bdmf_address_p2p_ae_sci_hi_19,
    bdmf_address_p2p_ae_sci_lo_20,
    bdmf_address_p2p_ae_sci_hi_20,
    bdmf_address_p2p_ae_sci_lo_21,
    bdmf_address_p2p_ae_sci_hi_21,
    bdmf_address_p2p_ae_sci_lo_22,
    bdmf_address_p2p_ae_sci_hi_22,
    bdmf_address_p2p_ae_sci_lo_23,
    bdmf_address_p2p_ae_sci_hi_23,
    bdmf_address_p2p_ae_sci_lo_24,
    bdmf_address_p2p_ae_sci_hi_24,
    bdmf_address_p2p_ae_sci_lo_25,
    bdmf_address_p2p_ae_sci_hi_25,
    bdmf_address_p2p_ae_sci_lo_26,
    bdmf_address_p2p_ae_sci_hi_26,
    bdmf_address_p2p_ae_sci_lo_27,
    bdmf_address_p2p_ae_sci_hi_27,
    bdmf_address_p2p_ae_sci_lo_28,
    bdmf_address_p2p_ae_sci_hi_28,
    bdmf_address_p2p_ae_sci_lo_29,
    bdmf_address_p2p_ae_sci_hi_29,
    bdmf_address_p2p_ae_sci_lo_30,
    bdmf_address_p2p_ae_sci_hi_30,
    bdmf_address_p2p_ae_sci_lo_31,
    bdmf_address_p2p_ae_sci_hi_31,
    bdmf_address_up_1588_ts_offset_lo,
    bdmf_address_up_1588_ts_offset_hi,
    bdmf_address_up_1588_two_step_ts_ctl,
    bdmf_address_up_1588_two_step_ts_value_lo,
    bdmf_address_up_1588_two_step_ts_value_hi,
    bdmf_address_1588_ts_sync_offset,
    bdmf_address_sec_mpcp_offset,
}
bdmf_address;
...
static int bcm_xif_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        xif_int_status int_status = { .ts1588pktabort=parm[1].value.unumber, .ts1588twostepff=parm[2].value.unumber, .secrxrplyprtctabrtint=parm[3].value.unumber, .sectxpktnummaxint=parm[4].value.unumber, .tsfullupdint=parm[5].value.unumber, .txhangint=parm[6].value.unumber, .negtimeint=parm[7].value.unumber, .pmctsjttrint=parm[8].value.unumber, .secrxoutffovrflwint=parm[9].value.unumber};
        err = ag_drv_xif_int_status_set(&int_status);
        break;
    }
    case BDMF_int_mask:
    {
        xif_int_mask int_mask = { .mskts1588pktabort=parm[1].value.unumber, .mskts1588twostepff=parm[2].value.unumber, .msksecrxreplayprotctabort=parm[3].value.unumber, .mskpktnumthreshint=parm[4].value.unumber, .msktsfullupdint=parm[5].value.unumber, .msktxhangint=parm[6].value.unumber, .msknegtimeint=parm[7].value.unumber, .mskpmctsjttrint=parm[8].value.unumber, .msksecrxoutffint=parm[9].value.unumber};
    ...
    case BDMF_sec_ctl:
    {
        xif_sec_ctl sec_ctl = { .cfgkeynum_4_an_3=parm[1].value.unumber, .cfgkeynum_4_an_2=parm[2].value.unumber, .cfgkeynum_4_an_1=parm[3].value.unumber, .cfgkeynum_4_an_0=parm[4].value.unumber, .cfgsecrxenshortlen=parm[5].value.unumber, .cfgensectxfakeaes=parm[6].value.unumber, .cfgensecrxfakeaes=parm[7].value.unumber, .cfgsecrxenpktnumrlovr=parm[8].value.unumber, .cfgsectxenpktnumrlovr=parm[9].value.unumber, .cfgenaereplayprct=parm[10].value.unumber};
    ...
    case BDMF_p2p_ae_sci_hi_15:
        ...
        break;
    case BDMF_ctl_2:
        err = ag_drv_xif_ctl_2_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber, parm[4].value.unumber);
        break;
    case BDMF_vlan_type_1:
        err = ag_drv_xif_vlan_type_1_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_lo_16:
        err = ag_drv_xif_p2p_ae_sci_lo_16_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_hi_16:
        err = ag_drv_xif_p2p_ae_sci_hi_16_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_lo_17:
        err = ag_drv_xif_p2p_ae_sci_lo_17_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_hi_17:
        err = ag_drv_xif_p2p_ae_sci_hi_17_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_lo_18:
        err = ag_drv_xif_p2p_ae_sci_lo_18_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_hi_18:
        err = ag_drv_xif_p2p_ae_sci_hi_18_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_lo_19:
        err = ag_drv_xif_p2p_ae_sci_lo_19_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_hi_19:
        err = ag_drv_xif_p2p_ae_sci_hi_19_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_lo_20:
        err = ag_drv_xif_p2p_ae_sci_lo_20_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_hi_20:
        err = ag_drv_xif_p2p_ae_sci_hi_20_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_lo_21:
        err = ag_drv_xif_p2p_ae_sci_lo_21_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_hi_21:
        err = ag_drv_xif_p2p_ae_sci_hi_21_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_lo_22:
        err = ag_drv_xif_p2p_ae_sci_lo_22_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_hi_22:
        err = ag_drv_xif_p2p_ae_sci_hi_22_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_lo_23:
        err = ag_drv_xif_p2p_ae_sci_lo_23_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_hi_23:
        err = ag_drv_xif_p2p_ae_sci_hi_23_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_lo_24:
        err = ag_drv_xif_p2p_ae_sci_lo_24_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_hi_24:
        err = ag_drv_xif_p2p_ae_sci_hi_24_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_lo_25:
        err = ag_drv_xif_p2p_ae_sci_lo_25_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_hi_25:
        err = ag_drv_xif_p2p_ae_sci_hi_25_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_lo_26:
        err = ag_drv_xif_p2p_ae_sci_lo_26_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_hi_26:
        err = ag_drv_xif_p2p_ae_sci_hi_26_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_lo_27:
        err = ag_drv_xif_p2p_ae_sci_lo_27_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_hi_27:
        err = ag_drv_xif_p2p_ae_sci_hi_27_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_lo_28:
        err = ag_drv_xif_p2p_ae_sci_lo_28_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_hi_28:
        err = ag_drv_xif_p2p_ae_sci_hi_28_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_lo_29:
        err = ag_drv_xif_p2p_ae_sci_lo_29_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_hi_29:
        err = ag_drv_xif_p2p_ae_sci_hi_29_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_lo_30:
        err = ag_drv_xif_p2p_ae_sci_lo_30_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_hi_30:
        err = ag_drv_xif_p2p_ae_sci_hi_30_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_lo_31:
        err = ag_drv_xif_p2p_ae_sci_lo_31_set(parm[1].value.unumber);
        break;
    case BDMF_p2p_ae_sci_hi_31:
        err = ag_drv_xif_p2p_ae_sci_hi_31_set(parm[1].value.unumber);
        break;
    case BDMF_up_1588_ts_offset_lo:
        err = ag_drv_xif_up_1588_ts_offset_lo_set(parm[1].value.unumber);
        break;
    case BDMF_up_1588_ts_offset_hi:
        err = ag_drv_xif_up_1588_ts_offset_hi_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case BDMF_up_1588_two_step_ts_ctl:
        err = ag_drv_xif_up_1588_two_step_ts_ctl_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case BDMF_1588_ts_sync_offset:
        err = ag_drv_xif_1588_ts_sync_offset_set(parm[1].value.unumber);
        break;
    case BDMF_sec_mpcp_offset:
        err = ag_drv_xif_sec_mpcp_offset_set(parm[1].value.unumber);
        break;
    default:
...
static int bcm_xif_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case BDMF_int_status:
    {
        ...
        bdmf_session_print(session, "ts1588pktabort = %u = 0x%x\n", int_status.ts1588pktabort, int_status.ts1588pktabort);
        bdmf_session_print(session, "ts1588twostepff = %u = 0x%x\n", int_status.ts1588twostepff, int_status.ts1588twostepff);
    ...
    case BDMF_int_mask:
    {
        ...
        bdmf_session_print(session, "mskts1588pktabort = %u = 0x%x\n", int_mask.mskts1588pktabort, int_mask.mskts1588pktabort);
        bdmf_session_print(session, "mskts1588twostepff = %u = 0x%x\n", int_mask.mskts1588twostepff, int_mask.mskts1588twostepff);
    ...
    case BDMF_sec_ctl:
    {
        ...
        bdmf_session_print(session, "cfgkeynum_4_an_3 = %u = 0x%x\n", sec_ctl.cfgkeynum_4_an_3, sec_ctl.cfgkeynum_4_an_3);
        bdmf_session_print(session, "cfgkeynum_4_an_2 = %u = 0x%x\n", sec_ctl.cfgkeynum_4_an_2, sec_ctl.cfgkeynum_4_an_2);
        bdmf_session_print(session, "cfgkeynum_4_an_1 = %u = 0x%x\n", sec_ctl.cfgkeynum_4_an_1, sec_ctl.cfgkeynum_4_an_1);
        bdmf_session_print(session, "cfgkeynum_4_an_0 = %u = 0x%x\n", sec_ctl.cfgkeynum_4_an_0, sec_ctl.cfgkeynum_4_an_0);
    ...
    case BDMF_ctl_2:
    {
        bdmf_boolean cfgen1588adj4parb4da;
        bdmf_boolean cfgentx1588;
        bdmf_boolean cfgdisp2pdnindexmap;
        bdmf_boolean cfgdisp2pupindexmap;
        err = ag_drv_xif_ctl_2_get(&cfgen1588adj4parb4da, &cfgentx1588, &cfgdisp2pdnindexmap, &cfgdisp2pupindexmap);
        bdmf_session_print(session, "cfgen1588adj4parb4da = %u = 0x%x\n", cfgen1588adj4parb4da, cfgen1588adj4parb4da);
        bdmf_session_print(session, "cfgentx1588 = %u = 0x%x\n", cfgentx1588, cfgentx1588);
        bdmf_session_print(session, "cfgdisp2pdnindexmap = %u = 0x%x\n", cfgdisp2pdnindexmap, cfgdisp2pdnindexmap);
        bdmf_session_print(session, "cfgdisp2pupindexmap = %u = 0x%x\n", cfgdisp2pupindexmap, cfgdisp2pupindexmap);
        break;
    }
    case BDMF_vlan_type_1:
    {
        uint16_t cfgvlantype_1;
        err = ag_drv_xif_vlan_type_1_get(&cfgvlantype_1);
        bdmf_session_print(session, "cfgvlantype_1 = %u = 0x%x\n", cfgvlantype_1, cfgvlantype_1);
        break;
    }
    case BDMF_p2p_ae_sci_lo_16:
    {
        uint32_t cfgp2psci_lo_16;
        err = ag_drv_xif_p2p_ae_sci_lo_16_get(&cfgp2psci_lo_16);
        bdmf_session_print(session, "cfgp2psci_lo_16 = %u = 0x%x\n", cfgp2psci_lo_16, cfgp2psci_lo_16);
        break;
    }
    case BDMF_p2p_ae_sci_hi_16:
    {
        uint32_t cfgp2psci_hi_16;
        err = ag_drv_xif_p2p_ae_sci_hi_16_get(&cfgp2psci_hi_16);
        bdmf_session_print(session, "cfgp2psci_hi_16 = %u = 0x%x\n", cfgp2psci_hi_16, cfgp2psci_hi_16);
        break;
    }
    case BDMF_p2p_ae_sci_lo_17:
    {
        uint32_t cfgp2psci_lo_17;
        err = ag_drv_xif_p2p_ae_sci_lo_17_get(&cfgp2psci_lo_17);
        bdmf_session_print(session, "cfgp2psci_lo_17 = %u = 0x%x\n", cfgp2psci_lo_17, cfgp2psci_lo_17);
        break;
    }
    case BDMF_p2p_ae_sci_hi_17:
    {
        uint32_t cfgp2psci_hi_17;
        err = ag_drv_xif_p2p_ae_sci_hi_17_get(&cfgp2psci_hi_17);
        bdmf_session_print(session, "cfgp2psci_hi_17 = %u = 0x%x\n", cfgp2psci_hi_17, cfgp2psci_hi_17);
        break;
    }
    case BDMF_p2p_ae_sci_lo_18:
    {
        uint32_t cfgp2psci_lo_18;
        err = ag_drv_xif_p2p_ae_sci_lo_18_get(&cfgp2psci_lo_18);
        bdmf_session_print(session, "cfgp2psci_lo_18 = %u = 0x%x\n", cfgp2psci_lo_18, cfgp2psci_lo_18);
        break;
    }
    case BDMF_p2p_ae_sci_hi_18:
    {
        uint32_t cfgp2psci_hi_18;
        err = ag_drv_xif_p2p_ae_sci_hi_18_get(&cfgp2psci_hi_18);
        bdmf_session_print(session, "cfgp2psci_hi_18 = %u = 0x%x\n", cfgp2psci_hi_18, cfgp2psci_hi_18);
        break;
    }
    case BDMF_p2p_ae_sci_lo_19:
    {
        uint32_t cfgp2psci_lo_19;
        err = ag_drv_xif_p2p_ae_sci_lo_19_get(&cfgp2psci_lo_19);
        bdmf_session_print(session, "cfgp2psci_lo_19 = %u = 0x%x\n", cfgp2psci_lo_19, cfgp2psci_lo_19);
        break;
    }
    case BDMF_p2p_ae_sci_hi_19:
    {
        uint32_t cfgp2psci_hi_19;
        err = ag_drv_xif_p2p_ae_sci_hi_19_get(&cfgp2psci_hi_19);
        bdmf_session_print(session, "cfgp2psci_hi_19 = %u = 0x%x\n", cfgp2psci_hi_19, cfgp2psci_hi_19);
        break;
    }
    case BDMF_p2p_ae_sci_lo_20:
    {
        uint32_t cfgp2psci_lo_20;
        err = ag_drv_xif_p2p_ae_sci_lo_20_get(&cfgp2psci_lo_20);
        bdmf_session_print(session, "cfgp2psci_lo_20 = %u = 0x%x\n", cfgp2psci_lo_20, cfgp2psci_lo_20);
        break;
    }
    case BDMF_p2p_ae_sci_hi_20:
    {
        uint32_t cfgp2psci_hi_20;
        err = ag_drv_xif_p2p_ae_sci_hi_20_get(&cfgp2psci_hi_20);
        bdmf_session_print(session, "cfgp2psci_hi_20 = %u = 0x%x\n", cfgp2psci_hi_20, cfgp2psci_hi_20);
        break;
    }
    case BDMF_p2p_ae_sci_lo_21:
    {
        uint32_t cfgp2psci_lo_21;
        err = ag_drv_xif_p2p_ae_sci_lo_21_get(&cfgp2psci_lo_21);
        bdmf_session_print(session, "cfgp2psci_lo_21 = %u = 0x%x\n", cfgp2psci_lo_21, cfgp2psci_lo_21);
        break;
    }
    case BDMF_p2p_ae_sci_hi_21:
    {
        uint32_t cfgp2psci_hi_21;
        err = ag_drv_xif_p2p_ae_sci_hi_21_get(&cfgp2psci_hi_21);
        bdmf_session_print(session, "cfgp2psci_hi_21 = %u = 0x%x\n", cfgp2psci_hi_21, cfgp2psci_hi_21);
        break;
    }
    case BDMF_p2p_ae_sci_lo_22:
    {
        uint32_t cfgp2psci_lo_22;
        err = ag_drv_xif_p2p_ae_sci_lo_22_get(&cfgp2psci_lo_22);
        bdmf_session_print(session, "cfgp2psci_lo_22 = %u = 0x%x\n", cfgp2psci_lo_22, cfgp2psci_lo_22);
        break;
    }
    case BDMF_p2p_ae_sci_hi_22:
    {
        uint32_t cfgp2psci_hi_22;
        err = ag_drv_xif_p2p_ae_sci_hi_22_get(&cfgp2psci_hi_22);
        bdmf_session_print(session, "cfgp2psci_hi_22 = %u = 0x%x\n", cfgp2psci_hi_22, cfgp2psci_hi_22);
        break;
    }
    case BDMF_p2p_ae_sci_lo_23:
    {
        uint32_t cfgp2psci_lo_23;
        err = ag_drv_xif_p2p_ae_sci_lo_23_get(&cfgp2psci_lo_23);
        bdmf_session_print(session, "cfgp2psci_lo_23 = %u = 0x%x\n", cfgp2psci_lo_23, cfgp2psci_lo_23);
        break;
    }
    case BDMF_p2p_ae_sci_hi_23:
    {
        uint32_t cfgp2psci_hi_23;
        err = ag_drv_xif_p2p_ae_sci_hi_23_get(&cfgp2psci_hi_23);
        bdmf_session_print(session, "cfgp2psci_hi_23 = %u = 0x%x\n", cfgp2psci_hi_23, cfgp2psci_hi_23);
        break;
    }
    case BDMF_p2p_ae_sci_lo_24:
    {
        uint32_t cfgp2psci_lo_24;
        err = ag_drv_xif_p2p_ae_sci_lo_24_get(&cfgp2psci_lo_24);
        bdmf_session_print(session, "cfgp2psci_lo_24 = %u = 0x%x\n", cfgp2psci_lo_24, cfgp2psci_lo_24);
        break;
    }
    case BDMF_p2p_ae_sci_hi_24:
    {
        uint32_t cfgp2psci_hi_24;
        err = ag_drv_xif_p2p_ae_sci_hi_24_get(&cfgp2psci_hi_24);
        bdmf_session_print(session, "cfgp2psci_hi_24 = %u = 0x%x\n", cfgp2psci_hi_24, cfgp2psci_hi_24);
        break;
    }
    case BDMF_p2p_ae_sci_lo_25:
    {
        uint32_t cfgp2psci_lo_25;
        err = ag_drv_xif_p2p_ae_sci_lo_25_get(&cfgp2psci_lo_25);
        bdmf_session_print(session, "cfgp2psci_lo_25 = %u = 0x%x\n", cfgp2psci_lo_25, cfgp2psci_lo_25);
        break;
    }
    case BDMF_p2p_ae_sci_hi_25:
    {
        uint32_t cfgp2psci_hi_25;
        err = ag_drv_xif_p2p_ae_sci_hi_25_get(&cfgp2psci_hi_25);
        bdmf_session_print(session, "cfgp2psci_hi_25 = %u = 0x%x\n", cfgp2psci_hi_25, cfgp2psci_hi_25);
        break;
    }
    case BDMF_p2p_ae_sci_lo_26:
    {
        uint32_t cfgp2psci_lo_26;
        err = ag_drv_xif_p2p_ae_sci_lo_26_get(&cfgp2psci_lo_26);
        bdmf_session_print(session, "cfgp2psci_lo_26 = %u = 0x%x\n", cfgp2psci_lo_26, cfgp2psci_lo_26);
        break;
    }
    case BDMF_p2p_ae_sci_hi_26:
    {
        uint32_t cfgp2psci_hi_26;
        err = ag_drv_xif_p2p_ae_sci_hi_26_get(&cfgp2psci_hi_26);
        bdmf_session_print(session, "cfgp2psci_hi_26 = %u = 0x%x\n", cfgp2psci_hi_26, cfgp2psci_hi_26);
        break;
    }
    case BDMF_p2p_ae_sci_lo_27:
    {
        uint32_t cfgp2psci_lo_27;
        err = ag_drv_xif_p2p_ae_sci_lo_27_get(&cfgp2psci_lo_27);
        bdmf_session_print(session, "cfgp2psci_lo_27 = %u = 0x%x\n", cfgp2psci_lo_27, cfgp2psci_lo_27);
        break;
    }
    case BDMF_p2p_ae_sci_hi_27:
    {
        uint32_t cfgp2psci_hi_27;
        err = ag_drv_xif_p2p_ae_sci_hi_27_get(&cfgp2psci_hi_27);
        bdmf_session_print(session, "cfgp2psci_hi_27 = %u = 0x%x\n", cfgp2psci_hi_27, cfgp2psci_hi_27);
        break;
    }
    case BDMF_p2p_ae_sci_lo_28:
    {
        uint32_t cfgp2psci_lo_28;
        err = ag_drv_xif_p2p_ae_sci_lo_28_get(&cfgp2psci_lo_28);
        bdmf_session_print(session, "cfgp2psci_lo_28 = %u = 0x%x\n", cfgp2psci_lo_28, cfgp2psci_lo_28);
        break;
    }
    case BDMF_p2p_ae_sci_hi_28:
    {
        uint32_t cfgp2psci_hi_28;
        err = ag_drv_xif_p2p_ae_sci_hi_28_get(&cfgp2psci_hi_28);
        bdmf_session_print(session, "cfgp2psci_hi_28 = %u = 0x%x\n", cfgp2psci_hi_28, cfgp2psci_hi_28);
        break;
    }
    case BDMF_p2p_ae_sci_lo_29:
    {
        uint32_t cfgp2psci_lo_29;
        err = ag_drv_xif_p2p_ae_sci_lo_29_get(&cfgp2psci_lo_29);
        bdmf_session_print(session, "cfgp2psci_lo_29 = %u = 0x%x\n", cfgp2psci_lo_29, cfgp2psci_lo_29);
        break;
    }
    case BDMF_p2p_ae_sci_hi_29:
    {
        uint32_t cfgp2psci_hi_29;
        err = ag_drv_xif_p2p_ae_sci_hi_29_get(&cfgp2psci_hi_29);
        bdmf_session_print(session, "cfgp2psci_hi_29 = %u = 0x%x\n", cfgp2psci_hi_29, cfgp2psci_hi_29);
        break;
    }
    case BDMF_p2p_ae_sci_lo_30:
    {
        uint32_t cfgp2psci_lo_30;
        err = ag_drv_xif_p2p_ae_sci_lo_30_get(&cfgp2psci_lo_30);
        bdmf_session_print(session, "cfgp2psci_lo_30 = %u = 0x%x\n", cfgp2psci_lo_30, cfgp2psci_lo_30);
        break;
    }
    case BDMF_p2p_ae_sci_hi_30:
    {
        uint32_t cfgp2psci_hi_30;
        err = ag_drv_xif_p2p_ae_sci_hi_30_get(&cfgp2psci_hi_30);
        bdmf_session_print(session, "cfgp2psci_hi_30 = %u = 0x%x\n", cfgp2psci_hi_30, cfgp2psci_hi_30);
        break;
    }
    case BDMF_p2p_ae_sci_lo_31:
    {
        uint32_t cfgp2psci_lo_31;
        err = ag_drv_xif_p2p_ae_sci_lo_31_get(&cfgp2psci_lo_31);
        bdmf_session_print(session, "cfgp2psci_lo_31 = %u = 0x%x\n", cfgp2psci_lo_31, cfgp2psci_lo_31);
        break;
    }
    case BDMF_p2p_ae_sci_hi_31:
    {
        uint32_t cfgp2psci_hi_31;
        err = ag_drv_xif_p2p_ae_sci_hi_31_get(&cfgp2psci_hi_31);
        bdmf_session_print(session, "cfgp2psci_hi_31 = %u = 0x%x\n", cfgp2psci_hi_31, cfgp2psci_hi_31);
        break;
    }
    case BDMF_up_1588_ts_offset_lo:
    {
        uint32_t cfgup1588tsoffset_lo;
        err = ag_drv_xif_up_1588_ts_offset_lo_get(&cfgup1588tsoffset_lo);
        bdmf_session_print(session, "cfgup1588tsoffset_lo = %u = 0x%x\n", cfgup1588tsoffset_lo, cfgup1588tsoffset_lo);
        break;
    }
    case BDMF_up_1588_ts_offset_hi:
    {
        uint8_t cfgcmhoffset;
        uint16_t cfgup1588tsoffset_hi;
        err = ag_drv_xif_up_1588_ts_offset_hi_get(&cfgcmhoffset, &cfgup1588tsoffset_hi);
        bdmf_session_print(session, "cfgcmhoffset = %u = 0x%x\n", cfgcmhoffset, cfgcmhoffset);
        bdmf_session_print(session, "cfgup1588tsoffset_hi = %u = 0x%x\n", cfgup1588tsoffset_hi, cfgup1588tsoffset_hi);
        break;
    }
    case BDMF_up_1588_two_step_ts_ctl:
    {
        ...
        err = ag_drv_xif_up_1588_two_step_ts_ctl_get(&twostepffrd, &twostepffentries);
    ...
    case BDMF_up_1588_two_step_ts_value_lo:
    {
        uint32_t twosteptimestamp_lo;
        err = ag_drv_xif_up_1588_two_step_ts_value_lo_get(&twosteptimestamp_lo);
        bdmf_session_print(session, "twosteptimestamp_lo = %u = 0x%x\n", twosteptimestamp_lo, twosteptimestamp_lo);
        break;
    }
    case BDMF_up_1588_two_step_ts_value_hi:
    {
        uint16_t twosteptimestamp_hi;
        err = ag_drv_xif_up_1588_two_step_ts_value_hi_get(&twosteptimestamp_hi);
    ...
    case BDMF_1588_ts_sync_offset:
    {
        ...
        err = ag_drv_xif_1588_ts_sync_offset_get(&cfgtssyncoffset);
        bdmf_session_print(session, "cfgtssyncoffset = %u = 0x%x\n", cfgtssyncoffset, cfgtssyncoffset);
        break;
    }
    case BDMF_sec_mpcp_offset:
    {
        uint32_t cfgsecrxmpcpoffset;
        err = ag_drv_xif_sec_mpcp_offset_get(&cfgsecrxmpcpoffset);
        bdmf_session_print(session, "cfgsecrxmpcpoffset = %u = 0x%x\n", cfgsecrxmpcpoffset, cfgsecrxmpcpoffset);
        break;
    }
    default:
        err = BDMF_ERR_NOT_SUPPORTED;
...
static int bcm_xif_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        xif_int_status int_status = {.ts1588pktabort=gtmv(m, 1), .ts1588twostepff=gtmv(m, 1), .secrxrplyprtctabrtint=gtmv(m, 1), .sectxpktnummaxint=gtmv(m, 1), .tsfullupdint=gtmv(m, 1), .txhangint=gtmv(m, 1), .negtimeint=gtmv(m, 1), .pmctsjttrint=gtmv(m, 1), .secrxoutffovrflwint=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_xif_int_status_set( %u %u %u %u %u %u %u %u %u)\n", int_status.ts1588pktabort, int_status.ts1588twostepff, int_status.secrxrplyprtctabrtint, int_status.sectxpktnummaxint, int_status.tsfullupdint, int_status.txhangint, int_status.negtimeint, int_status.pmctsjttrint, int_status.secrxoutffovrflwint);
        if(!err) ag_drv_xif_int_status_set(&int_status);
        if(!err) ag_drv_xif_int_status_get( &int_status);
        if(!err) bdmf_session_print(session, "ag_drv_xif_int_status_get( %u %u %u %u %u %u %u %u %u)\n", int_status.ts1588pktabort, int_status.ts1588twostepff, int_status.secrxrplyprtctabrtint, int_status.sectxpktnummaxint, int_status.tsfullupdint, int_status.txhangint, int_status.negtimeint, int_status.pmctsjttrint, int_status.secrxoutffovrflwint);
        if(err || int_status.ts1588pktabort!=gtmv(m, 1) || int_status.ts1588twostepff!=gtmv(m, 1) || int_status.secrxrplyprtctabrtint!=gtmv(m, 1) || int_status.sectxpktnummaxint!=gtmv(m, 1) || int_status.tsfullupdint!=gtmv(m, 1) || int_status.txhangint!=gtmv(m, 1) || int_status.negtimeint!=gtmv(m, 1) || int_status.pmctsjttrint!=gtmv(m, 1) || int_status.secrxoutffovrflwint!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
        xif_int_mask int_mask = {.mskts1588pktabort=gtmv(m, 1), .mskts1588twostepff=gtmv(m, 1), .msksecrxreplayprotctabort=gtmv(m, 1), .mskpktnumthreshint=gtmv(m, 1), .msktsfullupdint=gtmv(m, 1), .msktxhangint=gtmv(m, 1), .msknegtimeint=gtmv(m, 1), .mskpmctsjttrint=gtmv(m, 1), .msksecrxoutffint=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_xif_int_mask_set( %u %u %u %u %u %u %u %u %u)\n", int_mask.mskts1588pktabort, int_mask.mskts1588twostepff, int_mask.msksecrxreplayprotctabort, int_mask.mskpktnumthreshint, int_mask.msktsfullupdint, int_mask.msktxhangint, int_mask.msknegtimeint, int_mask.mskpmctsjttrint, int_mask.msksecrxoutffint);
        if(!err) ag_drv_xif_int_mask_set(&int_mask);
        if(!err) ag_drv_xif_int_mask_get( &int_mask);
        if(!err) bdmf_session_print(session, "ag_drv_xif_int_mask_get( %u %u %u %u %u %u %u %u %u)\n", int_mask.mskts1588pktabort, int_mask.mskts1588twostepff, int_mask.msksecrxreplayprotctabort, int_mask.mskpktnumthreshint, int_mask.msktsfullupdint, int_mask.msktxhangint, int_mask.msknegtimeint, int_mask.mskpmctsjttrint, int_mask.msksecrxoutffint);
        if(err || int_mask.mskts1588pktabort!=gtmv(m, 1) || int_mask.mskts1588twostepff!=gtmv(m, 1) || int_mask.msksecrxreplayprotctabort!=gtmv(m, 1) || int_mask.mskpktnumthreshint!=gtmv(m, 1) || int_mask.msktsfullupdint!=gtmv(m, 1) || int_mask.msktxhangint!=gtmv(m, 1) || int_mask.msknegtimeint!=gtmv(m, 1) || int_mask.mskpmctsjttrint!=gtmv(m, 1) || int_mask.msksecrxoutffint!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        xif_sec_ctl sec_ctl = {.cfgkeynum_4_an_3=gtmv(m, 1), .cfgkeynum_4_an_2=gtmv(m, 1), .cfgkeynum_4_an_1=gtmv(m, 1), .cfgkeynum_4_an_0=gtmv(m, 1), .cfgsecrxenshortlen=gtmv(m, 1), .cfgensectxfakeaes=gtmv(m, 1), .cfgensecrxfakeaes=gtmv(m, 1), .cfgsecrxenpktnumrlovr=gtmv(m, 1), .cfgsectxenpktnumrlovr=gtmv(m, 1), .cfgenaereplayprct=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_ctl_set( %u %u %u %u %u %u %u %u %u %u)\n", sec_ctl.cfgkeynum_4_an_3, sec_ctl.cfgkeynum_4_an_2, sec_ctl.cfgkeynum_4_an_1, sec_ctl.cfgkeynum_4_an_0, sec_ctl.cfgsecrxenshortlen, sec_ctl.cfgensectxfakeaes, sec_ctl.cfgensecrxfakeaes, sec_ctl.cfgsecrxenpktnumrlovr, sec_ctl.cfgsectxenpktnumrlovr, sec_ctl.cfgenaereplayprct);
        if(!err) ag_drv_xif_sec_ctl_set(&sec_ctl);
        if(!err) ag_drv_xif_sec_ctl_get( &sec_ctl);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_ctl_get( %u %u %u %u %u %u %u %u %u %u)\n", sec_ctl.cfgkeynum_4_an_3, sec_ctl.cfgkeynum_4_an_2, sec_ctl.cfgkeynum_4_an_1, sec_ctl.cfgkeynum_4_an_0, sec_ctl.cfgsecrxenshortlen, sec_ctl.cfgensectxfakeaes, sec_ctl.cfgensecrxfakeaes, sec_ctl.cfgsecrxenpktnumrlovr, sec_ctl.cfgsectxenpktnumrlovr, sec_ctl.cfgenaereplayprct);
        if(err || sec_ctl.cfgkeynum_4_an_3!=gtmv(m, 1) || sec_ctl.cfgkeynum_4_an_2!=gtmv(m, 1) || sec_ctl.cfgkeynum_4_an_1!=gtmv(m, 1) || sec_ctl.cfgkeynum_4_an_0!=gtmv(m, 1) || sec_ctl.cfgsecrxenshortlen!=gtmv(m, 1) || sec_ctl.cfgensectxfakeaes!=gtmv(m, 1) || sec_ctl.cfgensecrxfakeaes!=gtmv(m, 1) || sec_ctl.cfgsecrxenpktnumrlovr!=gtmv(m, 1) || sec_ctl.cfgsectxenpktnumrlovr!=gtmv(m, 1) || sec_ctl.cfgenaereplayprct!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        uint32_t cfgp2pscien=gtmv(m, 32);
    ...
    {
        bdmf_boolean cfgen1588adj4parb4da=gtmv(m, 1);
        bdmf_boolean cfgentx1588=gtmv(m, 1);
        bdmf_boolean cfgdisp2pdnindexmap=gtmv(m, 1);
        bdmf_boolean cfgdisp2pupindexmap=gtmv(m, 1);
        if(!err) bdmf_session_print(session, "ag_drv_xif_ctl_2_set( %u %u %u %u)\n", cfgen1588adj4parb4da, cfgentx1588, cfgdisp2pdnindexmap, cfgdisp2pupindexmap);
        if(!err) ag_drv_xif_ctl_2_set(cfgen1588adj4parb4da, cfgentx1588, cfgdisp2pdnindexmap, cfgdisp2pupindexmap);
        if(!err) ag_drv_xif_ctl_2_get( &cfgen1588adj4parb4da, &cfgentx1588, &cfgdisp2pdnindexmap, &cfgdisp2pupindexmap);
        if(!err) bdmf_session_print(session, "ag_drv_xif_ctl_2_get( %u %u %u %u)\n", cfgen1588adj4parb4da, cfgentx1588, cfgdisp2pdnindexmap, cfgdisp2pupindexmap);
        if(err || cfgen1588adj4parb4da!=gtmv(m, 1) || cfgentx1588!=gtmv(m, 1) || cfgdisp2pdnindexmap!=gtmv(m, 1) || cfgdisp2pupindexmap!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint16_t cfgvlantype_1=gtmv(m, 16);
        if(!err) bdmf_session_print(session, "ag_drv_xif_vlan_type_1_set( %u)\n", cfgvlantype_1);
        if(!err) ag_drv_xif_vlan_type_1_set(cfgvlantype_1);
        if(!err) ag_drv_xif_vlan_type_1_get( &cfgvlantype_1);
        if(!err) bdmf_session_print(session, "ag_drv_xif_vlan_type_1_get( %u)\n", cfgvlantype_1);
        if(err || cfgvlantype_1!=gtmv(m, 16))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_lo_16=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_16_set( %u)\n", cfgp2psci_lo_16);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_16_set(cfgp2psci_lo_16);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_16_get( &cfgp2psci_lo_16);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_16_get( %u)\n", cfgp2psci_lo_16);
        if(err || cfgp2psci_lo_16!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_hi_16=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_16_set( %u)\n", cfgp2psci_hi_16);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_16_set(cfgp2psci_hi_16);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_16_get( &cfgp2psci_hi_16);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_16_get( %u)\n", cfgp2psci_hi_16);
        if(err || cfgp2psci_hi_16!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_lo_17=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_17_set( %u)\n", cfgp2psci_lo_17);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_17_set(cfgp2psci_lo_17);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_17_get( &cfgp2psci_lo_17);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_17_get( %u)\n", cfgp2psci_lo_17);
        if(err || cfgp2psci_lo_17!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_hi_17=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_17_set( %u)\n", cfgp2psci_hi_17);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_17_set(cfgp2psci_hi_17);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_17_get( &cfgp2psci_hi_17);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_17_get( %u)\n", cfgp2psci_hi_17);
        if(err || cfgp2psci_hi_17!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_lo_18=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_18_set( %u)\n", cfgp2psci_lo_18);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_18_set(cfgp2psci_lo_18);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_18_get( &cfgp2psci_lo_18);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_18_get( %u)\n", cfgp2psci_lo_18);
        if(err || cfgp2psci_lo_18!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_hi_18=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_18_set( %u)\n", cfgp2psci_hi_18);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_18_set(cfgp2psci_hi_18);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_18_get( &cfgp2psci_hi_18);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_18_get( %u)\n", cfgp2psci_hi_18);
        if(err || cfgp2psci_hi_18!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_lo_19=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_19_set( %u)\n", cfgp2psci_lo_19);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_19_set(cfgp2psci_lo_19);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_19_get( &cfgp2psci_lo_19);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_19_get( %u)\n", cfgp2psci_lo_19);
        if(err || cfgp2psci_lo_19!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_hi_19=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_19_set( %u)\n", cfgp2psci_hi_19);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_19_set(cfgp2psci_hi_19);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_19_get( &cfgp2psci_hi_19);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_19_get( %u)\n", cfgp2psci_hi_19);
        if(err || cfgp2psci_hi_19!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_lo_20=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_20_set( %u)\n", cfgp2psci_lo_20);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_20_set(cfgp2psci_lo_20);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_20_get( &cfgp2psci_lo_20);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_20_get( %u)\n", cfgp2psci_lo_20);
        if(err || cfgp2psci_lo_20!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_hi_20=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_20_set( %u)\n", cfgp2psci_hi_20);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_20_set(cfgp2psci_hi_20);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_20_get( &cfgp2psci_hi_20);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_20_get( %u)\n", cfgp2psci_hi_20);
        if(err || cfgp2psci_hi_20!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_lo_21=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_21_set( %u)\n", cfgp2psci_lo_21);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_21_set(cfgp2psci_lo_21);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_21_get( &cfgp2psci_lo_21);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_21_get( %u)\n", cfgp2psci_lo_21);
        if(err || cfgp2psci_lo_21!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_hi_21=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_21_set( %u)\n", cfgp2psci_hi_21);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_21_set(cfgp2psci_hi_21);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_21_get( &cfgp2psci_hi_21);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_21_get( %u)\n", cfgp2psci_hi_21);
        if(err || cfgp2psci_hi_21!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_lo_22=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_22_set( %u)\n", cfgp2psci_lo_22);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_22_set(cfgp2psci_lo_22);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_22_get( &cfgp2psci_lo_22);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_22_get( %u)\n", cfgp2psci_lo_22);
        if(err || cfgp2psci_lo_22!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_hi_22=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_22_set( %u)\n", cfgp2psci_hi_22);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_22_set(cfgp2psci_hi_22);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_22_get( &cfgp2psci_hi_22);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_22_get( %u)\n", cfgp2psci_hi_22);
        if(err || cfgp2psci_hi_22!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_lo_23=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_23_set( %u)\n", cfgp2psci_lo_23);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_23_set(cfgp2psci_lo_23);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_23_get( &cfgp2psci_lo_23);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_23_get( %u)\n", cfgp2psci_lo_23);
        if(err || cfgp2psci_lo_23!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_hi_23=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_23_set( %u)\n", cfgp2psci_hi_23);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_23_set(cfgp2psci_hi_23);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_23_get( &cfgp2psci_hi_23);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_23_get( %u)\n", cfgp2psci_hi_23);
        if(err || cfgp2psci_hi_23!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_lo_24=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_24_set( %u)\n", cfgp2psci_lo_24);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_24_set(cfgp2psci_lo_24);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_24_get( &cfgp2psci_lo_24);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_24_get( %u)\n", cfgp2psci_lo_24);
        if(err || cfgp2psci_lo_24!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_hi_24=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_24_set( %u)\n", cfgp2psci_hi_24);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_24_set(cfgp2psci_hi_24);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_24_get( &cfgp2psci_hi_24);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_24_get( %u)\n", cfgp2psci_hi_24);
        if(err || cfgp2psci_hi_24!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_lo_25=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_25_set( %u)\n", cfgp2psci_lo_25);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_25_set(cfgp2psci_lo_25);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_25_get( &cfgp2psci_lo_25);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_25_get( %u)\n", cfgp2psci_lo_25);
        if(err || cfgp2psci_lo_25!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_hi_25=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_25_set( %u)\n", cfgp2psci_hi_25);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_25_set(cfgp2psci_hi_25);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_25_get( &cfgp2psci_hi_25);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_25_get( %u)\n", cfgp2psci_hi_25);
        if(err || cfgp2psci_hi_25!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_lo_26=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_26_set( %u)\n", cfgp2psci_lo_26);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_26_set(cfgp2psci_lo_26);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_26_get( &cfgp2psci_lo_26);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_26_get( %u)\n", cfgp2psci_lo_26);
        if(err || cfgp2psci_lo_26!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_hi_26=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_26_set( %u)\n", cfgp2psci_hi_26);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_26_set(cfgp2psci_hi_26);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_26_get( &cfgp2psci_hi_26);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_26_get( %u)\n", cfgp2psci_hi_26);
        if(err || cfgp2psci_hi_26!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_lo_27=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_27_set( %u)\n", cfgp2psci_lo_27);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_27_set(cfgp2psci_lo_27);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_27_get( &cfgp2psci_lo_27);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_27_get( %u)\n", cfgp2psci_lo_27);
        if(err || cfgp2psci_lo_27!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_hi_27=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_27_set( %u)\n", cfgp2psci_hi_27);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_27_set(cfgp2psci_hi_27);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_27_get( &cfgp2psci_hi_27);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_27_get( %u)\n", cfgp2psci_hi_27);
        if(err || cfgp2psci_hi_27!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_lo_28=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_28_set( %u)\n", cfgp2psci_lo_28);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_28_set(cfgp2psci_lo_28);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_28_get( &cfgp2psci_lo_28);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_28_get( %u)\n", cfgp2psci_lo_28);
        if(err || cfgp2psci_lo_28!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_hi_28=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_28_set( %u)\n", cfgp2psci_hi_28);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_28_set(cfgp2psci_hi_28);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_28_get( &cfgp2psci_hi_28);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_28_get( %u)\n", cfgp2psci_hi_28);
        if(err || cfgp2psci_hi_28!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_lo_29=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_29_set( %u)\n", cfgp2psci_lo_29);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_29_set(cfgp2psci_lo_29);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_29_get( &cfgp2psci_lo_29);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_29_get( %u)\n", cfgp2psci_lo_29);
        if(err || cfgp2psci_lo_29!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_hi_29=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_29_set( %u)\n", cfgp2psci_hi_29);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_29_set(cfgp2psci_hi_29);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_29_get( &cfgp2psci_hi_29);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_29_get( %u)\n", cfgp2psci_hi_29);
        if(err || cfgp2psci_hi_29!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_lo_30=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_30_set( %u)\n", cfgp2psci_lo_30);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_30_set(cfgp2psci_lo_30);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_30_get( &cfgp2psci_lo_30);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_30_get( %u)\n", cfgp2psci_lo_30);
        if(err || cfgp2psci_lo_30!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_hi_30=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_30_set( %u)\n", cfgp2psci_hi_30);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_30_set(cfgp2psci_hi_30);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_30_get( &cfgp2psci_hi_30);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_30_get( %u)\n", cfgp2psci_hi_30);
        if(err || cfgp2psci_hi_30!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_lo_31=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_31_set( %u)\n", cfgp2psci_lo_31);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_31_set(cfgp2psci_lo_31);
        if(!err) ag_drv_xif_p2p_ae_sci_lo_31_get( &cfgp2psci_lo_31);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_lo_31_get( %u)\n", cfgp2psci_lo_31);
        if(err || cfgp2psci_lo_31!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgp2psci_hi_31=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_31_set( %u)\n", cfgp2psci_hi_31);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_31_set(cfgp2psci_hi_31);
        if(!err) ag_drv_xif_p2p_ae_sci_hi_31_get( &cfgp2psci_hi_31);
        if(!err) bdmf_session_print(session, "ag_drv_xif_p2p_ae_sci_hi_31_get( %u)\n", cfgp2psci_hi_31);
        if(err || cfgp2psci_hi_31!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgup1588tsoffset_lo=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_up_1588_ts_offset_lo_set( %u)\n", cfgup1588tsoffset_lo);
        if(!err) ag_drv_xif_up_1588_ts_offset_lo_set(cfgup1588tsoffset_lo);
        if(!err) ag_drv_xif_up_1588_ts_offset_lo_get( &cfgup1588tsoffset_lo);
        if(!err) bdmf_session_print(session, "ag_drv_xif_up_1588_ts_offset_lo_get( %u)\n", cfgup1588tsoffset_lo);
        if(err || cfgup1588tsoffset_lo!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint8_t cfgcmhoffset=gtmv(m, 8);
        uint16_t cfgup1588tsoffset_hi=gtmv(m, 16);
        if(!err) bdmf_session_print(session, "ag_drv_xif_up_1588_ts_offset_hi_set( %u %u)\n", cfgcmhoffset, cfgup1588tsoffset_hi);
        if(!err) ag_drv_xif_up_1588_ts_offset_hi_set(cfgcmhoffset, cfgup1588tsoffset_hi);
        if(!err) ag_drv_xif_up_1588_ts_offset_hi_get( &cfgcmhoffset, &cfgup1588tsoffset_hi);
        if(!err) bdmf_session_print(session, "ag_drv_xif_up_1588_ts_offset_hi_get( %u %u)\n", cfgcmhoffset, cfgup1588tsoffset_hi);
        if(err || cfgcmhoffset!=gtmv(m, 8) || cfgup1588tsoffset_hi!=gtmv(m, 16))
            return err ? err : BDMF_ERR_IO;
    }
    {
        bdmf_boolean twostepffrd=gtmv(m, 1);
        uint8_t twostepffentries=gtmv(m, 3);
        if(!err) bdmf_session_print(session, "ag_drv_xif_up_1588_two_step_ts_ctl_set( %u %u)\n", twostepffrd, twostepffentries);
        if(!err) ag_drv_xif_up_1588_two_step_ts_ctl_set(twostepffrd, twostepffentries);
        if(!err) ag_drv_xif_up_1588_two_step_ts_ctl_get( &twostepffrd, &twostepffentries);
        if(!err) bdmf_session_print(session, "ag_drv_xif_up_1588_two_step_ts_ctl_get( %u %u)\n", twostepffrd, twostepffentries);
        if(err || twostepffrd!=gtmv(m, 1) || twostepffentries!=gtmv(m, 3))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t twosteptimestamp_lo=gtmv(m, 32);
        if(!err) ag_drv_xif_up_1588_two_step_ts_value_lo_get( &twosteptimestamp_lo);
        if(!err) bdmf_session_print(session, "ag_drv_xif_up_1588_two_step_ts_value_lo_get( %u)\n", twosteptimestamp_lo);
    }
    {
        uint16_t twosteptimestamp_hi=gtmv(m, 16);
        if(!err) ag_drv_xif_up_1588_two_step_ts_value_hi_get( &twosteptimestamp_hi);
        if(!err) bdmf_session_print(session, "ag_drv_xif_up_1588_two_step_ts_value_hi_get( %u)\n", twosteptimestamp_hi);
    }
    {
        uint8_t cfgtssyncoffset=gtmv(m, 6);
        if(!err) bdmf_session_print(session, "ag_drv_xif_1588_ts_sync_offset_set( %u)\n", cfgtssyncoffset);
        if(!err) ag_drv_xif_1588_ts_sync_offset_set(cfgtssyncoffset);
        if(!err) ag_drv_xif_1588_ts_sync_offset_get( &cfgtssyncoffset);
        if(!err) bdmf_session_print(session, "ag_drv_xif_1588_ts_sync_offset_get( %u)\n", cfgtssyncoffset);
        if(err || cfgtssyncoffset!=gtmv(m, 6))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgsecrxmpcpoffset=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_mpcp_offset_set( %u)\n", cfgsecrxmpcpoffset);
        if(!err) ag_drv_xif_sec_mpcp_offset_set(cfgsecrxmpcpoffset);
        if(!err) ag_drv_xif_sec_mpcp_offset_get( &cfgsecrxmpcpoffset);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_mpcp_offset_get( %u)\n", cfgsecrxmpcpoffset);
        if(err || cfgsecrxmpcpoffset!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    return err;
}
...
static int bcm_xif_cli_address(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case bdmf_address_ctl_2 : reg = &RU_REG(XIF, CTL_2); blk = &RU_BLK(XIF); break;
    case bdmf_address_vlan_type_1 : reg = &RU_REG(XIF, VLAN_TYPE_1); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_lo_16 : reg = &RU_REG(XIF, P2P_AE_SCI_LO_16); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_hi_16 : reg = &RU_REG(XIF, P2P_AE_SCI_HI_16); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_lo_17 : reg = &RU_REG(XIF, P2P_AE_SCI_LO_17); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_hi_17 : reg = &RU_REG(XIF, P2P_AE_SCI_HI_17); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_lo_18 : reg = &RU_REG(XIF, P2P_AE_SCI_LO_18); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_hi_18 : reg = &RU_REG(XIF, P2P_AE_SCI_HI_18); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_lo_19 : reg = &RU_REG(XIF, P2P_AE_SCI_LO_19); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_hi_19 : reg = &RU_REG(XIF, P2P_AE_SCI_HI_19); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_lo_20 : reg = &RU_REG(XIF, P2P_AE_SCI_LO_20); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_hi_20 : reg = &RU_REG(XIF, P2P_AE_SCI_HI_20); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_lo_21 : reg = &RU_REG(XIF, P2P_AE_SCI_LO_21); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_hi_21 : reg = &RU_REG(XIF, P2P_AE_SCI_HI_21); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_lo_22 : reg = &RU_REG(XIF, P2P_AE_SCI_LO_22); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_hi_22 : reg = &RU_REG(XIF, P2P_AE_SCI_HI_22); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_lo_23 : reg = &RU_REG(XIF, P2P_AE_SCI_LO_23); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_hi_23 : reg = &RU_REG(XIF, P2P_AE_SCI_HI_23); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_lo_24 : reg = &RU_REG(XIF, P2P_AE_SCI_LO_24); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_hi_24 : reg = &RU_REG(XIF, P2P_AE_SCI_HI_24); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_lo_25 : reg = &RU_REG(XIF, P2P_AE_SCI_LO_25); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_hi_25 : reg = &RU_REG(XIF, P2P_AE_SCI_HI_25); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_lo_26 : reg = &RU_REG(XIF, P2P_AE_SCI_LO_26); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_hi_26 : reg = &RU_REG(XIF, P2P_AE_SCI_HI_26); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_lo_27 : reg = &RU_REG(XIF, P2P_AE_SCI_LO_27); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_hi_27 : reg = &RU_REG(XIF, P2P_AE_SCI_HI_27); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_lo_28 : reg = &RU_REG(XIF, P2P_AE_SCI_LO_28); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_hi_28 : reg = &RU_REG(XIF, P2P_AE_SCI_HI_28); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_lo_29 : reg = &RU_REG(XIF, P2P_AE_SCI_LO_29); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_hi_29 : reg = &RU_REG(XIF, P2P_AE_SCI_HI_29); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_lo_30 : reg = &RU_REG(XIF, P2P_AE_SCI_LO_30); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_hi_30 : reg = &RU_REG(XIF, P2P_AE_SCI_HI_30); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_lo_31 : reg = &RU_REG(XIF, P2P_AE_SCI_LO_31); blk = &RU_BLK(XIF); break;
    case bdmf_address_p2p_ae_sci_hi_31 : reg = &RU_REG(XIF, P2P_AE_SCI_HI_31); blk = &RU_BLK(XIF); break;
    case bdmf_address_up_1588_ts_offset_lo : reg = &RU_REG(XIF, UP_1588_TS_OFFSET_LO); blk = &RU_BLK(XIF); break;
    case bdmf_address_up_1588_ts_offset_hi : reg = &RU_REG(XIF, UP_1588_TS_OFFSET_HI); blk = &RU_BLK(XIF); break;
    case bdmf_address_up_1588_two_step_ts_ctl : reg = &RU_REG(XIF, UP_1588_TWO_STEP_TS_CTL); blk = &RU_BLK(XIF); break;
    case bdmf_address_up_1588_two_step_ts_value_lo : reg = &RU_REG(XIF, UP_1588_TWO_STEP_TS_VALUE_LO); blk = &RU_BLK(XIF); break;
    case bdmf_address_up_1588_two_step_ts_value_hi : reg = &RU_REG(XIF, UP_1588_TWO_STEP_TS_VALUE_HI); blk = &RU_BLK(XIF); break;
    case bdmf_address_1588_ts_sync_offset : reg = &RU_REG(XIF, 1588_TS_SYNC_OFFSET); blk = &RU_BLK(XIF); break;
    case bdmf_address_sec_mpcp_offset : reg = &RU_REG(XIF, SEC_MPCP_OFFSET); blk = &RU_BLK(XIF); break;
    default :
...
bdmfmon_handle_t ag_drv_xif_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_int_status[]={
            BDMFMON_MAKE_PARM("ts1588pktabort", "ts1588pktabort", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("ts1588twostepff", "ts1588twostepff", BDMFMON_PARM_NUMBER, 0),
        ...
        static bdmfmon_cmd_parm_t set_int_mask[]={
            BDMFMON_MAKE_PARM("mskts1588pktabort", "mskts1588pktabort", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("mskts1588twostepff", "mskts1588twostepff", BDMFMON_PARM_NUMBER, 0),
        ...
        static bdmfmon_cmd_parm_t set_sec_ctl[]={
            BDMFMON_MAKE_PARM("cfgkeynum_4_an_3", "cfgkeynum_4_an_3", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfgkeynum_4_an_2", "cfgkeynum_4_an_2", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfgkeynum_4_an_1", "cfgkeynum_4_an_1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfgkeynum_4_an_0", "cfgkeynum_4_an_0", BDMFMON_PARM_NUMBER, 0),
        ...
        static bdmfmon_cmd_parm_t set_ctl_2[]={
            BDMFMON_MAKE_PARM("cfgen1588adj4parb4da", "cfgen1588adj4parb4da", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfgentx1588", "cfgentx1588", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfgdisp2pdnindexmap", "cfgdisp2pdnindexmap", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfgdisp2pupindexmap", "cfgdisp2pupindexmap", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_vlan_type_1[]={
            BDMFMON_MAKE_PARM("cfgvlantype_1", "cfgvlantype_1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_lo_16[]={
            BDMFMON_MAKE_PARM("cfgp2psci_lo_16", "cfgp2psci_lo_16", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_hi_16[]={
            BDMFMON_MAKE_PARM("cfgp2psci_hi_16", "cfgp2psci_hi_16", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_lo_17[]={
            BDMFMON_MAKE_PARM("cfgp2psci_lo_17", "cfgp2psci_lo_17", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_hi_17[]={
            BDMFMON_MAKE_PARM("cfgp2psci_hi_17", "cfgp2psci_hi_17", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_lo_18[]={
            BDMFMON_MAKE_PARM("cfgp2psci_lo_18", "cfgp2psci_lo_18", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_hi_18[]={
            BDMFMON_MAKE_PARM("cfgp2psci_hi_18", "cfgp2psci_hi_18", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_lo_19[]={
            BDMFMON_MAKE_PARM("cfgp2psci_lo_19", "cfgp2psci_lo_19", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_hi_19[]={
            BDMFMON_MAKE_PARM("cfgp2psci_hi_19", "cfgp2psci_hi_19", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_lo_20[]={
            BDMFMON_MAKE_PARM("cfgp2psci_lo_20", "cfgp2psci_lo_20", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_hi_20[]={
            BDMFMON_MAKE_PARM("cfgp2psci_hi_20", "cfgp2psci_hi_20", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_lo_21[]={
            BDMFMON_MAKE_PARM("cfgp2psci_lo_21", "cfgp2psci_lo_21", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_hi_21[]={
            BDMFMON_MAKE_PARM("cfgp2psci_hi_21", "cfgp2psci_hi_21", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_lo_22[]={
            BDMFMON_MAKE_PARM("cfgp2psci_lo_22", "cfgp2psci_lo_22", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_hi_22[]={
            BDMFMON_MAKE_PARM("cfgp2psci_hi_22", "cfgp2psci_hi_22", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_lo_23[]={
            BDMFMON_MAKE_PARM("cfgp2psci_lo_23", "cfgp2psci_lo_23", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_hi_23[]={
            BDMFMON_MAKE_PARM("cfgp2psci_hi_23", "cfgp2psci_hi_23", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_lo_24[]={
            BDMFMON_MAKE_PARM("cfgp2psci_lo_24", "cfgp2psci_lo_24", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_hi_24[]={
            BDMFMON_MAKE_PARM("cfgp2psci_hi_24", "cfgp2psci_hi_24", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_lo_25[]={
            BDMFMON_MAKE_PARM("cfgp2psci_lo_25", "cfgp2psci_lo_25", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_hi_25[]={
            BDMFMON_MAKE_PARM("cfgp2psci_hi_25", "cfgp2psci_hi_25", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_lo_26[]={
            BDMFMON_MAKE_PARM("cfgp2psci_lo_26", "cfgp2psci_lo_26", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_hi_26[]={
            BDMFMON_MAKE_PARM("cfgp2psci_hi_26", "cfgp2psci_hi_26", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_lo_27[]={
            BDMFMON_MAKE_PARM("cfgp2psci_lo_27", "cfgp2psci_lo_27", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_hi_27[]={
            BDMFMON_MAKE_PARM("cfgp2psci_hi_27", "cfgp2psci_hi_27", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_lo_28[]={
            BDMFMON_MAKE_PARM("cfgp2psci_lo_28", "cfgp2psci_lo_28", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_hi_28[]={
            BDMFMON_MAKE_PARM("cfgp2psci_hi_28", "cfgp2psci_hi_28", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_lo_29[]={
            BDMFMON_MAKE_PARM("cfgp2psci_lo_29", "cfgp2psci_lo_29", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_hi_29[]={
            BDMFMON_MAKE_PARM("cfgp2psci_hi_29", "cfgp2psci_hi_29", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_lo_30[]={
            BDMFMON_MAKE_PARM("cfgp2psci_lo_30", "cfgp2psci_lo_30", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_hi_30[]={
            BDMFMON_MAKE_PARM("cfgp2psci_hi_30", "cfgp2psci_hi_30", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_lo_31[]={
            BDMFMON_MAKE_PARM("cfgp2psci_lo_31", "cfgp2psci_lo_31", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_p2p_ae_sci_hi_31[]={
            BDMFMON_MAKE_PARM("cfgp2psci_hi_31", "cfgp2psci_hi_31", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_up_1588_ts_offset_lo[]={
            BDMFMON_MAKE_PARM("cfgup1588tsoffset_lo", "cfgup1588tsoffset_lo", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_up_1588_ts_offset_hi[]={
            BDMFMON_MAKE_PARM("cfgcmhoffset", "cfgcmhoffset", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfgup1588tsoffset_hi", "cfgup1588tsoffset_hi", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_up_1588_two_step_ts_ctl[]={
        ...
        static bdmfmon_cmd_parm_t set_1588_ts_sync_offset[]={
            BDMFMON_MAKE_PARM("cfgtssyncoffset", "cfgtssyncoffset", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_sec_mpcp_offset[]={
            BDMFMON_MAKE_PARM("cfgsecrxmpcpoffset", "cfgsecrxmpcpoffset", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="ctl_2", .val=BDMF_ctl_2, .parms=set_ctl_2 },
            { .name="vlan_type_1", .val=BDMF_vlan_type_1, .parms=set_vlan_type_1 },
            { .name="p2p_ae_sci_lo_16", .val=BDMF_p2p_ae_sci_lo_16, .parms=set_p2p_ae_sci_lo_16 },
            { .name="p2p_ae_sci_hi_16", .val=BDMF_p2p_ae_sci_hi_16, .parms=set_p2p_ae_sci_hi_16 },
            { .name="p2p_ae_sci_lo_17", .val=BDMF_p2p_ae_sci_lo_17, .parms=set_p2p_ae_sci_lo_17 },
            { .name="p2p_ae_sci_hi_17", .val=BDMF_p2p_ae_sci_hi_17, .parms=set_p2p_ae_sci_hi_17 },
            { .name="p2p_ae_sci_lo_18", .val=BDMF_p2p_ae_sci_lo_18, .parms=set_p2p_ae_sci_lo_18 },
            { .name="p2p_ae_sci_hi_18", .val=BDMF_p2p_ae_sci_hi_18, .parms=set_p2p_ae_sci_hi_18 },
            { .name="p2p_ae_sci_lo_19", .val=BDMF_p2p_ae_sci_lo_19, .parms=set_p2p_ae_sci_lo_19 },
            { .name="p2p_ae_sci_hi_19", .val=BDMF_p2p_ae_sci_hi_19, .parms=set_p2p_ae_sci_hi_19 },
            { .name="p2p_ae_sci_lo_20", .val=BDMF_p2p_ae_sci_lo_20, .parms=set_p2p_ae_sci_lo_20 },
            { .name="p2p_ae_sci_hi_20", .val=BDMF_p2p_ae_sci_hi_20, .parms=set_p2p_ae_sci_hi_20 },
            { .name="p2p_ae_sci_lo_21", .val=BDMF_p2p_ae_sci_lo_21, .parms=set_p2p_ae_sci_lo_21 },
            { .name="p2p_ae_sci_hi_21", .val=BDMF_p2p_ae_sci_hi_21, .parms=set_p2p_ae_sci_hi_21 },
            { .name="p2p_ae_sci_lo_22", .val=BDMF_p2p_ae_sci_lo_22, .parms=set_p2p_ae_sci_lo_22 },
            { .name="p2p_ae_sci_hi_22", .val=BDMF_p2p_ae_sci_hi_22, .parms=set_p2p_ae_sci_hi_22 },
            { .name="p2p_ae_sci_lo_23", .val=BDMF_p2p_ae_sci_lo_23, .parms=set_p2p_ae_sci_lo_23 },
            { .name="p2p_ae_sci_hi_23", .val=BDMF_p2p_ae_sci_hi_23, .parms=set_p2p_ae_sci_hi_23 },
            { .name="p2p_ae_sci_lo_24", .val=BDMF_p2p_ae_sci_lo_24, .parms=set_p2p_ae_sci_lo_24 },
            { .name="p2p_ae_sci_hi_24", .val=BDMF_p2p_ae_sci_hi_24, .parms=set_p2p_ae_sci_hi_24 },
            { .name="p2p_ae_sci_lo_25", .val=BDMF_p2p_ae_sci_lo_25, .parms=set_p2p_ae_sci_lo_25 },
            { .name="p2p_ae_sci_hi_25", .val=BDMF_p2p_ae_sci_hi_25, .parms=set_p2p_ae_sci_hi_25 },
            { .name="p2p_ae_sci_lo_26", .val=BDMF_p2p_ae_sci_lo_26, .parms=set_p2p_ae_sci_lo_26 },
            { .name="p2p_ae_sci_hi_26", .val=BDMF_p2p_ae_sci_hi_26, .parms=set_p2p_ae_sci_hi_26 },
            { .name="p2p_ae_sci_lo_27", .val=BDMF_p2p_ae_sci_lo_27, .parms=set_p2p_ae_sci_lo_27 },
            { .name="p2p_ae_sci_hi_27", .val=BDMF_p2p_ae_sci_hi_27, .parms=set_p2p_ae_sci_hi_27 },
            { .name="p2p_ae_sci_lo_28", .val=BDMF_p2p_ae_sci_lo_28, .parms=set_p2p_ae_sci_lo_28 },
            { .name="p2p_ae_sci_hi_28", .val=BDMF_p2p_ae_sci_hi_28, .parms=set_p2p_ae_sci_hi_28 },
            { .name="p2p_ae_sci_lo_29", .val=BDMF_p2p_ae_sci_lo_29, .parms=set_p2p_ae_sci_lo_29 },
            { .name="p2p_ae_sci_hi_29", .val=BDMF_p2p_ae_sci_hi_29, .parms=set_p2p_ae_sci_hi_29 },
            { .name="p2p_ae_sci_lo_30", .val=BDMF_p2p_ae_sci_lo_30, .parms=set_p2p_ae_sci_lo_30 },
            { .name="p2p_ae_sci_hi_30", .val=BDMF_p2p_ae_sci_hi_30, .parms=set_p2p_ae_sci_hi_30 },
            { .name="p2p_ae_sci_lo_31", .val=BDMF_p2p_ae_sci_lo_31, .parms=set_p2p_ae_sci_lo_31 },
            { .name="p2p_ae_sci_hi_31", .val=BDMF_p2p_ae_sci_hi_31, .parms=set_p2p_ae_sci_hi_31 },
            { .name="up_1588_ts_offset_lo", .val=BDMF_up_1588_ts_offset_lo, .parms=set_up_1588_ts_offset_lo },
            { .name="up_1588_ts_offset_hi", .val=BDMF_up_1588_ts_offset_hi, .parms=set_up_1588_ts_offset_hi },
            { .name="up_1588_two_step_ts_ctl", .val=BDMF_up_1588_two_step_ts_ctl, .parms=set_up_1588_two_step_ts_ctl },
            { .name="1588_ts_sync_offset", .val=BDMF_1588_ts_sync_offset, .parms=set_1588_ts_sync_offset },
            { .name="sec_mpcp_offset", .val=BDMF_sec_mpcp_offset, .parms=set_sec_mpcp_offset },
            BDMFMON_ENUM_LAST
        };
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="ctl_2", .val=BDMF_ctl_2, .parms=set_default },
            { .name="vlan_type_1", .val=BDMF_vlan_type_1, .parms=set_default },
            { .name="p2p_ae_sci_lo_16", .val=BDMF_p2p_ae_sci_lo_16, .parms=set_default },
            { .name="p2p_ae_sci_hi_16", .val=BDMF_p2p_ae_sci_hi_16, .parms=set_default },
            { .name="p2p_ae_sci_lo_17", .val=BDMF_p2p_ae_sci_lo_17, .parms=set_default },
            { .name="p2p_ae_sci_hi_17", .val=BDMF_p2p_ae_sci_hi_17, .parms=set_default },
            { .name="p2p_ae_sci_lo_18", .val=BDMF_p2p_ae_sci_lo_18, .parms=set_default },
            { .name="p2p_ae_sci_hi_18", .val=BDMF_p2p_ae_sci_hi_18, .parms=set_default },
            { .name="p2p_ae_sci_lo_19", .val=BDMF_p2p_ae_sci_lo_19, .parms=set_default },
            { .name="p2p_ae_sci_hi_19", .val=BDMF_p2p_ae_sci_hi_19, .parms=set_default },
            { .name="p2p_ae_sci_lo_20", .val=BDMF_p2p_ae_sci_lo_20, .parms=set_default },
            { .name="p2p_ae_sci_hi_20", .val=BDMF_p2p_ae_sci_hi_20, .parms=set_default },
            { .name="p2p_ae_sci_lo_21", .val=BDMF_p2p_ae_sci_lo_21, .parms=set_default },
            { .name="p2p_ae_sci_hi_21", .val=BDMF_p2p_ae_sci_hi_21, .parms=set_default },
            { .name="p2p_ae_sci_lo_22", .val=BDMF_p2p_ae_sci_lo_22, .parms=set_default },
            { .name="p2p_ae_sci_hi_22", .val=BDMF_p2p_ae_sci_hi_22, .parms=set_default },
            { .name="p2p_ae_sci_lo_23", .val=BDMF_p2p_ae_sci_lo_23, .parms=set_default },
            { .name="p2p_ae_sci_hi_23", .val=BDMF_p2p_ae_sci_hi_23, .parms=set_default },
            { .name="p2p_ae_sci_lo_24", .val=BDMF_p2p_ae_sci_lo_24, .parms=set_default },
            { .name="p2p_ae_sci_hi_24", .val=BDMF_p2p_ae_sci_hi_24, .parms=set_default },
            { .name="p2p_ae_sci_lo_25", .val=BDMF_p2p_ae_sci_lo_25, .parms=set_default },
            { .name="p2p_ae_sci_hi_25", .val=BDMF_p2p_ae_sci_hi_25, .parms=set_default },
            { .name="p2p_ae_sci_lo_26", .val=BDMF_p2p_ae_sci_lo_26, .parms=set_default },
            { .name="p2p_ae_sci_hi_26", .val=BDMF_p2p_ae_sci_hi_26, .parms=set_default },
            { .name="p2p_ae_sci_lo_27", .val=BDMF_p2p_ae_sci_lo_27, .parms=set_default },
            { .name="p2p_ae_sci_hi_27", .val=BDMF_p2p_ae_sci_hi_27, .parms=set_default },
            { .name="p2p_ae_sci_lo_28", .val=BDMF_p2p_ae_sci_lo_28, .parms=set_default },
            { .name="p2p_ae_sci_hi_28", .val=BDMF_p2p_ae_sci_hi_28, .parms=set_default },
            { .name="p2p_ae_sci_lo_29", .val=BDMF_p2p_ae_sci_lo_29, .parms=set_default },
            { .name="p2p_ae_sci_hi_29", .val=BDMF_p2p_ae_sci_hi_29, .parms=set_default },
            { .name="p2p_ae_sci_lo_30", .val=BDMF_p2p_ae_sci_lo_30, .parms=set_default },
            { .name="p2p_ae_sci_hi_30", .val=BDMF_p2p_ae_sci_hi_30, .parms=set_default },
            { .name="p2p_ae_sci_lo_31", .val=BDMF_p2p_ae_sci_lo_31, .parms=set_default },
            { .name="p2p_ae_sci_hi_31", .val=BDMF_p2p_ae_sci_hi_31, .parms=set_default },
            { .name="up_1588_ts_offset_lo", .val=BDMF_up_1588_ts_offset_lo, .parms=set_default },
            { .name="up_1588_ts_offset_hi", .val=BDMF_up_1588_ts_offset_hi, .parms=set_default },
            { .name="up_1588_two_step_ts_ctl", .val=BDMF_up_1588_two_step_ts_ctl, .parms=set_default },
            { .name="up_1588_two_step_ts_value_lo", .val=BDMF_up_1588_two_step_ts_value_lo, .parms=set_default },
            { .name="up_1588_two_step_ts_value_hi", .val=BDMF_up_1588_two_step_ts_value_hi, .parms=set_default },
            { .name="1588_ts_sync_offset", .val=BDMF_1588_ts_sync_offset, .parms=set_default },
            { .name="sec_mpcp_offset", .val=BDMF_sec_mpcp_offset, .parms=set_default },
            BDMFMON_ENUM_LAST
        };
    ...
    }
    {
        static bdmfmon_enum_val_t enum_table_address[] = {
            ...
            { .name="CTL_2" , .val=bdmf_address_ctl_2 },
            { .name="VLAN_TYPE_1" , .val=bdmf_address_vlan_type_1 },
            { .name="P2P_AE_SCI_LO_16" , .val=bdmf_address_p2p_ae_sci_lo_16 },
            { .name="P2P_AE_SCI_HI_16" , .val=bdmf_address_p2p_ae_sci_hi_16 },
            { .name="P2P_AE_SCI_LO_17" , .val=bdmf_address_p2p_ae_sci_lo_17 },
            { .name="P2P_AE_SCI_HI_17" , .val=bdmf_address_p2p_ae_sci_hi_17 },
            { .name="P2P_AE_SCI_LO_18" , .val=bdmf_address_p2p_ae_sci_lo_18 },
            { .name="P2P_AE_SCI_HI_18" , .val=bdmf_address_p2p_ae_sci_hi_18 },
            { .name="P2P_AE_SCI_LO_19" , .val=bdmf_address_p2p_ae_sci_lo_19 },
            { .name="P2P_AE_SCI_HI_19" , .val=bdmf_address_p2p_ae_sci_hi_19 },
            { .name="P2P_AE_SCI_LO_20" , .val=bdmf_address_p2p_ae_sci_lo_20 },
            { .name="P2P_AE_SCI_HI_20" , .val=bdmf_address_p2p_ae_sci_hi_20 },
            { .name="P2P_AE_SCI_LO_21" , .val=bdmf_address_p2p_ae_sci_lo_21 },
            { .name="P2P_AE_SCI_HI_21" , .val=bdmf_address_p2p_ae_sci_hi_21 },
            { .name="P2P_AE_SCI_LO_22" , .val=bdmf_address_p2p_ae_sci_lo_22 },
            { .name="P2P_AE_SCI_HI_22" , .val=bdmf_address_p2p_ae_sci_hi_22 },
            { .name="P2P_AE_SCI_LO_23" , .val=bdmf_address_p2p_ae_sci_lo_23 },
            { .name="P2P_AE_SCI_HI_23" , .val=bdmf_address_p2p_ae_sci_hi_23 },
            { .name="P2P_AE_SCI_LO_24" , .val=bdmf_address_p2p_ae_sci_lo_24 },
            { .name="P2P_AE_SCI_HI_24" , .val=bdmf_address_p2p_ae_sci_hi_24 },
            { .name="P2P_AE_SCI_LO_25" , .val=bdmf_address_p2p_ae_sci_lo_25 },
            { .name="P2P_AE_SCI_HI_25" , .val=bdmf_address_p2p_ae_sci_hi_25 },
            { .name="P2P_AE_SCI_LO_26" , .val=bdmf_address_p2p_ae_sci_lo_26 },
            { .name="P2P_AE_SCI_HI_26" , .val=bdmf_address_p2p_ae_sci_hi_26 },
            { .name="P2P_AE_SCI_LO_27" , .val=bdmf_address_p2p_ae_sci_lo_27 },
            { .name="P2P_AE_SCI_HI_27" , .val=bdmf_address_p2p_ae_sci_hi_27 },
            { .name="P2P_AE_SCI_LO_28" , .val=bdmf_address_p2p_ae_sci_lo_28 },
            { .name="P2P_AE_SCI_HI_28" , .val=bdmf_address_p2p_ae_sci_hi_28 },
            { .name="P2P_AE_SCI_LO_29" , .val=bdmf_address_p2p_ae_sci_lo_29 },
            { .name="P2P_AE_SCI_HI_29" , .val=bdmf_address_p2p_ae_sci_hi_29 },
            { .name="P2P_AE_SCI_LO_30" , .val=bdmf_address_p2p_ae_sci_lo_30 },
            { .name="P2P_AE_SCI_HI_30" , .val=bdmf_address_p2p_ae_sci_hi_30 },
            { .name="P2P_AE_SCI_LO_31" , .val=bdmf_address_p2p_ae_sci_lo_31 },
            { .name="P2P_AE_SCI_HI_31" , .val=bdmf_address_p2p_ae_sci_hi_31 },
            { .name="UP_1588_TS_OFFSET_LO" , .val=bdmf_address_up_1588_ts_offset_lo },
            { .name="UP_1588_TS_OFFSET_HI" , .val=bdmf_address_up_1588_ts_offset_hi },
            { .name="UP_1588_TWO_STEP_TS_CTL" , .val=bdmf_address_up_1588_two_step_ts_ctl },
            { .name="UP_1588_TWO_STEP_TS_VALUE_LO" , .val=bdmf_address_up_1588_two_step_ts_value_lo },
            { .name="UP_1588_TWO_STEP_TS_VALUE_HI" , .val=bdmf_address_up_1588_two_step_ts_value_hi },
            { .name="1588_TS_SYNC_OFFSET" , .val=bdmf_address_1588_ts_sync_offset },
            { .name="SEC_MPCP_OFFSET" , .val=bdmf_address_sec_mpcp_offset },
            BDMFMON_ENUM_LAST
        };
