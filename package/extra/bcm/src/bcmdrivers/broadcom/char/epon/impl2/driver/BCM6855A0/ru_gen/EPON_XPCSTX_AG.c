...
/******************************************************************************
 * Field: XPCSTX_TX_CONTROL_CFG_TEST_PAT_GEN_VLD_DIS_125
 ******************************************************************************/
const ru_field_rec XPCSTX_TX_CONTROL_CFG_TEST_PAT_GEN_VLD_DIS_125_FIELD =
{
    "CFG_TEST_PAT_GEN_VLD_DIS_125",
#if RU_INCLUDE_DESC
    "",
    "Disable test generation from asserting valid."
    "This will allow the scrambler to put out a constant pattern.",
#endif
    XPCSTX_TX_CONTROL_CFG_TEST_PAT_GEN_VLD_DIS_125_FIELD_MASK,
    0,
    XPCSTX_TX_CONTROL_CFG_TEST_PAT_GEN_VLD_DIS_125_FIELD_WIDTH,
    XPCSTX_TX_CONTROL_CFG_TEST_PAT_GEN_VLD_DIS_125_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPCSTX_TX_CONTROL_CFG_TEST_PAT_GEN_EN_125
 ******************************************************************************/
const ru_field_rec XPCSTX_TX_CONTROL_CFG_TEST_PAT_GEN_EN_125_FIELD =
{
    "CFG_TEST_PAT_GEN_EN_125",
#if RU_INCLUDE_DESC
    "",
    "Enable TX test pattern : 0 - test pattern off; 1 - TX test pattern"
    "US"
    "Test patter configured using cfg_test_pat_seed[63:0] and"
    "cfg_test_pat_data[63:0]",
#endif
    XPCSTX_TX_CONTROL_CFG_TEST_PAT_GEN_EN_125_FIELD_MASK,
    0,
    XPCSTX_TX_CONTROL_CFG_TEST_PAT_GEN_EN_125_FIELD_WIDTH,
    XPCSTX_TX_CONTROL_CFG_TEST_PAT_GEN_EN_125_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
#if RU_INCLUDE_DESC
    "",
    "Debug function to enable sequence number generation in the"
    "start-of-burst delimiter.",
#endif
...
/******************************************************************************
 * Field: XPCSTX_TX_TEST_PATTERN_SEED_31_0_CFG_TEST_PAT_SEED_31_0
 ******************************************************************************/
const ru_field_rec XPCSTX_TX_TEST_PATTERN_SEED_31_0_CFG_TEST_PAT_SEED_31_0_FIELD =
{
    "CFG_TEST_PAT_SEED_31_0",
#if RU_INCLUDE_DESC
    "",
    "Bits 0 to 31 of the test pattern."
    "Set to An or Bn per Clause 59.1.1"
    "pattern 1 = Bn 63:0 = D241_AEE1_68E2_213C"
    "pattern 2 = An 63:0 = F22D_1372_ADA0_13DA"
    "Default is Bn",
#endif
    XPCSTX_TX_TEST_PATTERN_SEED_31_0_CFG_TEST_PAT_SEED_31_0_FIELD_MASK,
    0,
    XPCSTX_TX_TEST_PATTERN_SEED_31_0_CFG_TEST_PAT_SEED_31_0_FIELD_WIDTH,
    XPCSTX_TX_TEST_PATTERN_SEED_31_0_CFG_TEST_PAT_SEED_31_0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPCSTX_TX_TEST_PATTERN_SEED_63_32_CFG_TEST_PAT_SEED_63_32
 ******************************************************************************/
const ru_field_rec XPCSTX_TX_TEST_PATTERN_SEED_63_32_CFG_TEST_PAT_SEED_63_32_FIELD =
{
    "CFG_TEST_PAT_SEED_63_32",
#if RU_INCLUDE_DESC
    "",
    "Bits 32 to 63 of the test pattern."
    "Set to An or Bn per Clause 59.1.1"
    "pattern 1 = Bn 63:0 = D241_AEE1_68E2_213C"
    "pattern 2 = An 63:0 = F22D_1372_ADA0_13DA"
    "Default is Bn",
#endif
    XPCSTX_TX_TEST_PATTERN_SEED_63_32_CFG_TEST_PAT_SEED_63_32_FIELD_MASK,
    0,
    XPCSTX_TX_TEST_PATTERN_SEED_63_32_CFG_TEST_PAT_SEED_63_32_FIELD_WIDTH,
    XPCSTX_TX_TEST_PATTERN_SEED_63_32_CFG_TEST_PAT_SEED_63_32_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPCSTX_TX_TEST_PATTERN_DATA_31_0_CFG_TEST_PAT_DATA_31_0
 ******************************************************************************/
const ru_field_rec XPCSTX_TX_TEST_PATTERN_DATA_31_0_CFG_TEST_PAT_DATA_31_0_FIELD =
{
    "CFG_TEST_PAT_DATA_31_0",
#if RU_INCLUDE_DESC
    "",
    "Bits 0 to 31 of the test pattern."
    "Set to 0 or sequence set per Clause 59.1.1"
    "pattern 1 = data 63:0 = 5500_0001_0000_0001"
    "pattern 2 = data 63:0 = 0000_0000_0000_0000"
    "Default is Sequence set LF for pattern 1",
#endif
    XPCSTX_TX_TEST_PATTERN_DATA_31_0_CFG_TEST_PAT_DATA_31_0_FIELD_MASK,
    0,
    XPCSTX_TX_TEST_PATTERN_DATA_31_0_CFG_TEST_PAT_DATA_31_0_FIELD_WIDTH,
    XPCSTX_TX_TEST_PATTERN_DATA_31_0_CFG_TEST_PAT_DATA_31_0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPCSTX_TX_TEST_PATTERN_DATA_63_32_CFG_TEST_PAT_DATA_63_32
 ******************************************************************************/
const ru_field_rec XPCSTX_TX_TEST_PATTERN_DATA_63_32_CFG_TEST_PAT_DATA_63_32_FIELD =
{
    "CFG_TEST_PAT_DATA_63_32",
#if RU_INCLUDE_DESC
    "",
    "Bits 32 to 63 of the test pattern."
    "Set to 0 or sequence set per Clause 59.1.1"
    ...
    "Default is Sequence set LF for pattern 1",
#endif
    XPCSTX_TX_TEST_PATTERN_DATA_63_32_CFG_TEST_PAT_DATA_63_32_FIELD_MASK,
    0,
    XPCSTX_TX_TEST_PATTERN_DATA_63_32_CFG_TEST_PAT_DATA_63_32_FIELD_WIDTH,
    XPCSTX_TX_TEST_PATTERN_DATA_63_32_CFG_TEST_PAT_DATA_63_32_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPCSTX_TX_TEST_PATTERN_SH_RESERVED0
 ******************************************************************************/
const ru_field_rec XPCSTX_TX_TEST_PATTERN_SH_RESERVED0_FIELD =
{
    "RESERVED0",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    XPCSTX_TX_TEST_PATTERN_SH_RESERVED0_FIELD_MASK,
    0,
    XPCSTX_TX_TEST_PATTERN_SH_RESERVED0_FIELD_WIDTH,
    XPCSTX_TX_TEST_PATTERN_SH_RESERVED0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPCSTX_TX_TEST_PATTERN_SH_CFG_TEST_PAT_SH
 ******************************************************************************/
const ru_field_rec XPCSTX_TX_TEST_PATTERN_SH_CFG_TEST_PAT_SH_FIELD =
{
    "CFG_TEST_PAT_SH",
#if RU_INCLUDE_DESC
    "",
    "Sync header for transmit of test pattern data and seed.",
#endif
    XPCSTX_TX_TEST_PATTERN_SH_CFG_TEST_PAT_SH_FIELD_MASK,
    0,
    XPCSTX_TX_TEST_PATTERN_SH_CFG_TEST_PAT_SH_FIELD_WIDTH,
    XPCSTX_TX_TEST_PATTERN_SH_CFG_TEST_PAT_SH_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
static const ru_field_rec *XPCSTX_TX_CONTROL_FIELDS[] =
{
    ...
    &XPCSTX_TX_CONTROL_CFG_TEST_PAT_GEN_VLD_DIS_125_FIELD,
    &XPCSTX_TX_CONTROL_CFG_TEST_PAT_GEN_EN_125_FIELD,
...
/******************************************************************************
 * Register: XPCSTX_TX_TEST_PATTERN_SEED_31_0
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *XPCSTX_TX_TEST_PATTERN_SEED_31_0_FIELDS[] =
{
    &XPCSTX_TX_TEST_PATTERN_SEED_31_0_CFG_TEST_PAT_SEED_31_0_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec XPCSTX_TX_TEST_PATTERN_SEED_31_0_REG = 
{
    "TX_TEST_PATTERN_SEED_31_0",
#if RU_INCLUDE_DESC
    "XPCS_TX_TEST_PATTERN_SEED_31_0 Register",
    "Test pattern seed bits 31 to 0.",
#endif
    XPCSTX_TX_TEST_PATTERN_SEED_31_0_REG_OFFSET,
    0,
    0,
    643,
#if RU_INCLUDE_ACCESS
...
#if RU_INCLUDE_FIELD_DB
    1,
    XPCSTX_TX_TEST_PATTERN_SEED_31_0_FIELDS,
#endif /* RU_INCLUDE_FIELD_DB */
    ru_reg_size_32
};

/******************************************************************************
 * Register: XPCSTX_TX_TEST_PATTERN_SEED_63_32
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *XPCSTX_TX_TEST_PATTERN_SEED_63_32_FIELDS[] =
{
    &XPCSTX_TX_TEST_PATTERN_SEED_63_32_CFG_TEST_PAT_SEED_63_32_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec XPCSTX_TX_TEST_PATTERN_SEED_63_32_REG = 
{
    "TX_TEST_PATTERN_SEED_63_32",
#if RU_INCLUDE_DESC
    "XPCS_TX_TEST_PATTERN_SEED_63_32 Register",
    "Test pattern seed bits 63 to 32.",
#endif
    XPCSTX_TX_TEST_PATTERN_SEED_63_32_REG_OFFSET,
    0,
    0,
    644,
#if RU_INCLUDE_ACCESS
...
#if RU_INCLUDE_FIELD_DB
    1,
    XPCSTX_TX_TEST_PATTERN_SEED_63_32_FIELDS,
#endif /* RU_INCLUDE_FIELD_DB */
    ru_reg_size_32
};

/******************************************************************************
 * Register: XPCSTX_TX_TEST_PATTERN_DATA_31_0
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *XPCSTX_TX_TEST_PATTERN_DATA_31_0_FIELDS[] =
{
    &XPCSTX_TX_TEST_PATTERN_DATA_31_0_CFG_TEST_PAT_DATA_31_0_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec XPCSTX_TX_TEST_PATTERN_DATA_31_0_REG = 
{
    "TX_TEST_PATTERN_DATA_31_0",
#if RU_INCLUDE_DESC
    "XPCS_TX_TEST_PATTERN_DATA_31_0 Register",
    "Test pattern data bits 31 to 0.",
#endif
    XPCSTX_TX_TEST_PATTERN_DATA_31_0_REG_OFFSET,
    0,
    0,
    645,
#if RU_INCLUDE_ACCESS
...
#if RU_INCLUDE_FIELD_DB
    1,
    XPCSTX_TX_TEST_PATTERN_DATA_31_0_FIELDS,
#endif /* RU_INCLUDE_FIELD_DB */
    ru_reg_size_32
};

/******************************************************************************
 * Register: XPCSTX_TX_TEST_PATTERN_DATA_63_32
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *XPCSTX_TX_TEST_PATTERN_DATA_63_32_FIELDS[] =
{
    &XPCSTX_TX_TEST_PATTERN_DATA_63_32_CFG_TEST_PAT_DATA_63_32_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec XPCSTX_TX_TEST_PATTERN_DATA_63_32_REG = 
{
    "TX_TEST_PATTERN_DATA_63_32",
#if RU_INCLUDE_DESC
    "XPCS_TX_TEST_PATTERN_DATA_63_32 Register",
    "Test pattern data bits 63 to 32.",
#endif
    XPCSTX_TX_TEST_PATTERN_DATA_63_32_REG_OFFSET,
    0,
    0,
    646,
#if RU_INCLUDE_ACCESS
...
#if RU_INCLUDE_FIELD_DB
    1,
    XPCSTX_TX_TEST_PATTERN_DATA_63_32_FIELDS,
#endif /* RU_INCLUDE_FIELD_DB */
    ru_reg_size_32
};

/******************************************************************************
 * Register: XPCSTX_TX_TEST_PATTERN_SH
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *XPCSTX_TX_TEST_PATTERN_SH_FIELDS[] =
{
    &XPCSTX_TX_TEST_PATTERN_SH_RESERVED0_FIELD,
    &XPCSTX_TX_TEST_PATTERN_SH_CFG_TEST_PAT_SH_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec XPCSTX_TX_TEST_PATTERN_SH_REG = 
{
    "TX_TEST_PATTERN_SH",
#if RU_INCLUDE_DESC
    "XPCS_TX_TEST_PATTERN_SH Register",
    "SH for generation for type 1 and type 2 test pattern.",
#endif
    XPCSTX_TX_TEST_PATTERN_SH_REG_OFFSET,
    0,
    0,
    647,
#if RU_INCLUDE_ACCESS
...
#if RU_INCLUDE_FIELD_DB
    2,
    XPCSTX_TX_TEST_PATTERN_SH_FIELDS,
#endif /* RU_INCLUDE_FIELD_DB */
    ru_reg_size_32
};
...
static const ru_reg_rec *XPCSTX_REGS[] =
{
    ...
    &XPCSTX_TX_TEST_PATTERN_SEED_31_0_REG,
    &XPCSTX_TX_TEST_PATTERN_SEED_63_32_REG,
    &XPCSTX_TX_TEST_PATTERN_DATA_31_0_REG,
    &XPCSTX_TX_TEST_PATTERN_DATA_63_32_REG,
    &XPCSTX_TX_TEST_PATTERN_SH_REG,
};
