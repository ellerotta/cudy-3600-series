...
bdmf_error_t ag_drv_epn_upf_refresh_time_set(uint32_t cfgupfrefreshtime)
{
    uint32_t reg_upf_refresh_time=0;

#ifdef VALIDATE_PARMS
    if((cfgupfrefreshtime >= _24BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_upf_refresh_time = RU_FIELD_SET(0, EPN, UPF_REFRESH_TIME, CFGUPFREFRESHTIME, reg_upf_refresh_time, cfgupfrefreshtime);

    RU_REG_WRITE(0, EPN, UPF_REFRESH_TIME, reg_upf_refresh_time);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_epn_upf_refresh_time_get(uint32_t *cfgupfrefreshtime)
{
    uint32_t reg_upf_refresh_time=0;

#ifdef VALIDATE_PARMS
    if(!cfgupfrefreshtime)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    ...
    RU_REG_READ(0, EPN, UPF_REFRESH_TIME, reg_upf_refresh_time);

    *cfgupfrefreshtime = RU_FIELD_GET(0, EPN, UPF_REFRESH_TIME, CFGUPFREFRESHTIME, reg_upf_refresh_time);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_epn_upf_sa_31_0_set(uint32_t cfgupfsalower32)
{
    uint32_t reg_upf_sa_31_0=0;

#ifdef VALIDATE_PARMS
#endif

    reg_upf_sa_31_0 = RU_FIELD_SET(0, EPN, UPF_SA_31_0, CFGUPFSALOWER32, reg_upf_sa_31_0, cfgupfsalower32);

    RU_REG_WRITE(0, EPN, UPF_SA_31_0, reg_upf_sa_31_0);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_epn_upf_sa_31_0_get(uint32_t *cfgupfsalower32)
{
    uint32_t reg_upf_sa_31_0=0;
    ...
    RU_REG_READ(0, EPN, UPF_SA_31_0, reg_upf_sa_31_0);

    *cfgupfsalower32 = RU_FIELD_GET(0, EPN, UPF_SA_31_0, CFGUPFSALOWER32, reg_upf_sa_31_0);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_epn_upf_sa_47_32_set(uint16_t cfgupfsaupper16)
{
    uint32_t reg_upf_sa_47_32=0;

#ifdef VALIDATE_PARMS
#endif

    reg_upf_sa_47_32 = RU_FIELD_SET(0, EPN, UPF_SA_47_32, CFGUPFSAUPPER16, reg_upf_sa_47_32, cfgupfsaupper16);

    RU_REG_WRITE(0, EPN, UPF_SA_47_32, reg_upf_sa_47_32);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_epn_upf_sa_47_32_get(uint16_t *cfgupfsaupper16)
{
    uint32_t reg_upf_sa_47_32=0;
    ...
    RU_REG_READ(0, EPN, UPF_SA_47_32, reg_upf_sa_47_32);

    *cfgupfsaupper16 = RU_FIELD_GET(0, EPN, UPF_SA_47_32, CFGUPFSAUPPER16, reg_upf_sa_47_32);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_epn_upf_pause_time_set(uint16_t cfgupfpausetime)
{
    uint32_t reg_upf_pause_time=0;

#ifdef VALIDATE_PARMS
#endif

    reg_upf_pause_time = RU_FIELD_SET(0, EPN, UPF_PAUSE_TIME, CFGUPFPAUSETIME, reg_upf_pause_time, cfgupfpausetime);

    RU_REG_WRITE(0, EPN, UPF_PAUSE_TIME, reg_upf_pause_time);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_epn_upf_pause_time_get(uint16_t *cfgupfpausetime)
{
    uint32_t reg_upf_pause_time=0;
    ...
    RU_REG_READ(0, EPN, UPF_PAUSE_TIME, reg_upf_pause_time);

    *cfgupfpausetime = RU_FIELD_GET(0, EPN, UPF_PAUSE_TIME, CFGUPFPAUSETIME, reg_upf_pause_time);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_epn_upf_cosmap_set(uint8_t upfcosmapsent, uint8_t cfgupfcosmap)
{
    uint32_t reg_upf_cosmap=0;

#ifdef VALIDATE_PARMS
#endif

    reg_upf_cosmap = RU_FIELD_SET(0, EPN, UPF_COSMAP, UPFCOSMAPSENT, reg_upf_cosmap, upfcosmapsent);
    reg_upf_cosmap = RU_FIELD_SET(0, EPN, UPF_COSMAP, CFGUPFCOSMAP, reg_upf_cosmap, cfgupfcosmap);

    RU_REG_WRITE(0, EPN, UPF_COSMAP, reg_upf_cosmap);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_epn_upf_cosmap_get(uint8_t *upfcosmapsent, uint8_t *cfgupfcosmap)
{
    uint32_t reg_upf_cosmap=0;

#ifdef VALIDATE_PARMS
    if(!upfcosmapsent || !cfgupfcosmap)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    ...
    RU_REG_READ(0, EPN, UPF_COSMAP, reg_upf_cosmap);

    *upfcosmapsent = RU_FIELD_GET(0, EPN, UPF_COSMAP, UPFCOSMAPSENT, reg_upf_cosmap);
    *cfgupfcosmap = RU_FIELD_GET(0, EPN, UPF_COSMAP, CFGUPFCOSMAP, reg_upf_cosmap);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_epn_upf_cos_1_0_time_set(uint16_t cfgupfcos1, uint16_t cfgupfcos0)
{
    uint32_t reg_upf_cos_1_0_time=0;

#ifdef VALIDATE_PARMS
#endif

    reg_upf_cos_1_0_time = RU_FIELD_SET(0, EPN, UPF_COS_1_0_TIME, CFGUPFCOS1, reg_upf_cos_1_0_time, cfgupfcos1);
    reg_upf_cos_1_0_time = RU_FIELD_SET(0, EPN, UPF_COS_1_0_TIME, CFGUPFCOS0, reg_upf_cos_1_0_time, cfgupfcos0);

    RU_REG_WRITE(0, EPN, UPF_COS_1_0_TIME, reg_upf_cos_1_0_time);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_epn_upf_cos_1_0_time_get(uint16_t *cfgupfcos1, uint16_t *cfgupfcos0)
{
    uint32_t reg_upf_cos_1_0_time=0;

#ifdef VALIDATE_PARMS
    if(!cfgupfcos1 || !cfgupfcos0)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    ...
    RU_REG_READ(0, EPN, UPF_COS_1_0_TIME, reg_upf_cos_1_0_time);

    *cfgupfcos1 = RU_FIELD_GET(0, EPN, UPF_COS_1_0_TIME, CFGUPFCOS1, reg_upf_cos_1_0_time);
    *cfgupfcos0 = RU_FIELD_GET(0, EPN, UPF_COS_1_0_TIME, CFGUPFCOS0, reg_upf_cos_1_0_time);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_epn_upf_cos_3_2_time_set(uint16_t cfgupfcos3, uint16_t cfgupfcos2)
{
    uint32_t reg_upf_cos_3_2_time=0;

#ifdef VALIDATE_PARMS
#endif

    reg_upf_cos_3_2_time = RU_FIELD_SET(0, EPN, UPF_COS_3_2_TIME, CFGUPFCOS3, reg_upf_cos_3_2_time, cfgupfcos3);
    reg_upf_cos_3_2_time = RU_FIELD_SET(0, EPN, UPF_COS_3_2_TIME, CFGUPFCOS2, reg_upf_cos_3_2_time, cfgupfcos2);

    RU_REG_WRITE(0, EPN, UPF_COS_3_2_TIME, reg_upf_cos_3_2_time);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_epn_upf_cos_3_2_time_get(uint16_t *cfgupfcos3, uint16_t *cfgupfcos2)
{
    uint32_t reg_upf_cos_3_2_time=0;

#ifdef VALIDATE_PARMS
    if(!cfgupfcos3 || !cfgupfcos2)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    ...
    RU_REG_READ(0, EPN, UPF_COS_3_2_TIME, reg_upf_cos_3_2_time);

    *cfgupfcos3 = RU_FIELD_GET(0, EPN, UPF_COS_3_2_TIME, CFGUPFCOS3, reg_upf_cos_3_2_time);
    *cfgupfcos2 = RU_FIELD_GET(0, EPN, UPF_COS_3_2_TIME, CFGUPFCOS2, reg_upf_cos_3_2_time);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_epn_upf_cos_5_4_time_set(uint16_t cfgupfcos5, uint16_t cfgupfcos4)
{
    uint32_t reg_upf_cos_5_4_time=0;

#ifdef VALIDATE_PARMS
#endif

    reg_upf_cos_5_4_time = RU_FIELD_SET(0, EPN, UPF_COS_5_4_TIME, CFGUPFCOS5, reg_upf_cos_5_4_time, cfgupfcos5);
    reg_upf_cos_5_4_time = RU_FIELD_SET(0, EPN, UPF_COS_5_4_TIME, CFGUPFCOS4, reg_upf_cos_5_4_time, cfgupfcos4);

    RU_REG_WRITE(0, EPN, UPF_COS_5_4_TIME, reg_upf_cos_5_4_time);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_epn_upf_cos_5_4_time_get(uint16_t *cfgupfcos5, uint16_t *cfgupfcos4)
{
    uint32_t reg_upf_cos_5_4_time=0;

#ifdef VALIDATE_PARMS
    if(!cfgupfcos5 || !cfgupfcos4)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    ...
    RU_REG_READ(0, EPN, UPF_COS_5_4_TIME, reg_upf_cos_5_4_time);

    *cfgupfcos5 = RU_FIELD_GET(0, EPN, UPF_COS_5_4_TIME, CFGUPFCOS5, reg_upf_cos_5_4_time);
    *cfgupfcos4 = RU_FIELD_GET(0, EPN, UPF_COS_5_4_TIME, CFGUPFCOS4, reg_upf_cos_5_4_time);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_epn_upf_cos_7_6_time_set(uint16_t cfgupfcos7, uint16_t cfgupfcos6)
{
    uint32_t reg_upf_cos_7_6_time=0;

#ifdef VALIDATE_PARMS
#endif

    reg_upf_cos_7_6_time = RU_FIELD_SET(0, EPN, UPF_COS_7_6_TIME, CFGUPFCOS7, reg_upf_cos_7_6_time, cfgupfcos7);
    reg_upf_cos_7_6_time = RU_FIELD_SET(0, EPN, UPF_COS_7_6_TIME, CFGUPFCOS6, reg_upf_cos_7_6_time, cfgupfcos6);

    RU_REG_WRITE(0, EPN, UPF_COS_7_6_TIME, reg_upf_cos_7_6_time);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_epn_upf_cos_7_6_time_get(uint16_t *cfgupfcos7, uint16_t *cfgupfcos6)
{
    uint32_t reg_upf_cos_7_6_time=0;

#ifdef VALIDATE_PARMS
    if(!cfgupfcos7 || !cfgupfcos6)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    ...
    RU_REG_READ(0, EPN, UPF_COS_7_6_TIME, reg_upf_cos_7_6_time);

    *cfgupfcos7 = RU_FIELD_GET(0, EPN, UPF_COS_7_6_TIME, CFGUPFCOS7, reg_upf_cos_7_6_time);
    *cfgupfcos6 = RU_FIELD_GET(0, EPN, UPF_COS_7_6_TIME, CFGUPFCOS6, reg_upf_cos_7_6_time);
...
enum
{
    ...
    BDMF_dpf_int_status,
    BDMF_dpf_int_mask,
    BDMF_upf_refresh_time,
    BDMF_upf_sa_31_0,
    BDMF_upf_sa_47_32,
    BDMF_upf_pause_time,
    BDMF_upf_cosmap,
    BDMF_upf_cos_1_0_time,
    BDMF_upf_cos_3_2_time,
    BDMF_upf_cos_5_4_time,
    BDMF_upf_cos_7_6_time,
    BDMF_burst_cap_0,
    BDMF_burst_cap_1,
    BDMF_burst_cap_2,
    BDMF_burst_cap_3,
...
typedef enum
{
    ...
    bdmf_address_upf_refresh_time,
    bdmf_address_upf_sa_31_0,
    bdmf_address_upf_sa_47_32,
    bdmf_address_upf_pause_time,
    bdmf_address_upf_cosmap,
    bdmf_address_upf_cos_1_0_time,
    bdmf_address_upf_cos_3_2_time,
    bdmf_address_upf_cos_5_4_time,
    bdmf_address_upf_cos_7_6_time,
...
static int bcm_epn_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case BDMF_ts_sync_offset:
        err = ag_drv_epn_ts_sync_offset_set(parm[42].value.unumber);
        break;
    ...
    case BDMF_upf_refresh_time:
        err = ag_drv_epn_upf_refresh_time_set(parm[44].value.unumber);
        break;
    case BDMF_upf_sa_31_0:
        err = ag_drv_epn_upf_sa_31_0_set(parm[44].value.unumber);
        break;
    case BDMF_upf_sa_47_32:
        err = ag_drv_epn_upf_sa_47_32_set(parm[44].value.unumber);
        break;
    case BDMF_upf_pause_time:
        err = ag_drv_epn_upf_pause_time_set(parm[44].value.unumber);
        break;
    case BDMF_upf_cosmap:
        err = ag_drv_epn_upf_cosmap_set(parm[44].value.unumber, parm[45].value.unumber);
        break;
    case BDMF_upf_cos_1_0_time:
        err = ag_drv_epn_upf_cos_1_0_time_set(parm[44].value.unumber, parm[45].value.unumber);
        break;
    case BDMF_upf_cos_3_2_time:
        err = ag_drv_epn_upf_cos_3_2_time_set(parm[44].value.unumber, parm[45].value.unumber);
        break;
    case BDMF_upf_cos_5_4_time:
        err = ag_drv_epn_upf_cos_5_4_time_set(parm[44].value.unumber, parm[45].value.unumber);
        break;
    case BDMF_upf_cos_7_6_time:
        err = ag_drv_epn_upf_cos_7_6_time_set(parm[44].value.unumber, parm[45].value.unumber);
        break;
...
static int bcm_epn_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case BDMF_upf_refresh_time:
    {
        uint32_t cfgupfrefreshtime;
        err = ag_drv_epn_upf_refresh_time_get(&cfgupfrefreshtime);
        bdmf_session_print(session, "cfgupfrefreshtime = %u = 0x%x\n", cfgupfrefreshtime, cfgupfrefreshtime);
        break;
    }
    case BDMF_upf_sa_31_0:
    {
        uint32_t cfgupfsalower32;
        err = ag_drv_epn_upf_sa_31_0_get(&cfgupfsalower32);
        bdmf_session_print(session, "cfgupfsalower32 = %u = 0x%x\n", cfgupfsalower32, cfgupfsalower32);
        break;
    }
    case BDMF_upf_sa_47_32:
    {
        uint16_t cfgupfsaupper16;
        err = ag_drv_epn_upf_sa_47_32_get(&cfgupfsaupper16);
        bdmf_session_print(session, "cfgupfsaupper16 = %u = 0x%x\n", cfgupfsaupper16, cfgupfsaupper16);
        break;
    }
    case BDMF_upf_pause_time:
    {
        uint16_t cfgupfpausetime;
        err = ag_drv_epn_upf_pause_time_get(&cfgupfpausetime);
        bdmf_session_print(session, "cfgupfpausetime = %u = 0x%x\n", cfgupfpausetime, cfgupfpausetime);
        break;
    }
    case BDMF_upf_cosmap:
    {
        uint8_t upfcosmapsent;
        uint8_t cfgupfcosmap;
        err = ag_drv_epn_upf_cosmap_get(&upfcosmapsent, &cfgupfcosmap);
        bdmf_session_print(session, "upfcosmapsent = %u = 0x%x\n", upfcosmapsent, upfcosmapsent);
        bdmf_session_print(session, "cfgupfcosmap = %u = 0x%x\n", cfgupfcosmap, cfgupfcosmap);
        break;
    }
    case BDMF_upf_cos_1_0_time:
    {
        uint16_t cfgupfcos1;
        uint16_t cfgupfcos0;
        err = ag_drv_epn_upf_cos_1_0_time_get(&cfgupfcos1, &cfgupfcos0);
        bdmf_session_print(session, "cfgupfcos1 = %u = 0x%x\n", cfgupfcos1, cfgupfcos1);
        bdmf_session_print(session, "cfgupfcos0 = %u = 0x%x\n", cfgupfcos0, cfgupfcos0);
        break;
    }
    case BDMF_upf_cos_3_2_time:
    {
        uint16_t cfgupfcos3;
        uint16_t cfgupfcos2;
        err = ag_drv_epn_upf_cos_3_2_time_get(&cfgupfcos3, &cfgupfcos2);
        bdmf_session_print(session, "cfgupfcos3 = %u = 0x%x\n", cfgupfcos3, cfgupfcos3);
        bdmf_session_print(session, "cfgupfcos2 = %u = 0x%x\n", cfgupfcos2, cfgupfcos2);
        break;
    }
    case BDMF_upf_cos_5_4_time:
    {
        uint16_t cfgupfcos5;
        uint16_t cfgupfcos4;
        err = ag_drv_epn_upf_cos_5_4_time_get(&cfgupfcos5, &cfgupfcos4);
        bdmf_session_print(session, "cfgupfcos5 = %u = 0x%x\n", cfgupfcos5, cfgupfcos5);
        bdmf_session_print(session, "cfgupfcos4 = %u = 0x%x\n", cfgupfcos4, cfgupfcos4);
        break;
    }
    case BDMF_upf_cos_7_6_time:
    {
        uint16_t cfgupfcos7;
        uint16_t cfgupfcos6;
        err = ag_drv_epn_upf_cos_7_6_time_get(&cfgupfcos7, &cfgupfcos6);
        bdmf_session_print(session, "cfgupfcos7 = %u = 0x%x\n", cfgupfcos7, cfgupfcos7);
        bdmf_session_print(session, "cfgupfcos6 = %u = 0x%x\n", cfgupfcos6, cfgupfcos6);
        break;
    }
    case BDMF_burst_cap_0:
    {
...
static int bcm_epn_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        uint32_t cfgupfrefreshtime=gtmv(m, 24);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_refresh_time_set( %u)\n", cfgupfrefreshtime);
        if(!err) ag_drv_epn_upf_refresh_time_set(cfgupfrefreshtime);
        if(!err) ag_drv_epn_upf_refresh_time_get( &cfgupfrefreshtime);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_refresh_time_get( %u)\n", cfgupfrefreshtime);
        if(err || cfgupfrefreshtime!=gtmv(m, 24))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfgupfsalower32=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_sa_31_0_set( %u)\n", cfgupfsalower32);
        if(!err) ag_drv_epn_upf_sa_31_0_set(cfgupfsalower32);
        if(!err) ag_drv_epn_upf_sa_31_0_get( &cfgupfsalower32);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_sa_31_0_get( %u)\n", cfgupfsalower32);
        if(err || cfgupfsalower32!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint16_t cfgupfsaupper16=gtmv(m, 16);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_sa_47_32_set( %u)\n", cfgupfsaupper16);
        if(!err) ag_drv_epn_upf_sa_47_32_set(cfgupfsaupper16);
        if(!err) ag_drv_epn_upf_sa_47_32_get( &cfgupfsaupper16);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_sa_47_32_get( %u)\n", cfgupfsaupper16);
        if(err || cfgupfsaupper16!=gtmv(m, 16))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint16_t cfgupfpausetime=gtmv(m, 16);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_pause_time_set( %u)\n", cfgupfpausetime);
        if(!err) ag_drv_epn_upf_pause_time_set(cfgupfpausetime);
        if(!err) ag_drv_epn_upf_pause_time_get( &cfgupfpausetime);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_pause_time_get( %u)\n", cfgupfpausetime);
        if(err || cfgupfpausetime!=gtmv(m, 16))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint8_t upfcosmapsent=gtmv(m, 8);
        uint8_t cfgupfcosmap=gtmv(m, 8);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_cosmap_set( %u %u)\n", upfcosmapsent, cfgupfcosmap);
        if(!err) ag_drv_epn_upf_cosmap_set(upfcosmapsent, cfgupfcosmap);
        if(!err) ag_drv_epn_upf_cosmap_get( &upfcosmapsent, &cfgupfcosmap);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_cosmap_get( %u %u)\n", upfcosmapsent, cfgupfcosmap);
        if(err || upfcosmapsent!=gtmv(m, 8) || cfgupfcosmap!=gtmv(m, 8))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint16_t cfgupfcos1=gtmv(m, 16);
        uint16_t cfgupfcos0=gtmv(m, 16);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_cos_1_0_time_set( %u %u)\n", cfgupfcos1, cfgupfcos0);
        if(!err) ag_drv_epn_upf_cos_1_0_time_set(cfgupfcos1, cfgupfcos0);
        if(!err) ag_drv_epn_upf_cos_1_0_time_get( &cfgupfcos1, &cfgupfcos0);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_cos_1_0_time_get( %u %u)\n", cfgupfcos1, cfgupfcos0);
        if(err || cfgupfcos1!=gtmv(m, 16) || cfgupfcos0!=gtmv(m, 16))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint16_t cfgupfcos3=gtmv(m, 16);
        uint16_t cfgupfcos2=gtmv(m, 16);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_cos_3_2_time_set( %u %u)\n", cfgupfcos3, cfgupfcos2);
        if(!err) ag_drv_epn_upf_cos_3_2_time_set(cfgupfcos3, cfgupfcos2);
        if(!err) ag_drv_epn_upf_cos_3_2_time_get( &cfgupfcos3, &cfgupfcos2);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_cos_3_2_time_get( %u %u)\n", cfgupfcos3, cfgupfcos2);
        if(err || cfgupfcos3!=gtmv(m, 16) || cfgupfcos2!=gtmv(m, 16))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint16_t cfgupfcos5=gtmv(m, 16);
        uint16_t cfgupfcos4=gtmv(m, 16);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_cos_5_4_time_set( %u %u)\n", cfgupfcos5, cfgupfcos4);
        if(!err) ag_drv_epn_upf_cos_5_4_time_set(cfgupfcos5, cfgupfcos4);
        if(!err) ag_drv_epn_upf_cos_5_4_time_get( &cfgupfcos5, &cfgupfcos4);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_cos_5_4_time_get( %u %u)\n", cfgupfcos5, cfgupfcos4);
        if(err || cfgupfcos5!=gtmv(m, 16) || cfgupfcos4!=gtmv(m, 16))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint16_t cfgupfcos7=gtmv(m, 16);
        uint16_t cfgupfcos6=gtmv(m, 16);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_cos_7_6_time_set( %u %u)\n", cfgupfcos7, cfgupfcos6);
        if(!err) ag_drv_epn_upf_cos_7_6_time_set(cfgupfcos7, cfgupfcos6);
        if(!err) ag_drv_epn_upf_cos_7_6_time_get( &cfgupfcos7, &cfgupfcos6);
        if(!err) bdmf_session_print(session, "ag_drv_epn_upf_cos_7_6_time_get( %u %u)\n", cfgupfcos7, cfgupfcos6);
        if(err || cfgupfcos7!=gtmv(m, 16) || cfgupfcos6!=gtmv(m, 16))
            return err ? err : BDMF_ERR_IO;
    }
    {
...
static int bcm_epn_cli_address(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case bdmf_address_upf_refresh_time : reg = &RU_REG(EPN, UPF_REFRESH_TIME); blk = &RU_BLK(EPN); break;
    case bdmf_address_upf_sa_31_0 : reg = &RU_REG(EPN, UPF_SA_31_0); blk = &RU_BLK(EPN); break;
    case bdmf_address_upf_sa_47_32 : reg = &RU_REG(EPN, UPF_SA_47_32); blk = &RU_BLK(EPN); break;
    case bdmf_address_upf_pause_time : reg = &RU_REG(EPN, UPF_PAUSE_TIME); blk = &RU_BLK(EPN); break;
    case bdmf_address_upf_cosmap : reg = &RU_REG(EPN, UPF_COSMAP); blk = &RU_BLK(EPN); break;
    case bdmf_address_upf_cos_1_0_time : reg = &RU_REG(EPN, UPF_COS_1_0_TIME); blk = &RU_BLK(EPN); break;
    case bdmf_address_upf_cos_3_2_time : reg = &RU_REG(EPN, UPF_COS_3_2_TIME); blk = &RU_BLK(EPN); break;
    case bdmf_address_upf_cos_5_4_time : reg = &RU_REG(EPN, UPF_COS_5_4_TIME); blk = &RU_BLK(EPN); break;
    case bdmf_address_upf_cos_7_6_time : reg = &RU_REG(EPN, UPF_COS_7_6_TIME); blk = &RU_BLK(EPN); break;
...
bdmfmon_handle_t ag_drv_epn_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_upf_refresh_time[]={
            BDMFMON_MAKE_PARM("cfgupfrefreshtime", "cfgupfrefreshtime", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_upf_sa_31_0[]={
            BDMFMON_MAKE_PARM("cfgupfsalower32", "cfgupfsalower32", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_upf_sa_47_32[]={
            BDMFMON_MAKE_PARM("cfgupfsaupper16", "cfgupfsaupper16", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_upf_pause_time[]={
            BDMFMON_MAKE_PARM("cfgupfpausetime", "cfgupfpausetime", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_upf_cosmap[]={
            BDMFMON_MAKE_PARM("upfcosmapsent", "upfcosmapsent", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfgupfcosmap", "cfgupfcosmap", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_upf_cos_1_0_time[]={
            BDMFMON_MAKE_PARM("cfgupfcos1", "cfgupfcos1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfgupfcos0", "cfgupfcos0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_upf_cos_3_2_time[]={
            BDMFMON_MAKE_PARM("cfgupfcos3", "cfgupfcos3", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfgupfcos2", "cfgupfcos2", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_upf_cos_5_4_time[]={
            BDMFMON_MAKE_PARM("cfgupfcos5", "cfgupfcos5", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfgupfcos4", "cfgupfcos4", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_upf_cos_7_6_time[]={
            BDMFMON_MAKE_PARM("cfgupfcos7", "cfgupfcos7", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfgupfcos6", "cfgupfcos6", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="upf_refresh_time", .val=BDMF_upf_refresh_time, .parms=set_upf_refresh_time },
            { .name="upf_sa_31_0", .val=BDMF_upf_sa_31_0, .parms=set_upf_sa_31_0 },
            { .name="upf_sa_47_32", .val=BDMF_upf_sa_47_32, .parms=set_upf_sa_47_32 },
            { .name="upf_pause_time", .val=BDMF_upf_pause_time, .parms=set_upf_pause_time },
            { .name="upf_cosmap", .val=BDMF_upf_cosmap, .parms=set_upf_cosmap },
            { .name="upf_cos_1_0_time", .val=BDMF_upf_cos_1_0_time, .parms=set_upf_cos_1_0_time },
            { .name="upf_cos_3_2_time", .val=BDMF_upf_cos_3_2_time, .parms=set_upf_cos_3_2_time },
            { .name="upf_cos_5_4_time", .val=BDMF_upf_cos_5_4_time, .parms=set_upf_cos_5_4_time },
            { .name="upf_cos_7_6_time", .val=BDMF_upf_cos_7_6_time, .parms=set_upf_cos_7_6_time },
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="upf_refresh_time", .val=BDMF_upf_refresh_time, .parms=set_default },
            { .name="upf_sa_31_0", .val=BDMF_upf_sa_31_0, .parms=set_default },
            { .name="upf_sa_47_32", .val=BDMF_upf_sa_47_32, .parms=set_default },
            { .name="upf_pause_time", .val=BDMF_upf_pause_time, .parms=set_default },
            { .name="upf_cosmap", .val=BDMF_upf_cosmap, .parms=set_default },
            { .name="upf_cos_1_0_time", .val=BDMF_upf_cos_1_0_time, .parms=set_default },
            { .name="upf_cos_3_2_time", .val=BDMF_upf_cos_3_2_time, .parms=set_default },
            { .name="upf_cos_5_4_time", .val=BDMF_upf_cos_5_4_time, .parms=set_default },
            { .name="upf_cos_7_6_time", .val=BDMF_upf_cos_7_6_time, .parms=set_default },
    ...
    }
    {
        static bdmfmon_enum_val_t enum_table_address[] = {
            ...
            { .name="UPF_REFRESH_TIME" , .val=bdmf_address_upf_refresh_time },
            { .name="UPF_SA_31_0" , .val=bdmf_address_upf_sa_31_0 },
            { .name="UPF_SA_47_32" , .val=bdmf_address_upf_sa_47_32 },
            { .name="UPF_PAUSE_TIME" , .val=bdmf_address_upf_pause_time },
            { .name="UPF_COSMAP" , .val=bdmf_address_upf_cosmap },
            { .name="UPF_COS_1_0_TIME" , .val=bdmf_address_upf_cos_1_0_time },
            { .name="UPF_COS_3_2_TIME" , .val=bdmf_address_upf_cos_3_2_time },
            { .name="UPF_COS_5_4_TIME" , .val=bdmf_address_upf_cos_5_4_time },
            { .name="UPF_COS_7_6_TIME" , .val=bdmf_address_upf_cos_7_6_time },
