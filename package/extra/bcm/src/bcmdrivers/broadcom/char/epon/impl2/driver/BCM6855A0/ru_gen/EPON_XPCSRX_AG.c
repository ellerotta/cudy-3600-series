...
#if RU_INCLUDE_DESC
    "",
    "NOT USED, 0 - Interrupt is masked. 1 - Interrupt is unmasked.",
#endif
...
/******************************************************************************
 * Field: XPCSRX_RX_FEC_CTL_CFGXPCSRXIDLEINVLDRESEN
 ******************************************************************************/
const ru_field_rec XPCSRX_RX_FEC_CTL_CFGXPCSRXIDLEINVLDRESEN_FIELD =
{
    "CFGXPCSRXIDLEINVLDRESEN",
#if RU_INCLUDE_DESC
    "",
    "Allow Idle insert to use the restore invalid time at the FEC decoder"
    "to properly"
    "place gaps with respect to the DA in the packet.  Reduces DA jitter"
    "as seen by MAC."
    "Improvement for 1588.",
#endif
    XPCSRX_RX_FEC_CTL_CFGXPCSRXIDLEINVLDRESEN_FIELD_MASK,
    0,
    XPCSRX_RX_FEC_CTL_CFGXPCSRXIDLEINVLDRESEN_FIELD_WIDTH,
    XPCSRX_RX_FEC_CTL_CFGXPCSRXIDLEINVLDRESEN_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPCSRX_RX_FEC_CTL_CFGXPCSRXFECINVLDRESEN
 ******************************************************************************/
const ru_field_rec XPCSRX_RX_FEC_CTL_CFGXPCSRXFECINVLDRESEN_FIELD =
{
    "CFGXPCSRXFECINVLDRESEN",
#if RU_INCLUDE_DESC
    "",
    "Allow FEC decoder to restore invalid time in CW where framer"
    "generated it."
    "Improvement for 1588.",
#endif
    XPCSRX_RX_FEC_CTL_CFGXPCSRXFECINVLDRESEN_FIELD_MASK,
    0,
    XPCSRX_RX_FEC_CTL_CFGXPCSRXFECINVLDRESEN_FIELD_WIDTH,
    XPCSRX_RX_FEC_CTL_CFGXPCSRXFECINVLDRESEN_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPCSRX_RX_TEST_CTL_CFGXPCSRXTESTPSUDOHAM
 ******************************************************************************/
const ru_field_rec XPCSRX_RX_TEST_CTL_CFGXPCSRXTESTPSUDOHAM_FIELD =
{
    "CFGXPCSRXTESTPSUDOHAM",
#if RU_INCLUDE_DESC
    "",
    "Allow error in psudo test pattern detector.",
#endif
    XPCSRX_RX_TEST_CTL_CFGXPCSRXTESTPSUDOHAM_FIELD_MASK,
    0,
    XPCSRX_RX_TEST_CTL_CFGXPCSRXTESTPSUDOHAM_FIELD_WIDTH,
    XPCSRX_RX_TEST_CTL_CFGXPCSRXTESTPSUDOHAM_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPCSRX_RX_TEST_CTL_RESERVED1
 ******************************************************************************/
const ru_field_rec XPCSRX_RX_TEST_CTL_RESERVED1_FIELD =
{
    "RESERVED1",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    XPCSRX_RX_TEST_CTL_RESERVED1_FIELD_MASK,
    0,
    XPCSRX_RX_TEST_CTL_RESERVED1_FIELD_WIDTH,
    XPCSRX_RX_TEST_CTL_RESERVED1_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
#if RU_INCLUDE_DESC
    "",
    "NOT USED, Raw status on interrups.",
#endif
...
/******************************************************************************
 * Field: XPCSRX_RX_TEST_PSUDO_PAT_SH_RESERVED0
 ******************************************************************************/
const ru_field_rec XPCSRX_RX_TEST_PSUDO_PAT_SH_RESERVED0_FIELD =
{
    "RESERVED0",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    XPCSRX_RX_TEST_PSUDO_PAT_SH_RESERVED0_FIELD_MASK,
    0,
    XPCSRX_RX_TEST_PSUDO_PAT_SH_RESERVED0_FIELD_WIDTH,
    XPCSRX_RX_TEST_PSUDO_PAT_SH_RESERVED0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPCSRX_RX_TEST_PSUDO_PAT_SH_CFGXPCSRXTESTPSUDODETPATSH
 ******************************************************************************/
const ru_field_rec XPCSRX_RX_TEST_PSUDO_PAT_SH_CFGXPCSRXTESTPSUDODETPATSH_FIELD =
{
    "CFGXPCSRXTESTPSUDODETPATSH",
#if RU_INCLUDE_DESC
    "",
    "SH pattern for psudo pattern 1 and pattern 2."
    "For psudo test SH = control type = 2'b01.",
#endif
    XPCSRX_RX_TEST_PSUDO_PAT_SH_CFGXPCSRXTESTPSUDODETPATSH_FIELD_MASK,
    0,
    XPCSRX_RX_TEST_PSUDO_PAT_SH_CFGXPCSRXTESTPSUDODETPATSH_FIELD_WIDTH,
    XPCSRX_RX_TEST_PSUDO_PAT_SH_CFGXPCSRXTESTPSUDODETPATSH_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPCSRX_RX_TEST_PSUDO_PAT1_LOW_CFGXPCSRXTESTPSUDODETPAT1LOW
 ******************************************************************************/
const ru_field_rec XPCSRX_RX_TEST_PSUDO_PAT1_LOW_CFGXPCSRXTESTPSUDODETPAT1LOW_FIELD =
{
    "CFGXPCSRXTESTPSUDODETPAT1LOW",
#if RU_INCLUDE_DESC
    "",
    "Lower 31 bit of Type 1 pattern."
    "For psudo type 1, data = sequence type LF.",
#endif
    XPCSRX_RX_TEST_PSUDO_PAT1_LOW_CFGXPCSRXTESTPSUDODETPAT1LOW_FIELD_MASK,
    0,
    XPCSRX_RX_TEST_PSUDO_PAT1_LOW_CFGXPCSRXTESTPSUDODETPAT1LOW_FIELD_WIDTH,
    XPCSRX_RX_TEST_PSUDO_PAT1_LOW_CFGXPCSRXTESTPSUDODETPAT1LOW_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPCSRX_RX_TEST_PSUDO_PAT1_HIGH_CFGXPCSRXTESTPSUDODETPAT1HIGH
 ******************************************************************************/
const ru_field_rec XPCSRX_RX_TEST_PSUDO_PAT1_HIGH_CFGXPCSRXTESTPSUDODETPAT1HIGH_FIELD =
{
    "CFGXPCSRXTESTPSUDODETPAT1HIGH",
#if RU_INCLUDE_DESC
    "",
    "Upper 31 bit of Type 1 pattern."
    "For psudo type 1, data = sequence type LF.",
#endif
    XPCSRX_RX_TEST_PSUDO_PAT1_HIGH_CFGXPCSRXTESTPSUDODETPAT1HIGH_FIELD_MASK,
    0,
    XPCSRX_RX_TEST_PSUDO_PAT1_HIGH_CFGXPCSRXTESTPSUDODETPAT1HIGH_FIELD_WIDTH,
    XPCSRX_RX_TEST_PSUDO_PAT1_HIGH_CFGXPCSRXTESTPSUDODETPAT1HIGH_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPCSRX_RX_TEST_PSUDO_PAT2_LOW_CFGXPCSRXTESTPSUDODETPAT2LOW
 ******************************************************************************/
const ru_field_rec XPCSRX_RX_TEST_PSUDO_PAT2_LOW_CFGXPCSRXTESTPSUDODETPAT2LOW_FIELD =
{
    "CFGXPCSRXTESTPSUDODETPAT2LOW",
#if RU_INCLUDE_DESC
    "",
    "Lower 31 bit of Type 2 pattern."
    "For psudo type 1, data = sequence type LF.",
#endif
    XPCSRX_RX_TEST_PSUDO_PAT2_LOW_CFGXPCSRXTESTPSUDODETPAT2LOW_FIELD_MASK,
    0,
    XPCSRX_RX_TEST_PSUDO_PAT2_LOW_CFGXPCSRXTESTPSUDODETPAT2LOW_FIELD_WIDTH,
    XPCSRX_RX_TEST_PSUDO_PAT2_LOW_CFGXPCSRXTESTPSUDODETPAT2LOW_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPCSRX_RX_TEST_PSUDO_PAT2_HIGH_CFGXPCSRXTESTPSUDODETPAT2HIGH
 ******************************************************************************/
const ru_field_rec XPCSRX_RX_TEST_PSUDO_PAT2_HIGH_CFGXPCSRXTESTPSUDODETPAT2HIGH_FIELD =
{
    "CFGXPCSRXTESTPSUDODETPAT2HIGH",
#if RU_INCLUDE_DESC
    "",
    "Upper 31 bit of Type 2 pattern."
    "For psudo type 1, data = all zeros.",
#endif
    XPCSRX_RX_TEST_PSUDO_PAT2_HIGH_CFGXPCSRXTESTPSUDODETPAT2HIGH_FIELD_MASK,
    0,
    XPCSRX_RX_TEST_PSUDO_PAT2_HIGH_CFGXPCSRXTESTPSUDODETPAT2HIGH_FIELD_WIDTH,
    XPCSRX_RX_TEST_PSUDO_PAT2_HIGH_CFGXPCSRXTESTPSUDODETPAT2HIGH_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
static const ru_field_rec *XPCSRX_RX_FEC_CTL_FIELDS[] =
{
    ...
    &XPCSRX_RX_FEC_CTL_CFGXPCSRXIDLEINVLDRESEN_FIELD,
    &XPCSRX_RX_FEC_CTL_CFGXPCSRXFECINVLDRESEN_FIELD,
...
static const ru_field_rec *XPCSRX_RX_TEST_CTL_FIELDS[] =
{
    ...
    &XPCSRX_RX_TEST_CTL_CFGXPCSRXTESTPSUDOHAM_FIELD,
    &XPCSRX_RX_TEST_CTL_RESERVED1_FIELD,
...
/******************************************************************************
 * Register: XPCSRX_RX_TEST_PSUDO_PAT_SH
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *XPCSRX_RX_TEST_PSUDO_PAT_SH_FIELDS[] =
{
    &XPCSRX_RX_TEST_PSUDO_PAT_SH_RESERVED0_FIELD,
    &XPCSRX_RX_TEST_PSUDO_PAT_SH_CFGXPCSRXTESTPSUDODETPATSH_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec XPCSRX_RX_TEST_PSUDO_PAT_SH_REG = 
{
    "RX_TEST_PSUDO_PAT_SH",
#if RU_INCLUDE_DESC
    "XPCSRX_TEST_PSUDO_PAT_SH Register",
    "Provides control over test circuits in XPCS RX.",
#endif
    XPCSRX_RX_TEST_PSUDO_PAT_SH_REG_OFFSET,
    0,
    0,
    615,
#if RU_INCLUDE_ACCESS
...
#if RU_INCLUDE_FIELD_DB
    2,
    XPCSRX_RX_TEST_PSUDO_PAT_SH_FIELDS,
#endif /* RU_INCLUDE_FIELD_DB */
    ru_reg_size_32
};

/******************************************************************************
 * Register: XPCSRX_RX_TEST_PSUDO_PAT1_LOW
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *XPCSRX_RX_TEST_PSUDO_PAT1_LOW_FIELDS[] =
{
    &XPCSRX_RX_TEST_PSUDO_PAT1_LOW_CFGXPCSRXTESTPSUDODETPAT1LOW_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec XPCSRX_RX_TEST_PSUDO_PAT1_LOW_REG = 
{
    "RX_TEST_PSUDO_PAT1_LOW",
#if RU_INCLUDE_DESC
    "XPCSRX_TEST_PSUDO_PAT1_LOW Register",
    "Provides control over test circuits in XPCS RX.",
#endif
    XPCSRX_RX_TEST_PSUDO_PAT1_LOW_REG_OFFSET,
    0,
    0,
    616,
#if RU_INCLUDE_ACCESS
...
#if RU_INCLUDE_FIELD_DB
    1,
    XPCSRX_RX_TEST_PSUDO_PAT1_LOW_FIELDS,
#endif /* RU_INCLUDE_FIELD_DB */
    ru_reg_size_32
};

/******************************************************************************
 * Register: XPCSRX_RX_TEST_PSUDO_PAT1_HIGH
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *XPCSRX_RX_TEST_PSUDO_PAT1_HIGH_FIELDS[] =
{
    &XPCSRX_RX_TEST_PSUDO_PAT1_HIGH_CFGXPCSRXTESTPSUDODETPAT1HIGH_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec XPCSRX_RX_TEST_PSUDO_PAT1_HIGH_REG = 
{
    "RX_TEST_PSUDO_PAT1_HIGH",
#if RU_INCLUDE_DESC
    "XPCSRX_TEST_PSUDO_PAT1_HIGH Register",
    "Provides control over test circuits in XPCS RX.",
#endif
    XPCSRX_RX_TEST_PSUDO_PAT1_HIGH_REG_OFFSET,
    0,
    0,
    617,
#if RU_INCLUDE_ACCESS
...
#if RU_INCLUDE_FIELD_DB
    1,
    XPCSRX_RX_TEST_PSUDO_PAT1_HIGH_FIELDS,
#endif /* RU_INCLUDE_FIELD_DB */
    ru_reg_size_32
};

/******************************************************************************
 * Register: XPCSRX_RX_TEST_PSUDO_PAT2_LOW
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *XPCSRX_RX_TEST_PSUDO_PAT2_LOW_FIELDS[] =
{
    &XPCSRX_RX_TEST_PSUDO_PAT2_LOW_CFGXPCSRXTESTPSUDODETPAT2LOW_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec XPCSRX_RX_TEST_PSUDO_PAT2_LOW_REG = 
{
    "RX_TEST_PSUDO_PAT2_LOW",
#if RU_INCLUDE_DESC
    "XPCSRX_TEST_PSUDO_PAT2_LOW Register",
    "Provides control over test circuits in XPCS RX.",
#endif
    XPCSRX_RX_TEST_PSUDO_PAT2_LOW_REG_OFFSET,
    0,
    0,
    618,
#if RU_INCLUDE_ACCESS
...
#if RU_INCLUDE_FIELD_DB
    1,
    XPCSRX_RX_TEST_PSUDO_PAT2_LOW_FIELDS,
#endif /* RU_INCLUDE_FIELD_DB */
    ru_reg_size_32
};

/******************************************************************************
 * Register: XPCSRX_RX_TEST_PSUDO_PAT2_HIGH
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *XPCSRX_RX_TEST_PSUDO_PAT2_HIGH_FIELDS[] =
{
    &XPCSRX_RX_TEST_PSUDO_PAT2_HIGH_CFGXPCSRXTESTPSUDODETPAT2HIGH_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec XPCSRX_RX_TEST_PSUDO_PAT2_HIGH_REG = 
{
    "RX_TEST_PSUDO_PAT2_HIGH",
#if RU_INCLUDE_DESC
    "XPCSRX_TEST_PSUDO_PAT2_HIGH Register",
    "Provides control over test circuits in XPCS RX.",
#endif
    XPCSRX_RX_TEST_PSUDO_PAT2_HIGH_REG_OFFSET,
    0,
    0,
    619,
#if RU_INCLUDE_ACCESS
...
#if RU_INCLUDE_FIELD_DB
    1,
    XPCSRX_RX_TEST_PSUDO_PAT2_HIGH_FIELDS,
#endif /* RU_INCLUDE_FIELD_DB */
    ru_reg_size_32
};
...
static const ru_reg_rec *XPCSRX_REGS[] =
{
    ...
    &XPCSRX_RX_TEST_PSUDO_PAT_SH_REG,
    &XPCSRX_RX_TEST_PSUDO_PAT1_LOW_REG,
    &XPCSRX_RX_TEST_PSUDO_PAT1_HIGH_REG,
    &XPCSRX_RX_TEST_PSUDO_PAT2_LOW_REG,
    &XPCSRX_RX_TEST_PSUDO_PAT2_HIGH_REG,
};
