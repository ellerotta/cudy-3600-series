...
const ru_field_rec LIF_DATA_PORT_COMMAND_RAM_SELECT_FIELD =
{
    ...
    "(256 x 32 bits)"
    "1: SEC Downstream Key (64 x 225 bits)"
    "2: FEC Downstream Data (2048 x 20 bits)*"
    "3: SEC Upstream Key (32 x 234 bits)"
...
#if RU_INCLUDE_DESC
    "",
    "Approximately the maximum number of double words which the frame can"
...
const ru_reg_rec LIF_DATA_PORT_COMMAND_REG = 
{
    ...
    "even/odd key."
    "Must match key number specified in portData7[8]. In P2P"
    "mode, TCI[1:0]"
