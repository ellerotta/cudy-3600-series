...
#define XTMCFGIOCTL_ACCESS_SAR \
    _IOWR(XTMCFGDRV_MAJOR, 20, XTMCFGDRV_ACCESS_SAR_PARAMS)
#define XTMCFGIOCTL_SAR_REG_DUMP \
    _IOWR(XTMCFGDRV_MAJOR, 21, XTMCFGDRV_SAR_REG_DUMP)
#define XTMCFGIOCTL_GET_XTMP_STATUS \
    _IOWR(XTMCFGDRV_MAJOR, 22, XTMCFGDRV_XTMP_STATUS)

#define MAX_XTMCFGDRV_IOCTL_COMMANDS   23
...
typedef struct
{
    UINT8  bReadIO ;
    BCMXTM_STATUS bxStatus ;
} XTMCFGDRV_ACCESS_SAR_PARAMS, *PXTMCFGDRV_ACCESS_SAR_PARAMS;

typedef struct 
{
    UINT32 regCategoryId;
    BCM_IOC_PTR(void*, pRegBuff);
    UINT32 buffSize;
    UINT32 baseAddr;
    UINT32 numRegs;
    BCMXTM_STATUS bxStatus;
} XTMCFGDRV_SAR_REG_DUMP, *PXTMCFGDRV_SAR_REG_DUMP;

typedef struct
{
    XTM_XTMP_STATUS XTMPStatus;
    BCMXTM_STATUS bxStatus;
} XTMCFGDRV_XTMP_STATUS, *PXTMCFGDRV_XTMP_STATUS;
