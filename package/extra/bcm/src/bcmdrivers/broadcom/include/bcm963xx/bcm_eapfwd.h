...
int dhd_eap_bind(struct net_device * dhd_dev, int radio_idx,
            d3lut_t * lut, pktlist_context_t * dhd_pktlist_context,
            HOOKP dhd_pktfwd_xfer_hook);

int wl_eap_unbind(int radio_idx);

int dhd_eap_unbind(int radio_idx);
