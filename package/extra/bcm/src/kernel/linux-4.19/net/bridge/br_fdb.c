...
{
#if defined(CONFIG_BCM_KF_BR_HOOKS) 
	return bcm_br_has_fdb_expired(br, fdb);
#else
...
#if defined(CONFIG_BCM_KF_BR_HOOKS)
		bcm_br_fdb_cleanup(f, now, delay);
#endif
