...
/* Definitions for ATM/PTM ulTxChannelCfg. */
#define TXCH_DISABLE_ZERO_PAD               0x1
#define TXCH_MIN_PKT_SIZE                   0x3c
#define TXCH_DIS_64BYTE_ZERO_PAD_MASK       0x00080000
#define TXCH_DIS_64BYTE_ZERO_PAD_SHIFT      19
#define TXCH_MIN_PKT_SIZE_ZERO_PAD_MASK     0x07F00000
#define TXCH_MIN_PKT_SIZE_ZERO_PAD_SHIFT    20
...
#else
#define INTR_PTM_FRAG_ERROR                 0x00000004
#define INTR_PTM_FRAG_EOP_ERROR             0x00000008
#endif
...
#else
#define INTR_RXCHANBUFF_IRQ_MASK            0x00070000
#define INTR_RXCHANBUFF_IRQ_SHIFT           16
#endif
#else
...
#endif
#define INTR_TEST_IRQ                       0x80000000

/* Definitions for ulSoftReset */
#define RX_SOFT_RST                         0x00000001
#define TX_SOFT_RST                         0x00000002
#define RX_FLUSH_REQ                        0x00000010
#if defined(CONFIG_BCM963146)
#define RX_FLUSH_DONE                       0x00000020
#define TX_FLUSH_REQ                        0x00000040
#define TX_FLUSH_DONE                       0x00000080
#endif

/* Definitions for ulTxPktBufSpacePadding */
#define PTM_NON_BONDED_PAD_MASK             0x000000ff
#define PTM_NON_BONDED_PAD_SHIFT            0
#define PTM_BONDED_PAD_MASK                 0x0000ff00
#define PTM_BONDED_PAD_SHIFT                8
#define PTM_ATM_PAD_MASK                    0x00ff0000
#define PTM_ATM_PAD_SHIFT                   16
...
#define TXSARP_USE_ALT_PTM_CRC              0x00004000 /* Use Ikanos PTM CRC-16 calculations for IOP purposes */
...
/* Definitions for ulTxFragCfg. */
#define TXFRAG_MAX_FRAG_SIZE_MASK           0x0000ffff
#define TXFRAG_MAX_FRAG_SIZE_SHIFT          0
#define TXFRAG_MIN_FRAG_SIZE_MASK           0xffff0000
#define TXFRAG_MIN_FRAG_SIZE_SHIFT          16
#define TXFRAG_FRAG_OVERHEAD_SIZE           4  /* (2) FragHdr, (2) CRC-16 */
#define TXFRAG_MIN_FRAG_SIZE                (64+TXFRAG_FRAG_OVERHEAD_SIZE)
#define TXFRAG_MAX_FRAG_SIZE                (512+TXFRAG_FRAG_OVERHEAD_SIZE)
...
/* Definition for ulSsNewCfgD0_or_Reserved6 */
#define SHPR_NEWCFGD0_DISABLE_OLD             0x80000000
#define SHPR_NEWCFGD0_DISABLE_OLD_SHIFT       31
#define SHPR_NEWCFGD0_EN24HDR                 0x40000000
#define SHPR_NEWCFGD0_NEW_BOND_P_DISABLE_MASK 0x0F000000
#define SHPR_NEWCFGD0_NEW_BOND_P_SHIFT        24

/* Definition for ulTxIfCfg */
#define TXIF_BURST_SIZE_CFG_MASK            0x7c000000
#define TXIF_BURST_SIZE_CFG_SHIFT           26
#define TXIF_THOLD_CFG_MASK                 0x03ff0000
#define TXIF_THOLD_CFG_SHIFT                16
#define TXIF_SAR_ARB_PRIO_EN                0x00000040
#define TXIF_SAR_TXIF_PRIO_EN               0x00000020
#define TXIF_INIT_REQ                       0x00000010
#define TXIF_FIFO_SPACE_CFG_MASK            0x00000007
#define TXIF_FIFO_SPACE_CFG_SHIFT           0
#define TXIF_FIFO_SPACE_1_CHANNEL           0x1
#define TXIF_FIFO_SPACE_2_CHANNEL           0x2
#define TXIF_FIFO_SPACE_4_CHANNEL           0x3
#define TXIF_FIFO_SPACE_8_CHANNEL           0x4
#define TXIF_FIFO_SPACE_16_CHANNEL          0x0
...
#if defined(CONFIG_BCM963146)
#define TMUEXT_SCRINCR_INDEX                0
#define TMUEXT_PCRINCR_INDEX                0
#define TMUEXT_ACCLMT_INDEX                 1
#define TMUEXT_CURACC_INDEX                 2
#define TMUEXT_SITLMT_CURSIT_INDEX          3
#else
#define TMUEXT_SCRINCR_INDEX                0
#define TMUEXT_PCRINCR_INDEX                0
#define TMUEXT_ACCLMT_INDEX                 1
#define TMUEXT_CURACC_INDEX                 1
#define TMUEXT_SITLMT_CURSIT_INDEX          2
#endif
...
#if defined(CONFIG_BCM963146)
#define SSTE_SCR_CURACC_MASK                0x000fffff
#define SSTE_SCR_CURACC_SHIFT               0
#define SSTE_SCR_ACCLMT_MASK                0x000fffff
#define SSTE_SCR_ACCLMT_SHIFT               0
#else
...
#if defined(CONFIG_BCM963146)
#define SSTE_PCR_CURACC_MASK                0x000fffff
#define SSTE_PCR_CURACC_SHIFT               0
#define SSTE_PCR_ACCLMT_MASK                0x000fffff
#define SSTE_PCR_ACCLMT_SHIFT               0
#else
...
/* Definitions for ulSsteUtoPortScrW0. */
#define SSTE_UTOPCRMW_SCR_PLVLWT_MASK       0x0000000f
#define SSTE_UTOPCRMW_SCR_PLVLWT_SHIFT      0

#define SSTE_UTOPCRMW_SCR_INCR_MASK         0x7FFF0000
#define SSTE_UTOPCRMW_SCR_INCR_SHIFT        16

/* Definitions for ulSsteUtoPortScrW1. */
#if defined(CONFIG_BCM963146)
#define SSTE_UTOPCRMW_SCR_CURACC_MASK       0x000fffff
#define SSTE_UTOPCRMW_SCR_CURACC_SHIFT      0

#define SSTE_UTOPCRMW_SCR_ACCLMT_MASK       0x000fffff
#define SSTE_UTOPCRMW_SCR_ACCLMT_SHIFT      0
#else
#define SSTE_UTOPCRMW_SCR_CURACC_MASK       0x00007FFF
#define SSTE_UTOPCRMW_SCR_CURACC_SHIFT      0

#define SSTE_UTOPCRMW_SCR_ACCLMT_MASK       0x7FFF0000
#define SSTE_UTOPCRMW_SCR_ACCLMT_SHIFT      16
#endif

/* Definitions for ulSsteUtoPortScrW2. */
#define SSTE_UTOPCRMW_SCR_CURSIT_MASK       0x00007FFF
#define SSTE_UTOPCRMW_SCR_CURSIT_SHIFT      0

#define SSTE_UTOPCRMW_SCR_SITLMT_MASK       0x7FFF0000
#define SSTE_UTOPCRMW_SCR_SITLMT_SHIFT      16
...
#if defined(CONFIG_BCM963146)
#define SSTE_UTOPCRMW_PCR_CURACC_MASK       0x000fffff
#define SSTE_UTOPCRMW_PCR_CURACC_SHIFT      0

#define SSTE_UTOPCRMW_PCR_ACCLMT_MASK       0x000fffff
#define SSTE_UTOPCRMW_PCR_ACCLMT_SHIFT      0
#else
...
#define SST_TX_FIFO_EMPTY                       0xFFFF
...
/*
** SAR Registers Offset and Size
*/

#define SAR_TXDMA_CTRL_REGS_OFFSET                     (0x00000000) /* SAR Tx Channel Control Registers */
#define SAR_TXDMA_CTRL_REGS_SZ                          0x00000040
#define SAR_TXPBUF_PAD_REGS_OFFSET                     (0x0000005C) /* SAR TxPktBuf Pad Registers */
#define SAR_TXPBUF_PAD_REGS_SZ                          0x00000004
#define SAR_TX_CTL_REGS_OFFSET                         (0x00000060) /* SAR Tx Control Registers */
#if defined(CONFIG_BCM963146)
#define SAR_TX_CTL_REGS_SZ                              0x00000030
#define SAR_RX_CTL_REGS_OFFSET                         (0x00000090) /* SAR Rx Control Registers */
#else
#define SAR_TX_CTL_REGS_SZ                              0x00000020
#define SAR_RX_CTL_REGS_OFFSET                         (0x00000080) /* SAR Rx Control Registers */
#endif //63146
#define SAR_RX_CTL_REGS_SZ                              0x00000040
#define SAR_TX_VPI_VCI_REGS_OFFSET                     (0x00000100) /* SAR  Tx ATM VPI_VCI Table Reg Registers */
#define SAR_TX_VPI_VCI_REGS_SZ                          0x00000040
#define SAR_RX_VCAM_REGS_OFFSET                        (0x00000140) /* SAR  Rx ATM VPI_VCI CAM Table Reg Registers */
#define SAR_RX_VCAM_REGS_SZ                             0x00000080
#define SAR_SHPR_REGS_OFFSET                           (0x00000200) /* SAR Atm Shaper Source Shaping Table Registers */
#if defined(CONFIG_BCM963158) || defined(CONFIG_BCM963178) || defined(CONFIG_BCM963146)
#define SAR_SHPR_REGS_SZ                                0x00000090
#else
#define SAR_SHPR_REGS_SZ                                0x00000070
#endif //63158/63178/63146
#define SAR_TXIF_CFG_REGS_OFFSET                       (0x000002A0) /* SAR TxIf to XRDP BBH Config Registers */
#define SAR_TXIF_CFG_REGS_SZ                            0x00000004
#define SAR_RX_PBUF_REGS_OFFSET                        (0x00000300) /* SAR Rx Packet Buffer Control Registers */
#define SAR_RX_PBUF_REGS_SZ                             0x00000060
#define SAR_MIB_REGS_OFFSET                            (0x00000600) /* SAR  Atm MIB Counters Registers */
#define SAR_MIB_REGS_SZ                                 0x000000C0
#if defined(CONFIG_BCM963158) || defined(CONFIG_BCM963178) || defined(CONFIG_BCM963146)
#define SAR_DIAG_REGS_OFFSET                           (0x00000700) /* SAR  Diagnostic Registers */
#define SAR_DIAG_REGS_SZ                                0x00000100
#endif //63158/63178/63146
#define SAR_RX_PAF_REGS_OFFSET                         (0x00000800) /* SAR RxPaf Top Registers */
#define SAR_RX_PAF_REGS_SZ                              0x00000100
#define SAR_RX_BOND_REGS_OFFSET                        (0x00000900) /* SAR RxPaf Bonding Registers */
#define SAR_RX_BOND_REGS_SZ                             0x000000D0
#define SAR_TMUEXT_REGS_OFFSET                         (0x00001000) /* SAR Traffic Management Unit Extended Registers */
#if defined(CONFIG_BCM963158) || defined(CONFIG_BCM963178) || defined(CONFIG_BCM963146)
#define SAR_TMUEXT_REGS_SZ                              0x00000910
#else
#define SAR_TMUEXT_REGS_SZ                              0x00000600
#endif //63158/63178/63146
#define SAR_TX_DBG_MIB_REGS_OFFSET                     (0x00002800) /* SAR Tx MIB Counters Registers */
#define SAR_TX_DBG_MIB_REGS_SZ                          0x00000090
#define SAR_TXBBH_FIFO_OFFSET                          (0x00002900) /* SAR Tx BBH FiFo Data Registers */
#define SAR_TXBBH_FIFO_SZ                               0x00000800
#define SAR_TXPKT_FIFO_OFFSET                          (0x00003100) /* SAR Tx Pkt FiFo Data Registers */
#define SAR_TXPKT_FIFO_SZ                               0x00000800
#define SAR_TXUTO_FIFO_OFFSET                          (0x00003900) /* SAR Tx Uto FiFo Data Registers */
#define SAR_TXUTO_FIFO_SZ                               0x00000200


/* Specific SAR Rx Control Registers - LED Configuration Register */
#if defined(CONFIG_BCM963146)
#define SAR_RX_CTL_LED_CFG_OFFSET                      (0x000000BC) /* LED Configuration Register */
#else
#define SAR_RX_CTL_LED_CFG_OFFSET                      (0x000000AC) /* LED Configuration Register */
#endif
#define SARRXCTLLEDCFG_OFFSET ((volatile uint32 * const) (SAR_RX_CTL_LED_CFG_OFFSET))
...
typedef struct XtmProcessorRegisters
{
    ...
    UINT32 ulTxPktBufSpacePadding;                                  /* 005C */
#else
...
#if defined(CONFIG_BCM963146)
    UINT32 ulTxFragCfg;                                             /* 0080 */
    UINT32 ulReserved3[3];                                          /* 0084 */
#endif
    UINT32 ulRxAtmCfg[XP_MAX_PORTS];                                /* 0080 / 0090 */
    UINT32 ulRxSarCfg;                                              /* 0090 / 00a0 */
    UINT32 ulRxOamCfg;                                              /* 0094 / 00a4 */
    UINT32 ulRxAtmStatus;                                           /* 0098 / 00a8 */
    UINT32 ulRxUtopiaCfg;                                           /* 009c / 00aC */
    UINT32 ulRxAalCfg;                                              /* 00a0 / 00b0 */
    UINT32 ulRxAalMaxSdu;                                           /* 00a4 / 00b4 */
    UINT32 ulRxAalStatus;                                           /* 00a8 / 00b8 */
    UINT32 ulLedCtrl;                                               /* 00ac / 00bc */
#if defined(CONFIG_BCM963138) || defined(CONFIG_BCM963148) || defined(CONFIG_BCM963158) || defined(CONFIG_BCM963178) || defined(CONFIG_BCM963146)
    UINT32 ulRxAalClenCrcErrCnt;                                    /* 00b0 / 00c0 */
    UINT32 ulRxAalMaxSduErrCnt;                                     /* 00b4 / 00c4 */
    UINT32 ulRxAtmErrCellVcid0;                                     /* 00b8 / 00c8 */
    UINT32 ulRxAtmErrCellVcid1;                                     /* 00bc / 00cc */
#if !defined(CONFIG_BCM963146)
    UINT32 ulReserved4[12];                                         /* 00c0 / 00d0 */
#else
    UINT32 ulReserved4[8];                                          /* 00c0 / 00d0 */
#endif
    UINT32 ulUbusCfg;                                               /* 00f0 */
    UINT32 ulUbusReqEop;                                            /* 00f4 */
    UINT32 ulReserved5[2];                                          /* 00f8 */
#else
    UINT32 ulReserved4[20];                                         /* 00b0 */
#endif
    UINT32 ulTxVpiVciTable[XP_MAX_CONNS];                           /* 0100 */
    UINT32 ulRxVpiVciCam[XP_MAX_CONNS * 2];                         /* 0140 */
    UINT32 ulReserved6[16];                                         /* 01c0 */
    ...
    UINT32 ulReserved7[7];                                          /*       / 0284 */
    UINT32 ulTxIfCfg;                                               /*       / 02a0 */
    UINT32 ulReserved7_1[23];                                       /*       / 02a4 */
#else
...
#if defined(CONFIG_BCM963138) || defined(CONFIG_BCM963148) || defined(CONFIG_BCM963158) || defined(CONFIG_BCM963178) || defined(CONFIG_BCM93146)
...
extern volatile PXTM_PROCESSOR_REGISTERS XP_REGS;
extern volatile PTXPAF_PROCESSOR_REGISTERS TXPAF_REGS;
extern UINT32 SAR_CLOCK;
