...
/***********************************************************************/
/*                                                                     */
/*   MODULE:  63138_common.h                                           */
/*   DATE:    03/13/13                                                 */
/*   PURPOSE: Register definition used by assembly for BCM63138        */
/*                                                                     */
/***********************************************************************/
#ifndef __BCM63138_MAP_COMMON_H
#define __BCM63138_MAP_COMMON_H
...
#define MISC_STRAP_BUS_STRAP_SW_SEL_1_SHIFT     25
#define MISC_STRAP_BUS_STRAP_SW_SEL_1_MASK      (0x1<<MISC_STRAP_BUS_STRAP_SW_SEL_1_SHIFT)
#define MISC_STRAP_BUS_STRAP_SW_SEL_0_SHIFT     24
#define MISC_STRAP_BUS_STRAP_SW_SEL_0_MASK      (0x1<<MISC_STRAP_BUS_STRAP_SW_SEL_0_SHIFT)
...
#define MISC_STRAP_BUS_BOOTSEL_3_4_MASK         (0x18<<MISC_STRAP_BUS_BOOTSEL_SHIFT)

#define MISC_STRAP_BUS_BOOT_SPINOR              0x18    /* valid spi nor values: 0b11xxx  */
#define MISC_STRAP_BUS_BOOT_SPINAND             0x08    /* valid spi nand values: 0b01xxx */
#define MISC_STRAP_BUS_BOOT_EMMCFL              0x10    /* valid emmc values: 0b10xxx     */
...
#####################################################################
*/
#define L2C_CONTROL_OFFSET                        0x100
#define L2C_AUX_CONTROL_OFFSET                    0x104
#define L2C_INTR_CLEAR_OFFSET                     0x220
#define	L2C_AUX_CONTROL_EARLY_BRESP_EN            (1 << 30)
#define L2C_AUX_CONTROL_I_PREF_EN                 (1 << 29)
#define L2C_AUX_CONTROL_D_PREF_EN                 (1 << 28)
#define L2C_AUX_CONTROL_NS_INT_EN                 (1 << 27)
#define L2C_AUX_CONTROL_NS_LOCK_EN                (1 << 26)
#define L2C_AUX_CONTROL_SHARED_OVERRIDE_EN        (1 << 22)
#define L2C_AUX_CONTROL_WAY_SIZE_32KB             (2 << 17)
#define L2C_AUX_CONTROL_WAY_SIZE_MASK             (3 << 17)
#define L2C_AUX_CONTROL_ASSOCIATIVITY_16WAY       (1 << 16)
#define L2C_AUX_CONTROL_EXCL_EN                   (1 << 12)
#define L2C_AUX_CONTROL_STR_BUFF_DEV_LIM_EN       (1 << 11)
#define L2C_AUX_CONTROL_FLZ_EN                    (1 << 0)
#define L2C_INVALID_PA_OFFSET                     0x770
#define L2C_CLEAN_PA_OFFSET                       0x7B0
#define L2C_INVALID_WAY_OFFSET                    0x77C
#define L2C_CLEAN_WAY_OFFSET                      0x7BC
#define L2C_SYNC_OFFSET                           0x730
