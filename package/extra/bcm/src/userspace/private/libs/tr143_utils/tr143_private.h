...
//common.c
int open_conn_socket(struct sockaddr_storage *addr, char *ipAddr, int len);
...
int proto_Readn_discard(tProtoCtx *pc, char *ptr, int nbytes);
...
#ifdef BRCM_SPDTEST
extern uint8_t g_stream_active[];
extern pthread_mutex_t g_stream_disconnect_lock[];
