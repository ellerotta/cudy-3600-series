...
export ARCH CFLAGS LIB_INSTALL_DIR HEADER_INSTALL_DIR BUILD_LIBMODSW
...
COND_BUILD_CBK_OPENPLAT := 1
endif

ifeq ($(strip $(COND_BUILD_CBK_OPENPLAT)),1)
