...
typedef unsigned int    BOS_UINT32;    /** UINT32 is platform independant */
typedef int             BOS_SINT32;    /** SINT32 is platform independant */
...
typedef unsigned long   BOS_UINTP;     /** Platform dependent long integer/address value. Used only for casting between pointers and integers */
