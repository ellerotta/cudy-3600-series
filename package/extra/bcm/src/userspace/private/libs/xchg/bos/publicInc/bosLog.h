...
*
*/
void extBosLog(BOS_LOGLEVEL loglevel, const char* func, const char* fmt, ...);

#define bosLog(fmt, ...)        extBosLog(BOS_LOGLEVEL_ALWAYS,  __FUNCTION__, fmt, ##__VA_ARGS__)
#define bosLogEmerg(fmt, ...)   extBosLog(BOS_LOGLEVEL_EMERG,   __FUNCTION__, fmt, ##__VA_ARGS__)
#define bosLogCrit(fmt, ...)    extBosLog(BOS_LOGLEVEL_CRIT,    __FUNCTION__, fmt, ##__VA_ARGS__)
#define bosLogAlert(fmt, ...)   extBosLog(BOS_LOGLEVEL_ALERT,   __FUNCTION__, fmt, ##__VA_ARGS__)
#define bosLogErr(fmt, ...)     extBosLog(BOS_LOGLEVEL_ERROR,   __FUNCTION__, fmt, ##__VA_ARGS__)
#define bosLogWarning(fmt, ...) extBosLog(BOS_LOGLEVEL_WARNING, __FUNCTION__, fmt, ##__VA_ARGS__)
#define bosLogNotice(fmt, ...)  extBosLog(BOS_LOGLEVEL_NOTICE,  __FUNCTION__, fmt, ##__VA_ARGS__)
#define bosLogInfo(fmt, ...)    extBosLog(BOS_LOGLEVEL_INFO,    __FUNCTION__, fmt, ##__VA_ARGS__)
#define bosLogDebug(fmt, ...)   extBosLog(BOS_LOGLEVEL_DEBUG,   __FUNCTION__, fmt, ##__VA_ARGS__)
