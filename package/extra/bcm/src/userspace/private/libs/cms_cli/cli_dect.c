...
{
   { "ping",  cmdDectHandsetPing,     1, 2, cmdDectHsFuncMap, decthsping  },
...
static CmsRet cmdDectTestSyncTime(unsigned int argc,const char **argv, CMD_FUNC_MAP *map)
{
   ...
   dalVoice_SetDectMsgReq(&parms, CMS_MSG_VOICE_DECT_SYNC_DATE_TIME);
   cmsLck_releaseLock();
...
{
   DAL_VOICE_PARMS parms = { 0 };
   char msgData[MAX_TR104_OBJ_SIZE] = { 0 };
   int i;
   ...
   snprintf(msgData, sizeof(msgData), "%d,%s,%s",
            MSG_DECT_CM_SIG_MWI,
            argv[i],
            argv[i+1]);
   ...
   cmsLck_acquireLock();
   dalVoice_mapSpNumToVpInst( 0, &parms.op[0] );
   dalVoice_SetMsgData(&parms, msgData);
   dalVoice_SetDectMsgReq(&parms, CMS_MSG_VOICE_DECT_CM_EVENT);
   cmsLck_releaseLock();
...
static CmsRet cmdDectSetMode(unsigned int argc, const char **argv, CMD_FUNC_MAP *map)
{
   ...
   snprintf(msgData, sizeof(msgData), "%s", argv[i]);

   cmsLck_acquireLock();
   dalVoice_mapSpNumToVpInst( 0, &parms.op[0] );
   dalVoice_SetMsgData(&parms, msgData);
   dalVoice_SetDectMsgReq(&parms, CMS_MSG_VOICE_DECT_MODE_SET);
   cmsLck_releaseLock();
...
static CmsRet cmdDectSetEEProm(unsigned int argc, const char **argv, CMD_FUNC_MAP *map)
{
   ...
   snprintf(msgData, sizeof(msgData), "%s %s", argv[i], argv[i+1]);

   cmsLck_acquireLock();
   dalVoice_mapSpNumToVpInst( 0, &parms.op[0] );
   dalVoice_SetMsgData(&parms, msgData);
   dalVoice_SetDectMsgReq(&parms, CMS_MSG_VOICE_DECT_MEM_SET);
   cmsLck_releaseLock();
...
static CmsRet cmdDectGetEEProm(unsigned int argc, const char **argv, CMD_FUNC_MAP *map)
{
   ...
   dalVoice_mapSpNumToVpInst( 0, &parms.op[0] );
   dalVoice_SetMsgData(&parms, msgData);
   dalVoice_SetDectMsgReq(&parms, CMS_MSG_VOICE_DECT_MEM_GET);
   cmsLck_releaseLock();
...
static CmsRet cmdDectGetMode(unsigned int argc, const char **argv, CMD_FUNC_MAP *map)
{
   ...
   cmsLck_acquireLock();
   dalVoice_mapSpNumToVpInst( 0, &parms.op[0] );
   dalVoice_SetDectMsgReq(&parms, CMS_MSG_VOICE_DECT_MODE_GET);
   cmsLck_releaseLock();
...
static CmsRet cmdDectStart(unsigned int argc, const char **argv, CMD_FUNC_MAP *map)
{
   ...
   cmsLck_acquireLock();
   dalVoice_mapSpNumToVpInst( 0, &parms.op[0] );
   dalVoice_SetDectMsgReq(&parms, CMS_MSG_VOICE_DECT_START);
   cmsLck_releaseLock();
...
static CmsRet cmdDectStop(unsigned int argc, const char **argv, CMD_FUNC_MAP *map)
{
   ...
   cmsLck_acquireLock();
   dalVoice_mapSpNumToVpInst( 0, &parms.op[0] );
   dalVoice_SetDectMsgReq(&parms, CMS_MSG_VOICE_DECT_STOP);
   cmsLck_releaseLock();
...
static CmsRet cmdDectCallCmd(unsigned int argc, const char **argv, CMD_FUNC_MAP *map)
{
   ...
   snprintf(msgData, sizeof(msgData), "%d,%d,%d,%d,%d",
            callCtlCmd,
            DECT_UNKNOWN_ID,
            cid,
            ( callCtlCmd == MSG_DECT_CALL_CTL_INTERCEPT ) ? atoi( argv[map[0].aPos + 2] ) : DECT_UNKNOWN_ID,
            hsetId);

   cmsLck_acquireLock();
   dalVoice_mapSpNumToVpInst( 0, &parms.op[0] );
   dalVoice_SetMsgData(&parms, msgData);
   dalVoice_SetVoiceMsgReq(&parms, CMS_MSG_VOICE_DECT_CALL_CTL_CMD);
   cmsLck_releaseLock();
...
static CmsRet cmdDectGetLineSetting(unsigned int argc, const char **argv, CMD_FUNC_MAP *map)
{
   ...
   cmsLck_acquireLock();
   /* Map to vpInst */
   ret = dalVoice_mapSpNumToVpInst( spNum, &vpInst );
   /* Map to lineInst */
   if( ret == CMSRET_SUCCESS )
   {
      ret = dalVoice_mapAcntNumToLineInst( vpInst, accNum, &lineInst );
   }
   cmsLck_releaseLock();
...
static CmsRet cmdDectDebugStart(unsigned int argc, const char **argv, CMD_FUNC_MAP *map)
{
   ...
   cmsLck_acquireLock();
   dalVoice_mapSpNumToVpInst( 0, &parms.op[0] );
   dalVoice_SetDectMsgReq(&parms, CMS_MSG_VOICE_DECT_DBG_START);
   cmsLck_releaseLock();
...
static CmsRet cmdDectDebugStop(unsigned int argc, const char **argv, CMD_FUNC_MAP *map)
{
   ...
   cmsLck_acquireLock();
   dalVoice_mapSpNumToVpInst( 0, &parms.op[0] );
   dalVoice_SetDectMsgReq(&parms, CMS_MSG_VOICE_DECT_DBG_STOP);
   cmsLck_releaseLock();
