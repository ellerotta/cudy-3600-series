...
:>
*/
#ifndef __TMCTL_API_RUNNER_H_
#define __TMCTL_API_RUNNER_H_
...
#define ifp_to_llid(if_p) if_p->eponIf.llid
#define ifp_to_tcont(if_p) if_p->gponIf.tcontid
#endif /* __TMCTL_API_RUNNER_H_ */
