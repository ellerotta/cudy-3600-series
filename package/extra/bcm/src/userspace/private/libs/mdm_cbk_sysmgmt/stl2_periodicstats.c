...
CmsRet stl_dev2PeriodicStatObject(_Dev2PeriodicStatObject *obj __attribute((unused)), const InstanceIdStack *iidStack __attribute((unused)))
{
...
CmsRet stl_dev2SampleSetObject(_Dev2SampleSetObject *obj, const InstanceIdStack *iidStack)
{
   ...
   /* coverity[dont_call][remediation] */
   rc = fscanf(file, "%s", bufResult);
   if (rc == 1)
   {
