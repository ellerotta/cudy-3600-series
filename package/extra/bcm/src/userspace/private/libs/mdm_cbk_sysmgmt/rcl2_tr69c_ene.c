...
/*
 * this file is an extension of "rcl2_tr69c.c", to implement the rcl handlers for EE   
 ...
 * should be empty.
 */
CmsRet rcl_e2E_Dev2ManagementServerObject( _E2E_Dev2ManagementServerObject *newObj,
                                       const _E2E_Dev2ManagementServerObject *currObj,
                                       const InstanceIdStack *iidStack __attribute((unused)),
                                       char **errorParam __attribute((unused)),
                                       CmsRet *errorCode __attribute((unused)))
{
#ifdef BRCM_BDK_BUILD // TR69c_2 is not supported in BDK
   ...
   if (newObj != NULL && currObj != NULL)
   {
      ...
      if (b == TRUE)
      {
         char *acsConfigId = MULTI_TR69C_CONFIG_INDEX_2; /* ACS config#2 changed */
...
CmsRet rcl_e2E_Dev2ManagementServerManageableDeviceObject(_E2E_Dev2ManagementServerManageableDeviceObject *newObj,
                                                      const _E2E_Dev2ManagementServerManageableDeviceObject *currObj,
...
CmsRet rcl_e2E_Dev2AutonXferCompletePolicyObject( _E2E_Dev2AutonXferCompletePolicyObject *newObj __attribute__((unused)), 
                                              const _E2E_Dev2AutonXferCompletePolicyObject *currObj __attribute__((unused)),
...
CmsRet rcl_e2E_Dev2DuStateChangeComplPolicyObject( _E2E_Dev2DuStateChangeComplPolicyObject *newObj __attribute__((unused)),
                                               const _E2E_Dev2DuStateChangeComplPolicyObject *currObj __attribute__((unused)),
                                               const InstanceIdStack *iidStack __attribute__((unused)),
                                               char **errorParam __attribute__((unused)),
                                               CmsRet *errorCode __attribute__((unused)))
{
