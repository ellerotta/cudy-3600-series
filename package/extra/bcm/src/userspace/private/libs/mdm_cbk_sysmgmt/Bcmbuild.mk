...
COND_BUILD_CBK_SYSMGMT := 1
endif
ifneq ($(strip $(BUILD_BRCM_BDK)),)
COND_BUILD_CBK_SYSMGMT := 1
endif

# export variables that are used in sub-Makefile
export BRCM_MULTIPLE_TR69C_SUPPORT
export BUILD_TR69_PERIODIC_STATISTICS
export BUILD_SERDES_VI

ifeq ($(strip $(COND_BUILD_CBK_SYSMGMT)),1)
