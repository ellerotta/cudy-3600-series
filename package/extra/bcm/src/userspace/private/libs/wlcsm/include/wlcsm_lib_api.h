 ...
 *      <ul>
 *		<li> Kernel Module. This part is a separated kernel module(<b>bcm_knvram.ko</b>)
 *		<li> Kernel source is located under <b>/bcmdrivers/opensource/char/bcm_knvram</b>
...
typedef enum {
    ...
    WLCSM_MNGR_CMD_START_SECURITY_DAEMONS,  	/**< application request wlmngr to start security deamons */
    WLCSM_MNGR_CMD_STOP_SECURITY_DAEMONS,  	/**< application request wlmngr to stop security deamons */
    WLCSM_MNGR_CMD_SAVE_NVRAM,  	/**< application request wlmngr to save NVRAM */
    WLCSM_MNGR_CMD_WIFI_HAL_STARTED,  	/**< application request wlmngr to indicate RDKB wifi hal started */
    WLCSM_MNGR_CMD_RESTART_ACSD,  	/**< application request to restart ACSD */
    WLCSM_MNGR_CMD_LAST,
} WLCSM_MNGR_CMD;
...
#define WLCSM_MNGR_CMD_GET_IDX(idx)                             ((idx)&0xf)
#define WLCSM_MNGR_CMD_SET_IDX(target,idx)                      (target) = (((target)&(~0xf))|idx)

#define WLCSM_MNGR_CMD_GET_AP_IDX(idx)                          ((idx>>4)&0xf)
#define WLCSM_MNGR_CMD_SET_AP_IDX(target,idx)                   (target) = (((target)&(~0xf0))|(idx<<4))
...
#define WLCSM_MNGR_CMD_GET_RESET_AP(idx)                        (idx &0x8000000)
#define WLCSM_MNGR_CMD_SET_RESET_AP(target)                     (target) = ((target)|(1<<27))
 ...
 *
 **/
#if defined(WLCSM_DEBUG) && !defined(BUILD_RDKWIFI)
