 ...
 * @param *linkLowerLayers             (IN) lowerLayers of this link
...
/** Use to increment or decrement the number of instance of PTM Link in PTM table
 * @param delta                      (IN) 1 to increment or -1 to decrement PTM's LinkNumberOfEntries
 */
