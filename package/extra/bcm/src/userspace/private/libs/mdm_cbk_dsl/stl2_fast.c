...
#ifdef DESKTOP_LINUX
CmsRet stl_dev2FastLineStatsObject(_Dev2FastLineStatsObject *obj __attribute__((unused)), const InstanceIdStack *iidStack __attribute__((unused)))
{
   /* for desktop, just pretend adsl link is always up */
   return (CMSRET_SUCCESS_OBJECT_UNCHANGED);
}

CmsRet stl_dev2FastLineStatsTotalObject(_Dev2FastLineStatsTotalObject *obj __attribute__((unused)), const InstanceIdStack *iidStack __attribute__((unused)))
{
   /* for desktop, just pretend adsl link is always up */
   return (CMSRET_SUCCESS_OBJECT_UNCHANGED);
}

CmsRet stl_dev2FastLineStatsShowtimeObject(_Dev2FastLineStatsShowtimeObject *obj __attribute__((unused)),
...
CmsRet stl_dev2FastLineStatsCurrentDayObject(_Dev2FastLineStatsCurrentDayObject *obj __attribute__((unused)),
                                             const InstanceIdStack *iidStack __attribute__((unused)))
{
   /* for desktop, just pretend adsl link is always up */
   return (CMSRET_SUCCESS_OBJECT_UNCHANGED);
...
CmsRet stl_dev2FastLineStatsQuarterHourObject(_Dev2FastLineStatsQuarterHourObject *obj __attribute__((unused)),
                                              const InstanceIdStack *iidStack __attribute__((unused)))
{
   /* for desktop, just pretend adsl link is always up */
   return (CMSRET_SUCCESS_OBJECT_UNCHANGED);
...
CmsRet stl_dev2FastLineTestParamsObject(_Dev2FastLineTestParamsObject *obj __attribute__((unused)),
                                        const InstanceIdStack *iidStack __attribute__((unused)))
{
   /* for desktop, just pretend adsl link is always up */
   return (CMSRET_SUCCESS_OBJECT_UNCHANGED);
...
CmsRet stl_dev2FastLineStatsObject(_Dev2FastLineStatsObject *obj, const InstanceIdStack *iidStack __attribute__((unused)))
{
   ...
   if (obj != NULL)
   {
      ret = rutfast_getLineStats_dev2(obj,iidStack);
   }
   else
   {
