...
/** Use to increment or decrement the number of instance of ATM Link in ATM table
 * @param delta                      (IN) 1 to increment or -1 to decrement ATM's LinkNumberOfEntries
 */
