...
CmsRet stl_dev2AtmLinkStatsObject(_Dev2AtmLinkStatsObject *obj, const InstanceIdStack *iidStack)
{
   ...
   if (cmsObj_get(MDMOID_DEV2_ATM_LINK,iidStack,0,(void **)&atmObj) == CMSRET_SUCCESS)
   {
      if ((obj != NULL) && (!cmsUtl_strcmp(atmObj->status, MDMVS_UP)))
      {
         ...
         rutatm_getLinkStats_dev2(obj, atmObj->name, atmObj->lowerLayers, reset);
      }
      else
      {
...
CmsRet stl_dev2AtmDiagnosticsObject(_Dev2AtmDiagnosticsObject *obj __attribute__((unused)),
                                    const InstanceIdStack *iidStack __attribute__((unused)))
{
...
CmsRet stl_dev2AtmDiagnosticsF5LoopbackObject(_Dev2AtmDiagnosticsF5LoopbackObject *obj __attribute__((unused)),
                                              const InstanceIdStack *iidStack __attribute__((unused)))
{
   /* no change is needed since RCL is updating MDM with proper stats from DRIVER */   
   return CMSRET_SUCCESS_OBJECT_UNCHANGED;
...
CmsRet stl_dev2AtmDiagnosticsF4EndToEndLoopbackObject(_Dev2AtmDiagnosticsF4EndToEndLoopbackObject *obj __attribute__((unused)),
                                                      const InstanceIdStack *iidStack __attribute__((unused)))
{
   /* no change is needed since RCL is updating MDM with proper stats from DRIVER */   
   return CMSRET_SUCCESS_OBJECT_UNCHANGED;
...
CmsRet stl_dev2AtmDiagnosticsF4LoopbackObject(_Dev2AtmDiagnosticsF4LoopbackObject *obj __attribute__((unused)),
                                              const InstanceIdStack *iidStack __attribute__((unused)))
{
   /* no change is needed since RCL is updating MDM with proper stats from DRIVER */   
   return CMSRET_SUCCESS_OBJECT_UNCHANGED;
...
CmsRet stl_dev2AtmDiagnosticsF5EndToEndLoopbackObject(_Dev2AtmDiagnosticsF5EndToEndLoopbackObject *obj __attribute__((unused)),
                                                      const InstanceIdStack *iidStack __attribute__((unused)))
{
   /* no change is needed since RCL is updating MDM with proper stats from DRIVER */   
   return CMSRET_SUCCESS_OBJECT_UNCHANGED;
