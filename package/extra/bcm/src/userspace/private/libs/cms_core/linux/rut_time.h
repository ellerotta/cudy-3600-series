...
#ifndef __RUT_TIME_H__
#define __RUT_TIME_H__


/*!\file rut_time.h
 * \brief System level interface functions for TIME functionality.
 *
...
/** Restart ntpd with the TimeServerCfg entry in the MDM
 *
 ...
 *
 * @param ntpObj (IN) The new TIME object to check.
 *
 * @return TRUE if all required fields are non-null, otherwise, return FALSE.
 */
UBOOL8 rutTime_isAllRequiredValuesPresent(const _TimeServerCfgObject *ntpObj);


/** Detect changes of any fields between newObj and currObj.
 *
 * @param newObj  (IN) The new TimeServerCfg object.
 * @param currObj (IN) The current TimeServerCfg object.
 *
