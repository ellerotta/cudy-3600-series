...
CmsRet stl_dev2GreObject(_Dev2GreObject *obj,
...
CmsRet stl_dev2GreTunnelObject(_Dev2GreTunnelObject *obj,
                                 const InstanceIdStack *iidStack)
{
   cmsLog_debug("Enter");
   return CMSRET_SUCCESS_OBJECT_UNCHANGED;
...
CmsRet stl_dev2GreTunnelStatsObject(_Dev2GreTunnelStatsObject *obj,
                                       const InstanceIdStack *iidStack)
{
   CmsRet ret = CMSRET_SUCCESS;
   cmsLog_debug("Enter");
   InstanceIdStack iidStackChild = EMPTY_INSTANCE_ID_STACK;
   Dev2GreTunnelInterfaceStatsObject *tunnelIfStatsObj = NULL;
   ...
   while (cmsObj_getNextInSubTree(MDMOID_DEV2_GRE_TUNNEL_INTERFACE_STATS, iidStack, &iidStackChild,
...
CmsRet stl_dev2GreTunnelInterfaceObject(_Dev2GreTunnelInterfaceObject *obj,
                                            const InstanceIdStack *iidStack)
{
   cmsLog_debug("Enter");
...
CmsRet stl_dev2GreTunnelInterfaceStatsObject(_Dev2GreTunnelInterfaceStatsObject *obj,
                                            const InstanceIdStack *iidStack)
{
   CmsRet ret = CMSRET_SUCCESS;
   Dev2GreTunnelInterfaceObject *greTunnelIntf = NULL;
   ...
   if ((ret = cmsObj_get(MDMOID_DEV2_GRE_TUNNEL_INTERFACE,
                                 iidStack, OGF_NO_VALUE_UPDATE,
                                 (void **) &greTunnelIntf)) == CMSRET_SUCCESS)
   {
      ...
      rut_getIntfStats_uint64(greTunnelIntf->name,
      ...
      cmsObj_free((void **) &greTunnelIntf);
   }
