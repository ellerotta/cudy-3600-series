...
#define rutcwmp_tmctl_addMirror(arg...)       rutwrap_tmctl_addMirror(TMCTL_USER_TR69, ##arg)
#define rutcwmp_tmctl_delMirror(arg...)       rutwrap_tmctl_delMirror(TMCTL_USER_TR69, ##arg)
...
#define rutomci_tmctl_setPortState(arg...)    rutwrap_tmctl_setPortState(TMCTL_USER_OMCI, ##arg)
#define rutomci_tmctl_addMirror(arg...)       rutwrap_tmctl_addMirror(TMCTL_USER_OMCI, ##arg)
#define rutomci_tmctl_delMirror(arg...)       rutwrap_tmctl_delMirror(TMCTL_USER_OMCI, ##arg)
...
#define rutoam_tmctl_addMirror(arg...)        rutwrap_tmctl_addMirror(TMCTL_USER_OAM, ##arg)
#define rutoam_tmctl_delMirror(arg...)        rutwrap_tmctl_delMirror(TMCTL_USER_OAM, ##arg)
...
#define rutsuper_tmctl_addMirror(arg...)        rutwrap_tmctl_addMirror(TMCTL_USER_MAX, ##arg)
#define rutsuper_tmctl_delMirror(arg...)        rutwrap_tmctl_delMirror(TMCTL_USER_MAX, ##arg)
...
tmctl_ret_e rutwrap_tmctl_setPortState(eTmctlUser user, tmctl_devType_e devType,
  tmctl_if_t *if_p, BOOL state);
...
tmctl_ret_e rutwrap_tmctl_deletePolicer(eTmctlUser user, int policerId);
tmctl_ret_e rutwrap_tmctl_addMirror(eTmctlUser user, tmctl_devType_e devType,
  tmctl_if_t* if_p, tmctl_mirror_op_e op, tmctl_ethIf_t destIf);
tmctl_ret_e rutwrap_tmctl_delMirror(eTmctlUser user, tmctl_devType_e devType,
  tmctl_mirror_op_e op, tmctl_if_t* if_p);

CmsRet rutwrap_tmctl_GetDevInfoByIfName(const char *l2ifname, 
