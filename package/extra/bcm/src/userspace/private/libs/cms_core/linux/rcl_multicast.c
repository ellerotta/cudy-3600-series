                ...
                CmsRet *errorCode __attribute__((unused)))
{
   ...
   {
      UINT32 snoopingMode;
      snoopingMode = (cmsUtl_strcmp(newObj->mode, MDMVS_STANDARD) == 0) ? 1 : 2;

      rutMulti_configIgmpSnooping(brIntfName, snoopingMode, newObj->lanToLanEnable);
                ...
                CmsRet *errorCode __attribute__((unused)))
{
             ...
             rutMulti_isMldSnoopingCfgChanged(newObj, currObj)))
   {
      ...
      rutMulti_configMldSnooping(brIntfName, snoopingMode, newObj->lanToLanEnable);
                ...
                CmsRet *errorCode __attribute__((unused)))
{
   ...
   /* Even when no parameters of the object is changed, still do a reload. */
   ret = rutMulti_reloadMcpdWithType(BCM_MCAST_PROTO_IPV4);
                ...
                CmsRet *errorCode __attribute__((unused)))
{
   ...
   /* Even when no parameters of the object is changed, still do a reload. */
   ret = rutMulti_reloadMcpdWithType(BCM_MCAST_PROTO_IPV6);
