...
// This function is only needed if (DMP_X_BROADCOM_COM_MULTIPLE_TR69C_SUPPORT_1 == 2)
// However, to support the binary only libmdm_db.so, just compile this function in.
