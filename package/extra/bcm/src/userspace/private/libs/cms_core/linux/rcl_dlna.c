...
*/
          ...
          fputs(cmdStr, fs);
          snprintf(cmdStr, sizeof(cmdStr), "fileExtension=rm:gif:jpg:jpeg:jpe:png:wav:mp3:wma:m1a:m2a:m4a:mpa:mp4:ts:wmv:mpg:mpv:mpeg:mpeg1:mpeg2:mpeg4:asf:avi:ac3:amr:divx:flv:mkv:m2ts:vob:m1v:m2v:m4v:mov:3gp:pcm:tts\n");
          fputs(cmdStr, fs);
