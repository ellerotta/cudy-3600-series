...
// Ugh, also defined in mcpd_config.c
...
/*  Return '|' separate lists of WAN interface and bridge group where the WAN interface belongs to.
  */
void rutMulti_createWanAssocList(char *strictWanAssocList, int strictWanAssocListLen);
...
#if defined(SUPPORT_DM_LEGACY98)
#define rutMulti_createWanAssocList(a, b)   rutMulti_createWanAssocList_igd((a), (b))
#elif defined(SUPPORT_DM_HYBRID)
#define rutMulti_createWanAssocList(a, b)   rutMulti_createWanAssocList_igd((a), (b))
#elif defined(SUPPORT_DM_PURE181)
#define rutMulti_createWanAssocList(a, b)   rutMulti_createWanAssocList_dev2((a), (b))
#elif defined(SUPPORT_DM_DETECT)
#define rutMulti_createWanAssocList(a, b)   (cmsMdm_isDataModelDevice2() ? \
            rutMulti_createWanAssocList_dev2((a), (b)) : \
            rutMulti_createWanAssocList_igd((a), (b))
#endif
