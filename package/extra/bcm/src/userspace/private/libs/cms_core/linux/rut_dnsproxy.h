...
#ifndef __RUT_DNSPROXY_H__
#define __RUT_DNSPROXY_H__
...
#define DNSMASQ_RESOLV_CONF  "/var/resolv.dnsmasq.conf"

/** config files for stubby 
  */
#define STUBBY_CONF  "/var/stubby.yml"


/** Check if dnsproxy is enabled or not
 *
 * @return  TRUE or FALSE
 */
UBOOL8 rutDpx_isEnabled(void);

/** Create all config files and start dnsproxy, if it is enabled.
 *
 * @return CmsRet enum.
 */
