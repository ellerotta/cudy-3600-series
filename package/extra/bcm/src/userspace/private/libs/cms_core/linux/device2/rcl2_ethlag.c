   ...
   if (ENABLE_NEW_OR_ENABLE_EXISTING(newObj, currObj))
   {
      ...
      {        
         ...
         */
         ...
         cmsUtl_strncpy(ethLagLowerLayers, eth1FullPath, sizeof(ethLagLowerLayers));
...
#else
            cmsUtl_strncpy(ifNameBuf, currObj->name, sizeof(ifNameBuf));
#endif  
...
#else
            cmsUtl_strncpy(ifNameBuf, currObj->X_BROADCOM_COM_EthIfName1, sizeof(ifNameBuf));
#endif  
...
#else
            cmsUtl_strncpy(ifNameBuf, currObj->X_BROADCOM_COM_EthIfName2, sizeof(ifNameBuf));
#endif  
            rutBridge_addLanIntfToBridge_dev2(ifNameBuf, "br0");
         }  
      }
