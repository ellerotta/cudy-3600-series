...
/** This parameter belongs to USP, used in MdmParamNode.flags. */
#define PRN_BBF_PROTOCOL_USP                0x2000

/** This parameter belongs to CWMP, used in MdmParamNode.flags. */
#define PRN_BBF_PROTOCOL_CWMP               0x4000
 ...
 * that ability.
 */
#define OBN_INSTANCE_NODE           0x0001
...
#define OBN_DYNAMIC_INSTANCES       0x0002
 ...
 */
#define OBN_PRUNE_WRITE_TO_CONFIG_FILE      0x0004

/** A flag to tell tr69c to not report this object, or any child parameters
 * or objects to the ACS.
 */
#define OBN_HIDE_OBJECT_FROM_ACS            0x0008

/** Automatically re-order and compact instances based on the order param.
 */
#define OBN_AUTO_ORDER_INSTANCES            0x0010

/** This obj node contains xyzNumberOfEntries that may have to be summed over
 *  multiple remote MDM's.
 */
#define OBN_MULTI_COMP_SUM                  0x0020

/** This obj node must use the multi component instance number ranges.
 */
#define OBN_MULTI_COMP_OBJ                  0x0040

/** This obj node must reset intance ID on empty
 */
#define OBN_RESET_INSTANCE_ON_EMPTY         0X0080

#define OBN_BBF_PROTOCOL_USP                0x0100

#define OBN_BBF_PROTOCOL_CWMP               0x0200
...
/*! \brief Is this node need to reset on empty?
 */
#define IS_RESET_INSTANCE_ON_EMPTY(n)   ((n)->flags & OBN_RESET_INSTANCE_ON_EMPTY)
...
typedef struct MdmObjectNode
{
   ...
   const char *name;       /**< (leaf) name of this object. */
   const char *genericFullpath;  /**< generic fullpath of this object */
   const char *profile;    /**< Profile name */
   UINT32      oidInfoIdx; /**< Index into oidInfoArray for faster lookup (set during mdm_init)*/
   UINT16      flags;      /**< Flags for this node, see OBN_xxx */
