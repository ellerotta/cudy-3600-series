...
CmsRet stl_voiceMtaObject(_VoiceMtaObject *obj, const InstanceIdStack *iidStack)
{
   return CMSRET_SUCCESS_OBJECT_UNCHANGED;
}
...
CmsRet stl_sIPNetworkAnnouncementObject(_SIPNetworkAnnouncementObject *obj, const InstanceIdStack *iidStack)
{
   return CMSRET_SUCCESS_OBJECT_UNCHANGED;
}
...
CmsRet stl_voiceDebugInfoObject(_VoiceDebugInfoObject *obj, const InstanceIdStack *iidStack)
{
   RUT_VOICE_DEBUG_INFO voiceDebugInfo;

   /* Obtain debug stats from DSP and update */
   if ( rutVoice_getDspHalDebugStats(&voiceDebugInfo) == CMSRET_SUCCESS )
   {
      obj->X_BROADCOM_COM_DspHalUnderruns = voiceDebugInfo.dspHalUnderrunCount;
      obj->X_BROADCOM_COM_PeakDspHalUnderruns = voiceDebugInfo.peakDspHalUnderrunCount;
