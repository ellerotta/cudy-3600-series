...
/** Change the IPv6AddressNumberOfEntries field in the ancestor object.
 *
 * @param iidStack (IN) iidStack of the (ancestor) DEV2_IP_INTERFACE object.
 * @param delta    (IN) The number of increment or decrement the count by.
 *                      This number should only be 1 or -1.
...
/** Change the IPv6PrefixNumberOfEntries field in the ancestor object.
 *
 * @param iidStack (IN) iidStack of the (ancestor) DEV2_IP_INTERFACE object.
 * @param delta    (IN) The number of increment or decrement the count by.
 *                      This number should only be 1 or -1.
...
/** Change the interfaceSettingNumberOfEntries field in the ancestor object.
 *
 * @param iidStack (IN) iidStack of the (ancestor) DEV2_ROUTER_ADVERTISEMENT object.
 * @param delta    (IN) The number of increment or decrement the count by.
 *                      This number should only be 1 or -1.
 *
 */
...
/** Change the poolNumberOfEntries field in the ancestor object.
 *
 * @param iidStack (IN) iidStack of the (ancestor) DHCPv6_SERVER object.
 * @param delta    (IN) The number of increment or decrement the count by.
 *                      This number should only be 1 or -1.
 *
 */
...
/** Change the VxLan tunnel TunnelNumberOfEntries field in the ancestor object.
 *
 * @param iidStack (IN) iidStack of the (ancestor) Dev2VxlanTunnelObject  object.
 * @param delta    (IN) The number of increment or decrement the count by.
 *                      This number should only be 1 or -1.
 *
 */
...
/** Change the VxLan InterfaceNumberOfEntries field in the ancestor object.
 *
 * @param iidStack (IN) iidStack of the (ancestor) Dev2VxlanTunnelInterfaceObject  object.
 * @param delta    (IN) The number of increment or decrement the count by.
 *                      This number should only be 1 or -1.
 *
 */
...
/** Change the VxLan filter FilterNumberOfEntries field in the ancestor object.
 *
 * @param iidStack (IN) iidStack of the (ancestor) Dev2VxlanFilterObject  object.
 * @param delta    (IN) The number of increment or decrement the count by.
 *                      This number should only be 1 or -1.
 *
 */
void rutUtil_modifyNumVxlanFilter_dev2(const InstanceIdStack *iidStack, SINT32 delta);
#endif /* SUPPORT_VXLAN_TUNNEL_TR181 */

#ifdef SUPPORT_GRE_TUNNEL_TR181
/** Change the GRE tunnel TunnelNumberOfEntries field in the ancestor object.
 *
 * @param iidStack (IN) iidStack of the (ancestor) Dev2GreTunnelObject  object.
 * @param delta    (IN) The number of increment or decrement the count by.
 *                      This number should only be 1 or -1.
 *
 */
...
/** Change the GRE InterfaceNumberOfEntries field in the ancestor object.
 *
 * @param iidStack (IN) iidStack of the (ancestor) Dev2GreTunnelInterfaceObject  object.
 * @param delta    (IN) The number of increment or decrement the count by.
 *                      This number should only be 1 or -1.
 *
 */
...
/** Change the optical InterfaceNumberOfEntries field in the ancestor object.
 *
 * @param iidStack (IN) iidStack of the OpticalInterfaceObject object.
 * @param delta    (IN) The number of increment or decrement the count by.
 *                      This number should only be 1 or -1.
 *
 */
...
/** Check current state about allow wldataeld writeback to MDM or not.
 */
int rutUtil_Check_Dataelm_HOLD_status(void);

/** Allow wldataeld writeback to MDM.
 */
int rutUtil_UnHold_Dataelm_MDM_Update(void);

/** Diallow wldataeld writeback to MDM.
 */
