...
#ifndef __RUT2_DNS_H__
#define __RUT2_DNS_H__
...
CmsRet rutDns_activateIpv6DnsServers_dev2(const char *ipIntfFullPath);
CmsRet rutDns_deactivateIpv6DnsServers_dev2(const char *ipIntfFullPath);
