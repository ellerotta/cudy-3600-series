...
/** update a prefix to all Nptv6 wan
 *
 * @param *prefix   (IN) Prefix info to be delegated
 * @UBOOL8 isAdd (IN) is it add or delete
 * @return none.
 */
void rutWan_updateRuleForAllNptv6(char *prefix, UBOOL8 isAdd);


/** update all prefix to a Nptv6 wan
 *
 ...
 * @return CmsRet enum.
 */
CmsRet rutWan_updateNptv6Rule(const void *pObj, UBOOL8 isIpObj, UBOOL8 isAdd);
