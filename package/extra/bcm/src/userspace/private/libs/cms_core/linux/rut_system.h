...
#define LOG_LOCAL_FILES                        "/var/log/message*"
...
/** Update the log destination mask (in bcmuLog) for the specified application.
 *
 */
...
/** Send out TR69 ACTIVE_NOTIFICATION or ALT_NOTIFICATION msg. */
void rut_sendChangeNotification(void);
void rut_sendAltChangeNotification(void);

/** Should we process value change notification for this EID? */
