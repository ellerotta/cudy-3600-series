...
enum mdm_config_attribute
{
   ...
   MDM_CONFIG_XMLATTR_ALTNOTIFICATION=6,
   MDM_CONFIG_XMLATTR_BDK_CONFIG_IDENT=7
};
...
#define CONFIG_FILE_ATTR_BDK_CONFIG_IDENT  "bdkConfigIdent"
...
#define CONFIG_FILE_ATTR_ALTNOTIFICATION "altNotif"
