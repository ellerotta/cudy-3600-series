...
#ifndef __WDE_ACCESS_H__
#define __WDE_ACCESS_H__

#include <json-c/json.h>

int build_wde_array_mapped(char *fullpath, json_object **cur_jobj, json_object *parent_jobj);
