...
ALLOWED_INCLUDE_PATHS += -I$(BCM_FSBUILD_DIR)/public/include/libxml2

export ARCH CFLAGS LIB_INSTALL_DIR HEADER_INSTALL_DIR BCM_LD_FLAGS BCM_LIB_PATH
