...
CmsRet devCtl_xtmGetXTMPStatus( PXTM_XTMP_STATUS pXTMPStatus __attribute__((unused)))
{
   return CMSRET_SUCCESS;
} 
...
CmsRet devCtl_xtmAccessSAR( int SarIO __attribute__((unused)))
{
   return CMSRET_SUCCESS;
}

CmsRet devCtl_xtmSARRegDump( PXTM_SAR_REG_DUMP pSarRegDump __attribute__((unused)))
{
   return CMSRET_SUCCESS;
}
