...
# Note that the diag component includes X_BROADCOM_COM_SpeedSvc, which is
# used in BDK (Distributed MDM) as well as CMS TR98 and TR181 modes.
ifneq ($(strip $(BUILD_BRCM_CMS)),)
COND_BUILD_CBK_DIAG := 1
endif
ifneq ($(strip $(BUILD_DISTRIBUTED_MDM)),)
COND_BUILD_CBK_DIAG := 1
endif

ifeq ($(strip $(COND_BUILD_CBK_DIAG)),1)
