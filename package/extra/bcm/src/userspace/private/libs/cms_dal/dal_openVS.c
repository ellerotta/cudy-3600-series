...
CmsRet dalOpenVSCfg(const char *enable, const char *ofControllerAddr,UINT32 ofControllerPort, const char *openVSports )
{
   ...
   {  // change to default value
      ...
      openVSCfg->OFControllerPortNumber = 6653;
      CMSMEM_REPLACE_STRING(openVSCfg->OFControllerIPAddress, "0.0.0.0");
      CMSMEM_REPLACE_STRING(openVSCfg->ifNameList, "");
   }
...
CmsRet dalGetOpenVSPorts(char *ports)
{
   ...
   if (openVSCfg->ifNameList != NULL) 
      sprintf(ports, "%s", openVSCfg->ifNameList);
