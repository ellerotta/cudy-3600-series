...
#if defined(SUPPORT_DM_LEGACY98)
#define dalQos_queueAdd(i, s, e, n, u, w, p, m, h, b, y, z, d0, d1, d2, d3, d4, ack)  dalQos_queueAdd_igd((i), (s), (e), (n), (u), (w), (p), (m), (h), (b), (y), (z), (d0), (d1), (d2), (d3), (d4), (ack))
#elif defined(SUPPORT_DM_HYBRID)
#define dalQos_queueAdd(i, s, e, n, u, w, p, m, h, b, y, z, d0, d1, d2, d3, d4, ack)  dalQos_queueAdd_igd((i), (s), (e), (n), (u), (w), (p), (m), (h), (b), (y), (z), (d0), (d1), (d2), (d3), (d4), (ack))
#elif defined(SUPPORT_DM_PURE181)
#define dalQos_queueAdd(i, s, e, n, u, w, p, m, h, b, y, z, d0, d1, d2, d3, d4, ack)  dalQos_queueAdd_dev2((i), (s), (e), (n), (u), (w), (p), (m), (h), (b), (y), (z), (d0), (d1), (d2), (d3), (d4), (ack))
#elif defined(SUPPORT_DM_DETECT)
#define dalQos_queueAdd(i, s, e, n, u, w, p, m, h, b, y, z, d0, d1, d2, d3, d4, ack)  (cmsMdm_isDataModelDevice2() ? \
        dalQos_queueAdd_dev2((i), (s), (e), (n), (u), (w), (p), (m), (h), (b), (y), (z), (d0), (d1), (d2), (d3), (d4), (ack)) : \
        dalQos_queueAdd_igd((i), (s), (e), (n), (u), (w), (p), (m), (h), (b), (y), (z), (d0), (d1), (d2), (d3), (d4)), (ack))
#endif
