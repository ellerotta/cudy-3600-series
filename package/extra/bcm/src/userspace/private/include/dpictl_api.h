...
#define DPICTL_HOSTNAME_LENGTH      256
...
struct dc_dev {
   ...
   uint16_t family;
   uint8_t  mac[6];
   char     hostname[DPICTL_HOSTNAME_LENGTH];
};
...
struct dc_url {
   char              url[DPICTL_HOSTNAME_LENGTH];
   struct dc_app     app;
   uint64_t          hits;
};
 ...
 *------------------------------------------------------------------------------
 */
int dpictl_reset_stats(uint64_t flags);
 ...
 *------------------------------------------------------------------------------
 */
char *dpictl_get_name(uint64_t id, int db_id);
 ...
 *------------------------------------------------------------------------------
 */
struct dc_appinst *dpictl_get_appinst(uint64_t app_id, uint8_t *mac);
 ...
 *------------------------------------------------------------------------------
 */
struct dc_app_stat *dpictl_get_app(uint64_t app_id);
 ...
 *------------------------------------------------------------------------------
 */
struct dc_qos_appinst_stat *dpictl_get_qos_appinst(uint64_t app_id,
                                                   uint8_t *mac);
