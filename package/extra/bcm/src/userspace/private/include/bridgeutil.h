...
/*
 *------------------------------------------------------------------------------
 * Function Name: br_util_get_bridge_ifindex_from_lower_ifname
 * Description  : get ifindex of the bridge which the given interface belongs to
 * Returns      : negative - error, positive - ifindex
 *------------------------------------------------------------------------------
 */
int br_util_get_bridge_ifindex_from_lower_ifname(const char *ifname);
...
/*
 *------------------------------------------------------------------------------
 * Function Name: br_util_set_aging 
 * Description  : Set the ethernet (MAC) address ageing time, in 10 ms.
 *                brname: bridge name; age: aging time in seconds/100
 * Returns      : 0 - success, otherwise failure
 *------------------------------------------------------------------------------
 */
int br_util_set_aging(const char *brname, unsigned int age);
