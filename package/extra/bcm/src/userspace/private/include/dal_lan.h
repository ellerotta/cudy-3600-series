 ...
 *
 */
void dalLan_getIpIntfInfo(UBOOL8 getDefaults, const char *ifName, char *ipAddr, char *subnetMask, UBOOL8 *lanFirewallEnabledi, UBOOL8 *dhcpcEnabled);

void dalLan_getIpIntfInfo_igd(UBOOL8 getDefaults, const char *ifName, char *ipAddr, char *subnetMask, UBOOL8 *lanFirewallEnabled, UBOOL8 *dhcpcEnabled);

void dalLan_getIpIntfInfo_dev2(UBOOL8 getDefaults, const char *ifName, char *ipAddr, char *subnetMask, UBOOL8 *lanFirewallEnabled, UBOOL8 *dhcpcEnabled);


#if defined(SUPPORT_DM_LEGACY98)
#define dalLan_getIpIntfInfo(a, b, c, d, e, f)   dalLan_getIpIntfInfo_igd((a), (b), (c), (d), (e), (f))
#elif defined(SUPPORT_DM_HYBRID)
#define dalLan_getIpIntfInfo(a, b, c, d, e, f)   dalLan_getIpIntfInfo_igd((a), (b), (c), (d), (e), (f))
#elif defined(SUPPORT_DM_PURE181)
#define dalLan_getIpIntfInfo(a, b, c, d, e, f)   dalLan_getIpIntfInfo_dev2((a), (b), (c), (d), (e), (f))
#elif defined(SUPPORT_DM_DETECT)
#define dalLan_getIpIntfInfo(a, b, c, d, e, f)  (cmsMdm_isDataModelDevice2() ? \
                        dalLan_getIpIntfInfo_dev2((a), (b), (c), (d), (e), (f)) : \
                        dalLan_getIpIntfInfo_igd((a), (b), (c), (d), (e), (f)))
#endif
...
/** Add a bridge port on top of the lower layer interface specified by
 * fullPath.
 *
 ...
 * Note that this function is called in place of dalBridge_addFullPathToBridge_dev2
...
/** Delete the VLAN port that is associated with a bridge port.
 *
 * @param brPortIidStack (IN) Bridge port object iidstack.
 *
 * @return CmsRet
 */
