...
#define IP_NTFY_SRVR_ADDR   0xE000FF87 /* Notification Server*/
...
int bcm_mcast_api_send_sock_msg_wait_rsp(int port, void *pBuf, 
                                         int buf_size, void *rcv_buf, 
                                         int rcv_bufsize);
int bcm_mcast_api_ipv4_purge_grp_reporter(int sock_nl, int ifi, int dstdev_ifi, struct in_addr *rep, struct in_addr *grp);
int bcm_mcast_api_ipv6_purge_grp_reporter(int sock_nl, int ifi, int dstdev_ifi, struct in6_addr *rep, struct in6_addr *grp);
