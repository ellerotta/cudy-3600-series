...
**
**  PURPOSE:        Set association between call control line and SIP client
**
**  INPUT PARMS:    op[0] - voice service instance
...
**
**  PURPOSE:        Get association between call control line and SIP client
**
**  INPUT PARMS:    op[0] - voice service instance
**                  op[1] - call ctrl line instance
**                   
**
**  OUTPUT PARMS:   op[2] - sip client instance 
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
*
* Parameters   : parms->op[0] = vpInst, parms->op[1] = clientInst, value = value to be set
* Returns      : CMSRET_SUCCESS when successful.
****************************************************************************/
...
**                  (X_BROADCOM_COM_DspHalUnderruns)
**
**  INPUT PARMS:    None
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetPeakDspUnderruns
**
**  PURPOSE:        Get peak DSP Underruns
**                  (X_BROADCOM_COM_PeakDspUnderruns)
**
**  INPUT PARMS:    None
**
**  OUTPUT PARMS:   getVal - number of peak DSP HAL Underruns
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetCcLineStatsJbUnderrun
**
**  PURPOSE:        set JB underrun count for a given line
**
**  INPUT PARMS:    op[0] - voice service instance
**                  op[1] - line instance
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetCcLineStatsJbOverrun
**
**  PURPOSE:        set JB underrun count for a given line
**
**  INPUT PARMS:    op[0] - voice service instance
...
/****************************************************************************
* FUNCTION:    dalVoice_GetMtaLogIndex
*
...
*
* OUTPUT:      value - index value for the given log
*
* RETURNS:     CMSRET_SUCCESS - Operation success
*              other failed, check with reason code
****************************************************************************/
...
/****************************************************************************
* FUNCTION:    dalVoice_GetCallLogUsedLine
*
* PURPOSE:     Get calllog used line number
*
* PARAMETERS:  parms->op[0] = vpInst
*              parms->op[1] = calllog instance number
*              value = string buffer to hold value
*              length = length of value buffer
*
* OUTPUT:      value = string containing call log used line
*                      currently support:
*
* RETURNS:     CMSRET_SUCCESS - Operation success
*              other failed, check with reason code
...
/****************************************************************************
* FUNCTION:    dalVoice_SetCallLogSessionSrcRtpMinJitter
*
* PURPOSE:     Set calllog session source min jitter
*
* PARAMETERS:  parms->op[0] = vpInst
*              parms->op[1] = calllog instance number
*              parms->op[2] = session instance number
...
/****************************************************************************
* FUNCTION:    dalVoice_GetCallLogSessionDstRtpMinJitter
*
* PURPOSE:     Get calllog session destination rtp min jitter
*
* PARAMETERS:  parms->op[0] = vpInst
*              parms->op[1] = calllog instance number
*              parms->op[2] = session instance number
...
*              other failed, check with reason code
****************************************************************************/
CmsRet dalVoice_GetCallLogSessionDstRtpMinJitter( DAL_VOICE_PARMS *parms, char *value, unsigned int length );

/****************************************************************************
* FUNCTION:    dalVoice_SetCallLogSessionSrcRtpMeanJitter
*
* PURPOSE:     Set calllog session source mean jitter
*
* PARAMETERS:  parms->op[0] = vpInst
*              parms->op[1] = calllog instance number
*              parms->op[2] = session instance number
...
/****************************************************************************
* FUNCTION:    dalVoice_GetCallLogSessionDstRtpMeanJitter
*
* PURPOSE:     Get calllog session destination rtp mean jitter
*
* PARAMETERS:  parms->op[0] = vpInst
*              parms->op[1] = calllog instance number
*              parms->op[2] = session instance number
...
*              other failed, check with reason code
****************************************************************************/
CmsRet dalVoice_GetCallLogSessionDstRtpMeanJitter( DAL_VOICE_PARMS *parms, char *value, unsigned int length );

/****************************************************************************
* FUNCTION:    dalVoice_SetCallLogSessionSrcRtpPeakJitter
*
* PURPOSE:     Set calllog session source peak jitter
*
* PARAMETERS:  parms->op[0] = vpInst
*              parms->op[1] = calllog instance number
*              parms->op[2] = session instance number
...
/****************************************************************************
* FUNCTION:    dalVoice_GetCallLogSessionDstRtpPeakJitter
*
* PURPOSE:     Get calllog session destination rtp mean jitter
*
* PARAMETERS:  parms->op[0] = vpInst
...
*              other failed, check with reason code
****************************************************************************/
CmsRet dalVoice_GetCallLogSessionDstRtpPeakJitter( DAL_VOICE_PARMS *parms, char *value, unsigned int length );
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetCXEndOnNotify
**
**  PURPOSE:        Get the CXEndOnNotify.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              featInst: parms->op[1]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - CXEndOnNotify
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetCXEndOnNotify
**
**  PURPOSE:        Set the CXEndOnNotify.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              featInst: parms->op[1]
**                  value   - CXEndOnNotify
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetCXInDialogRefer
**
...
**
**  PURPOSE:        Get the hook flash enable flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              featInst: parms->op[1]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - MDMVS_YES or MDMVS_NO
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetHookFlashEnable
**
**  PURPOSE:        Set the hook flash enable flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              featInst: parms->op[1]
**                  value   - string of flag value
**
**  RETURNS:        CMSRET_SUCCESS - Write Success
**                  other failed, check with reason code
**
...
**
**  PURPOSE:        Get the dial tone pattern default override flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              featInst: parms->op[1]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - "StandardDialTone"
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetDialTonePattern
**
**  PURPOSE:        Set the dial tone pattern default override flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              featInst: parms->op[1]
**                  value - "StandardDialTone"
**                          "SpecialConditionTone"
**                          "MessageWaitingTone"
**
**  RETURNS:        CMSRET_SUCCESS - Write Success
...
#define DALVOICE_ISPKTCBLMODE(tempObj) ( !strcmp( tempObj, "pktcbl" )     \
                                         || !strcmp( tempObj, "charter" ) \
                                         || !strcmp( tempObj, "comcast" ) \
                                         || !strcmp( tempObj, "lgi" )     \
                                       )

/*****************************************************************
**  FUNCTION:       dalVoice_GetCustomProfile
**
**  PURPOSE:        Get the custom profile.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - custom profile
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetCustomProfile
**
**  PURPOSE:        Set the custom profile.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetCctkInterop
**
**  PURPOSE:        Get the interop config.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - interop config (HEX string format)
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetCctkSigBehaveTx
**
**  PURPOSE:        Get the TX signaling config.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - signaling config (HEX string format)
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetCctkSigBehaveRx
**
**  PURPOSE:        Get the RX signaling config.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                  length  - Buffer length
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetInitRegDelay
**
**  PURPOSE:        Get the initial registration delay.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - reg delay in seconds
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetRtcpRandomInt
**
**  PURPOSE:        Get the RTCP random interval enable.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              profInst: parms->op[1]
**                  length  - Buffer length
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetNoToneOutOfSrv
**
**  PURPOSE:        Get the no tone when out of service config.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - config flag
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetRemove100rel
**
**  PURPOSE:        Get Remove100rel config.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                  length  - Buffer length
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetBackToPrimMinTmr
**
**  PURPOSE:        Get the minimum back to primary timer.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - min timer in seconds
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetBackToPrimMaxTmr
**
**  PURPOSE:        Get the maximum back to primary timer.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - max timer in seconds
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetRegRetryTimerMin
**
**  PURPOSE:        Get the minimum registration retry timer.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetRegRetryTimerMax
**
**  PURPOSE:        Get the maximum registration retry timer.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetSubExpTmr
**
**  PURPOSE:        Get the general subscription expiration timer.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - timer in seconds
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetSdpAnswerIn180
**
**  PURPOSE:        Get the SDP answer in 180 flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - flag
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetRegEvtSub
**
**  PURPOSE:        Get the reg event subscription flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetPCSCFDiscoveryState
**
**  PURPOSE:        Get the PCSCF Discovery state
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - string of the value
**                  1 = Success, 2 = Failure, 3 = In Progress
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetPCSCFDiscoveryRetryMin
**
**  PURPOSE:        Get the PCSCF Discovery minimum retry time
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetPCSCFDiscoveryRetryMax
**
**  PURPOSE:        Get the PCSCF Discovery maximum retry time
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetAllowUnsolicitedMWIEvent
**
**  PURPOSE:        Get the Allow Unsolicited MWI NOTIFY Event flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetAllowUnsolicitedUAProfEvent
**
**  PURPOSE:        Get the Allow Unsolicited ua-profile NOTIFY Event flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetAllowUnsolicitedRegEvent
**
**  PURPOSE:        Get the Allow Unsolicited reg NOTIFY Event flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetNfMWISubRetryTimer
**
**  PURPOSE:        Get the NfMWISubRetryTimer.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - NfMWISubRetryTimer
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetNfMWISubRetryTimer
**
**  PURPOSE:        Set the NfMWISubRetryTimer.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  value   - NfMWISubRetryTimer
**
**  RETURNS:        CMSRET_SUCCESS - Write Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetNfMWIAddr
**
**  PURPOSE:        Get the MWI server address.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - MWI server address
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetNfMWIAddr
**
**  PURPOSE:        Set the MWI IP address.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  value   - MWI IP address
**
**  RETURNS:        CMSRET_SUCCESS - Write Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetNfMWIAddrPort
**
**  PURPOSE:        Get the MWI Address port.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - MWI address port
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetNfMWIAddrPort
**
**  PURPOSE:        Set the MWI IP address port.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  value   - MWI IP address port
**
**  RETURNS:        CMSRET_SUCCESS - Write Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetNfMWIStutterToneEnabled
**
**  PURPOSE:        Get the MWI stutter tone enabled flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - MWI stutter tone enabled flag
**                          "No" if false (MDMVS_NO),
**                          "Yes" if true (MDMVS_YES).
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetNfMWIStutterToneEnabled
**
**  PURPOSE:        Set the MWI stutter tone enabled flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  value   - MWI stutter tone enabled flag
**                            "No" if false (MDMVS_NO),
**                            "Yes" if true (MDMVS_YES).
**
**  RETURNS:        CMSRET_SUCCESS - Write Success
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetNfMWIClearMWI
**
**  PURPOSE:        Get the Clear MWI flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - MWI current state
**                          "No" if on (MDMVS_NO),
**                          "Yes" if off (MDMVS_YES).
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
*******************************************************************/
CmsRet dalVoice_GetNfMWIClearMWI( DAL_VOICE_PARMS *parms, char *value, unsigned int length );

/*****************************************************************
**  FUNCTION:       dalVoice_SetNfMWIClearMWI
**
**  PURPOSE:        Set the Clear MWI flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  value   - Clear MWI
**                            "No" to turn MWI on (MDMVS_NO),
**                            "Yes" to turn MWI off (MDMVS_YES).
**
**  RETURNS:        CMSRET_SUCCESS - Write Success
**                  other failed, check with reason code
**
*******************************************************************/
CmsRet dalVoice_SetNfMWIClearMWI( DAL_VOICE_PARMS *parms, char *value );

/*****************************************************************
**  FUNCTION:       dalVoice_SetMWISubscribed
**
**  PURPOSE:        Set the MWI Subscribed flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  value   - MWI Subscribed
**                            "No" MWI is not currently subscribed (MDMVS_NO),
**                            "Yes" MWI is currently subscribed (MDMVS_YES).
**
**  RETURNS:        CMSRET_SUCCESS - Write Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetUAProfSubscribed
**
**  PURPOSE:        Set the UA Profile Subscribed flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  value   - UA Profile Subscribed
**                            "No" UAP is not currently subscribed (MDMVS_NO),
**                            "Yes" UAP is currently subscribed (MDMVS_YES).
**
**  RETURNS:        CMSRET_SUCCESS - Write Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetVMWIStatus
**
**  PURPOSE:        Set the VMWI status flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  value   - VMWI status
**                            "Yes" to set VMWI status as on (MDMVS_YES),
**                            "No" to set VMWI status as off (MDMVS_NO).
**
**  RETURNS:        CMSRET_SUCCESS - Write Success
**                  other failed, check with reason code
**
...
**
**  PURPOSE:        Get the "application/simservs+xml" feature enabled flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - simservs+xml feature enabled flag
**                          "No" if false (MDMVS_NO),
**                          "Yes" if true (MDMVS_YES).
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetSimServsXmlFeatureEnable
**
**  PURPOSE:        Set the "application/simservs+xml" feature enabled flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              netInst: parms->op[1]
**                  value   - simservs+xml feature enabled flag
**                            "No" if false (MDMVS_NO),
**                            "Yes" if true (MDMVS_YES).
**
**  RETURNS:        CMSRET_SUCCESS - Write Success
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetEServiceDontDiscOnAlarm
**
**  PURPOSE:        Get the EServiceDontDiscOnAlarm flag.
**
**  PARAMETERS:     parms   - Parameter index - vpInst:  parms->op[0]
**                                              featInst: parms->op[1]
**                  length  - Buffer length
**
**  OUTPUT PARMS:   value - boolean flag
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetVoiceAnnouncementOperStatus
**
**  PURPOSE:        Get voice announcement OperStatus as a string.
**                  MDMVS_INPROGRESS ("InProgress")
**                  MDMVS_COMPLETEFROMPROVISIONING ("CompleteFromProvisioning")
**                  MDMVS_COMPLETEFROMMGT ("CompleteFromMgt")
**                  MDMVS_FAILED ("Failed")
**                  MDMVS_OTHER ("Other")
**
**  PARAMETERS:     parms   - parms->op[0] = vpInst (voiceProfile instance)
**                            parms->op[1] = nwInst (network instance)
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetVoiceAnnouncementOperStatus
**
**  PURPOSE:        Set voice announcement OperStatus as a string.
**                  MDMVS_INPROGRESS ("InProgress")
**                  MDMVS_COMPLETEFROMPROVISIONING ("CompleteFromProvisioning")
**                  MDMVS_COMPLETEFROMMGT ("CompleteFromMgt")
**                  MDMVS_FAILED ("Failed")
...
**  PARAMETERS:     parms   - parms->op[0] = vpInst (voiceProfile instance)
**                            parms->op[1] = nwInst (network instance)
**                  value   - string buffer that contains value to set
**
**  RETURNS:        CMSRET_SUCCESS - Write Success
**                  other failed, check with reason code
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetVoiceAnnouncementCurrentVersion
**
**  PURPOSE:        Get voice announcement CurrentVersion as a string.
**
**  PARAMETERS:     parms   - parms->op[0] = vpInst (voiceProfile instance)
**                            parms->op[1] = nwInst (network instance)
**                  value   - buffer to receive value
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetVoiceAnnouncementCurrentVersion
**
**  PURPOSE:        Set voice announcement CurrentVersion as a string.
**
**  PARAMETERS:     parms   - parms->op[0] = vpInst (voiceProfile instance)
**                            parms->op[1] = nwInst (network instance)
**                  value   - string buffer that contains value to set
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetVoiceAnnouncementAdminStatus
**
**  PURPOSE:        Get voice announcement AdminStatus as a string.
**                  MDMVS_UPGRADEFROMMGT ("UpgradeFromMgt")
**                  MDMVS_ALLOWPROVISIONINGUPGRADE ("AllowProvisioningUpgrade")
**                  MDMVS_IGNOREPROVISIONINGUPGRADE ("IgnoreProvisioningUpgrade")
**
**  PARAMETERS:     parms   - parms->op[0] = vpInst (voiceProfile instance)
**                            parms->op[1] = nwInst (network instance)
**                  value   - buffer to receive value
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetVoiceAnnouncementAdminStatus
**
**  PURPOSE:        Set voice announcement AdminStatus as a string.
**                  MDMVS_UPGRADEFROMMGT ("UpgradeFromMgt")
**                  MDMVS_ALLOWPROVISIONINGUPGRADE ("AllowProvisioningUpgrade")
**                  MDMVS_IGNOREPROVISIONINGUPGRADE ("IgnoreProvisioningUpgrade")
**
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetVoiceAnnouncementFileName
**
**  PURPOSE:        Get voice announcement FileName as a string.
**
**  PARAMETERS:     parms   - parms->op[0] = vpInst (voiceProfile instance)
**                            parms->op[1] = nwInst (network instance)
**                  value   - buffer to receive value
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetVoiceAnnouncementFileName
**
**  PURPOSE:        Set voice announcement FileName as a string.
**
**  PARAMETERS:     parms   - parms->op[0] = vpInst (voiceProfile instance)
**                            parms->op[1] = nwInst (network instance)
**                  value   - string buffer that contains value to set
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetVoiceAnnouncementServerAddrType
**
**  PURPOSE:        Get voice announcement ServerAddressType as a string.
**                  MDMVS_IPV4 ("IPv4")
**                  MDMVS_IPV6 ("IPv6")
**
**  PARAMETERS:     parms   - parms->op[0] = vpInst (voiceProfile instance)
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetVoiceAnnouncementServerAddrType
**
**  PURPOSE:        Set voice announcement ServerAddressType as a string.
**                  MDMVS_IPV4 ("IPv4")
**                  MDMVS_IPV6 ("IPv6")
**
**  PARAMETERS:     parms   - parms->op[0] = vpInst (voiceProfile instance)
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetVoiceAnnouncementServerAddr
**
**  PURPOSE:        Get voice announcement ServerAddress as a string.
**
**  PARAMETERS:     parms   - parms->op[0] = vpInst (voiceProfile instance)
**                            parms->op[1] = nwInst (network instance)
**                  value   - buffer to receive value
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetVoiceAnnouncementServerAddr
**
**  PURPOSE:        Set voice announcement ServerAddress as a string.
**
**  PARAMETERS:     parms   - parms->op[0] = vpInst (voiceProfile instance)
**                            parms->op[1] = nwInst (network instance)
**                  value   - string buffer that contains value to set
...
/*****************************************************************
**  FUNCTION:       dalVoice_GetVoiceAnnouncementCtrl
**
**  PURPOSE:        Get voice announcement AnnouncementCtrl as a string.
**
**  PARAMETERS:     parms   - parms->op[0] = vpInst (voiceProfile instance)
**                            parms->op[1] = nwInst (network instance)
**                  value   - buffer to receive value
...
/*****************************************************************
**  FUNCTION:       dalVoice_SetVoiceAnnouncementCtrl
**
**  PURPOSE:        Set voice announcement AnnouncementCtrl as a string.
**
**  PARAMETERS:     parms   - parms->op[0] = vpInst (voiceProfile instance)
**                            parms->op[1] = nwInst (network instance)
**                  value   - string buffer that contains value to set
