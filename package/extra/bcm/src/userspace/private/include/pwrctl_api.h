...
int pwr_api_xrdp_clock_divider_get(char *param, int *enable);
int pwr_api_xrdp_clock_divider_set(char *param, int enable);
...
int pwr_api_spu_set(char *param, int enable);
int pwr_api_spu_get(char *param, int *enable);
int pwr_api_pon_set_inline(int enable);
int pwr_api_pon_set(char *param, int enable);
int pwr_api_pon_get(char *param, int *enable);
int pwr_api_wan_sfp_set(char *param, int enable);
int pwr_api_wan_sfp_get(char *param, int *enable);
int pwr_api_led_set(char *param, int enable);
int pwr_api_led_get(char *param, int *enable);
...
int pwr_wake_set(wake_type_t type, char *param1, char *param2);
