...
/** XTM Access SAR
 *
 * This function is called to indicate to XTM Drivers about the userspace ctl access directly
 * to SAR space for debug information.
 *
 * @param  int SarIO(IN) - TRUE/FALSE indicating access start and done
 * conditions.
 *
 * @return CmsRet enum.
 */
...
/** XTM SAR Register Dump
 *
 * This function is called to dump the SAR register values.
 *
 * @param  int pSarRegDump(IN/OUT) - Pointer to an XTM_SAR_REG_DUMP structure.
 *
 * @return CmsRet enum.
 */
