...
#define kExtObjSnrMin                  0
#define kExtObjSnrMax                  1
#define kExtObjSnrmMin                 2
#define kExtObjSnrmMax                 3
#define kExtObjNum                     4
...
/** Set OEM EOC param.
 *
 * @param lineId (IN) usually 0, in bonding config, may be 1.
 * @param paramId (IN) ADSL_OEM_EOC_* defined in bcmadsl.h
...
BcmRet xdslCtl_DiagProcessCommandFrame(unsigned char lineId, void *diagBuf, int diagBufLen);
...
BcmRet xdslCtl_Check(unsigned char lineId);
...
BcmRet xdslCtl_Uninitialize(unsigned char lineId);
...
BcmRet xdslCtl_ConnectionStart(unsigned char lineId);
...
BcmRet xdslCtl_ConnectionStop(unsigned char lineId);
...
BcmRet xdslCtl_StopBERT(unsigned char lineId);
 ...
 * @return BcmRet enum.
 */
BcmRet devCtl_adslSelectTones(int xmtStartTone, int xmtNumTones, int rcvStartTone,
                              int rcvNumTones, char *xmtToneMap, char *rcvToneMap);
BcmRet xdslCtl_SelectTones(unsigned char lineId, int xmtStartTone, int xmtNumTones,
...
BcmRet xdslCtl_StartSeltTest(unsigned char lineId, unsigned char *steps, unsigned int *cfg);
...
BcmRet xdslCtl_isSeltTestComplete(unsigned char lineId, int *complete);
...
BcmRet xdslCtl_SeltConfigureTest(unsigned char lineId, float psdLevel, float duration, float maxFreq, unsigned char *steps);
...
BcmRet xdslCtl_SeltFetchAndPostProcess(unsigned char lineId, int calibrate, int process, char *folderIn, char *folderOut, int *errReport);
 ...
 *         NULL
*/
BcmRet xdslCtl_GetSeltAlgorithmVersion(char *version);
 ...
 *         NULL
*/
BcmRet xdslCtl_StopSeltMeasurement(unsigned char lineId);
