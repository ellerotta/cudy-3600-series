...
UBOOL8 qdmQos_isAnyInterfaceOfQueuesMatchedLocked(const void *obj);
UBOOL8 qdmQos_isAnyInterfaceOfQueuesMatchedLocked_igd(const void *obj);
UBOOL8 qdmQos_isAnyInterfaceOfQueuesMatchedLocked_dev2(const void *obj);

#if defined(SUPPORT_DM_LEGACY98)
#define qdmQos_isAnyInterfaceOfQueuesMatchedLocked(a)  qdmQos_isAnyInterfaceOfQueuesMatchedLocked_igd((a))
#elif defined(SUPPORT_DM_HYBRID)
#define qdmQos_isAnyInterfaceOfQueuesMatchedLocked(a)  qdmQos_isAnyInterfaceOfQueuesMatchedLocked_igd((a))
#elif defined(SUPPORT_DM_PURE181)
#define qdmQos_isAnyInterfaceOfQueuesMatchedLocked(a)  qdmQos_isAnyInterfaceOfQueuesMatchedLocked_dev2((a))
#elif defined(SUPPORT_DM_DETECT)
#define qdmQos_isAnyInterfaceOfQueuesMatchedLocked(a)  (cmsMdm_isDataModelDevice2() ? \
                           qdmQos_isAnyInterfaceOfQueuesMatchedLocked_dev2((a)) : \
                           qdmQos_isAnyInterfaceOfQueuesMatchedLocked_igd((a)))
