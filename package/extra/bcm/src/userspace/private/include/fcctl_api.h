...
#define FCACHE_CONFIG_OPT_L2TP              5       /* L2TP enable/disable values   */
#define FCACHE_CONFIG_OPT_ACCEL_MODE        6       /* Acceleration mode values     */
#define FCACHE_CONFIG_OPT_TCP_ACK_MFLOWS    7       /* TCP Ack Prioritization       */
#define FCACHE_CONFIG_OPT_HW_ACCEL          8       /* HW Acceleration en/disable   */
#define FCACHE_CONFIG_OPT_LOW_PKT_RATE      9       /* Set low pkt rate value       */
#define FCACHE_CONFIG_OPT_NOTIFY_PROC_MODE  10      /* Set notify processing mode   */
#define FCACHE_CONFIG_OPT_SW_DEFER          11      /* Set pkt SW deferral rate value*/
#define FCACHE_CONFIG_OPT_GRE               12      /* GRE enable/disable values    */
#define FCACHE_CONFIG_OPT_4O6_FRAG          13      /* 4over6 frag support          */
#define FCACHE_CONFIG_OPT_TOS_MFLOWS        14      /* ToS Multi Flow support       */
#define FCACHE_CONFIG_OPT_UNKNOWN_UCAST     15      /* Unknown Ucast Flow support   */
#define FCACHE_CONFIG_OPT_IDLE_TIMER_TCP    16      /* TCP flow idle timer          */
#define FCACHE_CONFIG_OPT_IDLE_TIMER_UDP    17      /* UDP flow idle timer          */
#define FCACHE_CONFIG_OPT_IDLE_TIMER_L2     18      /* L2 flow idle timer           */
#define FCACHE_CONFIG_OPT_IDLE_TIMER_MCAST  19      /* mcast flow idle timer        */
#define FCACHE_CONFIG_OPT_IDLE_TIMER_UNKNOWN_UCAST  20  /* Unknown Ucast flow idle timer */
#define FCACHE_CONFIG_OPT_IDLE_TIMER_OTHER  21      /* other flow (non-TCP, UDP, etc.)*/
#define FCACHE_CONFIG_OPT_TX_THREAD         22      /* TX using thread en/disable   */
#define FCACHE_CONFIG_OPT_TX_THREAD_IDELAY  23      /* TX thread idle delay check   */
#define FCACHE_CONFIG_OPT_PURE_LLC          24      /* Pure LLC Flow support        */
#define FCACHE_CONFIG_OPT_RX_PKTLEN_MODE	25		/* RX max pktlen mode           */
#define FCACHE_CONFIG_OPT_MAX               26       
