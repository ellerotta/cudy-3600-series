...
/** Get the URL of the TR69 Management server object.
 *
 * @param ifName  (OUT)  A buffer of maximum 256 bytes long.
 *                       On successful return, will contain the URL.
 *
 * @return CmsRet enum.
 */
CmsRet qdmTr69c_getUrlLocked(char *url);

CmsRet qdmTr69c_getUrlLocked_igd(char *url);

CmsRet qdmTr69c_getUrlLocked_dev2(char *ifNurlame);

#if defined(SUPPORT_DM_LEGACY98)
#define qdmTr69c_getUrlLocked(i)   qdmTr69c_getUrlLocked_igd((i))
#elif defined(SUPPORT_DM_HYBRID)
#define qdmTr69c_getUrlLocked(i)   qdmTr69c_getUrlLocked_igd((i))
#elif defined(SUPPORT_DM_PURE181)
#define qdmTr69c_getUrlLocked(i)   qdmTr69c_getUrlLocked_dev2((i))
#elif defined(SUPPORT_DM_DETECT)
#define qdmTr69c_getUrlLocked(i)       (cmsMdm_isDataModelDevice2() ? \
                                     qdmTr69c_getUrlLocked_dev2((i)) : \
                                     qdmTr69c_getUrlLocked_igd((i)))
#endif
