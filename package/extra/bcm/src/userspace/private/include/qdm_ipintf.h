...
UBOOL8 qdmIpIntf_isLanDhcpcEnabled_igd(const char *ifName);

#if defined(SUPPORT_DM_LEGACY98)
#define qdmIpIntf_isLanDhcpcEnabled(i)   qdmIpIntf_isLanDhcpcEnabled_igd((i))
#elif defined(SUPPORT_DM_HYBRID)
#define qdmIpIntf_isLanDhcpcEnabled(i)   qdmIpIntf_isLanDhcpcEnabled_igd((i))
#elif defined(SUPPORT_DM_PURE181)
#define qdmIpIntf_isLanDhcpcEnabled(i)   qdmIpIntf_isLanDhcpcEnabled_dev2((i))
#elif defined(SUPPORT_DM_DETECT)
#define qdmIpIntf_isLanDhcpcEnabled(i, a)   (cmsMdm_isDataModelDevice2() ? \
                 qdmIpIntf_isLanDhcpcEnabled_dev2((i)) : \
                 qdmIpIntf_isLanDhcpcEnabled_igd((i)))
#endif
#endif /* _QDM_INTF_H_ */
