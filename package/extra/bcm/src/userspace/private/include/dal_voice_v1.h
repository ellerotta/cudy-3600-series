...
*
* Description  : Set the PacketsSent parameter for the line stats structure
...
*
* Description  : Set the PacketsReceived parameter for the line stats structure
...
*
* Description  : Set the BytesSent parameter for the line stats structure
...
*
* Description  : Set the BytesReceived parameter for the line stats structure
...
**  INPUT PARMS:    vpInst - parms->op[0]
**
**  OUTPUT PARMS:   value - true for using SIP URI for TLS calls, false otherwise
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
**
**  PUROPOSE:       Set the enable or disable flag for using built-in
**                  SIP stack DNS resolver
...
**  INPUT PARMS:    None
**
**  OUTPUT PARMS:   getVal - Use built-in SIP stack DNS resolver ("0" or "1")
**
**  RETURNS:        CMSRET_SUCCESS - Read Success
**                  other failed, check with reason code
**
...
CmsRet dalVoice_GetEServiceObject ( DAL_VOICE_PARMS *parms, void **obj );
CmsRet dalVoice_GetEServiceNwHoldTime ( DAL_VOICE_PARMS *parms, char *time, unsigned int length );
...
CmsRet dalVoice_SetEServiceNwHoldTime ( DAL_VOICE_PARMS *parms, char *time );
CmsRet dalVoice_SetEServiceNwHoldDisable ( DAL_VOICE_PARMS *parms, char *disable );
CmsRet dalVoice_SetEServiceNwHoldBypass ( DAL_VOICE_PARMS *parms, char *chk );
CmsRet dalVoice_SetEServiceAllow3WayCall ( DAL_VOICE_PARMS *parms, char *allow );
CmsRet dalVoice_SetEServiceNoLocInfo ( DAL_VOICE_PARMS *parms, char *loc );
CmsRet dalVoice_SetEServiceDSCPMark ( DAL_VOICE_PARMS *parms, char *dscp );
CmsRet dalVoice_SetEServiceEndCallAcptIncEmerg ( DAL_VOICE_PARMS *parms, char *endCall );
