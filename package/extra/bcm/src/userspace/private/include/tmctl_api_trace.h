...
tmctl_ret_e tmctl_getOverAllShaperTrace(tmctl_devType_e devType,
                                     tmctl_if_t *if_p, tmctl_shaper_t *shaper_p);
tmctl_ret_e tmctl_setOverAllShaperTrace(tmctl_devType_e devType,
                                     tmctl_shaper_t *shaper_p);
tmctl_ret_e tmctl_linkOverAllShaperTrace(tmctl_devType_e devType,
                                     tmctl_if_t *if_p);
tmctl_ret_e tmctl_unlinkOverAllShaperTrace(tmctl_devType_e devType,
                                     tmctl_if_t *if_p);
...
tmctl_ret_e tmctl_setTcToQueueTrace(int table_index, tmctl_tcToQCfg_t* cfg_p);
...
tmctl_ret_e tmctl_SeleteShaperTrace(uint64_t shaper_obj);
