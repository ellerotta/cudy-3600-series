...
////////////////////////////////////////////////////////////////////////////////
/// \brief API to Get the port l2cp stats.
///
////////////////////////////////////////////////////////////////////////////////
extern
...
////////////////////////////////////////////////////////////////////////////////
/// \brief API to Clear all port l2cp stats.
///
////////////////////////////////////////////////////////////////////////////////
extern
int eponStack_CtlL2cpStatsClearAll(void);


////////////////////////////////////////////////////////////////////////////////
/// \brief API to Sync the Uni port name with EPON driver.
///
////////////////////////////////////////////////////////////////////////////////
extern
int eponStack_CtlUniPortNameSync(U8 portIdx, const char *portName);

////////////////////////////////////////////////////////////////////////////////
///\brief API to Sync the Uni port Num with EPON driver.
///
////////////////////////////////////////////////////////////////////////////////
extern
int eponStack_CtlUniPortNumSync(U8 portNum);
...
extern
int eponStack_CtlTxTestPacket(EponTxTestPacketParam * txPara);
...
extern
int eponStack_CtlGetLinkMacAddr(U8 link , MacAddr * mac);

extern
int eponStatck_CtlGetEncryptLatestPktNum(U8 link, U32 * number);

extern
int eponStack_CtlSetLinkKeyClear(U8 link);

extern
int eponStack_CtlEponReInitLink(U8 link);

extern
int eponStack_CtlGetRogueCount(U32* count);
