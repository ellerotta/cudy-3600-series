...
typedef enum {
   ...
   EID_WLNVRAM=17,      /* used by the standalone nvram command line app */
   EID_WLNVRAM_LIB=18,  /* used by libnvram.so, which creates a msgHandle on behalf of the app it links with */
   EID_WLEVENT=19,
   EID_SMD=20,
   EID_SSK=21,
   EID_PPP=22,
   ...
   EID_TFTPD=26,
   EID_TFTP=27,
   EID_DNSPROBE_DELETED=28,
   EID_XMPPC=29,
   EID_SYSLOGD=30,
   EID_KLOGD=31,
   EID_WEBSOCKD=32,
   EID_DDNSD_DELETED=33,
   EID_ZEBRA=34,
   EID_RIPD=35,
   EID_SNTP=36,
   EID_URLFILTERD=37,
   EID_CWMPD_DEPRECATED=38,  /* this app no longer exists, will be removed after 504L04 */
   EID_TRACERT=39,
   EID_PING=40,
   EID_DHCP6C=41,
   EID_DHCP6S=42,
   EID_RADVD=43,
   EID_DNSPROXY_DELETED=44,
   EID_IPPD=45,
   EID_FTP=46,
   EID_DSLDIAGD=48,
   EID_DNSMASQ=49,
   ...
   EID_VECTORINGD=80,
   EID_WLSSK_LINK_MONITOR=88,
   EID_WLSSK=89,
   EID_UNITTEST=90,
   EID_MISC=91,
   EID_WLMNGR_DELETED=92,
   EID_WLWPS=93,
   EID_CMFD=94,
   EID_MCPD_DEPRECATED=95,   /* mcpd still exists, but does not use EID */
   EID_MOCAD_DELETED=96,
   EID_RNGD_DEPRECATED=97,   /* no longer used in 504L02 and beyond. */
   EID_DMSD=98,
   EID_SWMDK_DELETED=100,
   EID_OLT_TEST=101,
   EID_BMUD=103,
   EID_BMUCTL=104,
   EID_MCPCTL_DEPRECATED=107,  /* mcpctl still exists, but does not use EID */
   EID_1905=111,
   EID_I5CTL=112,
   EID_NTPD=113,
   ...
   EID_LOCPOL=164,
   EID_DECTDBGD=199,
   EID_CMSCLI=270,         /* should use EID between 1 and 15, but just share NDA_ACCESS_CONSOLED since cmscli and consoled are similar */
   EID_SEND_CMS_MSG=280,
   EID_WLDATAELD=290,
   EID_WLDATAELD_COLLECT_THREAD=291,
   EID_WLDATAELM_CTL=292,
   EID_BASD=300,
   EID_BAS_CLIENT_RG=301,
   EID_BAS_CLIENT_OPENPLAT=302,
   EID_BAS_CLIENT_XDSL=303,
   EID_BAS_CLIENT_GPON=304,
   EID_BAS_CLIENT_VOICE=305,
   EID_BAS_CLIENT_SGS=306,
   EID_BAS_CLIENT_RDS=307,
   EID_BAS_CLIENT_TR143=308,
   EID_BAS_CLIENT_RDPA=309,
   EID_BAS_CLIENT_TR471=310,
   EID_BAS_CLIENT_WIFI=311,
   EID_BAS_CLIENT_EYE=312,
   EID_BAS_CLIENT_RG_BDK=313,
   EID_BAS_CLIENT_WLDATAELM=314,
   EID_OSGID=500,              /* Begin BCM Modular Software EID range */
   EID_LINMOSD_DELETED=510,        /* linmosd has been deleted */
   EID_MODUPDTV=511,
   EID_PMD_DELETED=512,            /* pmd has been deleted */
   EID_DAD_DELETED=513,            /* dad has been deleted */
   EID_OPENWRTD=514,
   EID_LXC_MONITOR=515,
   EID_DMAD_DELETED=517,   /* dmad has been deleted */
   EID_DOCKERMD=519,
   EID_FIREWALLD=520,
   EID_ALEXA=521,
   EID_FFV=522, 
   ...
   EID_UPLOAD_DIAG=541,
   EID_UDPECHO=542,
   EID_TMSCTL_DEPRECATED=543,  /* tmsctl still exists, but does not use EID */
   EID_SPEEDSVC=544,
   EID_WANCONF=546,
   EID_TMCTL_UTETS=547,
   EID_BDMF_UTETS=548,
   ...
   EID_UDPECHO_DIAG=554,
   EID_SERVERSELECTION_DIAG=555,
   EID_DIAG_RESERVED_END=559,  /* End Diag reserved range            */
   EID_BCM_MSGD=1000,          /* BCM message router (in BDK) */
   EID_DEVINFO_MD=1001,
   EID_DSL_MD=1002,
   EID_GPON_MD=1003,
   EID_EPON_MD=1004,
   ...
   EID_VOICE_MD=1006,
   EID_STORAGE_MD=1007,
   EID_OPENPLAT_MD=1008,
   EID_OPENPLAT_HELPER=1009,
   EID_SYSMGMT_MD=1010,
   EID_SYS_DIRECTORY=1011,
   EID_SYSDIR_NOTIFIER=1012,
   EID_SYSDIRCLI=1013,
   EID_OPENPLAT_OOM=1014,
   EID_TR69_MD=1015,
   EID_USP_MD=1016,
   EID_OBUSPA=1017,
   EID_TR69_PROXY=1018,
   EID_USP_PROXY=1019,
   EID_AUDIO_MD=1020,
   EID_DEVINFO_HAL_THREAD=1021,
   EID_DSL_HAL_THREAD=1022,
   EID_GPON_HAL_THREAD=1023,
   EID_EPON_HAL_THREAD=1024,
   EID_WIFI_HAL_THREAD=1025,
   EID_VOICE_HAL_THREAD=1026,
   EID_STORAGE_HAL_THREAD=1027,
   EID_DEVINFO_HAL_TMP_CONN=1031,
   EID_DSL_HAL_TMP_CONN=1032,
   EID_GPON_HAL_TMP_CONN=1033,
   EID_EPON_HAL_TMP_CONN=1034,
   EID_WIFI_HAL_TMP_CONN=1035,
   EID_VOICE_HAL_TMP_CONN=1036,
   EID_STORAGE_HAL_TMP_CONN=1037,
   EID_SYSMGMT_NB_BUS_SVR=1040,   /* non-blocking bus server in sysmgmt */
   EID_DIAG_MD=1048,
   EID_DIAG_SSK=1049,
   EID_DSL_SSK=1050,
   EID_MDM_CLI=1051,
   EID_REMOTE_OBJD=1052,
   EID_APIBDK_SD=1053,
   EID_WRTSYSMGMT=1055,
   EID_MHD_GPON=1071,
   EID_MODSWD=1080,
   EID_JSON_HAL_SERVER_DSL=1082,   /* DO NOT CHANGE: hardcoded in json_hal_server_dsl.c */
   EID_JSON_HAL_SERVER_GPON=1083,  /* DO NOT CHANGE: hardcoded in json_hal_server_gpon.c */
   EID_JSON_HAL_SERVER_VOICE=1086, /* DO NOT CHANGE: hardcoded in json_hal_server_voice.c */
   EID_OBUSPA_UPLOAD_THREAD=1101,
   EID_OBUSPA_DOWNLOAD_THREAD=1102,
   EID_OBUSPA_ACTIVATE_THREAD=1103,
   EID_OBUDPST=1121,
   EID_BCM_BDK_END_RESERVED_RANGE=1499,
...
/** Param accessible by md components of BDK; Used in MdmNodeAttributes.accessBitMask. */
#define NDA_ACCESS_BDK_MD             0x0100
...
#define NDA_ACCESS_SUBSCRIBER  (NDA_ACCESS_TR64C        |                         \
                                ...
                                NDA_ACCESS_BDK_MD   | NDA_ACCESS_AVAILABLE10 | \
...
/** Entity can have multiple instances */
#define EIF_MULTIPLE_INSTANCES        0x80

/** Entity can have multiple threads */
#define EIF_MULTIPLE_THREADS      0x100000

/** Starting in 504L04P2, CMS and BDK will treat multiple instance and
 *  multiple thread entities the same.  Specifically, if the entity can have
 *  multiple instances or threads, the EID will contain the thread id in the
 *  upper 16 bits and the generic eid (CmsEntityId enum) in the lower 16 bits.
 *  However, if the entity is a single instance and single threaded app (which
 *  is the most common case), then the EID will just be the generic entity id
 *  in the lower 16 bits).
 */
#define EIF_MULTIPLE_INSTANCES_OR_THREADS (EIF_MULTIPLE_INSTANCES|EIF_MULTIPLE_THREADS)
...
// #define EIF_MULTIPLE_THREADS     0x100000 << in use, see above

#define EIF_NEW_AUTO_CREATE         0x200000
...
typedef struct
{
   ...
   CmsEntityId eid;    /**< The generic entity id for this entry. */
...
/** Mask to get the thread id out of a UINT32 eid field */
/** EID_PID_MASK is deprecated, use EID_THREAD_ID_MASK instead */
#define EID_PID_MASK        0xffff0000
#define EID_THREAD_ID_MASK  0xffff0000

/** Get the generic eid out of a UINT32 eid field */
#define GENERIC_EID(e) (((UINT32) e) & EID_EID_MASK)

/** Get the thread id  out of a UINT32 eid field */
/** PID_IN_EID is deprecated, use THREAD_ID_IN_EID instead.  We always put
 *  a thread id (not pid) in the top 16 bits of a specific EID. */
#define PID_IN_EID(e)       ((((UINT32) e) & EID_PID_MASK) >> 16)
#define THREAD_ID_IN_EID(e) ((((UINT32) e) & EID_THREAD_ID_MASK) >> 16)

/** Make a specific UINT32 eid field out of a thread id and a generic eid */
