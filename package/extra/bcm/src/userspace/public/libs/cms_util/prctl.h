...
/** A simplified version of prctl_spawnProcess.
 *
 * Internally, it fills out the complicated spawnInfo struct for the caller
 * and calls prctl_spawnProcess.  This function will launch the app in the
 * "SPAWN_AND_RETURN" mode.
 */
extern CmsRet prctl_launchApp(const char *prefix, const char *exe, const char *args, int *pid);
 ...
 * to another file, as in iptables -w -L > /tmp/iptables_out.
 * 
