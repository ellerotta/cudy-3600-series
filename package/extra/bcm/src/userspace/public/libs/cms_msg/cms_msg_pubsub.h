...
typedef struct
{
  ...
  char bridgeType[16];     /**< Empty string means the interface isn't a bridge. Otherwise the value can be either "Linux" or "Ovs". */
  SINT32 bridgeIndex;  /** <For bridge interface, its index number in MDM. */
  ...
  SINT32 wlBrIndex;  /**<  for wifi to request to be put under this bridge */
...
#define PUBSUB_KEY_UDPECHO_DIAG_COMPLETE    "UDPECHO_DIAG_COMPLETE"
#define PUBSUB_KEY_SPDSVC_DIAG_EVENT        "SPDSVC_DIAG_EVENT"
#define PUBSUB_KEY_SPDSVC_DIAG_COMPLETE     "SPDSVC_DIAG_COMPLETE"
#define PUBSUB_KEY_OBUDPST_DIAG_COMPLETE    "OBUDPST_DIAG_COMPLETE"
#define PUBSUB_KEY_ETHCABLE_DIAG_COMPLETE   "ETHCABLE_DIAG_COMPLETE"

#define PUBSUB_KEY_SERVERSELECTION_DIAG_COMPLETE   "SERVERSELECTION_DIAG_COMPLETE"


#define PUBSUB_INTF_TAG_DEFAULT_LAN         "Default_LAN"
#define PUBSUB_INTF_TAG_DEFAULT_WAN         "Default_WAN"

#define PUBSUB_KEY_CERTIFICATE_CHANGE       "CERTIFICATE_CHANGE"
