...
typedef struct
{
   CmsEntityId  eid;        /**< Entity id of the owner of this handle.
                             *   Note for apps that are EIF_MULTIPLE_INSTANCES
                             *   or EIF_MULTIPLE_THREADS, this field contains
                             *   the generic EID plus the thread id.  See
                             *   cms_eid.h and oal_msg.c for details. */
   ...
   char busName[BCM_MSG_BUS_NAME_LENGTH]; /**< Name of the message bus */
} CmsMsgHandle;
 ...
 *
 * @param msgBusName (IN) SMD_MESSAGE_ADDR or *_MSG_BUS defined in bdk_params.h
 * @param backlog    (IN) *_MESSAGE_BACKLOG defined in *_params.h
 *
