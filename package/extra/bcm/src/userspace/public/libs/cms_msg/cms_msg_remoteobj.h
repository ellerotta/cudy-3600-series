...
typedef struct
{
    char genericPath[MDM_SINGLE_FULLPATH_BUFLEN];
    UBOOL8 isMultiCompGetNext;
...
typedef struct
{
    char nextFullpath[MDM_SINGLE_FULLPATH_BUFLEN];
    SINT32 numEntries;
    UINT32 size;
...
typedef struct
{
    UINT32 flags;
    char fullpath[MDM_SINGLE_FULLPATH_BUFLEN];
} RemoteObjClearStatisticsRequest;
...
typedef struct
{
    char ancestorGenericPath[MDM_SINGLE_FULLPATH_BUFLEN];
    char decendentGenericPath[MDM_SINGLE_FULLPATH_BUFLEN];
    InstanceIdStack iidStack;
    UINT32 flags;
