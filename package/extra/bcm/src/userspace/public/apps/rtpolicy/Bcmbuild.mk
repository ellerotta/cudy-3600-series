...
SCRIPTS := scripts/rtpolicy scripts/rtpolicy_bg
...
export RT_SETTINGS_FILES_INSTALL_DIR BUILD_DIR KERNEL_DIR
...
ifneq ($(strip $(SKIP_RTPOLICY)),)
all install:
	@echo "skipping rtpolicy install"
	echo "#!/bin/sh" > $(INSTALL_DIR)/bin/rtpolicy_bg
	echo "true" >> $(INSTALL_DIR)/bin/rtpolicy_bg
	chmod +x $(INSTALL_DIR)/bin/rtpolicy_bg
gen_metadata:
	@echo "skipping rtpolicy metadata"
else
all install: $(SCRIPTS)
