...
ifeq ($(strip $(BUILD_EPON_SDK)),)
ifeq ($(strip $(BUILD_GPON)),)
CFLAGS += -DSUPPORT_DEFAULT_GBE
endif
endif

export ARCH CFLAGS BCM_LD_FLAGS CMS_LIB_PATH CMS_OPTION_RPATH CMS_LIB_RPATH EXE_INSTALL_DIR
export RELEASE_BUILD BRCM_PON_WAN_TYPE_AUTO_DETECT BUILD_PMD
export LINUX_VER_STR BUILD_BRCM_CMS BUILD_BRCM_BDK BUILD_DBUS BUILD_UBUS BCM_COND_HAVE_UBUS BUILD_BDK_SYSTEM_MANAGEMENT
