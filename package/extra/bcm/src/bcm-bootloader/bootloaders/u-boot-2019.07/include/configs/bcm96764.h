...
/* RAM */
#define PHYS_SDRAM_1			0x00000000ULL
...
#define CONFIG_SYS_SEC_CRED_ADDR        (CONFIG_SYS_INIT_STD_32K_ADDR + 0x77D0)
/* U-Boot */
...
/* SPL code, data, bss   0x90200000 - 0x90250000 */
/* SPL page table        0x90250000 - 0x90260000 */
/* SPL DDR std, dpfe     0x90260000 - 0x90280000 */
/* SPL GD, stack, heap   0x90280000 - 0x90290000 */
#define CONFIG_SYS_INIT_RAM_ADDR	CONFIG_SPL_TEXT_BASE
#define CONFIG_SYS_INIT_RAM_SIZE	0x00090000
#define CONFIG_SYS_INIT_SP_OFFSET \
	(CONFIG_SYS_INIT_RAM_SIZE - GENERATED_GBL_DATA_SIZE)
#define CONFIG_SYS_INIT_SP_ADDR \
	(CONFIG_SYS_INIT_RAM_ADDR + CONFIG_SYS_INIT_SP_OFFSET)
#define CONFIG_SYS_PAGETBL_BASE		CONFIG_SYS_INIT_RAM_ADDR+0x0050000
#ifdef CONFIG_ARMV7_LPAE
#define CONFIG_SYS_PAGETBL_SIZE		0x00005000
#else
#define CONFIG_SYS_PAGETBL_SIZE		0x00004000
#endif
...
#define CONFIG_SPL_UBI_VOL_IDS		9
