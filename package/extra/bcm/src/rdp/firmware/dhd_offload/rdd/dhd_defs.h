...
#define DHD_RX_POST_BUFFER_SIZE                     2048
#define DHD_RX_POST_FLOW_RING_SIZE                  16
#define DHD_TX_COMPLETE_FLOW_RING_SIZE              16
#define DHD_RX_COMPLETE_FLOW_RING_SIZE              16

#else

#if defined(CONFIG_CPU_RX_FROM_XPM)
/*Assuming MTU from Wifi is limited to 2KB and therefore 4KB is sufficient for 2KB + headroom + tailroom*/
#define DHD_RX_POST_BUFFER_SIZE                     4096
#else
#define DHD_RX_POST_BUFFER_SIZE                     2048
#endif
...
#define DHD_IDMA_NUM_OF_GROUPS                      16
...
#define DHD_RX_POST_VALID_REQ_ID_OFFSET             18 /* max FPM number width for any XRDP project */
...
#else
#define DHD_RADIO_OFFSET_COMMON_A(index)            (DHD_RADIO_INSTANCE_COMMON_A_DATA_ADDRESS + (index * sizeof(DHD_RADIO_INSTANCE_COMMON_A_ENTRY_STRUCT)))
#define DHD_RADIO_OFFSET_COMMON_B(index)            (DHD_RADIO_INSTANCE_COMMON_B_DATA_ADDRESS + (index * sizeof(DHD_RADIO_INSTANCE_COMMON_B_ENTRY_STRUCT)))
#endif
...
#else
#define DHD_FPM_SIZE_OFFSET                         17
#define DHD_FPM_SIZE_WIDTH                          3
#endif
...
/* RCH defines */
#define RCH_HEADER_SIZE                 8
#define RCH_SDU_SIZE                    8
#define RCH_SDU_SIZE_POWER              3
#define RCH_HEADER_OFFSET               (RCH_HEADER_SIZE + RCH_SDU_SIZE*4)
#define RCH_MAX_SUPPORTED_SEG           8
#define RCH_MAX_HEADER_SIZE             (RCH_HEADER_SIZE + (RCH_SDU_SIZE*RCH_MAX_SUPPORTED_SEG))
#define HWA_RXCPLE_FLAGS_RCH            0x04
#define HWA_RXCPLE_FLAGS_RCH_BIT        31
