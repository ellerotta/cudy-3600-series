...
{
    WLAN_MCAST_DHD_LIST_TABLE_STRUCT *dhd_list_table = wlan_mcast_dhd_list_table_g.virt_p;
    ...
    {
        WLAN_MCAST_DHD_LIST_ENTRY_STRUCT *dhd_list_entry_ptr = (WLAN_MCAST_DHD_LIST_ENTRY_STRUCT *)
    ...
    WLAN_MCAST_DHD_LIST_ENTRY_STRUCT *dhd_list_entry, uint32_t *dhd_list_size)
{
    ...
    for (i = 0; i < RDD_WLAN_MCAST_DHD_LIST_ENTRY_ARRAY_DHD_STATION_NUMBER; ++i)
    {
        ...
        {
            __debug("DHD List DELETE: entry %px (%u) -> value %u\n", dhd_list_entry_ptr, i, dhd_list_entry->index);
    ...
    WLAN_MCAST_DHD_LIST_ENTRY_STRUCT *dhd_list_entry)
{
    ...
    for (i = 0; i < RDD_WLAN_MCAST_DHD_LIST_ENTRY_ARRAY_DHD_STATION_NUMBER; ++i)
    {
        ...
        {
            __debug("DHD List FIND: entry %px (%u) -> value %u\n", dhd_list_entry_ptr, i, dhd_list_entry->index);
