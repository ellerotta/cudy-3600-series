...
typedef struct {
    uint32_t prealloc_fpm_tokens; /* number of host preallocated tokens */
...
int rdd_dhd_helper_codel_enable_set(uint32_t radio_idx, uint8_t codel_enable);
int rdd_dhd_helper_codel_enable_get(uint32_t radio_idx, uint8_t *codel_enable);
