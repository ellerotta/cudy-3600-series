...
void dump_RDD_G9991_SCHEDULING_INFO_ENTRY(bdmf_session_handle session, unsigned char *p)
{
	unsigned int r;
	bdmf_session_print(session, "  Register G9991_SCHEDULING_INFO_ENTRY\n");

	MREAD_32((uint8_t *)(p), (r));
	bdmf_session_print(session, "\tcontrol_sid              = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_32((uint8_t *)(p) + 4, (r));
	bdmf_session_print(session, "\tphysical_port_mapping    = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	MREAD_16((uint8_t *)(p) + 10, (r));
	bdmf_session_print(session, "\tdrr_counter_address      = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
void dump_RDD_G9991_EMAC_TO_BB_QUEUE_ENTRY(bdmf_session_handle session, unsigned char *p)
{
	unsigned int r;
	bdmf_session_print(session, "  Register G9991_EMAC_TO_BB_QUEUE_ENTRY\n");

	MREAD_8((uint8_t *)(p), (r));
	bdmf_session_print(session, "\tbb_queue                 = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
void dump_RDD_G9991_EMAC_TO_BB_ID_ENTRY(bdmf_session_handle session, unsigned char *p)
{
	unsigned int r;
	bdmf_session_print(session, "  Register G9991_EMAC_TO_BB_ID_ENTRY\n");

	MREAD_8((uint8_t *)(p), (r));
	bdmf_session_print(session, "\tbb_id                    = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
void dump_RDD_G9991_VPORT_TO_BB_ID_ENTRY(bdmf_session_handle session, unsigned char *p)
{
	unsigned int r;
	bdmf_session_print(session, "  Register G9991_VPORT_TO_BB_ID_ENTRY\n");
