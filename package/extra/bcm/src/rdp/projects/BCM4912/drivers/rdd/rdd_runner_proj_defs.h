...
#define DS_TM_BBH_QUEUE_TABLE_SIZE                          RDD_IMAGE_6_DS_TM_BBH_QUEUE_TABLE_SIZE
...
#define DS_TM_BUDGET_ALLOCATION_THREAD_NUMBER               IMAGE_6_IMAGE_6_GENERAL_TIMER_THREAD_NUMBER
#define TM_BUDGET_ALLOCATION_US_THREAD_NUMBER               IMAGE_5_IMAGE_5_BUDGET_ALLOCATION_THREAD_NUMBER

#define RDD_DS_TM_FLOW_CNTR_TABLE_SIZE                      RDD_IMAGE_6_DS_TM_TM_FLOW_CNTR_TABLE_SIZE

#define DS_TM_UPDATE_FIFO_THREAD_NUMBER  IMAGE_6_IMAGE_6_UPDATE_FIFO_THREAD_NUMBER
#define US_TM_UPDATE_FIFO_THREAD_NUMBER  IMAGE_5_IMAGE_5_UPDATE_FIFO_THREAD_NUMBER

#define DS_TM_BUDGET_ALLOCATION_DS_THREAD_NUMBER  IMAGE_6_IMAGE_6_BUDGET_ALLOCATION_DS_THREAD_NUMBER
#define US_TM_BUDGET_ALLOCATION_US_THREAD_NUMBER  IMAGE_5_IMAGE_5_BUDGET_ALLOCATION_US_THREAD_NUMBER
#define DS_TM_FLUSH_THREAD_NUMBER                 IMAGE_6_IMAGE_6_DS_FLUSH_THREAD_NUMBER
#define US_TM_FLUSH_THREAD_NUMBER                 IMAGE_5_IMAGE_5_US_FLUSH_THREAD_NUMBER
#define US_TM_OVL_BUDGET_ALLOCATION_US_THREAD_NUMBER  IMAGE_5_IMAGE_5_OVL_BUDGET_ALLOCATION_US_THREAD_NUMBER
...
#define US_TM_BUFFER_CONG_MGT_THREAD_NUMBER         IMAGE_5_IMAGE_5_BUFFER_CONG_MGT_THREAD_NUMBER
#define DS_TM_BUFFER_CONG_MGT_THREAD_NUMBER         IMAGE_6_IMAGE_6_BUFFER_CONG_MGT_THREAD_NUMBER

/* WAN port on US_TM */
#define RDD_IMAGE_WAN_VPORT_TX_FLOW_TABLE_SIZE      RDD_IMAGE_5_VPORT_TX_FLOW_TABLE_SIZE

#define TM_INDEX_DSL_OR_PON              0 /* N/A */
...
#define SPDSVC_GEN_THREAD_NUMBER                    IMAGE_6_IMAGE_6_SPDSVC_GEN_THREAD_NUMBER
#define TCPSPDTEST_GEN_THREAD_NUMBER                IMAGE_6_IMAGE_6_TCPSPDTEST_GEN_THREAD_NUMBER
#define TCPSPDTEST_THREAD_NUMBER                    IMAGE_6_IMAGE_6_TCPSPDTEST_THREAD_NUMBER
...
#define CPU_TX_MCORE_THREAD_NUMBER                  IMAGE_4_IMAGE_4_CPU_TX_MCORE_THREAD_NUMBER
#define CPU_TX_MCORE_TIMER_TASK                     IMAGE_4_IMAGE_4_GENERAL_TIMER_THREAD_NUMBER
...
/* flush */
#define RDD_DS_TM_FLUSH_CFG_FW_TABLE_ADDRESS                IMAGE_6_DS_TM_FLUSH_CFG_FW_TABLE_ADDRESS
#define RDD_DS_TM_FLUSH_CFG_ENABLE_TABLE_ADDRESS            IMAGE_6_DS_TM_FLUSH_CFG_ENABLE_TABLE_ADDRESS
...
#define RDD_SERVICE_QUEUES_FLUSH_CFG_FW_TABLE_ADDRESS       IMAGE_1_SERVICE_QUEUES_FLUSH_CFG_FW_TABLE_ADDRESS
#define RDD_SERVICE_QUEUES_FLUSH_CFG_ENABLE_TABLE_ADDRESS   IMAGE_1_SERVICE_QUEUES_FLUSH_CF

#define BBH_ID_PON  BBH_ID_NULL

#define SPU_RESPONSE_THREAD_NUMBER IMAGE_0_IMAGE_0_SPU_RESPONSE_THREAD_NUMBER
