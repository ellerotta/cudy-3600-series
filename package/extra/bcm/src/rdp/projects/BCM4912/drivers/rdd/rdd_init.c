...
static void image_0_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    /* SPU response thread */
    local_regs[IMAGE_0_IMAGE_0_SPU_RESPONSE_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_0, c_spu_response_wakeup_request);
    local_regs[IMAGE_0_IMAGE_0_SPU_RESPONSE_THREAD_NUMBER][reg_id[30]] = IMAGE_0_SPU_RESPONSE_STACK_ADDRESS+IMAGE_0_SPU_RESPONSE_STACK_BYTE_SIZE;
#endif

    /* FPM_RINGS AND BUFMNG REFILL 5 */
#if defined(CONFIG_CPU_TX_FROM_XPM)
    local_regs[IMAGE_0_IMAGE_0_CPU_FPM_RINGS_REFILL_AND_BUFMNG_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_0, c_cpu_fpm_rings_and_bufmng_refill_wakeup_request);
    local_regs[IMAGE_0_IMAGE_0_CPU_FPM_RINGS_REFILL_AND_BUFMNG_THREAD_NUMBER][reg_id[8]] = IMAGE_0_IMAGE_0_CPU_FPM_RINGS_REFILL_AND_BUFMNG_THREAD_NUMBER;
    local_regs[IMAGE_0_IMAGE_0_CPU_FPM_RINGS_REFILL_AND_BUFMNG_THREAD_NUMBER][reg_id[30]] =
        IMAGE_0_CPU_FPM_RINGS_REFILL_AND_BUFMNG_STACK_ADDRESS + IMAGE_0_CPU_FPM_RINGS_REFILL_AND_BUFMNG_STACK_BYTE_SIZE;
#endif
...
static void image_1_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    local_regs[IMAGE_1_IMAGE_1_SERVICE_QUEUES_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_1, sq_tx_task_wakeup_request);
    local_regs[IMAGE_1_IMAGE_1_SERVICE_QUEUES_THREAD_NUMBER][reg_id[8]] = IMAGE_1_SQ_TM_PD_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_1_IMAGE_1_SERVICE_QUEUES_THREAD_NUMBER][reg_id[9]] = IMAGE_1_SQ_TM_UPDATE_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_1_IMAGE_1_SERVICE_QUEUES_THREAD_NUMBER][reg_id[30]] = IMAGE_1_SERVICE_QUEUES_STACK_ADDRESS + C_DEFS_SQ_TX_TASK_STACK_SIZE;
...
static void image_4_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    /* CPU_RECYCLE */
    local_regs[IMAGE_4_IMAGE_4_CPU_RECYCLE_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_4, c_cpu_recycle_wakeup_request);
    local_regs[IMAGE_4_IMAGE_4_CPU_RECYCLE_THREAD_NUMBER][reg_id[30]] = IMAGE_4_CPU_RECYCLE_STACK_ADDRESS+IMAGE_4_CPU_RECYCLE_STACK_BYTE_SIZE;

    /* CPU Tx Boost threads */
    local_regs[IMAGE_4_IMAGE_4_CPU_TX_MCORE_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_4, c_cpu_tx_mcore_wakeup_request);
    local_regs[IMAGE_4_IMAGE_4_CPU_TX_MCORE_THREAD_NUMBER][reg_id[8]] = IMAGE_4_IMAGE_4_CPU_TX_MCORE_THREAD_NUMBER;
    local_regs[IMAGE_4_IMAGE_4_CPU_TX_MCORE_THREAD_NUMBER][reg_id[30]] = IMAGE_4_CPU_TX_MCORE_STACK_ADDRESS+IMAGE_4_CPU_TX_MCORE_STACK_BYTE_SIZE;
#endif
...
static void image_5_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    local_regs[IMAGE_5_IMAGE_5_UPDATE_FIFO_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_5, tm_update_fifo_first_wakeup_request);
    local_regs[IMAGE_5_IMAGE_5_UPDATE_FIFO_THREAD_NUMBER][reg_id[8]] = IMAGE_5_UPDATE_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_5_IMAGE_5_UPDATE_FIFO_THREAD_NUMBER][reg_id[30]] = IMAGE_5_UPDATE_FIFO_STACK_ADDRESS + C_DEFS_UPDATE_FIFO_STACK_SIZE;

    /* SCHEDULING LAN */
    local_regs[IMAGE_5_IMAGE_5_TX_TASK_US_0_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_5, tm_tx_task_wakeup_request);
    local_regs[IMAGE_5_IMAGE_5_TX_TASK_US_0_THREAD_NUMBER][reg_id[8]] = 0;
    local_regs[IMAGE_5_IMAGE_5_TX_TASK_US_0_THREAD_NUMBER][reg_id[9]] = IMAGE_5_IMAGE_5_TX_TASK_US_0_THREAD_NUMBER;
    local_regs[IMAGE_5_IMAGE_5_TX_TASK_US_0_THREAD_NUMBER][reg_id[30]] = IMAGE_5_TX_TASK_US_0_STACK_ADDRESS + C_DEFS_TX_TASK_STACK_SIZE;

    /* SCHEDULING LAN1 */
    local_regs[IMAGE_5_IMAGE_5_TX_TASK_US_1_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_5, tm_tx_task_wakeup_request);
    local_regs[IMAGE_5_IMAGE_5_TX_TASK_US_1_THREAD_NUMBER][reg_id[8]] = 1;  /* BBH_TX_ID = 1 */
    local_regs[IMAGE_5_IMAGE_5_TX_TASK_US_1_THREAD_NUMBER][reg_id[9]] = IMAGE_5_IMAGE_5_TX_TASK_US_1_THREAD_NUMBER;
    local_regs[IMAGE_5_IMAGE_5_TX_TASK_US_1_THREAD_NUMBER][reg_id[30]] = IMAGE_5_TX_TASK_US_1_STACK_ADDRESS + C_DEFS_TX_TASK_STACK_SIZE;

#ifdef BUFFER_CONGESTION_MGT
    /* BUFFER_CONG_MGT: thread 3 */
    local_regs[IMAGE_5_IMAGE_5_BUFFER_CONG_MGT_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_5, buffer_cong_mgt_1st_wakeup_request);
#endif
...
static void image_6_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    uint32_t mem_cntxt_byte_num;
    uint32_t *sram_context;
    /* uint16_t pi2_probability_calc_descriptor_address; */
    ...
    local_regs[IMAGE_6_IMAGE_6_COMMON_REPROCESSING_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, c_common_reprocessing_wakeup_request);
    local_regs[IMAGE_6_IMAGE_6_COMMON_REPROCESSING_THREAD_NUMBER][reg_id[30]] = IMAGE_6_COMMON_REPROCESSING_STACK_ADDRESS+IMAGE_6_COMMON_REPROCESSING_STACK_BYTE_SIZE;

#if defined(CONFIG_BCM_SPDSVC_SUPPORT)
    /* SPDSVC_GEN - UDP Speed test generator (iperf3 / udp_spdt) */
    local_regs[IMAGE_6_IMAGE_6_SPDSVC_GEN_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, c_spdsvc_gen_wakeup_request);
    local_regs[IMAGE_6_IMAGE_6_SPDSVC_GEN_THREAD_NUMBER][reg_id[30]] = IMAGE_6_SPDSVC_GEN_STACK_ADDRESS+IMAGE_6_SPDSVC_GEN_STACK_BYTE_SIZE;

    /* TcpSpdTest + pktgen_tx */
    local_regs[IMAGE_6_IMAGE_6_TCPSPDTEST_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, tcpspdtest_wakeup_request);
    local_regs[IMAGE_6_IMAGE_6_TCPSPDTEST_THREAD_NUMBER][reg_id[14]] = IMAGE_6_TCPSPDTEST_SCRATCHPAD_ADDRESS;
    local_regs[IMAGE_6_IMAGE_6_TCPSPDTEST_THREAD_NUMBER][reg_id[13]] = IMAGE_6_TCPSPDTEST_UPDATE_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_6_IMAGE_6_TCPSPDTEST_THREAD_NUMBER][reg_id[12]] = (IMAGE_6_TCPSPDTEST_PD_FIFO_TABLE_ADDRESS) | (IMAGE_6_TCPSPDTEST_DISPATCHER_CREDIT_TABLE_ADDRESS << 16);

    /* TCP SPEED GEN task */
    local_regs[IMAGE_6_IMAGE_6_TCPSPDTEST_GEN_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, tcpspdtest_gen_wakeup_request);
    local_regs[IMAGE_6_IMAGE_6_TCPSPDTEST_GEN_THREAD_NUMBER][reg_id[9]] = ((BB_ID_DISPATCHER_REORDER + (DISP_REOR_VIQ_TCPSPDTEST_GEN << 6)) << 16);
    local_regs[IMAGE_6_IMAGE_6_TCPSPDTEST_GEN_THREAD_NUMBER][reg_id[12]] = (IMAGE_6_TCPSPDTEST_GEN_DISPATCHER_CREDIT_TABLE_ADDRESS << 16);
#endif
    ...
    /* SCHEDULING LAN */
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_DS_0_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, tm_tx_task_wakeup_request);
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_DS_0_THREAD_NUMBER][reg_id[8]] = 0;
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_DS_0_THREAD_NUMBER][reg_id[9]] = IMAGE_6_IMAGE_6_TX_TASK_DS_0_THREAD_NUMBER;
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_DS_0_THREAD_NUMBER][reg_id[30]] = IMAGE_6_TX_TASK_DS_0_STACK_ADDRESS + C_DEFS_TX_TASK_STACK_SIZE;

    /* SCHEDULING LAN1 */
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_DS_1_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, tm_tx_task_wakeup_request);
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_DS_1_THREAD_NUMBER][reg_id[8]] = 1;  /* BBH_TX_ID = 1 */
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_DS_1_THREAD_NUMBER][reg_id[9]] = IMAGE_6_IMAGE_6_TX_TASK_DS_1_THREAD_NUMBER;
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_DS_1_THREAD_NUMBER][reg_id[30]] = IMAGE_6_TX_TASK_DS_1_STACK_ADDRESS + C_DEFS_TX_TASK_STACK_SIZE;
...
int rdd_data_structures_init(rdd_init_params_t *init_params, HW_IPTV_CONFIGURATION_STRUCT *iptv_hw_config)
{
    ...
    ag_drv_rnr_regs_cfg_cpu_wakeup_set(get_runner_idx(us_tm_runner_image), IMAGE_5_IMAGE_5_GENERAL_TIMER_THREAD_NUMBER);
    ag_drv_rnr_regs_cfg_cpu_wakeup_set(get_runner_idx(ds_tm_runner_image), IMAGE_6_IMAGE_6_GENERAL_TIMER_THREAD_NUMBER);
    ag_drv_rnr_regs_cfg_cpu_wakeup_set(get_runner_idx(service_queues_runner_image), IMAGE_1_IMAGE_1_GENERAL_TIMER_THREAD_NUMBER);
