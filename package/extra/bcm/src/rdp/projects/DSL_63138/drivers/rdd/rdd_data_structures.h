...
#define RDD_CPU_RX_DESCRIPTOR_SKB_INDEX_READ( r, p )            RDP_FIELD_MREAD_32( ( (uint8_t *)p + 4),  0,  8, r )
#define RDD_CPU_RX_DESCRIPTOR_REASON_L_READ( p )                RDP_FIELD_GET( *( (uint32_t *)p + 0), 25,  6 )
#define RDD_CPU_RX_DESCRIPTOR_PAYLOAD_OFFSET_FLAG_L_READ( p )   RDP_FIELD_GET( *( (uint32_t *)p + 0), 22,  1 )
#define RDD_CPU_RX_DESCRIPTOR_FLOW_ID_L_READ( p )               RDP_FIELD_GET( *( (uint32_t *)p + 0), 14,  8 )
#define RDD_CPU_RX_DESCRIPTOR_PACKET_LENGTH_L_READ( p )         RDP_FIELD_GET( *( (uint32_t *)p + 0),  0, 14 )
#define RDD_CPU_RX_DESCRIPTOR_SRC_PORT_L_READ( p )              RDP_FIELD_GET( *( (uint32_t *)p + 1), 28,  4 )
#define RDD_CPU_RX_DESCRIPTOR_NEXT_PTR_L_READ( p )              RDP_FIELD_GET( *( (uint32_t *)p + 1), 15, 13 )
#define RDD_CPU_RX_DESCRIPTOR_ABS_FLAG_L_READ( p )              RDP_FIELD_GET( *( (uint32_t *)p + 1), 14,  1 )
#if defined(DSL_63138)
#define RDD_CPU_RX_DESCRIPTOR_BUFFER_NUMBER_L_READ( p )         RDP_FIELD_GET( *( (uint32_t *)p + 1),  0, 15 )
#else
#define RDD_CPU_RX_DESCRIPTOR_BUFFER_NUMBER_L_READ( p )         RDP_FIELD_GET( *( (uint32_t *)p + 1),  0, 14 )
#endif
#define RDD_CPU_RX_DESCRIPTOR_SKB_INDEX_L_READ( p )             RDP_FIELD_GET( *( (uint32_t *)p + 1),  0,  8 )


#define RDD_CPU_TX_DESCRIPTOR_CONTEXT_INDEX_WRITE( v, p )      RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 0), 0, 15, v )
#define RDD_CPU_TX_DESCRIPTOR_COUNTER_WRITE( v, p )            RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 0), 0,  5, v )
#define RDD_CPU_TX_DESCRIPTOR_IPTV_MAC_IDX_WRITE( v, p )       RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 0), 0, 11, v )
#define RDD_CPU_TX_DESCRIPTOR_COUNTER_4_BYTES_WRITE( v, p )    RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 0), 5,  1, v )
#define RDD_CPU_TX_DESCRIPTOR_SRC_BRIDGE_PORT_WRITE( v, p )    RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 0), 14, 5, v )
#define RDD_CPU_TX_DESCRIPTOR_QUEUE_WRITE( v, p )              RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 0), 19, 3, v )
#define RDD_CPU_TX_DESCRIPTOR_GROUP_WRITE( v, p )              RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 0), 19, 7, v )
#define RDD_CPU_TX_DESCRIPTOR_FLOW_WRITE( v, p )               RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 0), 19, 9, v )
#define RDD_CPU_TX_DESCRIPTOR_EMAC_WRITE( v, p )               RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 0), 22, 4, v )
#define RDD_CPU_TX_DESCRIPTOR_INTERRUPT_NUMBER_WRITE( v, p )   RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 0), 22, 4, v )
#define RDD_CPU_TX_DESCRIPTOR_TCONT_INDEX_WRITE( v, p )        RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 4), 22, 6, v )
#define RDD_CPU_TX_DESCRIPTOR_TX_QUEUE_PTR_WRITE( v, p )       RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 4), 23, 9, v )
#define RDD_CPU_TX_DESCRIPTOR_MESSAGE_PARAMETER_WRITE( v, p )  RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 4), 23, 5, v )
...
typedef struct {
    ...
    uint8_t lookup_port; /**< ingress vport */
...
typedef struct
{
    ...
    rdd_l2_flow_key_t            l2_lookup_entry;
...
typedef struct {
    ...
    uint8_t lookup_port; /**< lookup port */
} rdd_mcast_flow_key_t;
...
#define RDD_FC_MCAST_FLOW_CONTEXT_ENTRY_NUM_PORTS_PORT_MASK_WRITE( v, p ) RDP_FIELD_MWRITE_16((uint8_t *)p + 8, 0, 12, v )
