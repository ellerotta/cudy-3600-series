...
#define DIRECT_FLOW_THREAD_NUMBER                                    7
#endif
...
#define DIRECT_FLOW_THREAD_WAKEUP_REQUEST_VALUE                          THREAD_WAKEUP_REQUEST(DIRECT_FLOW_THREAD_NUMBER)
...
/* For CPU RX Interrupt Coalescing, we need:
 *     64 32bit counters. 4 counters per 16 CPU RXQs --> 4 Runner counter group: 28
 */
#define CPU_RX_INTERRUPT_COALESCING_GROUP                       28
...
#define FCMC_PROCESSING_MULTICAST_PKT       16
#define FCMC_PROCESSING_ENET_MULTICAST_PKT  17
#define FCMC_PROCESSING_MASTER_FLOW         18
#define NUMBER_OF_FCMC_PROCESSING_FLAGS     3
...
#define DEBUG_COUNTER_INC( _addr ) \
DECLARE_FULL_REG_VAR ( _debug_counter ) ;\
    nop ;\
    ldc32   _debug_counter _addr ;\
    alu     _debug_counter += 1 ;\
    stc32   _debug_counter _addr
