...
#define RDD_INGRESS_QUEUE_ENTRY_VALID_READ(r, p)              RDP_FIELD_MREAD_8(((uint8_t *)p + 0), 7, 1, r)
#define RDD_INGRESS_QUEUE_ENTRY_BRIDGE_OR_ROUTER_READ(r, p)   RDP_FIELD_MREAD_8(((uint8_t *)p + 0), 6, 1, r)
#define RDD_INGRESS_QUEUE_ENTRY_IH_BUFFER_NUM_READ(r, p)      RDP_FIELD_MREAD_8(((uint8_t *)p + 0), 0, 6, r)
...
#define RDD_PARSER_SUMMARY_FIVE_TUP_VLD_READ(r, p)          RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 31, 1, r)
#define RDD_PARSER_SUMMARY_IP_FRST_FRAG_READ(r, p)          RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 30, 1, r)
#define RDD_PARSER_SUMMARY_IP_FRAG_READ(r, p)               RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 29, 1, r)
#define RDD_PARSER_SUMMARY_IP_FILTER_MATCH_READ(r, p)       RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 28, 1, r)
#define RDD_PARSER_SUMMARY_IP_FILTER_MATCH_NUM_READ(r, p)   RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 26, 2, r)
#define RDD_PARSER_SUMMARY_TCP_UDP_READ(r, p)               RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 25, 1, r)
#define RDD_PARSER_SUMMARY_IPV6_EXT_HDR_FLT_READ(r, p)      RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 24, 1, r)
#define RDD_PARSER_SUMMARY_TCP_FLAG_READ(r, p)              RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 23, 1, r)
#define RDD_PARSER_SUMMARY_WAN_READ(r, p)                   RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 22, 1, r)
#define RDD_PARSER_SUMMARY_VID_FIL_HIT_READ(r, p)           RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 21, 1, r)
#define RDD_PARSER_SUMMARY_EXP_READ(r, p)                   RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 20, 1, r)
#define RDD_PARSER_SUMMARY_DA_FILT_NUM_READ(r, p)           RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 17, 3, r)
#define RDD_PARSER_SUMMARY_DA_FILTER_READ(r, p)             RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 16, 1, r)
#define RDD_PARSER_SUMMARY_L4_PROTOCOL_READ(r, p)           RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 12, 4, r)
#define RDD_PARSER_SUMMARY_ERROR_READ(r, p)                 RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 11, 1, r)
#define RDD_PARSER_SUMMARY_PTAG_READ(r, p)                  RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 10, 1, r)
#define RDD_PARSER_SUMMARY_VLAN_NUM_READ(r, p)              RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 8,  2, r)
#define RDD_PARSER_SUMMARY_BROADCAST_READ(r, p)             RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 7,  1, r)
#define RDD_PARSER_SUMMARY_MULTICAST_READ(r, p)             RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 6,  1, r)
#define RDD_PARSER_SUMMARY_L3_PROTOCOL_READ(r, p)           RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 4,  2, r)
#define RDD_PARSER_SUMMARY_L2_PROTOCOL_READ(r, p)           RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 0,  4, r)

#define RDD_IH_LKP_RESULT_MATCH_READ(r, p)                  RDP_FIELD_MREAD_32(((uint8_t *) p + 4), 0, 1, r)
#define RDD_IH_LKP_RESULT_CAM_READ(r, p)                    RDP_FIELD_MREAD_32(((uint8_t *) p + 4), 1, 1, r)
#define RDD_IH_LKP_RESULT_MOVE_READ(r, p)                   RDP_FIELD_MREAD_32(((uint8_t *) p + 4), 2, 1, r)
#define RDD_IH_LKP_RESULT_MATCH_OFFSET_READ(r, p)           RDP_FIELD_MREAD_32(((uint8_t *) p + 4), 4, 12, r)
#define RDD_IH_LKP_RESULT_PORT_READ(r, p)                   RDP_FIELD_MREAD_32(((uint8_t *) p + 4), 16, 16, r)
#define RDD_IH_LKP_RESULT_CONTEXT_ENTRY_READ(r, p)          MREAD_32(((uint8_t *) p + 0), r)

#define RDD_IH_EGRESS_HEADER_RB_VALID_READ(r, p)            RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 13, 1, r)
#define RDD_IH_EGRESS_HEADER_FORWARD_EN_READ(r, p)          RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 12, 1, r)
#define RDD_IH_EGRESS_HEADER_DIRECT_MODE_READ(r, p)         RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 11, 1, r)
#define RDD_IH_EGRESS_HEADER_TARGET_MEMORY_READ(r, p)       RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 10, 1, r)
#define RDD_IH_EGRESS_HEADER_INGRESS_QOS_READ(r, p)         RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 8,  2, r)
#define RDD_IH_EGRESS_HEADER_1588_TOD_READ(r, p)            { uint32_t temp; RDP_FIELD_MREAD_32(((uint8_t *) p + 0), 0, 8, temp); RDP_FIELD_MREAD_32(((uint8_t *) p + 4), 28, 4, r); r |= (temp << 4); }
#define RDD_IH_EGRESS_HEADER_WAN_FLOW_ID_READ(r, p)         RDP_FIELD_MREAD_32(((uint8_t *) p + 4), 20,  8, r)
#define RDD_IH_EGRESS_HEADER_PTI_READ(r, p)                 RDP_FIELD_MREAD_32(((uint8_t *) p + 4), 18, 2, r)
#define RDD_IH_EGRESS_HEADER_CLASS_OVERRIDE_EN_READ(r, p)   RDP_FIELD_MREAD_32(((uint8_t *) p + 4), 17, 1, r)
#define RDD_IH_EGRESS_HEADER_CLASS_READ(r, p)               RDP_FIELD_MREAD_32(((uint8_t *) p + 4), 13, 4, r)
#define RDD_IH_EGRESS_HEADER_HLEN_READ(r, p)                RDP_FIELD_MREAD_32(((uint8_t *) p + 4), 5, 8, r)
#define RDD_IH_EGRESS_HEADER_SRC_PORT_READ(r, p)            RDP_FIELD_MREAD_32(((uint8_t *) p + 4), 0, 5, r)
...
#define RDD_RUNNER_CONGESTION_STATE_STATE_READ(r, p)                   RDP_FIELD_MREAD_16(((uint8_t *) p + 0), 0,  5, r)
#define RDD_RUNNER_CONGESTION_STATE_ALLOCATED_RIBS_NUMBER_READ(r, p)   RDP_FIELD_MREAD_16(((uint8_t *) p + 0), 8,  7, r)
...
static int p_lilac_rdd_print_ddr_buffer(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        if ((i % 16) == 0)
            bdmf_session_print(session, "%px  ", packet_buffer_ptr);
