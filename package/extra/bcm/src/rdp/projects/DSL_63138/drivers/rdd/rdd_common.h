...
/* port_mapping structure and API */
...
#if defined(CONFIG_RNR_DSL_INTF_SUPPORT)
    case rdpa_port_dsl:
        tm_index = dsl_port_mapping[0].tm_index;
        break;
#endif
...
#if defined(CONFIG_RNR_DSL_INTF_SUPPORT)
    case rdpa_port_dsl:
        bb_rx_id = dsl_port_mapping[0].bb_rx_id;
        break;
#endif
...
/* Description:                                                               */
/*                                                                            */
/* configures the maximal packet size                                         */
...
/*                                                                            */
/******************************************************************************/
BL_LILAC_RDD_ERROR_DTE rdd_max_pkt_size_cfg ( uint16_t  xi_max_pkt_size );
