...
static BL_LILAC_RDD_ERROR_DTE __rdd_cpu_rx_meter_config ( BL_LILAC_RDD_CPU_METER_DTE  xi_cpu_meter,
...
BL_LILAC_RDD_ERROR_DTE rdd_cpu_rx_meter_config ( BL_LILAC_RDD_CPU_METER_DTE  xi_cpu_meter,
                                                 ...
                                                 uint16_t                    xi_burst_size )
{
    __rdd_cpu_rx_meter_config( xi_cpu_meter, xi_average_rate, xi_burst_size, rdpa_dir_ds );
    __rdd_cpu_rx_meter_config( xi_cpu_meter, xi_average_rate, xi_burst_size, rdpa_dir_us );
    return ( BL_LILAC_RDD_OK );
}


static BL_LILAC_RDD_ERROR_DTE __rdd_cpu_rx_meter_drop_counter_get (BL_LILAC_RDD_CPU_METER_DTE  xi_cpu_meter,
                                                           rdpa_traffic_dir            xi_direction,
...
{
    BL_LILAC_RDD_ERROR_DTE  rdd_error;
    uint32_t drop_counter_ds = 0, drop_counter_us = 0;

    rdd_error = __rdd_cpu_rx_meter_drop_counter_get ( xi_cpu_meter, rdpa_dir_ds, &drop_counter_ds );
    if (!rdd_error)
        rdd_error = __rdd_cpu_rx_meter_drop_counter_get ( xi_cpu_meter, rdpa_dir_us, &drop_counter_us );
    *xo_drop_counter = drop_counter_ds + drop_counter_us;
