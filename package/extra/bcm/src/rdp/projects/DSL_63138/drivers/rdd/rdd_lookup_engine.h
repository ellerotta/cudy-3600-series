...
#define RDD_HASH_TABLE_ENTRY_AGING_READ( r, p )    RDP_FIELD_MREAD_32( ( (uint8_t *)p + 4),  2,  1, r )
#define RDD_HASH_TABLE_ENTRY_SKIP_READ( r, p )     RDP_FIELD_MREAD_32( ( (uint8_t *)p + 4),  1,  1, r )
#define RDD_HASH_TABLE_ENTRY_VALID_READ( r, p )    RDP_FIELD_MREAD_32( ( (uint8_t *)p + 4),  0,  1, r )
#define RDD_HASH_TABLE_ENTRY_AGING_WRITE( v, p )   RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 4 ), 2,  1, v )
#define RDD_HASH_TABLE_ENTRY_SKIP_WRITE( v, p )    RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 4 ), 1,  1, v )
#define RDD_HASH_TABLE_ENTRY_VALID_WRITE( v, p )   RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 4 ), 0,  1, v )
...
#define RDD_DDR_HASH_TABLE_ENTRY_VALID_READ( r, p )           RDP_FIELD_MREAD_32( ( (uint8_t *)p + 0 ), 31,  1, r )
#define RDD_DDR_HASH_TABLE_ENTRY_CACHE_FLAG_READ( r, p )      RDP_FIELD_MREAD_32( ( (uint8_t *)p + 0 ), 30,  1, r )
#define RDD_DDR_HASH_TABLE_ENTRY_CONTEXT_PTR_READ( r , p )    RDP_FIELD_MREAD_32( ( (uint8_t *)p + 0 ), 5,  25, r )
#define RDD_DDR_HASH_TABLE_ENTRY_VALID_WRITE( v, p )          RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 0 ), 31,  1, v )
#define RDD_DDR_HASH_TABLE_ENTRY_CACHE_FLAG_WRITE( v, p )     RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 0 ), 30,  1, v )
#define RDD_DDR_HASH_TABLE_ENTRY_CONTEXT_PTR_WRITE( v , p )   RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 0 ), 5,  25, v )
...
#define RDD_DDR_HASH_TABLE_CONTEXT_ENTRY_VALID_READ( r, p )    RDP_FIELD_MREAD_32( ( (uint8_t *)p + 0 ), 31,  1, r )
#define RDD_DDR_HASH_TABLE_CONTEXT_ENTRY_VALID_WRITE( v, p )   RDP_FIELD_MWRITE_32( ( (uint8_t *)p + 0 ), 31,  1, v )
