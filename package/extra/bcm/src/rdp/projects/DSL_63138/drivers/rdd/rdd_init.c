...
static BL_LILAC_RDD_ERROR_DTE f_rdd_local_registers_initialize ( void )
{
    ...
    /* WAN direct */
    local_register[ DIRECT_FLOW_THREAD_NUMBER ][ CS_R16 ] = ADDRESS_OF(runner_a, direct_flow_wakeup_request) << 16;
    local_register[ DIRECT_FLOW_THREAD_NUMBER ][ CS_R8  ] = GPON_RX_DIRECT_DESCRIPTORS_ADDRESS;
    local_register[ DIRECT_FLOW_THREAD_NUMBER ][ CS_R10 ] = INGRESS_HANDLER_BUFFER_ADDRESS;
    local_register[ DIRECT_FLOW_THREAD_NUMBER ][ CS_R10 ] |= CPU_REASON_WAN0_TABLE_INDEX << 16;
#endif
...
#if defined(WL4908)
    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE0_THREAD_NUMBER ][ CS_R8  ] = ((DS_CONNECTION_CONTEXT_BUFFER_ADDRESS + 0x00c0) << 16) | (DS_CONNECTION_CONTEXT_BUFFER_ADDRESS + 0x0000);
#else
...
#endif
    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE0_THREAD_NUMBER ][ CS_R9  ] = (uint32_t)(( DS_PARALLEL_PROCESSING_IH_BUFFER_VECTOR_ADDRESS << 16 ) |
        (DS_FC_MCAST_PACKET_SAVE_DATA_TABLE_ADDRESS + (0 * sizeof(RDD_FC_MCAST_PACKET_SAVE_DATA_ENTRY_DTS))));
    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE0_THREAD_NUMBER ][ CS_R10 ] = ( FLOW_CACHE_SLAVE0_VECTOR_MASK << 24 ) | INGRESS_HANDLER_BUFFER_ADDRESS;

    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE1_THREAD_NUMBER ][ CS_R16 ] = ADDRESS_OF(runner_a, flow_cache_wakeup_request) << 16;
#if defined(WL4908)
    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE1_THREAD_NUMBER ][ CS_R8  ] = ((DS_CONNECTION_CONTEXT_BUFFER_ADDRESS + 0x01c0) << 16) | (DS_CONNECTION_CONTEXT_BUFFER_ADDRESS + 0x0100);
#else
...
#endif
    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE1_THREAD_NUMBER ][ CS_R9  ] = (uint32_t)((( DS_PARALLEL_PROCESSING_IH_BUFFER_VECTOR_ADDRESS + 1 ) << 16 ) |
        (DS_FC_MCAST_PACKET_SAVE_DATA_TABLE_ADDRESS + (1 * sizeof(RDD_FC_MCAST_PACKET_SAVE_DATA_ENTRY_DTS))));
    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE1_THREAD_NUMBER ][ CS_R10 ] = ( FLOW_CACHE_SLAVE1_VECTOR_MASK << 24 ) | INGRESS_HANDLER_BUFFER_ADDRESS;

    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE2_THREAD_NUMBER ][ CS_R16 ] = ADDRESS_OF(runner_a, flow_cache_wakeup_request) << 16;
#if defined(WL4908)
    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE2_THREAD_NUMBER ][ CS_R8  ] = ((DS_CONNECTION_CONTEXT_BUFFER_ADDRESS + 0x02c0) << 16) | (DS_CONNECTION_CONTEXT_BUFFER_ADDRESS + 0x0200);
#else
...
#endif
    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE2_THREAD_NUMBER ][ CS_R9  ] = (uint32_t)((( DS_PARALLEL_PROCESSING_IH_BUFFER_VECTOR_ADDRESS + 2 ) << 16 ) |
        (DS_FC_MCAST_PACKET_SAVE_DATA_TABLE_ADDRESS + (2 * sizeof(RDD_FC_MCAST_PACKET_SAVE_DATA_ENTRY_DTS))));
    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE2_THREAD_NUMBER ][ CS_R10 ] = ( FLOW_CACHE_SLAVE2_VECTOR_MASK << 24 ) | INGRESS_HANDLER_BUFFER_ADDRESS;

    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE3_THREAD_NUMBER ][ CS_R16 ] = ADDRESS_OF(runner_a, flow_cache_wakeup_request) << 16;
#if defined(WL4908)
    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE3_THREAD_NUMBER ][ CS_R8  ] = ((DS_CONNECTION_CONTEXT_BUFFER_ADDRESS + 0x03c0) << 16) | (DS_CONNECTION_CONTEXT_BUFFER_ADDRESS + 0x0300);
#else
...
#endif
    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE3_THREAD_NUMBER ][ CS_R9  ] = (uint32_t)((( DS_PARALLEL_PROCESSING_IH_BUFFER_VECTOR_ADDRESS + 3 ) << 16 )  |
        (DS_FC_MCAST_PACKET_SAVE_DATA_TABLE_ADDRESS + (3 * sizeof(RDD_FC_MCAST_PACKET_SAVE_DATA_ENTRY_DTS))));
    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE3_THREAD_NUMBER ][ CS_R10 ] = ( FLOW_CACHE_SLAVE3_VECTOR_MASK << 24 ) | INGRESS_HANDLER_BUFFER_ADDRESS;
    ...
    local_register[ UPSTREAM_FLOW_CACHE_SLAVE0_THREAD_NUMBER - 32 ][ CS_R10 ] = ( FLOW_CACHE_SLAVE0_VECTOR_MASK << 24 ) | INGRESS_HANDLER_BUFFER_ADDRESS;
    ...
    local_register[ UPSTREAM_FLOW_CACHE_SLAVE1_THREAD_NUMBER - 32 ][ CS_R10 ] = ( FLOW_CACHE_SLAVE1_VECTOR_MASK << 24 ) | INGRESS_HANDLER_BUFFER_ADDRESS;
    ...
    local_register[ UPSTREAM_FLOW_CACHE_SLAVE2_THREAD_NUMBER - 32 ][ CS_R10 ] = ( FLOW_CACHE_SLAVE2_VECTOR_MASK << 24 ) | INGRESS_HANDLER_BUFFER_ADDRESS;
    ...
    local_register[ UPSTREAM_FLOW_CACHE_SLAVE3_THREAD_NUMBER - 32 ][ CS_R10 ] = ( FLOW_CACHE_SLAVE3_VECTOR_MASK << 24 ) | INGRESS_HANDLER_BUFFER_ADDRESS;
...
#if defined(WL4908)
uint8_t vport_switch_port_mapping[] = {0, 1, 2, 3, 7, 0, 0, 0, 4};
#else
uint8_t vport_switch_port_mapping[] = {0, 1, 2, 3, 4, 5, 7, 0, 8};
#endif
...
BL_LILAC_RDD_ERROR_DTE rdd_broadcom_switch_ports_mapping_table_config ( BL_LILAC_RDD_BRIDGE_PORT_DTE  xi_bridge_port )
{
    ...
    RDD_BROADCOM_SWITCH_PORT_MAPPING_PHYSICAL_PORT_WRITE(xi_bridge_port, broadcom_switch_mapping_table_ptr +
        vport_switch_port_mapping[xi_bridge_port - BL_LILAC_RDD_LAN0_BRIDGE_PORT]);
                                                               ...
                                                               uint8_t                       xi_lookup_port )
{
    ...
    if ( xi_bridge_port > BL_LILAC_RDD_MAPPING_MAX_BRIDGE_PORT )
    {
        return ( BL_LILAC_RDD_ERROR_ILLEGAL_BRIDGE_PORT_ID );
    }
