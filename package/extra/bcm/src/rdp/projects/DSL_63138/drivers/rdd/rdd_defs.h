...
typedef enum
{
    ...
    BL_LILAC_RDD_WLAN0_BRIDGE_PORT          = 13,
    BL_LILAC_RDD_WLAN1_BRIDGE_PORT          = 14,
    BL_LILAC_RDD_WLAN2_BRIDGE_PORT          = 15,
    BL_LILAC_RDD_BOND0_BRIDGE_PORT          = 16,
    BL_LILAC_RDD_BOND1_BRIDGE_PORT          = 17,
...
#define PROJ_DEFS_NUMBER_OF_VPORTS   31

#define RDD_WAN0_VPORT       BL_LILAC_RDD_WAN0_BRIDGE_PORT
#define RDD_DSL_WAN_VPORT    BL_LILAC_RDD_WAN0_BRIDGE_PORT
#define RDD_WAN1_VPORT       BL_LILAC_RDD_WAN1_BRIDGE_PORT
#define RDD_LAN0_VPORT       BL_LILAC_RDD_LAN0_BRIDGE_PORT
#define RDD_LAN1_VPORT       BL_LILAC_RDD_LAN1_BRIDGE_PORT
#define RDD_LAN2_VPORT       BL_LILAC_RDD_LAN2_BRIDGE_PORT
#define RDD_LAN3_VPORT       BL_LILAC_RDD_LAN3_BRIDGE_PORT
#define RDD_LAN4_VPORT       BL_LILAC_RDD_LAN4_BRIDGE_PORT
#define RDD_LAN5_VPORT       BL_LILAC_RDD_LAN5_BRIDGE_PORT
#define RDD_LAN6_VPORT       BL_LILAC_RDD_LAN6_BRIDGE_PORT
#define RDD_CPU0_VPORT       BL_LILAC_RDD_CPU_BRIDGE_PORT
#define RDD_WLAN0_VPORT      BL_LILAC_RDD_WLAN0_BRIDGE_PORT
#define RDD_WLAN1_VPORT      BL_LILAC_RDD_WLAN1_BRIDGE_PORT
#define RDD_WLAN2_VPORT      BL_LILAC_RDD_WLAN2_BRIDGE_PORT
#define RDD_BOND0_VPORT      BL_LILAC_RDD_BOND0_BRIDGE_PORT
#define RDD_BOND1_VPORT      BL_LILAC_RDD_BOND1_BRIDGE_PORT
#define RDD_VPORT_MAX        RDD_BOND1_VPORT

#if !defined(WL4908)
#define RDD_LAN_VPORT_LAST   RDD_LAN6_VPORT
#define RDD_WAN_VPORT_LAST   RDD_WAN1_VPORT
#define OUTBOUND_SF2_PORTS_MASK 0xbf
#else
#define RDD_LAN_VPORT_LAST   RDD_LAN4_VPORT
#define RDD_WAN_VPORT_LAST   RDD_WAN0_VPORT
#define OUTBOUND_SF2_PORTS_MASK 0x8f
#endif
#define NUM_OUTBOUND_SF2_PORTS (RDD_LAN_VPORT_LAST - RDD_LAN0_VPORT + 1)
