...
static inline BL_LILAC_RDD_ERROR_DTE f_rdd_connection_entry_alloc ( uint32_t                  xi_hash_index,
                                                                    ...
                                                                    rdd_l3_flow_key_t         *xi_lookup_entry,
...
BL_LILAC_RDD_ERROR_DTE rdd_connection_entry_get ( rdpa_traffic_dir    xi_direction,
                                                  ...
                                                  rdd_l3_flow_key_t   *xo_connection_entry,
...
static uint32_t rdd_fc_mcast_compose_lkup_key(rdd_mcast_flow_key_t  *mcast_lookup_entry,
                                              uint8_t *key_bytes)
{
