...
static void image_1_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    ag_drv_rnr_regs_cfg_ext_acc_cfg_set(core_index, PACKET_BUFFER_PD_PTR(IMAGE_1_PROCESSING_4_TASKS_PACKET_BUFFER_ADDRESS, 0), 8, 8, 8);
    ...
    local_regs[IMAGE_1_IMAGE_1_CPU_RX_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_1, c_cpu_rx_wakeup_request);
    /* Remove after disabling binary builder on C */
#if !defined(CONFIG_CPU_RX_FROM_XPM)
    local_regs[IMAGE_1_IMAGE_1_CPU_RX_THREAD_NUMBER][reg_id[17]] = IMAGE_1_PD_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_1_IMAGE_1_CPU_RX_THREAD_NUMBER][reg_id[18]] = IMAGE_1_UPDATE_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_1_IMAGE_1_CPU_RX_THREAD_NUMBER][reg_id[8]] = IMAGE_1_PD_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_1_IMAGE_1_CPU_RX_THREAD_NUMBER][reg_id[9]] = IMAGE_1_UPDATE_FIFO_TABLE_ADDRESS;
#endif
    local_regs[IMAGE_1_IMAGE_1_CPU_RX_THREAD_NUMBER][reg_id[30]] = IMAGE_1_CPU_RX_STACK_ADDRESS+IMAGE_1_CPU_RX_STACK_BYTE_SIZE;
    ...
    local_regs[IMAGE_1_IMAGE_1_CPU_RX_COPY_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_1, c_cpu_rx_copy_wakeup_request);
    local_regs[IMAGE_1_IMAGE_1_CPU_RX_COPY_THREAD_NUMBER][reg_id[30]] = IMAGE_1_CPU_RX_COPY_STACK_ADDRESS+IMAGE_1_CPU_RX_COPY_STACK_BYTE_SIZE;
#endif
    /* PROCESSING : thread 8-11 */
    for (task = IMAGE_1_IMAGE_1_PROCESSING0_THREAD_NUMBER; task <= IMAGE_1_IMAGE_1_PROCESSING3_THREAD_NUMBER; task++)
    {
        local_regs[task][reg_id[0]] = ADDRESS_OF(image_1, processing_wakeup_request);
        local_regs[task][reg_id[8]] = task;
        local_regs[task][reg_id[9]] = PACKET_BUFFER_PD_PTR(IMAGE_1_PROCESSING_4_TASKS_PACKET_BUFFER_ADDRESS, (task - IMAGE_1_IMAGE_1_PROCESSING0_THREAD_NUMBER));
    }
    /* Stack init - should point to the end of stack */
...
static void image_3_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    local_regs[IMAGE_3_IMAGE_3_SERVICE_QUEUES_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_3, sq_tx_task_wakeup_request);
    local_regs[IMAGE_3_IMAGE_3_SERVICE_QUEUES_THREAD_NUMBER][reg_id[8]] = IMAGE_3_SQ_TM_PD_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_3_IMAGE_3_SERVICE_QUEUES_THREAD_NUMBER][reg_id[9]] = IMAGE_3_SQ_TM_UPDATE_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_3_IMAGE_3_SERVICE_QUEUES_THREAD_NUMBER][reg_id[30]] = IMAGE_3_SERVICE_QUEUES_STACK_ADDRESS + C_DEFS_SQ_TX_TASK_STACK_SIZE;
...
static void image_4_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
   ...
   /* GENERAL_TIMER: thread 0 */
    ...
    local_regs[IMAGE_4_DS_TM_BUFFER_CONG_MGT_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_4, buffer_cong_mgt_1st_wakeup_request) << 16;
#endif
    ...
    local_regs[IMAGE_4_DS_TM_TX_TASK_0_THREAD_NUMBER][reg_id[8]] = 0;
    local_regs[IMAGE_4_DS_TM_TX_TASK_0_THREAD_NUMBER][reg_id[9]] = IMAGE_4_DS_TM_TX_TASK_0_THREAD_NUMBER;
    local_regs[IMAGE_4_DS_TM_TX_TASK_0_THREAD_NUMBER][reg_id[30]] = IMAGE_4_TX_TASK_0_STACK_ADDRESS + C_DEFS_TX_TASK_STACK_SIZE;

    /* SCHEDULING LAN: thread 5 */
    local_regs[IMAGE_4_DS_TM_TX_TASK_1_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_4, tm_tx_task_wakeup_request);
    local_regs[IMAGE_4_DS_TM_TX_TASK_1_THREAD_NUMBER][reg_id[8]] = 1;
    local_regs[IMAGE_4_DS_TM_TX_TASK_1_THREAD_NUMBER][reg_id[9]] = IMAGE_4_DS_TM_TX_TASK_1_THREAD_NUMBER;
    local_regs[IMAGE_4_DS_TM_TX_TASK_1_THREAD_NUMBER][reg_id[30]] = IMAGE_4_TX_TASK_1_STACK_ADDRESS + C_DEFS_TX_TASK_STACK_SIZE;

    /* SCHEDULING LAN: thread 6 */
    local_regs[IMAGE_4_DS_TM_TX_TASK_2_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_4, tm_tx_task_wakeup_request);
    local_regs[IMAGE_4_DS_TM_TX_TASK_2_THREAD_NUMBER][reg_id[8]] = 2;
    local_regs[IMAGE_4_DS_TM_TX_TASK_2_THREAD_NUMBER][reg_id[9]] = IMAGE_4_DS_TM_TX_TASK_2_THREAD_NUMBER;
    local_regs[IMAGE_4_DS_TM_TX_TASK_2_THREAD_NUMBER][reg_id[30]] = IMAGE_4_TX_TASK_2_STACK_ADDRESS + C_DEFS_TX_TASK_STACK_SIZE;
...
static void image_5_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    /* Common reprocessing task is used for pktgen_reprocessing for tcp and udp speed test .
...
static void image_6_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    /* read the local registers from the Context memory - maybe it was initialized by the ACE compiler */
    MREAD_BLK_32(local_regs, sram_context, sizeof(local_regs));
    rdd_global_registers_init(core_index, local_regs, IMAGE_6_US_TM_LAST);

    /* DIRECT PROCESSING : thread 0 */
    local_regs[IMAGE_6_US_TM_DIRECT_FLOW_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, direct_flow_wakeup_request);
    local_regs[IMAGE_6_US_TM_DIRECT_FLOW_THREAD_NUMBER][reg_id[30]] = IMAGE_6_DIRECT_FLOW_STACK_ADDRESS + C_DEFS_DIRECT_FLOW_STACK_SIZE;

    /* GENERAL_TIMER: thread 1 */
    local_regs[IMAGE_6_US_TM_GENERAL_TIMER_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, general_timer_wakeup_request);
    local_regs[IMAGE_6_US_TM_GENERAL_TIMER_THREAD_NUMBER][reg_id[30]] = IMAGE_6_GENERAL_TIMER_STACK_ADDRESS + IMAGE_6_GENERAL_TIMER_STACK_BYTE_SIZE;

#ifdef BUFFER_CONGESTION_MGT
    /* BUFFER_CONG_MGT: thread 3 */
    local_regs[IMAGE_6_US_TM_BUFFER_CONG_MGT_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_6, buffer_cong_mgt_1st_wakeup_request) << 16;
#endif

    local_regs[IMAGE_6_US_TM_UPDATE_FIFO_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, tm_update_fifo_first_wakeup_request);
    local_regs[IMAGE_6_US_TM_UPDATE_FIFO_THREAD_NUMBER][reg_id[8]] = IMAGE_6_UPDATE_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_6_US_TM_UPDATE_FIFO_THREAD_NUMBER][reg_id[30]] = IMAGE_6_UPDATE_FIFO_STACK_ADDRESS + C_DEFS_UPDATE_FIFO_STACK_SIZE;

    /* SCHEDULING WAN: thread 7 */
    local_regs[IMAGE_6_US_TM_WAN_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, tm_tx_task_wakeup_request);
    local_regs[IMAGE_6_US_TM_WAN_THREAD_NUMBER][reg_id[8]] = 0;
    local_regs[IMAGE_6_US_TM_WAN_THREAD_NUMBER][reg_id[9]] = IMAGE_6_US_TM_WAN_THREAD_NUMBER;
    local_regs[IMAGE_6_US_TM_WAN_THREAD_NUMBER][reg_id[30]] = IMAGE_6_WAN_STACK_ADDRESS + C_DEFS_TX_TASK_STACK_SIZE;

    /* EPON UPDATE FIFO: thread 6 */
    local_regs[IMAGE_6_US_TM_EPON_UPDATE_FIFO_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, epon_tm_update_fifo_first_wakeup_request);
    local_regs[IMAGE_6_US_TM_EPON_UPDATE_FIFO_THREAD_NUMBER][reg_id[8]] = IMAGE_6_EPON_UPDATE_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_6_US_TM_EPON_UPDATE_FIFO_THREAD_NUMBER][reg_id[9]] = BB_ID_QM_RNR_GRID;
    local_regs[IMAGE_6_US_TM_EPON_UPDATE_FIFO_THREAD_NUMBER][reg_id[10]] = drv_qm_get_us_epon_start();
    local_regs[IMAGE_6_US_TM_EPON_UPDATE_FIFO_THREAD_NUMBER][reg_id[30]] = IMAGE_6_EPON_UPDATE_FIFO_STACK_ADDRESS + C_DEFS_EPON_UPDATE_FIFO_STACK_SIZE;
...
#if defined(CONFIG_BCM_SPDSVC_SUPPORT)
    local_regs[IMAGE_6_US_TM_SPDSVC_ANALYZER_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, c_spdsvc_analyzer_wakeup_request);
    local_regs[IMAGE_6_US_TM_SPDSVC_ANALYZER_THREAD_NUMBER][reg_id[30]] = IMAGE_6_SPDSVC_ANALYZER_STACK_ADDRESS+IMAGE_6_SPDSVC_ANALYZER_STACK_BYTE_SIZE;
#endif
...
int rdd_data_structures_init(rdd_init_params_t *init_params, HW_IPTV_CONFIGURATION_STRUCT *iptv_hw_config)
{
    ...
    ag_drv_rnr_regs_cfg_cpu_wakeup_set(get_runner_idx(us_tm_runner_image), IMAGE_6_US_TM_GENERAL_TIMER_THREAD_NUMBER);
    ag_drv_rnr_regs_cfg_cpu_wakeup_set(get_runner_idx(service_queues_runner_image), IMAGE_3_IMAGE_3_GENERAL_TIMER_THREAD_NUMBER);
