...
#define RDD_LAN_VPORT_LAST   RDD_LAN12_VPORT

#define RDD_WAN0_VPORT       RDD_VPORT_ID_13
...
/* TM */
#define RDD_TM_FLOW_CNTR_TABLE_SIZE                         RDD_IMAGE_6_US_TM_TM_FLOW_CNTR_TABLE_SIZE
...
#define DS_TM_BUDGET_ALLOCATION_THREAD_NUMBER               IMAGE_4_DS_TM_GENERAL_TIMER_THREAD_NUMBER
#define TM_BUDGET_ALLOCATION_US_THREAD_NUMBER               IMAGE_6_US_TM_BUDGET_ALLOCATION_THREAD_NUMBER

#define RDD_DS_TM_FLOW_CNTR_TABLE_SIZE                      RDD_IMAGE_4_DS_TM_TM_FLOW_CNTR_TABLE_SIZE
#define IMAGE_3_CPU_FPM_RINGS_AND_BUFMNG_REFILL_TIMER_INDEX IMAGE_3_CPU_FPM_RINGS_AND_BUFMNG_REFILL_TIMER_INDEX_LAST

#define US_TM_UPDATE_FIFO_THREAD_NUMBER                     IMAGE_6_US_TM_UPDATE_FIFO_THREAD_NUMBER
...
#define US_TM_BUFFER_CONG_MGT_THREAD_NUMBER                 IMAGE_6_US_TM_BUFFER_CONG_MGT_THREAD_NUMBER
...
#define CPU_RX_TIMER_TASK                                   IMAGE_1_IMAGE_1_GENERAL_TIMER_THREAD_NUMBER
#define CPU_RX_METER_BUDGET_ALLOCATOR_THREAD_NUMBER         IMAGE_1_IMAGE_1_GENERAL_TIMER_THREAD_NUMBER
