...
#define RDD_CPU_VPORT_FLOOD  (RDD_CPU_VPORT_FIRST + 5)
#define RDD_CPU_VPORT_LAST   RDD_CPU_VPORT_FLOOD

#define RDD_VPORT_MAX RDD_CPU_VPORT_LAST

#define RDD_CPU_VPORT_MASK ((1 << RDD_CPU0_VPORT) | (1 << RDD_CPU1_VPORT) | (1 << RDD_CPU2_VPORT) | \
    (1 << RDD_CPU3_VPORT) | (1 << RDD_CPU4_VPORT) | (1 << RDD_CPU_VPORT_FLOOD))
...
#define TM_BUDGET_ALLOCATION_US_THREAD_NUMBER       IMAGE_0_TM_BUDGET_ALLOCATION_US_THREAD_NUMBER
#define TM_OVL_BUDGET_ALLOCATION_US_THREAD_NUMBER   IMAGE_0_TM_OVL_BUDGET_ALLOCATION_US_THREAD_NUMBER
#define DS_TM_BUDGET_ALLOCATION_THREAD_NUMBER       IMAGE_0_TM_BUDGET_ALLOCATION_DS_THREAD_NUMBER
...
#define RDD_US_TM_FLUSH_CFG_FW_TABLE_ADDRESS IMAGE_0_US_TM_FLUSH_CFG_FW_TABLE_ADDRESS
#define RDD_US_TM_FLUSH_CFG_ENABLE_TABLE_ADDRESS IMAGE_0_US_TM_FLUSH_CFG_ENABLE_TABLE_ADDRESS
