...
#define runner_b_start_task_timer_scheduler_set		(0x2D98)
#define runner_b_timer_scheduler_set		(0x2D98)
#define runner_b_start_task_cpu_rx_wakeup_request		(0x12D8)
#define runner_b_cpu_rx_wakeup_request		(0x12D8)
#define runner_b_start_task_rx_buffer_copy_wakeup_request		(0x2468)
#define runner_b_rx_buffer_copy_wakeup_request		(0x2468)
#define runner_b_start_task_cpu_tx_wakeup_request		(0x262C)
#define runner_b_cpu_tx_wakeup_request		(0x262C)
#define runner_b_start_task_policer_budget_allocator_1st_wakeup_request		(0x32E4)
#define runner_b_policer_budget_allocator_1st_wakeup_request		(0x32E4)
...
#define runner_b_start_task_timer_7_1st_wakeup_request		(0x2FA0)
#define runner_b_timer_7_1st_wakeup_request		(0x2FA0)
#define runner_b_start_task_free_skb_index_wakeup_request		(0x2F2C)
#define runner_b_free_skb_index_wakeup_request		(0x2F2C)
#define runner_b_start_task_dhd_tx_post		(0x3440)
#define runner_b_dhd_tx_post		(0x3440)
...
#define runner_b_spdsvc_timer_wakeup_request		(0x2D04)
#define runner_b_cpu_rx_meter_budget_allocate		(0x2E18)
#define runner_b_upstream_rate_limiter_budget_allocate		(0x2E64)
#define runner_b_schedule_free_skb_index		(0x2F10)
#define runner_b_pps_rate_limiter_timer_wakeup_request		(0x3004)
