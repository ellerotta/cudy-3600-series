...
#define runner_b_start_task_timer_scheduler_set		(0x3504)
#define runner_b_timer_scheduler_set		(0x3504)
#define runner_b_start_task_cpu_rx_wakeup_request		(0x12D8)
#define runner_b_cpu_rx_wakeup_request		(0x12D8)
#define runner_b_start_task_rx_buffer_copy_wakeup_request		(0x2B14)
#define runner_b_rx_buffer_copy_wakeup_request		(0x2B14)
#define runner_b_start_task_cpu_tx_wakeup_request		(0x2D98)
#define runner_b_cpu_tx_wakeup_request		(0x2D98)
#define runner_b_start_task_policer_budget_allocator_1st_wakeup_request		(0x3A50)
#define runner_b_policer_budget_allocator_1st_wakeup_request		(0x3A50)
#define runner_b_start_task_rate_control_budget_allocator_1st_wakeup_request		(0x2308)
#define runner_b_rate_control_budget_allocator_1st_wakeup_request		(0x2308)
...
#define runner_b_start_task_wan_tx_wakeup_request		(0x57C)
#define runner_b_wan_tx_wakeup_request		(0x57C)
#define runner_b_start_task_debug_routine		(0x120)
#define runner_b_debug_routine		(0x120)
#define runner_b_start_task_timer_7_1st_wakeup_request		(0x370C)
#define runner_b_timer_7_1st_wakeup_request		(0x370C)
#define runner_b_start_task_free_skb_index_wakeup_request		(0x3698)
#define runner_b_free_skb_index_wakeup_request		(0x3698)
...
#define runner_b_spdsvc_timer_wakeup_request		(0x3470)
#define runner_b_cpu_rx_meter_budget_allocate		(0x3584)
#define runner_b_upstream_rate_limiter_budget_allocate		(0x35D0)
#define runner_b_schedule_free_skb_index		(0x367C)
#define runner_b_pps_rate_limiter_timer_wakeup_request		(0x3770)
