...
/****************************************************************************** 
  ...
  *   -------------------
  *   TCAM /    |  1040 
  *   DEF flow  |  (for PRV mode)
  *
  *  NOTE: IPTV has moved to use NATC counter, CNTR_group_12. This group is NOT shared any more.
*******************************************************************************/
...
/****************************************************************************** 
  ...
  * CNTR GROUP 6 :
  * --------------
  * Structure: 4B, not clear on read
  *  
...
/* CNPL GROUP 7: 4B (single counter for lock) */
...
#define CNTR6_CNPL7_CNTR_TYPE 0
