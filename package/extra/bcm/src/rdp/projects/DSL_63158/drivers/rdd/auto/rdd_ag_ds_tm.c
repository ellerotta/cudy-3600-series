...
int rdd_ag_ds_tm_cntr_stash_descriptor_get(rdd_cntr_stash_descriptor_t *cntr_stash_descriptor)
{
    RDD_CNTR_STASH_DESCRIPTOR_NUM_OF_PDS_READ_G(cntr_stash_descriptor->num_of_pds, RDD_DS_TM_CNTR_STASH_TABLE_ADDRESS_ARR, 0);
    RDD_CNTR_STASH_DESCRIPTOR_CNTR_ID_READ_G(cntr_stash_descriptor->cntr_id, RDD_DS_TM_CNTR_STASH_TABLE_ADDRESS_ARR, 0);

    return BDMF_ERR_OK;
}

int rdd_ag_ds_tm_cntr_stash_descriptor_set(rdd_cntr_stash_descriptor_t *cntr_stash_descriptor)
{
    RDD_CNTR_STASH_DESCRIPTOR_NUM_OF_PDS_WRITE_G(cntr_stash_descriptor->num_of_pds, RDD_DS_TM_CNTR_STASH_TABLE_ADDRESS_ARR, 0);
    RDD_CNTR_STASH_DESCRIPTOR_CNTR_ID_WRITE_G(cntr_stash_descriptor->cntr_id, RDD_DS_TM_CNTR_STASH_TABLE_ADDRESS_ARR, 0);

    return BDMF_ERR_OK;
}

int rdd_ag_ds_tm_cntr_stash_descriptor_get_core(rdd_cntr_stash_descriptor_t *cntr_stash_descriptor, int core_id)
{
    RDD_CNTR_STASH_DESCRIPTOR_NUM_OF_PDS_READ_CORE(cntr_stash_descriptor->num_of_pds, RDD_DS_TM_CNTR_STASH_TABLE_ADDRESS_ARR, 0, core_id);
    RDD_CNTR_STASH_DESCRIPTOR_CNTR_ID_READ_CORE(cntr_stash_descriptor->cntr_id, RDD_DS_TM_CNTR_STASH_TABLE_ADDRESS_ARR, 0, core_id);

    return BDMF_ERR_OK;
}

int rdd_ag_ds_tm_cntr_stash_descriptor_set_core(rdd_cntr_stash_descriptor_t *cntr_stash_descriptor, int core_id)
{
    RDD_CNTR_STASH_DESCRIPTOR_NUM_OF_PDS_WRITE_CORE(cntr_stash_descriptor->num_of_pds, RDD_DS_TM_CNTR_STASH_TABLE_ADDRESS_ARR, 0, core_id);
    RDD_CNTR_STASH_DESCRIPTOR_CNTR_ID_WRITE_CORE(cntr_stash_descriptor->cntr_id, RDD_DS_TM_CNTR_STASH_TABLE_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_ds_tm_codel_drop_descriptor_flush_enable_set_core(uint8_t flush_enable, int core_id)
{
...
int rdd_ag_ds_tm_codel_drop_descriptor_flush_enable_get_core(uint8_t *flush_enable, int core_id)
{
