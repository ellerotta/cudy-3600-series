...
static DUMP_RUNNERREG_STRUCT DS_TM_AQM_QUEUE_TABLE =
{
	4,
	{
		{ dump_RDD_AQM_QUEUE_DESCRIPTOR, 0x900 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_TM_AQM_QUEUE_TIMER_TABLE =
{
	2,
	{
		{ dump_RDD_AQM_QUEUE_TIMER_DESCRIPTOR, 0xb80 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DIRECT_FLOW_PD_TABLE =
{
	16,
	{
		{ dump_RDD_PROCESSING_RX_DESCRIPTOR, 0xe10 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT US_TM_WAN_0_BBH_TX_WAKE_UP_DATA_TABLE =
{
	8,
	{
		{ dump_RDD_BBH_TX_WAKE_UP_DATA_ENTRY, 0x1e08 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT GHOST_REPORTING_GLOBAL_CFG =
{
	4,
	{
		{ dump_RDD_GHOST_REPORTING_GLOBAL_CFG_ENTRY, 0x1ec4 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT HOST_TX_TRUNCATE_MIRRORING_TABLE =
{
	2,
	{
		{ dump_RDD_MIRRORING_TRUNCATE_ENTRY, 0x1ee0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT ETH_TM_TX_TRUNCATE_MIRRORING_TABLE =
{
	2,
	{
		{ dump_RDD_MIRRORING_TRUNCATE_ENTRY, 0x1fa0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT BUFFER_CONG_SCRATCHPAD =
{
	8,
	{
		{ dump_RDD_BUFFER_CONG_Q_OCCUPANCY, 0x1fc0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_TM_FLUSH_CFG_CPU_TABLE =
{
	16,
	{
		{ dump_RDD_FLUSH_CFG_ENTRY, 0x2410 },
		{ 0, 0 },
	}
};
#endif
...
#endif
#if defined BCM6846
static DUMP_RUNNERREG_STRUCT TM_PI2_PROBABILITY_CALC_DESCRIPTOR =
{
	58,
	{
		{ dump_RDD_PI2_PROBABILITY_CALC_DESCRIPTOR, 0x2440 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DIRECT_FLOW_PAUSE_QUANTA =
{
	2,
	{
		{ dump_RDD_PAUSE_QUANTA_ENTRY, 0x24c4 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT BBH_TX_EPON_WAKE_UP_DATA_TABLE =
{
	8,
	{
		{ dump_RDD_BBH_TX_WAKE_UP_DATA_ENTRY, 0x24f8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT US_TM_FLUSH_CFG_FW_TABLE =
{
	16,
	{
		{ dump_RDD_FLUSH_CFG_ENTRY, 0x2590 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CODEL_BIAS_SLOPE_TABLE =
{
	4,
	{
		{ dump_RDD_CODEL_BIAS_SLOPE, 0x25c0 },
		{ 0, 0 },
	}
};
#endif
...
#endif
#if defined BCM6846
static DUMP_RUNNERREG_STRUCT PON_TM_TX_TRUNCATE_MIRRORING_TABLE =
{
	2,
	{
		{ dump_RDD_MIRRORING_TRUNCATE_ENTRY, 0x27b6 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_TM_TM_FLOW_CNTR_TABLE =
{
	1,
	{
		{ dump_RDD_TM_FLOW_CNTR_ENTRY, 0x2a88 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT US_TM_FLUSH_CFG_CURRENT_TABLE =
{
	16,
	{
		{ dump_RDD_FLUSH_CFG_ENTRY, 0x2a90 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT BBH_TX_EGRESS_REPORT_COUNTER_TABLE =
{
	8,
	{
		{ dump_RDD_BBH_TX_EGRESS_COUNTER_ENTRY, 0x2ab8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_TM_FLUSH_CFG_CURRENT_TABLE =
{
	16,
	{
		{ dump_RDD_FLUSH_CFG_ENTRY, 0x2af0 },
		{ 0, 0 },
	}
};
#endif
#if defined BCM6846
static DUMP_RUNNERREG_STRUCT US_TM_AQM_QUEUE_TIMER_TABLE =
{
	2,
	{
		{ dump_RDD_AQM_QUEUE_TIMER_DESCRIPTOR, 0x2b00 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT BBH_TX_US_WAN_0_FIFO_BYTES_THRESHOLD =
{
	2,
	{
		{ dump_RDD_BYTES_2, 0x2b86 },
		{ 0, 0 },
	}
};
#endif
#if defined BCM6846
static DUMP_RUNNERREG_STRUCT BASIC_SCHEDULER_WAKEUP_CMD_US =
{
	4,
	{
		{ dump_RDD_BYTES_4, 0x2b88 },
		{ 0, 0 },
	}
};
#endif
...
#endif
#if defined BCM6846
static DUMP_RUNNERREG_STRUCT PON_TM_VPORT_TO_RL_OVERHEAD_TABLE =
{
	1,
	{
		{ dump_RDD_VPORT_TO_RL_OVERHEAD_ENTRY, 0x2bb4 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT TX_EXCEPTION =
{
	1,
	{
		{ dump_RDD_TX_EXCEPTION_ENTRY, 0x2bb6 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT RX_MIRRORING_CONFIGURATION =
{
	2,
	{
		{ dump_RDD_MIRRORING_DESCRIPTOR, 0x2bbe },
		{ 0, 0 },
	}
};
#endif
...
#endif
#if defined BCM6846
static DUMP_RUNNERREG_STRUCT SERVICE_QUEUES_FLUSH_AGGREGATION_TASK_DISABLE =
{
	1,
	{
...
static DUMP_RUNNERREG_STRUCT MAC_TYPE =
{
	1,
	{
		{ dump_RDD_MAC_TYPE_ENTRY, 0x2bec },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT OVERALL_RATE_LIMITER_TABLE =
{
	16,
	{
		{ dump_RDD_OVERALL_RATE_LIMITER_DESCRIPTOR, 0x2bf0 },
		{ 0, 0 },
	}
};
#endif
...
#endif
#if defined BCM6846
static DUMP_RUNNERREG_STRUCT US_TM_AQM_QUEUE_TABLE =
{
	4,
	{
...
static DUMP_RUNNERREG_STRUCT US_TM_FLUSH_CFG_ENABLE_TABLE =
{
	2,
	{
		{ dump_RDD_FLUSH_CFG_ENABLE_ENTRY, 0x2f88 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_TM_FLUSH_CFG_ENABLE_TABLE =
{
	2,
	{
		{ dump_RDD_FLUSH_CFG_ENABLE_ENTRY, 0x2fb8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT US_TM_TX_QUEUE_DROP_TABLE =
{
	8,
	{
		{ dump_RDD_PACKETS_AND_BYTES, 0x3200 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_TM_TX_QUEUE_DROP_TABLE =
{
	8,
	{
		{ dump_RDD_PACKETS_AND_BYTES, 0x3408 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT US_TM_CODEL_DROP_DESCRIPTOR =
{
	12,
	{
		{ dump_RDD_CODEL_DROP_DESCRIPTOR, 0x3610 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT VPORT_TO_RL_OVERHEAD_TABLE =
{
	1,
	{
		{ dump_RDD_VPORT_TO_RL_OVERHEAD_ENTRY, 0x3660 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_TM_CODEL_DROP_DESCRIPTOR =
{
	12,
	{
		{ dump_RDD_CODEL_DROP_DESCRIPTOR, 0x3670 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT REPORTING_QUEUE_COUNTER_TABLE =
{
	2,
	{
		{ dump_RDD_REPORTING_QUEUE_COUNTER, 0x3700 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SERVICE_QUEUES_AQM_QUEUE_TABLE =
{
	4,
	{
		{ dump_RDD_AQM_QUEUE_DESCRIPTOR, 0x3788 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SQ_TX_QUEUE_DROP_TABLE =
{
	8,
	{
		{ dump_RDD_PACKETS_AND_BYTES, 0x3948 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SERVICE_QUEUES_CODEL_DROP_DESCRIPTOR =
{
	12,
	{
		{ dump_RDD_CODEL_DROP_DESCRIPTOR, 0x39c0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT FPM_GLOBAL_CFG =
{
	20,
	{
		{ dump_RDD_FPM_GLOBAL_CFG, 0x39e0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DEBUG_PRINT_TABLE =
{
	16,
	{
		{ dump_RDD_DEBUG_PRINT_INFO, 0x3aa0 },
		{ 0, 0 },
	}
};
#endif
#if defined BCM6846
static DUMP_RUNNERREG_STRUCT SERVICE_QUEUES_AQM_QUEUE_TIMER_TABLE =
{
	2,
	{
		{ dump_RDD_AQM_QUEUE_TIMER_DESCRIPTOR, 0x3ab0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_TM_CNTR_STASH_TABLE =
{
	2,
	{
		{ dump_RDD_CNTR_STASH_DESCRIPTOR, 0x3af0 },
		{ 0, 0 },
	}
};
#endif
...
#endif
#if defined BCM6846
static DUMP_RUNNERREG_STRUCT US_TM_CNTR_STASH_TABLE =
{
	2,
	{
		{ dump_RDD_CNTR_STASH_DESCRIPTOR, 0x3b10 },
		{ 0, 0 },
	}
};
#endif
...
#endif
#if defined BCM6846
static DUMP_RUNNERREG_STRUCT PROCESSING_GROUP_PARAMS_GEN4_TABLE_1 =
{
	16,
	{
		{ dump_RDD_PROCESSING_GROUP_PARAMS_GEN4_ENTRY, 0x2280 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT FPM_POOL_NUMBER_MAPPING_TABLE_1 =
{
	1,
	{
		{ dump_RDD_FPM_POOL_NUMBER, 0x2890 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SPDSVC_GEN_PARAMS_TABLE_1 =
{
	60,
	{
		{ dump_RDD_SPDSVC_GEN_PARAMS, 0x28c0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT PBIT_TO_QUEUE_TABLE_1 =
{
	8,
	{
		{ dump_RDD_PBIT_TO_QUEUE_8, 0x2900 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_RECYCLE_INTERRUPT_COALESCING_TABLE_1 =
{
	16,
	{
		{ dump_RDD_CPU_INTERRUPT_COALESCING_ENTRY, 0x29f0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT LAYER2_HEADER_COPY_MAPPING_TABLE_1 =
{
	4,
	{
		{ dump_RDD_LAYER2_HEADER_COPY_MAPPING_ENTRY, 0x2b80 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT TX_ABS_RECYCLE_COUNTERS_1 =
{
	8,
	{
		{ dump_RDD_TX_ABS_RECYCLE_COUNTERS_ENTRY, 0x2bf8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_FEED_RING_DESCRIPTOR_TABLE_1 =
{
	16,
	{
		{ dump_RDD_CPU_RING_DESCRIPTOR, 0x2c70 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT UDPSPDT_TX_PARAMS_TABLE_1 =
{
	24,
	{
		{ dump_RDD_UDPSPDT_TX_PARAMS, 0x2d00 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT RX_MIRRORING_TABLE_1 =
{
	2,
	{
		{ dump_RDD_MIRRORING_TRUNCATE_ENTRY, 0x2d60 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT HOST_TX_TRUNCATE_MIRRORING_TABLE_1 =
{
	2,
	{
		{ dump_RDD_MIRRORING_TRUNCATE_ENTRY, 0x2e60 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT VPORT_CFG_EX_TABLE_1 =
{
	4,
	{
		{ dump_RDD_VPORT_CFG_EX_ENTRY, 0x2e80 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT VPORT_TO_RL_OVERHEAD_TABLE_1 =
{
	1,
	{
		{ dump_RDD_VPORT_TO_RL_OVERHEAD_ENTRY, 0x2fe0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SPDTEST_GEN_PARAM_1 =
{
	4,
	{
		{ dump_RDD_SPDTEST_GEN_CFG, 0x2ff0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SPDSVC_ANALYZER_PARAMS_TABLE_1 =
{
	16,
	{
		{ dump_RDD_SPDSVC_ANALYZER_PARAMS, 0x3230 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT PD_FIFO_TABLE_1 =
{
	16,
	{
		{ dump_RDD_PROCESSING_TX_DESCRIPTOR, 0x3240 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DEFAULT_VLAN_VID_TABLE_1 =
{
	2,
	{
		{ dump_RDD_DEFAULT_VLAN_VID_ENTRY, 0x3280 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT PKTGEN_SESSION_DATA_1 =
{
	32,
	{
		{ dump_RDD_PKTGEN_TX_PARAMS, 0x3380 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_CONFIGURATION_TABLE_1 =
{
	12,
	{
		{ dump_RDD_HW_IPTV_CONFIGURATION, 0x33e0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SPDSVC_TCPSPDTEST_COMMON_TABLE_1 =
{
	1,
	{
		{ dump_RDD_SPDSVC_TCPSPDTEST_COMMON_ENTRY, 0x33ec },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT RX_MIRRORING_CONFIGURATION_1 =
{
	2,
	{
		{ dump_RDD_MIRRORING_DESCRIPTOR, 0x33ee },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT GENERAL_QUEUE_DYNAMIC_MNG_TABLE_1 =
{
	12,
	{
		{ dump_RDD_QUEUE_DYNAMIC_MNG_ENTRY, 0x33f0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT TX_MIRRORING_CONFIGURATION_1 =
{
	2,
	{
		{ dump_RDD_MIRRORING_DESCRIPTOR, 0x33fc },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT PKTGEN_FPM_UG_MGMT_1 =
{
	20,
	{
		{ dump_RDD_PKTGEN_FPM_UG_MGMT_ENTRY, 0x3400 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT INGRESS_PACKET_BASED_MAPPING_1 =
{
	4,
	{
		{ dump_RDD_INGRESS_PACKET_BASED_MAPPING_ENTRY, 0x3418 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_REDIRECT_MODE_1 =
{
	1,
	{
		{ dump_RDD_CPU_REDIRECT_MODE_ENTRY, 0x341c },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_CLASSIFICATION_CFG_TABLE_1 =
{
	1,
	{
		{ dump_RDD_IPTV_CLASSIFICATION_CFG_ENTRY, 0x341f },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_RECYCLE_RING_DESCRIPTOR_TABLE_1 =
{
	16,
	{
		{ dump_RDD_CPU_RING_DESCRIPTOR, 0x3450 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_RECYCLE_RING_INTERRUPT_COUNTER_TABLE_1 =
{
	8,
	{
		{ dump_RDD_CPU_RING_INTERRUPT_COUNTER_ENTRY, 0x3478 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT PKTGEN_SBPM_EXTS_1 =
{
	4,
	{
		{ dump_RDD_PKTGEN_SBPM_EXT, 0x34d0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT TUNNEL_HEADER_PSRAM_BUFFER_1 =
{
	4,
	{
		{ dump_RDD_TUNNEL_HEADER_PSRAM_BUFFER, 0x3520 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT TUNNELS_PARSING_CFG_1 =
{
	8,
	{
		{ dump_RDD_TUNNELS_PARSING_CFG, 0x3538 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_DDR_CTX_TABLE_ADDRESS_1 =
{
	8,
	{
		{ dump_RDD_IPTV_DDR_CTX_TABLE_ADDRESS, 0x3558 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DHD_POST_COMMON_RADIO_DATA_2 =
{
	200,
	{
		{ dump_RDD_DHD_POST_COMMON_RADIO_ENTRY, 0xa00 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT PROCESSING_GROUP_PARAMS_GEN4_TABLE_2 =
{
	16,
	{
		{ dump_RDD_PROCESSING_GROUP_PARAMS_GEN4_ENTRY, 0xf80 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT POLICER_PARAMS_TABLE_2 =
{
	2,
	{
		{ dump_RDD_POLICER_PARAMS_ENTRY, 0x2600 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT FLOODING_HEADER_FPM_POOL_NUMBER_MAPPING_TABLE_2 =
{
	1,
	{
		{ dump_RDD_FPM_POOL_NUMBER, 0x26a0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT FPM_POOL_NUMBER_MAPPING_TABLE_2 =
{
	1,
	{
		{ dump_RDD_FPM_POOL_NUMBER, 0x2790 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT RX_MIRRORING_TABLE_2 =
{
	2,
	{
		{ dump_RDD_MIRRORING_TRUNCATE_ENTRY, 0x28a0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_RECYCLE_INTERRUPT_COALESCING_TABLE_2 =
{
	16,
	{
		{ dump_RDD_CPU_INTERRUPT_COALESCING_ENTRY, 0x2990 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT HOST_TX_TRUNCATE_MIRRORING_TABLE_2 =
{
	2,
	{
		{ dump_RDD_MIRRORING_TRUNCATE_ENTRY, 0x29a0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SPDSVC_ANALYZER_PARAMS_TABLE_2 =
{
	16,
	{
		{ dump_RDD_SPDSVC_ANALYZER_PARAMS, 0x2af0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SPDSVC_WLAN_TXPOST_PARAMS_TABLE_2 =
{
	2,
	{
		{ dump_RDD_SPDSVC_WLAN_TXPOST_PARAMS, 0x2be2 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT VPORT_TO_RL_OVERHEAD_TABLE_2 =
{
	1,
	{
		{ dump_RDD_VPORT_TO_RL_OVERHEAD_ENTRY, 0x2ce0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT TX_MIRRORING_CONFIGURATION_2 =
{
	2,
	{
		{ dump_RDD_MIRRORING_DESCRIPTOR, 0x2e7c },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT ECN_IPV6_REMARK_TABLE_2 =
{
	1,
	{
		{ dump_RDD_ECN_IPV6_REMARK_ENTRY, 0x2e7e },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DHD_TX_COMPLETE_FLOW_RING_BUFFER_2 =
{
	16,
	{
		{ dump_RDD_DHD_TX_COMPLETE_DESCRIPTOR, 0x2ec0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_CONFIGURATION_TABLE_2 =
{
	12,
	{
		{ dump_RDD_HW_IPTV_CONFIGURATION, 0x2ee0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_REDIRECT_MODE_2 =
{
	1,
	{
		{ dump_RDD_CPU_REDIRECT_MODE_ENTRY, 0x2eef },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT GENERAL_QUEUE_DYNAMIC_MNG_TABLE_2 =
{
	12,
	{
		{ dump_RDD_QUEUE_DYNAMIC_MNG_ENTRY, 0x2ef0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_CLASSIFICATION_CFG_TABLE_2 =
{
	1,
	{
		{ dump_RDD_IPTV_CLASSIFICATION_CFG_ENTRY, 0x2efd },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DHD_RX_POST_FLOW_RING_BUFFER_2 =
{
	32,
	{
		{ dump_RDD_DHD_RX_POST_DESCRIPTOR, 0x2f80 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SPDSVC_WLAN_GEN_PARAMS_TABLE_2 =
{
	10,
	{
		{ dump_RDD_SPDSVC_WLAN_GEN_PARAMS, 0x2ff0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_RECYCLE_RING_DESCRIPTOR_TABLE_2 =
{
	16,
	{
		{ dump_RDD_CPU_RING_DESCRIPTOR, 0x30d0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SYSTEM_CONFIGURATION_2 =
{
	5,
	{
		{ dump_RDD_SYSTEM_CONFIGURATION_ENTRY, 0x30f8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT RING_CPU_TX_DESCRIPTOR_DATA_TABLE_2 =
{
	16,
	{
		{ dump_RDD_RING_CPU_TX_DESCRIPTOR, 0x3100 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT INGRESS_PACKET_BASED_MAPPING_2 =
{
	4,
	{
		{ dump_RDD_INGRESS_PACKET_BASED_MAPPING_ENTRY, 0x3138 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT EMAC_FLOW_CTRL_BUDGET_2 =
{
	4,
	{
		{ dump_RDD_EMAC_FLOW_CTRL_BUDGET_ENTRY, 0x3140 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_TX_RING_INDICES_VALUES_TABLE_2 =
{
	4,
	{
		{ dump_RDD_CPU_TX_RING_INDICES, 0x3178 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT TUNNELS_PARSING_CFG_2 =
{
	8,
	{
		{ dump_RDD_TUNNELS_PARSING_CFG, 0x31a8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT TUNNEL_HEADER_PSRAM_BUFFER_2 =
{
	4,
	{
		{ dump_RDD_TUNNEL_HEADER_PSRAM_BUFFER, 0x3220 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_DDR_CTX_TABLE_ADDRESS_2 =
{
	8,
	{
		{ dump_RDD_IPTV_DDR_CTX_TABLE_ADDRESS, 0x3238 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_TX_SYNC_FIFO_TABLE_2 =
{
	8,
	{
		{ dump_RDD_CPU_TX_SYNC_FIFO_ENTRY, 0x3280 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT INGRESS_FILTER_CFG_2 =
{
	2,
	{
		{ dump_RDD_INGRESS_FILTER_CFG, 0x3298 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT MULTICAST_KEY_MASK_2 =
{
	4,
	{
		{ dump_RDD_MULTICAST_KEY_MASK_ENTRY, 0x32a0 },
		{ 0, 0 },
	}
};
#endif
...
#endif
#if defined BCM6846
	{ "COMPLEX_SCHEDULER_TABLE_DS", 1, CORE_0_INDEX, &COMPLEX_SCHEDULER_TABLE_DS, 6, 1, 1 },
#endif
#if defined BCM6846
	{ "DS_TM_AQM_QUEUE_TIMER_TABLE", 1, CORE_0_INDEX, &DS_TM_AQM_QUEUE_TIMER_TABLE, 64, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "COMPLEX_SCHEDULER_TABLE_US", 1, CORE_0_INDEX, &COMPLEX_SCHEDULER_TABLE_US, 4, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "HOST_TX_TRUNCATE_MIRRORING_TABLE", 1, CORE_0_INDEX, &HOST_TX_TRUNCATE_MIRRORING_TABLE, 16, 1, 1 },
#endif
#if defined BCM6846
	{ "REPORTING_COUNTER_TABLE", 1, CORE_0_INDEX, &REPORTING_COUNTER_TABLE, 40, 1, 1 },
#endif
#if defined BCM6846
	{ "ETH_TM_TX_TRUNCATE_MIRRORING_TABLE", 1, CORE_0_INDEX, &ETH_TM_TX_TRUNCATE_MIRRORING_TABLE, 16, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "TM_PI2_PROBABILITY_CALC_DESCRIPTOR", 1, CORE_0_INDEX, &TM_PI2_PROBABILITY_CALC_DESCRIPTOR, 1, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "PON_TM_TX_TRUNCATE_MIRRORING_TABLE", 1, CORE_0_INDEX, &PON_TM_TX_TRUNCATE_MIRRORING_TABLE, 1, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "US_TM_AQM_QUEUE_TIMER_TABLE", 1, CORE_0_INDEX, &US_TM_AQM_QUEUE_TIMER_TABLE, 65, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "BASIC_SCHEDULER_WAKEUP_CMD_US", 1, CORE_0_INDEX, &BASIC_SCHEDULER_WAKEUP_CMD_US, 1, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "PON_TM_VPORT_TO_RL_OVERHEAD_TABLE", 1, CORE_0_INDEX, &PON_TM_VPORT_TO_RL_OVERHEAD_TABLE, 1, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "SERVICE_QUEUES_FLUSH_AGGREGATION_TASK_DISABLE", 1, CORE_0_INDEX, &SERVICE_QUEUES_FLUSH_AGGREGATION_TASK_DISABLE, 1, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "US_TM_AQM_QUEUE_TABLE", 1, CORE_0_INDEX, &US_TM_AQM_QUEUE_TABLE, 65, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "DS_TM_TX_QUEUE_DROP_TABLE", 1, CORE_0_INDEX, &DS_TM_TX_QUEUE_DROP_TABLE, 64, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "SERVICE_QUEUES_AQM_QUEUE_TABLE", 1, CORE_0_INDEX, &SERVICE_QUEUES_AQM_QUEUE_TABLE, 8, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "SERVICE_QUEUES_AQM_QUEUE_TIMER_TABLE", 1, CORE_0_INDEX, &SERVICE_QUEUES_AQM_QUEUE_TIMER_TABLE, 8, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "US_TM_CNTR_STASH_TABLE", 1, CORE_0_INDEX, &US_TM_CNTR_STASH_TABLE, 1, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "TCAM_IC_CMD_TABLE", 1, CORE_1_INDEX, &TCAM_IC_CMD_TABLE_1, 4, 16, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "PROCESSING_GROUP_PARAMS_GEN4_TABLE", 1, CORE_1_INDEX, &PROCESSING_GROUP_PARAMS_GEN4_TABLE_1, 8, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "RX_MIRRORING_TABLE", 1, CORE_1_INDEX, &RX_MIRRORING_TABLE_1, 16, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "VPORT_TO_RL_OVERHEAD_TABLE", 1, CORE_1_INDEX, &VPORT_TO_RL_OVERHEAD_TABLE_1, 16, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "TCAM_IC_CFG_TABLE", 1, CORE_1_INDEX, &TCAM_IC_CFG_TABLE_1, 3, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "DHD_POST_COMMON_RADIO_DATA", 1, CORE_2_INDEX, &DHD_POST_COMMON_RADIO_DATA_2, 2, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "DHD_FLOW_RING_CACHE_CTX_TABLE", 1, CORE_2_INDEX, &DHD_FLOW_RING_CACHE_CTX_TABLE_2, 32, 1, 1 },
#endif
#if defined BCM6846
	{ "DHD_COMPLETE_COMMON_RADIO_DATA", 1, CORE_2_INDEX, &DHD_COMPLETE_COMMON_RADIO_DATA_2, 2, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "DHD_AUX_INFO_CACHE_TABLE", 1, CORE_2_INDEX, &DHD_AUX_INFO_CACHE_TABLE_2, 32, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "RX_MIRRORING_TABLE", 1, CORE_2_INDEX, &RX_MIRRORING_TABLE_2, 16, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "DHD_TX_POST_FLOW_RING_BUFFER", 1, CORE_2_INDEX, &DHD_TX_POST_FLOW_RING_BUFFER_2, 2, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "DHD_BACKUP_INDEX_CACHE", 1, CORE_2_INDEX, &DHD_BACKUP_INDEX_CACHE_2, 2, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "DHD_RX_COMPLETE_FLOW_RING_BUFFER", 1, CORE_2_INDEX, &DHD_RX_COMPLETE_FLOW_RING_BUFFER_2, 2, 1, 1 },
#endif
#if defined BCM6846
	{ "DHD_TX_COMPLETE_FLOW_RING_BUFFER", 1, CORE_2_INDEX, &DHD_TX_COMPLETE_FLOW_RING_BUFFER_2, 2, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "DHD_FLOW_RING_CACHE_LKP_TABLE", 1, CORE_2_INDEX, &DHD_FLOW_RING_CACHE_LKP_TABLE_2, 32, 1, 1 },
#endif
#if defined BCM6846
	{ "DHD_RX_COMPLETE_DISPATCHER_CREDIT_TABLE", 1, CORE_2_INDEX, &DHD_RX_COMPLETE_DISPATCHER_CREDIT_TABLE_2, 8, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "DHD_RX_POST_FLOW_RING_BUFFER", 1, CORE_2_INDEX, &DHD_RX_POST_FLOW_RING_BUFFER_2, 2, 1, 1 },
#endif
#if defined BCM6846
	{ "DHD_TX_COMPLETE_DISPATCHER_CREDIT_TABLE", 1, CORE_2_INDEX, &DHD_TX_COMPLETE_DISPATCHER_CREDIT_TABLE_2, 8, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "DHD_L2_HEADER", 1, CORE_2_INDEX, &DHD_L2_HEADER_2, 48, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "DHD_DOORBELL_TX_COMPLETE_VALUE", 1, CORE_2_INDEX, &DHD_DOORBELL_TX_COMPLETE_VALUE_2, 2, 1, 1 },
#endif
#if defined BCM6846
	{ "CPU_TX_RING_INDICES_VALUES_TABLE", 1, CORE_2_INDEX, &CPU_TX_RING_INDICES_VALUES_TABLE_2, 2, 1, 1 },
#endif
#if defined BCM6846
	{ "DHD_CPU_TX_POST_RING_DESCRIPTOR_TABLE", 1, CORE_2_INDEX, &DHD_CPU_TX_POST_RING_DESCRIPTOR_TABLE_2, 2, 1, 1 },
#endif
#if defined BCM6846
	{ "DHD_DOORBELL_RX_COMPLETE_VALUE", 1, CORE_2_INDEX, &DHD_DOORBELL_RX_COMPLETE_VALUE_2, 2, 1, 1 },
#endif
#if defined BCM6846
	{ "TUNNELS_PARSING_CFG", 1, CORE_2_INDEX, &TUNNELS_PARSING_CFG_2, 1, 1, 1 },
#endif
#if defined BCM6846
	{ "DHD_DOORBELL_RX_POST_VALUE", 1, CORE_2_INDEX, &DHD_DOORBELL_RX_POST_VALUE_2, 2, 1, 1 },
#endif
#if defined BCM6846
	{ "DHD_RX_POST_RING_SIZE", 1, CORE_2_INDEX, &DHD_RX_POST_RING_SIZE_2, 2, 1, 1 },
#endif
#if defined BCM6846
	{ "BITS_CALC_MASKS_TABLE", 1, CORE_2_INDEX, &BITS_CALC_MASKS_TABLE_2, 4, 1, 1 },
#endif
#if defined BCM6846
	{ "DHD_CPU_INT_ID", 1, CORE_2_INDEX, &DHD_CPU_INT_ID_2, 2, 1, 1 },
#endif
#if defined BCM6846
	{ "DHD_RX_COMPLETE_RING_SIZE", 1, CORE_2_INDEX, &DHD_RX_COMPLETE_RING_SIZE_2, 2, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "DHD_TX_COMPLETE_RING_SIZE", 1, CORE_2_INDEX, &DHD_TX_COMPLETE_RING_SIZE_2, 2, 1, 1 },
#endif
#if defined BCM6846
	{ "DHD_CPU_RECYCLE_RING_DESCRIPTOR_TABLE", 1, CORE_2_INDEX, &DHD_CPU_RECYCLE_RING_DESCRIPTOR_TABLE_2, 2, 1, 1 },
#endif
#if defined BCM6846
...
#endif
#if defined BCM6846
	{ "DHD_FPM_REPLY", 1, CORE_2_INDEX, &DHD_FPM_REPLY_2, 16, 1, 1 },
#endif
#if defined BCM6846
