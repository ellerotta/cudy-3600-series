...
static void image_0_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    /* FLUSH TASK: thread 6 */
    local_regs[IMAGE_0_TM_FLUSH_THREAD_NUMBER][reg_id[19]] = (drv_qm_get_sq_start() << 16) + drv_qm_get_ds_start(0);
    local_regs[IMAGE_0_TM_FLUSH_THREAD_NUMBER][reg_id[18]] = (((drv_qm_get_us_end() - drv_qm_get_us_start() + 8) / 8) << 16) +
        ((((drv_qm_get_ds_end(0) - (drv_qm_get_ds_start(0) & ~0x1F)) + 8) / 8));
    ...
    local_regs[IMAGE_0_TM_FLUSH_THREAD_NUMBER][reg_id[15]] = (IMAGE_0_SERVICE_QUEUES_PD_FIFO_TABLE_ADDRESS << 16) +
        IMAGE_0_DS_TM_PD_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_0_TM_FLUSH_THREAD_NUMBER][reg_id[14]] = (IMAGE_0_SERVICE_QUEUES_SCHEDULING_QUEUE_AGING_VECTOR_ADDRESS << 16) +
        IMAGE_0_DS_TM_SCHEDULING_QUEUE_AGING_VECTOR_ADDRESS;
    local_regs[IMAGE_0_TM_FLUSH_THREAD_NUMBER][reg_id[13]] = (((drv_qm_get_sq_start() - (drv_qm_get_sq_start() % 32)) / 8) << 16) +
        ((drv_qm_get_ds_start(0) - (drv_qm_get_ds_start(0) % 32)) / 8);
    local_regs[IMAGE_0_TM_FLUSH_THREAD_NUMBER][reg_id[11]] = ((IMAGE_0_AQM_ENABLE_TABLE_ADDRESS + ((drv_qm_get_sq_start() & ~0x1f) / 8)) << 16) +
        IMAGE_0_US_TM_PD_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_0_TM_FLUSH_THREAD_NUMBER][reg_id[10]] = (((drv_qm_get_sq_end() - drv_qm_get_sq_start() + 8) / 8) << 16) +
        IMAGE_0_US_TM_SCHEDULING_QUEUE_AGING_VECTOR_ADDRESS;
...
static void image_1_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    /* CPU_RX_COPY_READ + (TcpSpdTest + pktgen_tx): thread 4 */
    ...
    local_regs[IMAGE_1_PROCESSING_CPU_RX_COPY_THREAD_NUMBER][reg_id[13]] = IMAGE_1_CPU_RX_COPY_UPDATE_FIFO_TABLE_ADDRESS;
    ...
    local_regs[IMAGE_1_PROCESSING_COMMON_REPROCESSING_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_1, common_reprocessing_wakeup_request) << 16 |
    ...
    local_regs[IMAGE_1_PROCESSING_SPDSVC_GEN_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_1, spdsvc_gen_wakeup_request) << 16;
    local_regs[IMAGE_1_PROCESSING_SPDSVC_GEN_THREAD_NUMBER][reg_id[9]] = ((BB_ID_DISPATCHER_REORDER + (DISP_REOR_VIQ_SPDSVC << 6)) << 16);
    local_regs[IMAGE_1_PROCESSING_SPDSVC_GEN_THREAD_NUMBER][reg_id[12]] = (IMAGE_1_SPDSVC_GEN_DISPATCHER_CREDIT_TABLE_ADDRESS << 16);
#endif
...
static void image_2_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
...
#ifdef CONFIG_DHD_RUNNER
    if (g_dhd_hw_config.offload_config == 0)
    {
        /* DHD_TX_COMPLETE_0: thread 1 */
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_COMPLETE_0_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_2, dhd_tx_complete_wakeup_request) << 16;
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_COMPLETE_0_THREAD_NUMBER][reg_id[13]] = (BB_ID_DISPATCHER_REORDER + (DISP_REOR_VIQ_DHD_TX_COMPLETE_0 << 6));
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_COMPLETE_0_THREAD_NUMBER][reg_id[12]] = (IMAGE_2_DHD_COMPLETE_COMMON_RADIO_DATA_ADDRESS +
                                                                                  sizeof(DHD_COMPLETE_COMMON_RADIO_ENTRY_STRUCT)*0) |
                                                                                  (IMAGE_2_DHD_TX_COMPLETE_DISPATCHER_CREDIT_TABLE_ADDRESS << 16);
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_COMPLETE_0_THREAD_NUMBER][reg_id[11]] = 0;

        /* DHD_RX_COMPLETE_0: thread 2 */
        local_regs[IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_2, dhd_rx_complete_wakeup_request) << 16;
        local_regs[IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[13]] = ((IMAGE_2_DHD_COMPLETE_COMMON_RADIO_DATA_ADDRESS +
                                                                                  sizeof(DHD_COMPLETE_COMMON_RADIO_ENTRY_STRUCT)*0));
        local_regs[IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[12]] = 0;
        local_regs[IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[11]] = (BB_ID_DISPATCHER_REORDER + (DISP_REOR_VIQ_DHD_RX_COMPLETE_0 << 6));
        local_regs[IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[10]] = 0;
        local_regs[IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[9]] = IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER |
                                                                                 (IMAGE_2_DHD_RX_COMPLETE_DISPATCHER_CREDIT_TABLE_ADDRESS << 16);
    }
    else
    {
        /* radio wl1 offload configuration */

        /* DHD_TX_COMPLETE_0: thread 1 */
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_COMPLETE_0_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_2, dhd_tx_complete_wakeup_request) << 16;
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_COMPLETE_0_THREAD_NUMBER][reg_id[13]] = (BB_ID_DISPATCHER_REORDER + (DISP_REOR_VIQ_DHD_TX_COMPLETE_1 << 6));
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_COMPLETE_0_THREAD_NUMBER][reg_id[12]] = (IMAGE_2_DHD_COMPLETE_COMMON_RADIO_DATA_ADDRESS +
                                                                                  sizeof(DHD_COMPLETE_COMMON_RADIO_ENTRY_STRUCT)*1) |
                                                                                  ((IMAGE_2_DHD_TX_COMPLETE_DISPATCHER_CREDIT_TABLE_ADDRESS + 16) << 16);
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_COMPLETE_0_THREAD_NUMBER][reg_id[11]] = 1;

        /* DHD_RX_COMPLETE_0: thread 2 */
        local_regs[IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_2, dhd_rx_complete_wakeup_request) << 16;
        local_regs[IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[13]] = ((IMAGE_2_DHD_COMPLETE_COMMON_RADIO_DATA_ADDRESS +
                                                                                  sizeof(DHD_COMPLETE_COMMON_RADIO_ENTRY_STRUCT)*1));
        local_regs[IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[12]] = 1;
        local_regs[IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[11]] = (BB_ID_DISPATCHER_REORDER + (DISP_REOR_VIQ_DHD_RX_COMPLETE_1 << 6));
        local_regs[IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[10]] = 0;
        local_regs[IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[9]] = IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER |
                                                                                 ((IMAGE_2_DHD_RX_COMPLETE_DISPATCHER_CREDIT_TABLE_ADDRESS + 16) << 16);
    }
    ...
    local_regs[IMAGE_2_IMAGE_2_DHD_TIMER_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_2, dhd_timer_1st_wakeup_request) << 16;

    if (g_dhd_hw_config.offload_config == 0)
    {
    	/* DHD_TX_POST_0: thread 7 */
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_POST_0_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_2, dhd_tx_post_wakeup_request) << 16;
        /* high = post_common_radio_ptr , low =radio_idx */
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_POST_0_THREAD_NUMBER][reg_id[13]] = 0 | ((IMAGE_2_DHD_POST_COMMON_RADIO_DATA_ADDRESS +
                                                                                    sizeof(DHD_POST_COMMON_RADIO_ENTRY_STRUCT)*0)) << 16;
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_POST_0_THREAD_NUMBER][reg_id[11]] = IMAGE_2_DHD_TX_POST_PD_FIFO_TABLE_ADDRESS + sizeof(PROCESSING_TX_DESCRIPTOR_STRUCT)*0;
    }
    else
    {
        /* radio wl1 offload configuration */
        ...
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_POST_0_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_2, dhd_tx_post_wakeup_request) << 16;
        /* high = post_common_radio_ptr , low =radio_idx */
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_POST_0_THREAD_NUMBER][reg_id[13]] = 1 | ((IMAGE_2_DHD_POST_COMMON_RADIO_DATA_ADDRESS +
                                                                                    sizeof(DHD_POST_COMMON_RADIO_ENTRY_STRUCT)*1)) << 16;
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_POST_0_THREAD_NUMBER][reg_id[11]] = IMAGE_2_DHD_TX_POST_PD_FIFO_TABLE_ADDRESS + sizeof(PROCESSING_TX_DESCRIPTOR_STRUCT)*2;
    }
    ...
    if (g_dhd_hw_config.offload_config == 0)
    {
        ...
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_POST_UPDATE_FIFO_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_2, dhd_tx_post_update_fifo_wakeup_request) << 16;
    ...
    else
    {
        ...
        /* DHD_TX_POST_UPDATE_FIFO_READ: thread 14 */
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_POST_UPDATE_FIFO_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_2, dhd_tx_post_update_fifo_wakeup_request) << 16;
        /* DHD_TX_POST_0_THREAD_NUMBER assumed to be > 0 */
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_POST_UPDATE_FIFO_THREAD_NUMBER][reg_id[12]] = (((IMAGE_2_IMAGE_2_DHD_TX_POST_0_THREAD_NUMBER - 1) << 4) + 9);
        local_regs[IMAGE_2_IMAGE_2_DHD_TX_POST_UPDATE_FIFO_THREAD_NUMBER][reg_id[11]] = IMAGE_2_DHD_TX_POST_UPDATE_FIFO_TABLE_ADDRESS;
    }
