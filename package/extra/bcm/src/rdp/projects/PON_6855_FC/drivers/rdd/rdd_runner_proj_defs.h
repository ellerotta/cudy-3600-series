...
#define US_TM_BBH_QUEUE_TABLE_SIZE       RDD_IMAGE_10_US_TM_BBH_QUEUE_TABLE_SIZE
#define DS_TM_BBH_QUEUE_TABLE_SIZE       RDD_IMAGE_9_DS_TM_BBH_QUEUE_TABLE_SIZE
...
/* TODO 6855_TMC - for compilation gave general timer, but should handle properly inside timer (for all cores DS, US, SQ)*/
#define DS_TM_PI2_THREAD_NUMBER IMAGE_4_DS_TM_GENERAL_TIMER_THREAD_NUMBER
#define US_TM_PI2_THREAD_NUMBER IMAGE_5_US_TM_GENERAL_TIMER_THREAD_NUMBER
