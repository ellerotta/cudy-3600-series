...
rdd_vport_id_t rx_flow_to_vport[RX_FLOW_CONTEXTS_NUMBER] = {
    ...
    [RDD_NUM_OF_RX_WAN_FLOWS + BB_ID_RX_BBH_8] = RDD_LAN8_VPORT,
    [RDD_NUM_OF_RX_WAN_FLOWS + BB_ID_RX_BBH_9] = RDD_LAN9_VPORT,
    [RDD_NUM_OF_RX_WAN_FLOWS + BB_ID_RX_BBH_10] = RDD_LAN10_VPORT,
...
static void image_1_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    local_regs[IMAGE_1_IMAGE_1_TCPSPDTEST_GEN_THREAD_NUMBER][reg_id[9]] = ((BB_ID_DISPATCHER_REORDER + (DISP_REOR_VIQ_TCPSPDTEST_GEN << 6)) << 16);
...
static void image_3_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    /* CPU_RX_READ */
    local_regs[IMAGE_3_IMAGE_3_CPU_RX_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_3, c_cpu_rx_wakeup_request);
    /* Remove after disabling binary builder on C */
    local_regs[IMAGE_3_IMAGE_3_CPU_RX_THREAD_NUMBER][reg_id[17]] = IMAGE_3_PD_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_3_IMAGE_3_CPU_RX_THREAD_NUMBER][reg_id[18]] = IMAGE_3_UPDATE_FIFO_TABLE_ADDRESS;
    /* ---------------------------------- */
    local_regs[IMAGE_3_IMAGE_3_CPU_RX_THREAD_NUMBER][reg_id[8]] = IMAGE_3_PD_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_3_IMAGE_3_CPU_RX_THREAD_NUMBER][reg_id[9]] = IMAGE_3_UPDATE_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_3_IMAGE_3_CPU_RX_THREAD_NUMBER][reg_id[30]] = IMAGE_3_CPU_RX_STACK_ADDRESS+IMAGE_3_CPU_RX_STACK_BYTE_SIZE;

    /* CPU_RX_COPY_READ */
    local_regs[IMAGE_3_IMAGE_3_CPU_RX_COPY_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_3, c_cpu_rx_copy_wakeup_request);
    local_regs[IMAGE_3_IMAGE_3_CPU_RX_COPY_THREAD_NUMBER][reg_id[30]] = IMAGE_3_CPU_RX_COPY_STACK_ADDRESS+IMAGE_3_CPU_RX_COPY_STACK_BYTE_SIZE;
    ...
    local_regs[IMAGE_3_IMAGE_3_SPU_REQUEST_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_3, c_spu_request_wakeup_request);
    local_regs[IMAGE_3_IMAGE_3_SPU_REQUEST_THREAD_NUMBER][reg_id[30]] = IMAGE_3_SPU_REQUEST_STACK_ADDRESS+IMAGE_3_SPU_REQUEST_STACK_BYTE_SIZE;
#endif

#if defined(CONFIG_BCM_SPDSVC_SUPPORT)
    /* SPDSVC_ANALYZER */
    local_regs[IMAGE_3_IMAGE_3_SPDSVC_ANALYZER_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_3, c_spdsvc_analyzer_wakeup_request);
    local_regs[IMAGE_3_IMAGE_3_SPDSVC_ANALYZER_THREAD_NUMBER][reg_id[30]] = IMAGE_3_SPDSVC_ANALYZER_STACK_ADDRESS+IMAGE_3_SPDSVC_ANALYZER_STACK_BYTE_SIZE;
#endif
...
#ifdef CONFIG_DHD_RUNNER
    local_regs[IMAGE_4_IMAGE_4_DHD_TIMER_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_4, c_dhd_timer_wakeup_request);
    local_regs[IMAGE_4_IMAGE_4_DHD_TIMER_THREAD_NUMBER][reg_id[30]] = IMAGE_4_DHD_TIMER_STACK_ADDRESS+IMAGE_4_DHD_TIMER_STACK_BYTE_SIZE;

    /* DHD_TX_POST_UPDATE_FIFO */
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_POST_UPDATE_FIFO_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_4, c_dhd_tx_post_update_fifo_wakeup_request);
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_POST_UPDATE_FIFO_THREAD_NUMBER][reg_id[8]] = IMAGE_4_DHD_TX_POST_UPDATE_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_POST_UPDATE_FIFO_THREAD_NUMBER][reg_id[30]] = IMAGE_4_DHD_TX_POST_UPDATE_FIFO_STACK_ADDRESS + IMAGE_4_DHD_TX_POST_UPDATE_FIFO_STACK_BYTE_SIZE;

    /* DHD_TX_POST_0 */
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_POST_0_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_4, c_dhd_tx_post_wakeup_request);
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_POST_0_THREAD_NUMBER][reg_id[8]] = 0;
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_POST_0_THREAD_NUMBER][reg_id[30]] = IMAGE_4_DHD_TX_POST_0_STACK_ADDRESS + IMAGE_4_DHD_TX_POST_0_STACK_BYTE_SIZE;

    /* DHD_TX_POST_1 */
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_POST_1_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_4, c_dhd_tx_post_wakeup_request);
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_POST_1_THREAD_NUMBER][reg_id[8]] = 1;
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_POST_1_THREAD_NUMBER][reg_id[30]] = IMAGE_4_DHD_TX_POST_1_STACK_ADDRESS + IMAGE_4_DHD_TX_POST_1_STACK_BYTE_SIZE;

    /* DHD_TX_POST_2 */
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_POST_2_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_4, c_dhd_tx_post_wakeup_request);
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_POST_2_THREAD_NUMBER][reg_id[8]] = 2;
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_POST_2_THREAD_NUMBER][reg_id[30]] = IMAGE_4_DHD_TX_POST_2_STACK_ADDRESS + IMAGE_4_DHD_TX_POST_2_STACK_BYTE_SIZE;
#endif

#if defined(CONFIG_RUNNER_SPU_OFFLOAD)
    /* SPU response thread */
    local_regs[IMAGE_4_IMAGE_4_SPU_RESPONSE_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_4, c_spu_response_wakeup_request);
    local_regs[IMAGE_4_IMAGE_4_SPU_RESPONSE_THREAD_NUMBER][reg_id[30]] = IMAGE_4_SPU_RESPONSE_STACK_ADDRESS+IMAGE_4_SPU_RESPONSE_STACK_BYTE_SIZE;
#endif

    /* FPM_RINGS AND BUFMNG REFILL 5 */
#if defined(CONFIG_CPU_TX_FROM_XPM)
    local_regs[IMAGE_4_IMAGE_4_CPU_FPM_RINGS_REFILL_AND_BUFMNG_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_4, c_cpu_fpm_rings_and_bufmng_refill_wakeup_request);
    local_regs[IMAGE_4_IMAGE_4_CPU_FPM_RINGS_REFILL_AND_BUFMNG_THREAD_NUMBER][reg_id[8]] = IMAGE_4_IMAGE_4_CPU_FPM_RINGS_REFILL_AND_BUFMNG_THREAD_NUMBER;
    local_regs[IMAGE_4_IMAGE_4_CPU_FPM_RINGS_REFILL_AND_BUFMNG_THREAD_NUMBER][reg_id[30]] =
        IMAGE_4_CPU_FPM_RINGS_REFILL_AND_BUFMNG_STACK_ADDRESS + IMAGE_4_CPU_FPM_RINGS_REFILL_AND_BUFMNG_STACK_BYTE_SIZE;
#endif
...
static void image_5_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    /* DIRECT PROCESSING */
    local_regs[IMAGE_5_IMAGE_5_DIRECT_FLOW_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_5, direct_flow_wakeup_request);
    local_regs[IMAGE_5_IMAGE_5_DIRECT_FLOW_THREAD_NUMBER][reg_id[30]] = IMAGE_5_DIRECT_FLOW_STACK_ADDRESS + C_DEFS_DIRECT_FLOW_STACK_SIZE;

    /* REPORTING */
    local_regs[IMAGE_5_IMAGE_5_REPORTING_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_5, ghost_reporting_wakeup_request);
    local_regs[IMAGE_5_IMAGE_5_REPORTING_THREAD_NUMBER][reg_id[8]] = drv_qm_get_us_end();
    local_regs[IMAGE_5_IMAGE_5_REPORTING_THREAD_NUMBER][reg_id[9]] = xrdp_virt2phys(&RU_BLK(QM), 0) + RU_REG_OFFSET(QM, EPON_RPT_CNT_QUEUE_STATUS);
    local_regs[IMAGE_5_IMAGE_5_REPORTING_THREAD_NUMBER][reg_id[10]] = xrdp_virt2phys(&RU_BLK(QM), 0) + RU_REG_OFFSET(QM, EPON_RPT_CNT_COUNTER);
    local_regs[IMAGE_5_IMAGE_5_REPORTING_THREAD_NUMBER][reg_id[11]] = xrdp_virt2phys(&RU_BLK(QM), 0) + RU_REG_OFFSET(QM, TOTAL_VALID_COUNTER_COUNTER);
    local_regs[IMAGE_5_IMAGE_5_REPORTING_THREAD_NUMBER][reg_id[30]] = IMAGE_5_REPORTING_STACK_ADDRESS + IMAGE_5_REPORTING_STACK_BYTE_SIZE;

#if defined(CONFIG_CPU_TX_MCORE)
    /* GENERAL_TIMER */
    local_regs[IMAGE_5_IMAGE_5_GENERAL_TIMER_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_5, general_timer_wakeup_request);
    local_regs[IMAGE_5_IMAGE_5_GENERAL_TIMER_THREAD_NUMBER][reg_id[30]] = IMAGE_5_GENERAL_TIMER_STACK_ADDRESS+IMAGE_5_GENERAL_TIMER_STACK_BYTE_SIZE;

    /* CPU_RECYCLE */
    local_regs[IMAGE_5_IMAGE_5_CPU_RECYCLE_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_5, c_cpu_recycle_wakeup_request);
    local_regs[IMAGE_5_IMAGE_5_CPU_RECYCLE_THREAD_NUMBER][reg_id[30]] = IMAGE_5_CPU_RECYCLE_STACK_ADDRESS+IMAGE_5_CPU_RECYCLE_STACK_BYTE_SIZE;

    /* CPU Tx_mcore thread */
    local_regs[IMAGE_5_IMAGE_5_CPU_TX_MCORE_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_5, c_cpu_tx_mcore_wakeup_request);
    local_regs[IMAGE_5_IMAGE_5_CPU_TX_MCORE_THREAD_NUMBER][reg_id[8]] = IMAGE_5_IMAGE_5_CPU_TX_MCORE_THREAD_NUMBER;
    local_regs[IMAGE_5_IMAGE_5_CPU_TX_MCORE_THREAD_NUMBER][reg_id[30]] = IMAGE_5_CPU_TX_MCORE_STACK_ADDRESS+IMAGE_5_CPU_TX_MCORE_STACK_BYTE_SIZE;
#endif
    ...
    for (task = IMAGE_5_IMAGE_5_PROCESSING0_THREAD_NUMBER; task <= IMAGE_5_IMAGE_5_PROCESSING7_THREAD_NUMBER; task++)
    {
        ...
        local_regs[task][reg_id[10]] =
            image_5_dynamic_code_section + ((task - PROJ_DEFS_FIRST_PROCESSING_THREAD_ID) * (image_5_dynamic_code_section_proc1 - image_5_dynamic_code_section_proc0));
    }
    /* Stack init - should point to the end of stack */
...
static void image_6_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    ag_drv_rnr_regs_cfg_ext_acc_cfg_set(core_index, PACKET_BUFFER_PD_PTR(IMAGE_6_PROCESSING_2_TASKS_PACKET_BUFFER_ADDRESS, 0), 8, 8, 8);

    /* GENERAL_TIMER */
    local_regs[IMAGE_6_IMAGE_6_GENERAL_TIMER_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, general_timer_wakeup_request);
    local_regs[IMAGE_6_IMAGE_6_GENERAL_TIMER_THREAD_NUMBER][reg_id[30]] = IMAGE_6_GENERAL_TIMER_STACK_ADDRESS + IMAGE_6_GENERAL_TIMER_STACK_BYTE_SIZE;

    /* UPDATE_FIFO_READ for US */
    local_regs[IMAGE_6_IMAGE_6_UPDATE_FIFO_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, tm_update_fifo_first_wakeup_request);
    local_regs[IMAGE_6_IMAGE_6_UPDATE_FIFO_THREAD_NUMBER][reg_id[8]] = IMAGE_6_UPDATE_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_6_IMAGE_6_UPDATE_FIFO_THREAD_NUMBER][reg_id[30]] = IMAGE_6_UPDATE_FIFO_STACK_ADDRESS + C_DEFS_UPDATE_FIFO_STACK_SIZE;

    /* SCHEDULING LAN */
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_US_0_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, tm_tx_task_wakeup_request);
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_US_0_THREAD_NUMBER][reg_id[8]] = 0;
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_US_0_THREAD_NUMBER][reg_id[9]] = IMAGE_6_IMAGE_6_TX_TASK_US_0_THREAD_NUMBER;
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_US_0_THREAD_NUMBER][reg_id[30]] = IMAGE_6_TX_TASK_US_0_STACK_ADDRESS + C_DEFS_TX_TASK_STACK_SIZE;

    /* SCHEDULING LAN1 */
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_US_1_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, tm_tx_task_wakeup_request);
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_US_1_THREAD_NUMBER][reg_id[8]] = 1;  /* BBH_TX_ID = 1 */
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_US_1_THREAD_NUMBER][reg_id[9]] = IMAGE_6_IMAGE_6_TX_TASK_US_1_THREAD_NUMBER;
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_US_1_THREAD_NUMBER][reg_id[30]] = IMAGE_6_TX_TASK_US_1_STACK_ADDRESS + C_DEFS_TX_TASK_STACK_SIZE;

    /* SCHEDULING WAN */
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_PON_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, tm_tx_task_wakeup_request);
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_PON_THREAD_NUMBER][reg_id[8]] = TM_INDEX_DSL_OR_PON;
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_PON_THREAD_NUMBER][reg_id[9]] = IMAGE_6_IMAGE_6_TX_TASK_PON_THREAD_NUMBER;
    local_regs[IMAGE_6_IMAGE_6_TX_TASK_PON_THREAD_NUMBER][reg_id[30]] = IMAGE_6_TX_TASK_PON_STACK_ADDRESS + C_DEFS_TX_TASK_STACK_SIZE;

#if defined(EPON)
    /* EPON UPDATE FIFO */
    local_regs[IMAGE_6_US_TM_UPDATE_FIFO_EPON_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, epon_tm_update_fifo_first_wakeup_request);
    local_regs[IMAGE_6_US_TM_UPDATE_FIFO_EPON_THREAD_NUMBER][reg_id[8]] = IMAGE_6_UPDATE_FIFO_EPON_TABLE_ADDRESS;
    local_regs[IMAGE_6_US_TM_UPDATE_FIFO_EPON_THREAD_NUMBER][reg_id[9]] = BB_ID_QM_RNR_GRID;
    local_regs[IMAGE_6_US_TM_UPDATE_FIFO_EPON_THREAD_NUMBER][reg_id[10]] = drv_qm_get_us_epon_start();
    local_regs[IMAGE_6_US_TM_UPDATE_FIFO_EPON_THREAD_NUMBER][reg_id[30]] = IMAGE_6_UPDATE_FIFO_EPON_STACK_ADDRESS + C_DEFS_UPDATE_FIFO_EPON_STACK_SIZE;

    /* EPON WAN */
    local_regs[IMAGE_6_US_TM_WAN_EPON_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, epon_tm_tx_task_wakeup_request);
    local_regs[IMAGE_6_US_TM_WAN_EPON_THREAD_NUMBER][reg_id[8]] = BB_ID_TX_PON_ETH_PD;
    local_regs[IMAGE_6_US_TM_WAN_EPON_THREAD_NUMBER][reg_id[9]] = drv_qm_get_us_epon_start();
    local_regs[IMAGE_6_US_TM_WAN_EPON_THREAD_NUMBER][reg_id[10]] = BB_ID_QM_RNR_GRID;
    local_regs[IMAGE_6_US_TM_WAN_EPON_THREAD_NUMBER][reg_id[30]] = IMAGE_6_WAN_EPON_STACK_ADDRESS + C_DEFS_EPON_TX_TASK_STACK_SIZE;
#endif

#ifdef BUFFER_CONGESTION_MGT
    /* BUFFER_CONG_MGT: thread 3 */
    local_regs[IMAGE_6_IMAGE_6_BUFFER_CONG_MGT_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_6, buffer_cong_mgt_1st_wakeup_request);
#endif

    /* PROCESSING */
    for (task = IMAGE_6_IMAGE_6_PROCESSING0_THREAD_NUMBER; task <= IMAGE_6_IMAGE_6_PROCESSING1_THREAD_NUMBER; task++)
    {
        local_regs[task][reg_id[0]] = ADDRESS_OF(image_6, processing_wakeup_request);
        local_regs[task][reg_id[8]] = task;
        local_regs[task][reg_id[9]] = PACKET_BUFFER_PD_PTR(IMAGE_6_PROCESSING_2_TASKS_PACKET_BUFFER_ADDRESS, (task - IMAGE_6_IMAGE_6_PROCESSING0_THREAD_NUMBER));
        local_regs[task][reg_id[10]] =
            image_6_dynamic_code_section + ((task - PROJ_DEFS_FIRST_PROCESSING_THREAD_ID) * (image_6_dynamic_code_section_proc1 - image_6_dynamic_code_section_proc0));
    }
    /* Stack init - should point to the end of stack */
...
static void image_7_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    ag_drv_rnr_regs_cfg_ext_acc_cfg_set(core_index, PACKET_BUFFER_PD_PTR(IMAGE_7_PROCESSING_6_TASKS_PACKET_BUFFER_ADDRESS, 0), 8, 8, 8);

    /* GENERAL_TIMER: thread 0 */
    local_regs[IMAGE_7_IMAGE_7_GENERAL_TIMER_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_7, general_timer_wakeup_request);
    local_regs[IMAGE_7_IMAGE_7_GENERAL_TIMER_THREAD_NUMBER][reg_id[30]] = IMAGE_7_GENERAL_TIMER_STACK_ADDRESS + IMAGE_7_GENERAL_TIMER_STACK_BYTE_SIZE;

    /* UPDATE_FIFO_READ for DS */
    local_regs[IMAGE_7_IMAGE_7_UPDATE_FIFO_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_7, tm_update_fifo_first_wakeup_request);
    local_regs[IMAGE_7_IMAGE_7_UPDATE_FIFO_THREAD_NUMBER][reg_id[8]] = IMAGE_7_UPDATE_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_7_IMAGE_7_UPDATE_FIFO_THREAD_NUMBER][reg_id[30]] = IMAGE_7_UPDATE_FIFO_STACK_ADDRESS + C_DEFS_UPDATE_FIFO_STACK_SIZE;

    /* SCHEDULING LAN */
    local_regs[IMAGE_7_IMAGE_7_TX_TASK_DS_0_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_7, tm_tx_task_wakeup_request);
    local_regs[IMAGE_7_IMAGE_7_TX_TASK_DS_0_THREAD_NUMBER][reg_id[8]] = 0;
    local_regs[IMAGE_7_IMAGE_7_TX_TASK_DS_0_THREAD_NUMBER][reg_id[9]] = IMAGE_7_IMAGE_7_TX_TASK_DS_0_THREAD_NUMBER;
    local_regs[IMAGE_7_IMAGE_7_TX_TASK_DS_0_THREAD_NUMBER][reg_id[30]] = IMAGE_7_TX_TASK_DS_0_STACK_ADDRESS + C_DEFS_TX_TASK_STACK_SIZE;

    /* SCHEDULING LAN1 */
    local_regs[IMAGE_7_IMAGE_7_TX_TASK_DS_1_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_7, tm_tx_task_wakeup_request);
    local_regs[IMAGE_7_IMAGE_7_TX_TASK_DS_1_THREAD_NUMBER][reg_id[8]] = 1;  /* BBH_TX_ID = 1 */
    local_regs[IMAGE_7_IMAGE_7_TX_TASK_DS_1_THREAD_NUMBER][reg_id[9]] = IMAGE_7_IMAGE_7_TX_TASK_DS_1_THREAD_NUMBER;
    local_regs[IMAGE_7_IMAGE_7_TX_TASK_DS_1_THREAD_NUMBER][reg_id[30]] = IMAGE_7_TX_TASK_DS_1_STACK_ADDRESS + C_DEFS_TX_TASK_STACK_SIZE;

#ifdef BUFFER_CONGESTION_MGT
    /* BUFFER_CONG_MGT: thread 1 */
    local_regs[IMAGE_7_IMAGE_7_BUFFER_CONG_MGT_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_7, buffer_cong_mgt_1st_wakeup_request);
#endif

    /* PROCESSING */
    for (task = IMAGE_7_IMAGE_7_PROCESSING0_THREAD_NUMBER; task <= IMAGE_7_IMAGE_7_PROCESSING5_THREAD_NUMBER; task++)
    {
        local_regs[task][reg_id[0]] = ADDRESS_OF(image_7, processing_wakeup_request);
        local_regs[task][reg_id[8]] = task;
        local_regs[task][reg_id[9]] = PACKET_BUFFER_PD_PTR(IMAGE_7_PROCESSING_6_TASKS_PACKET_BUFFER_ADDRESS, (task - IMAGE_7_IMAGE_7_PROCESSING0_THREAD_NUMBER));
        local_regs[task][reg_id[10]] =
            image_7_dynamic_code_section + ((task - PROJ_DEFS_FIRST_PROCESSING_THREAD_ID) * (image_7_dynamic_code_section_proc1 - image_7_dynamic_code_section_proc0));
    }
    /* Stack init - should point to the end of stack */
...
int rdd_data_structures_init(rdd_init_params_t *init_params, HW_IPTV_CONFIGURATION_STRUCT *iptv_hw_config)
{
    ...
    ag_drv_rnr_regs_cfg_cpu_wakeup_set(get_runner_idx(us_tm_runner_image), IMAGE_6_IMAGE_6_GENERAL_TIMER_THREAD_NUMBER);
    ag_drv_rnr_regs_cfg_cpu_wakeup_set(get_runner_idx(ds_tm_runner_image), IMAGE_7_IMAGE_7_GENERAL_TIMER_THREAD_NUMBER);
    ...
    /* setting the FPI Mode to NATC TBL ID table */
    rc = rc ? rc : rdd_ag_processing_fpi_mode_to_natc_table_set(FPI_MODE_L2, FPI_NATC_TBL_IDX_L2);
    rc = rc ? rc : rdd_ag_processing_fpi_mode_to_natc_table_set(FPI_MODE_L3L4, FPI_NATC_TBL_IDX_L3L4);
#endif
