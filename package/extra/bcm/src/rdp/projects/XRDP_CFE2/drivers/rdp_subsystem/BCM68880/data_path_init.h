...
#define DISP_REOR_XRDP_VIQ_EN(viq_num)      ((((1 << viq_num) - 1) & ~(1 << BBH_ID_PON)) & ~(1UL << (BBH_ID_PON + BBH_ID_NUM)))
...
#define UBUS_SLV_VPB_START_ADDR 0x82600000
...
#define QM_COPY_DEC_PROFILE_COPY_TO_DDR        7
...
#define PSRAM1_BASE_OFFSET 0x82200000
#define PSRAM0_BASE_OFFSET 0x820000

// dma 0 (copy)
#define DMA_DDR_CREDITS_0   0
#define DMA_PSRAM_CREDITS_0 11

//  dma 1 
#define DMA_DDR_CREDITS_1   8
#define DMA_PSRAM_CREDITS_1 6

//  dma 2 
#define DMA_DDR_CREDITS_2   8
#define DMA_PSRAM_CREDITS_2 6

//  dma 3
#define DMA_DDR_CREDITS_3   8
#define DMA_PSRAM_CREDITS_3 6
