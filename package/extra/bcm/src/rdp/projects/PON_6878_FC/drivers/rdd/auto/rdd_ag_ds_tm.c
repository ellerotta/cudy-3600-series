...
int rdd_ag_ds_tm_tm_flow_cntr_table_set_core(uint32_t _entry, uint8_t cntr_id, int core_id)
{
    if(_entry >= RDD_DS_TM_TM_FLOW_CNTR_TABLE_SIZE)
          return BDMF_ERR_PARM;

    RDD_TM_FLOW_CNTR_ENTRY_CNTR_ID_WRITE_CORE(cntr_id, RDD_DS_TM_TM_FLOW_CNTR_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_ds_tm_tm_flow_cntr_table_get_core(uint32_t _entry, uint8_t *cntr_id, int core_id)
{
    if(_entry >= RDD_DS_TM_TM_FLOW_CNTR_TABLE_SIZE)
          return BDMF_ERR_PARM;

    RDD_TM_FLOW_CNTR_ENTRY_CNTR_ID_READ_CORE(*cntr_id, RDD_DS_TM_TM_FLOW_CNTR_TABLE_ADDRESS_ARR, _entry, core_id);
