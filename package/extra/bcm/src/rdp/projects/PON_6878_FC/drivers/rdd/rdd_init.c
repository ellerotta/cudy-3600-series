...
static void image_0_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    local_regs[IMAGE_0_TM_DIRECT_FLOW_THREAD_NUMBER][reg_id[0]] =  ADDRESS_OF(image_0, gpon_control_wakeup_request);
    local_regs[IMAGE_0_TM_DIRECT_FLOW_THREAD_NUMBER][reg_id[16]] = IMAGE_0_DIRECT_FLOW_PD_TABLE_ADDRESS;
...
static void image_1_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    /* Common reprocessing task is used for pktgen_reprocessing for tcp/udp speed test or pktgen_reprocessing for tcp speed test and for ABS.
...
static void image_2_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    local_regs[IMAGE_2_IMAGE_2_DHD_TX_COMPLETE_0_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_2, dhd_tx_complete_wakeup_request);
    ...
    local_regs[IMAGE_2_IMAGE_2_DHD_TX_COMPLETE_0_THREAD_NUMBER][reg_id[12]] =
        (IMAGE_2_DHD_COMPLETE_COMMON_RADIO_DATA_ADDRESS + sizeof(DHD_COMPLETE_COMMON_RADIO_ENTRY_STRUCT)*0) | (IMAGE_2_DHD_TX_COMPLETE_DISPATCHER_CREDIT_TABLE_ADDRESS << 16);
    local_regs[IMAGE_2_IMAGE_2_DHD_TX_COMPLETE_0_THREAD_NUMBER][reg_id[11]] = 0;


    /* DHD_RX_COMPLETE_0: thread 2 */
    local_regs[IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_2, dhd_rx_complete_wakeup_request);
    local_regs[IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[13]] = ((IMAGE_2_DHD_COMPLETE_COMMON_RADIO_DATA_ADDRESS + sizeof(DHD_COMPLETE_COMMON_RADIO_ENTRY_STRUCT)*0));
    ...
    local_regs[IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[9]] =
        IMAGE_2_IMAGE_2_DHD_RX_COMPLETE_0_THREAD_NUMBER | (IMAGE_2_DHD_RX_COMPLETE_DISPATCHER_CREDIT_TABLE_ADDRESS << 16);
    ...
    local_regs[IMAGE_2_IMAGE_2_TIMER_COMMON_THREAD_NUMBER][reg_id[0]] = ADDRESS_OF(image_2, timer_common_task_wakeup_request);
    ...
    local_regs[IMAGE_2_IMAGE_2_DHD_TX_POST_0_THREAD_NUMBER][reg_id[13]] = 0 | ((IMAGE_2_DHD_POST_COMMON_RADIO_DATA_ADDRESS + sizeof(DHD_POST_COMMON_RADIO_ENTRY_STRUCT)*0)) << 16;
