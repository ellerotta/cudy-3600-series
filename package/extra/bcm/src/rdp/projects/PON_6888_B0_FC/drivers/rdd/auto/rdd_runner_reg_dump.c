...
void dump_RDD_SYSTEM_CONFIGURATION_ENTRY(bdmf_session_handle session, unsigned char *p)
{
	...
	bdmf_session_print(session, "\tg9991_skip_parser_error_or_generic_class_extra_enable= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 4, 2, 1, (r));
	bdmf_session_print(session, "\tdp_eligibility_vector_used= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	RDP_FIELD_MREAD_8((uint8_t *)(p) + 5, 6, 1, (r));
	...
	bdmf_session_print(session, "\tdbg_power_measure_mode   = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_32((uint8_t *)(p) + 4, 0, 20, (r));
	bdmf_session_print(session, "\treserved1                = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
void dump_RDD_PACKET_BUFFER(bdmf_session_handle session, unsigned char *p)
{
	...
	bdmf_session_print(session, "\tPARSER_RESULTS_PARSER_SUMMARY_non_l4_protocol= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 163, 7, 1, (r));
	bdmf_session_print(session, "\tPARSER_RESULTS_PARSER_SUMMARY_gre_protocol_error= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 163, 6, 1, (r));
	bdmf_session_print(session, "\tPARSER_RESULTS_PARSER_SUMMARY_udp_cs_zero= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	bdmf_session_print(session, "\tPARSER_RESULTS_PARSER_ethernet_version= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	RDP_FIELD_MREAD_16((uint8_t *)(p) + 176, 0, 14, (r));
	...
	RDP_FIELD_MREAD_8((uint8_t *)(p) + 254, 3, 1, (r));
	bdmf_session_print(session, "\tPARSER_RESULTS_PARSER_IC_LKP_ENTRY_generic_class_extra_lkp= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 254, 0, 3, (r));
	...
	RDP_FIELD_MREAD_8((uint8_t *)(p) + 264, 2, 1, (r));
	bdmf_session_print(session, "\tPROCESSING_RX_DESCRIPTOR_is_gdx_rx= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_16((uint8_t *)(p) + 264, 2, 8, (r));
	bdmf_session_print(session, "\tPROCESSING_RX_DESCRIPTOR_ingress_vport_or_flow= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_32((uint8_t *)(p) + 264, 14, 4, (r));
	bdmf_session_print(session, "\tPROCESSING_RX_DESCRIPTOR_ssid= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_16((uint8_t *)(p) + 266, 0, 14, (r));
	bdmf_session_print(session, "\tPROCESSING_RX_DESCRIPTOR_bn1_or_fpm= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 268, 7, 1, (r));
	bdmf_session_print(session, "\tPROCESSING_RX_DESCRIPTOR_reserved_6= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	bdmf_session_print(session, "\tSCRATCH_UNICAST_FLOW_NATC_RESULT_FC_UCAST_FLOW_CONTEXT_ENTRY_reserved_0= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	bdmf_session_print(session, "\tSCRATCH_UNICAST_FLOW_NATC_RESULT_FC_UCAST_FLOW_CONTEXT_ENTRY_reserved_11= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	MREAD_32((uint8_t *)(p) + 272, (r));
	bdmf_session_print(session, "\tSCRATCH_UNICAST_FLOW_NATC_RESULT_CT_LKP_FLOW_CONTEXT_ENTRY_reserved1= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_32((uint8_t *)(p) + 276, (r));
	bdmf_session_print(session, "\tSCRATCH_UNICAST_FLOW_NATC_RESULT_CT_LKP_FLOW_CONTEXT_ENTRY_reserved2= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_32((uint8_t *)(p) + 280, 9, 23, (r));
	bdmf_session_print(session, "\tSCRATCH_UNICAST_FLOW_NATC_RESULT_CT_LKP_FLOW_CONTEXT_ENTRY_reserved3= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 282, 0, 1, (r));
	bdmf_session_print(session, "\tSCRATCH_UNICAST_FLOW_NATC_RESULT_CT_LKP_FLOW_CONTEXT_ENTRY_policer_en= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_8((uint8_t *)(p) + 283, (r));
	bdmf_session_print(session, "\tSCRATCH_UNICAST_FLOW_NATC_RESULT_CT_LKP_FLOW_CONTEXT_ENTRY_policer_id= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	RDP_FIELD_MREAD_8((uint8_t *)(p) + 277, 2, 1, (r));
	bdmf_session_print(session, "\tSCRATCH_MULTICAST_FLOW_NATC_RESULT_FC_UCAST_FLOW_CONTEXT_ENTRY_reserved_0= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	RDP_FIELD_MREAD_8((uint8_t *)(p) + 284, 5, 3, (r));
	bdmf_session_print(session, "\tSCRATCH_MULTICAST_FLOW_NATC_RESULT_FC_UCAST_FLOW_CONTEXT_ENTRY_reserved_11= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	MREAD_32((uint8_t *)(p) + 272, (r));
	bdmf_session_print(session, "\tSCRATCH_MULTICAST_FLOW_NATC_RESULT_CT_LKP_FLOW_CONTEXT_ENTRY_reserved1= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_32((uint8_t *)(p) + 276, (r));
	bdmf_session_print(session, "\tSCRATCH_MULTICAST_FLOW_NATC_RESULT_CT_LKP_FLOW_CONTEXT_ENTRY_reserved2= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_32((uint8_t *)(p) + 280, 9, 23, (r));
	bdmf_session_print(session, "\tSCRATCH_MULTICAST_FLOW_NATC_RESULT_CT_LKP_FLOW_CONTEXT_ENTRY_reserved3= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 282, 0, 1, (r));
	bdmf_session_print(session, "\tSCRATCH_MULTICAST_FLOW_NATC_RESULT_CT_LKP_FLOW_CONTEXT_ENTRY_policer_en= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_8((uint8_t *)(p) + 283, (r));
	bdmf_session_print(session, "\tSCRATCH_MULTICAST_FLOW_NATC_RESULT_CT_LKP_FLOW_CONTEXT_ENTRY_policer_id= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
{
	unsigned int r;
	bdmf_session_print(session, "  Register MIRRORING_TRUNCATE_ENTRY\n");

	MREAD_16((uint8_t *)(p), (r));
	bdmf_session_print(session, "\ttruncate_offset          = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
{
	unsigned int r;
	bdmf_session_print(session, "  Register LLQ_SELECTOR_ECN\n");
...
void dump_RDD_BUFMNG_STATUS_ENTRY(bdmf_session_handle session, unsigned char *p)
{
	...
	bdmf_session_print(session, "\n");
	bdmf_session_print(session, "\tmax_dhd_tx_queue_occupancy=\n\t");
	for (i=0,j=0; i<4; i++)
	{
...
void dump_RDD_DHD_POST_COMMON_RADIO_ENTRY(bdmf_session_handle session, unsigned char *p)
{
	...
	MREAD_32((uint8_t *)(p) + 24, (r));
	bdmf_session_print(session, "\tbackup_base_low          = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_32((uint8_t *)(p) + 28, (r));
	bdmf_session_print(session, "\tbackup_base_high         = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	RDP_FIELD_MREAD_8((uint8_t *)(p) + 60, 7, 1, (r));
	bdmf_session_print(session, "\tadd_llcsnap_header       = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 60, 5, 2, (r));
	bdmf_session_print(session, "\treserved                 = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 60, 2, 3, (r));
	bdmf_session_print(session, "\tflow_ring_format         = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 60, 1, 1, (r));
	bdmf_session_print(session, "\tidma_active              = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 60, 0, 1, (r));
	...
	bdmf_session_print(session, "\n");
	MREAD_8((uint8_t *)(p) + 184, (r));
	bdmf_session_print(session, "\treserved2                = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_8((uint8_t *)(p) + 185, (r));
	bdmf_session_print(session, "\tcoalescing_timeout       = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_8((uint8_t *)(p) + 186, (r));
	bdmf_session_print(session, "\tcoalescing_timeout_cntr  = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_8((uint8_t *)(p) + 187, (r));
	bdmf_session_print(session, "\tcur_frg_id               = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 188, 7, 1, (r));
	bdmf_session_print(session, "\ttx_mirroring_en          = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 188, 1, 6, (r));
	bdmf_session_print(session, "\tdst_vport                = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_16((uint8_t *)(p) + 188, 0, 9, (r));
	bdmf_session_print(session, "\tdst_queue                = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_16((uint8_t *)(p) + 190, (r));
	bdmf_session_print(session, "\ttx_mirror_truncate       = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_16((uint8_t *)(p) + 192, (r));
	bdmf_session_print(session, "\tbq_num_entries           = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	bdmf_session_print(session, "\treserved3                =\n\t");
	for (i=0,j=0; i<2; i++)
	{
		MREAD_I_8((uint8_t *)(p) + 194, i, (r));
		bdmf_session_print(session, "0x%08x ", (unsigned int)r);
		j++;
	}
	bdmf_session_print(session, "\n");
...
void dump_RDD_PROCESSING_TX_DESCRIPTOR(bdmf_session_handle session, unsigned char *p)
{
	...
	RDP_FIELD_MREAD_16((uint8_t *)(p), 0, 9, (r));
	bdmf_session_print(session, "\tsecond_level_q_spdsvs    = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	RDP_FIELD_MREAD_32((uint8_t *)(p) + 4, 14, 5, (r));
	bdmf_session_print(session, "\terror_type_or_qm_fc_source= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	RDP_FIELD_MREAD_8((uint8_t *)(p) + 8, 2, 1, (r));
	bdmf_session_print(session, "\teh                       = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_32((uint8_t *)(p) + 8, 14, 12, (r));
	bdmf_session_print(session, "\tingress_port             = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_16((uint8_t *)(p) + 10, 0, 14, (r));
...
void dump_RDD_CRYPTO_SESSION_PARAMS(bdmf_session_handle session, unsigned char *p)
{
	...
	RDP_FIELD_MREAD_8((uint8_t *)(p) + 8, 5, 1, (r));
	bdmf_session_print(session, "\ttransport_mode           = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 8, 4, 1, (r));
	bdmf_session_print(session, "\tis_gcm                   = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 8, 3, 1, (r));
	bdmf_session_print(session, "\tipv6                     = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_16((uint8_t *)(p) + 8, 6, 5, (r));
	bdmf_session_print(session, "\treserved                 = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 9, 0, 6, (r));
	bdmf_session_print(session, "\tchksm_offset             = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	MREAD_8((uint8_t *)(p) + 11, (r));
	bdmf_session_print(session, "\tiv_size                  = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
{
	unsigned int r;
	bdmf_session_print(session, "  Register RATE_LIMITER_BUDGET_DESCRIPTOR\n");
	...
	MREAD_8((uint8_t *)(p) + 4, (r));
	bdmf_session_print(session, "\trl_params_desc_0         = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_8((uint8_t *)(p) + 5, (r));
	bdmf_session_print(session, "\trl_params_desc_1         = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_8((uint8_t *)(p) + 6, (r));
	bdmf_session_print(session, "\trl_params_desc_2         = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_8((uint8_t *)(p) + 7, (r));
	bdmf_session_print(session, "\trl_params_desc_3         = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
{
	unsigned int r;
	bdmf_session_print(session, "  Register RATE_LIMITER_PROFILE\n");
	...
	RDP_FIELD_MREAD_16((uint8_t *)(p) + 2, 2, 14, (r));
	bdmf_session_print(session, "\tlimit_mantissa           = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 3, 0, 2, (r));
...
{
	unsigned int r;
	bdmf_session_print(session, "  Register RATE_LIMITER_PROFILE_RESIDUE\n");
...
void dump_RDD_AQM_QUEUE_DESCRIPTOR(bdmf_session_handle session, unsigned char *p)
{
	...
	RDP_FIELD_MREAD_16((uint8_t *)(p), 1, 15, (r));
	bdmf_session_print(session, "\tPI2_QUEUE_DESCRIPTOR_probability= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_32((uint8_t *)(p) + 0, 0, 17, (r));
	bdmf_session_print(session, "\tPI2_QUEUE_DESCRIPTOR_packet_select_probability= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_16((uint8_t *)(p), 1, 15, (r));
	bdmf_session_print(session, "\tLAQM_QUEUE_DESCRIPTOR_probability= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_32((uint8_t *)(p) + 0, 2, 15, (r));
	bdmf_session_print(session, "\tLAQM_QUEUE_DESCRIPTOR_packet_select_probability= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 3, 0, 2, (r));
	bdmf_session_print(session, "\tLAQM_QUEUE_DESCRIPTOR_reserved= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
{
	unsigned int r;
	bdmf_session_print(session, "  Register SECONDARY_SCHEDULER_DESCRIPTOR\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p), 7, 1, (r));
	bdmf_session_print(session, "\tis_positive_budget       = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p), 4, 3, (r));
	bdmf_session_print(session, "\tsir_dwrr_offset          = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p), 1, 3, (r));
	bdmf_session_print(session, "\tpir_dwrr_offset          = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	RDP_FIELD_MREAD_8((uint8_t *)(p) + 2, 1, 7, (r));
	bdmf_session_print(session, "\tlast_served_block        = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_16((uint8_t *)(p) + 2, 0, 9, (r));
	bdmf_session_print(session, "\tqueue_offset             = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	bdmf_session_print(session, "\tpir_rate_limiter_index   = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 9, 4, 4, (r));
	bdmf_session_print(session, "\tstatus_bit_vector        = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 9, 0, 4, (r));
	bdmf_session_print(session, "\treserved2                = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 10, 3, 5, (r));
	bdmf_session_print(session, "\tprimary_scheduler_slot_index= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 10, 0, 3, (r));
	bdmf_session_print(session, "\treserved3                = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 11, 7, 1, (r));
	bdmf_session_print(session, "\tpir_rate_limit_enable    = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 11, 0, 7, (r));
	bdmf_session_print(session, "\tprimary_scheduler_index  = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
{
	unsigned int r;
	bdmf_session_print(session, "  Register DISPATCHER_CREDIT_DESCRIPTOR\n");

	MREAD_32((uint8_t *)(p), (r));
	bdmf_session_print(session, "\treserved0                = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_32((uint8_t *)(p) + 4, 12, 20, (r));
	bdmf_session_print(session, "\treserved1                = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_16((uint8_t *)(p) + 6, 0, 12, (r));
	bdmf_session_print(session, "\ttotal                    = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_32((uint8_t *)(p) + 8, 12, 20, (r));
	bdmf_session_print(session, "\treserved2                = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_16((uint8_t *)(p) + 10, 0, 12, (r));
	bdmf_session_print(session, "\tused                     = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
void dump_RDD_SCHEDULING_QUEUE_DESCRIPTOR(bdmf_session_handle session, unsigned char *p)
{
	...
	RDP_FIELD_MREAD_8((uint8_t *)(p) + 2, 3, 1, (r));
	bdmf_session_print(session, "\tcodel_dropping           = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 2, 2, 1, (r));
	bdmf_session_print(session, "\tscheduler_type           = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_16((uint8_t *)(p) + 2, 3, 7, (r));
	bdmf_session_print(session, "\tscheduler_index          = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 3, 2, 1, (r));
	bdmf_session_print(session, "\tsir_rate_limit_enable    = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 3, 1, 1, (r));
	bdmf_session_print(session, "\tpir_rate_limit_enable    = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 3, 0, 1, (r));
	bdmf_session_print(session, "\treserved1                = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 4, 3, 5, (r));
	bdmf_session_print(session, "\tqueue_index              = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 4, 0, 3, (r));
	bdmf_session_print(session, "\treserved                 = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_8((uint8_t *)(p) + 5, (r));
	bdmf_session_print(session, "\tsir_rate_limiter_index   = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
void dump_RDD_CRYPTO_SESSION_SEQ_INFO(bdmf_session_handle session, unsigned char *p)
{
	...
	MREAD_32((uint8_t *)(p) + 24, (r));
	bdmf_session_print(session, "\trplyerr_blksize          = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	MREAD_32((uint8_t *)(p) + 72, (r));
	bdmf_session_print(session, "\tbitmap_2                 = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
{
	unsigned int r;
	bdmf_session_print(session, "  Register RATE_LIMITER_PARAMS_DESCRIPTOR\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p), 2, 6, (r));
	bdmf_session_print(session, "\trate_profile_id          = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_32((uint8_t *)(p), 14, 12, (r));
	bdmf_session_print(session, "\tstatus_update_offset_word= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 2, 1, 5, (r));
	bdmf_session_print(session, "\tstatus_update_offset_bit = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_16((uint8_t *)(p) + 2, 0, 9, (r));
	bdmf_session_print(session, "\tbudget_desc_id           = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 4, 6, 2, (r));
	bdmf_session_print(session, "\twakeup_mode              = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_16((uint8_t *)(p) + 4, 1, 13, (r));
	bdmf_session_print(session, "\twakeup_message_data      = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_32((uint8_t *)(p) + 4, 0, 17, (r));
	bdmf_session_print(session, "\treserved1                = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
void dump_RDD_PI2_PROBABILITY_CALC_DESCRIPTOR(bdmf_session_handle session, unsigned char *p)
{
	...
	MREAD_8((uint8_t *)(p) + 50, (r));
	bdmf_session_print(session, "\tlaqm_coupling_factor     = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	MREAD_32((uint8_t *)(p) + 52, (r));
	bdmf_session_print(session, "\tpackets_total            = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_32((uint8_t *)(p) + 56, (r));
	bdmf_session_print(session, "\tpackets_dropped          = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_32((uint8_t *)(p) + 60, (r));
	bdmf_session_print(session, "\tmax_latency              = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_32((uint8_t *)(p) + 64, (r));
	bdmf_session_print(session, "\tcumulative_latency       = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	bdmf_session_print(session, "\thistogram                =\n\t");
	for (i=0,j=0; i<32; i++)
	{
		MREAD_I_32((uint8_t *)(p) + 68, i, (r));
		bdmf_session_print(session, "0x%08x ", (unsigned int)r);
		j++;
		if (j >= 8)
		{
...
void dump_RDD_LAQM_DEBUG_DESCRIPTOR(bdmf_session_handle session, unsigned char *p)
{
	unsigned int r;
	int i,j;

	bdmf_session_print(session, "  Register LAQM_DEBUG_DESCRIPTOR\n");
	...
	MREAD_32((uint8_t *)(p) + 4, (r));
	bdmf_session_print(session, "\tpackets_remarked         = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_32((uint8_t *)(p) + 8, (r));
	bdmf_session_print(session, "\tpackets_remarked_by_cq   = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
{
	unsigned int r;
	bdmf_session_print(session, "  Register SCHEDULER_DESCRIPTOR\n");
	...
	RDP_FIELD_MREAD_8((uint8_t *)(p) + 7, 2, 6, (r));
	bdmf_session_print(session, "\tbbh_queue_desc_id        = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 7, 1, 1, (r));
	bdmf_session_print(session, "\treserved3                = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p) + 7, 0, 1, (r));
	bdmf_session_print(session, "\taqm_stats_enable         = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
	...
	MREAD_32((uint8_t *)(p) + 20, (r));
	bdmf_session_print(session, "\tsecondary_scheduler_vector= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
{
	unsigned int r;
	bdmf_session_print(session, "  Register AQM_QUEUE_TIMER_DESCRIPTOR\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p), 1, 7, (r));
	bdmf_session_print(session, "\tPI2_QUEUE_TIMER_DESCRIPTOR_prev_q_delay= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p), 0, 1, (r));
	bdmf_session_print(session, "\tPI2_QUEUE_TIMER_DESCRIPTOR_dual_queue= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
void dump_RDD_UDPSPDT_STREAM_TX_STAT(bdmf_session_handle session, unsigned char *p)
{
	...
	MREAD_32((uint8_t *)(p) + 8, (r));
	bdmf_session_print(session, "\ttx_no_sbpm               = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
void dump_RDD_BBH_QUEUE_TO_BBH_QUEUE_DESC_MAPPING_ENTRY(bdmf_session_handle session, unsigned char *p)
{
	...
	bdmf_session_print(session, "  Register BBH_QUEUE_TO_BBH_QUEUE_DESC_MAPPING_ENTRY\n");

	bdmf_session_print(session, "\tindex                    =\n\t");
	for (i=0,j=0; i<40; i++)
	{
		MREAD_I_8((uint8_t *)(p), i, (r));
		bdmf_session_print(session, "0x%08x ", (unsigned int)r);
...
void dump_RDD_BBH_QUEUE_DESCRIPTOR(bdmf_session_handle session, unsigned char *p)
{
	...
	RDP_FIELD_MREAD_8((uint8_t *)(p) + 4, 3, 5, (r));
	bdmf_session_print(session, "\tvport                    = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_32((uint8_t *)(p) + 4, 0, 27, (r));
	bdmf_session_print(session, "\treserved2                = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
{
	unsigned int r;
	bdmf_session_print(session, "  Register REPORTING_QUEUE_COUNTER\n");
...
void dump_RDD_GHOST_REPORTING_GLOBAL_CFG_ENTRY(bdmf_session_handle session, unsigned char *p)
{
	...
	MREAD_8((uint8_t *)(p) + 1, (r));
	bdmf_session_print(session, "\tlast_queue               = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
void dump_RDD_BBH_TX_EGRESS_COUNTER_ENTRY(bdmf_session_handle session, unsigned char *p)
{
	...
	RDP_FIELD_MREAD_32((uint8_t *)(p) + 0, 0, 24, (r));
	bdmf_session_print(session, "\treserved0                = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
void dump_RDD_FPM_RING_BUFMNG_CNT(bdmf_session_handle session, unsigned char *p)
{
	unsigned int r;
	int i,j;

	bdmf_session_print(session, "  Register FPM_RING_BUFMNG_CNT\n");

	bdmf_session_print(session, "\tfree_cnt_req             =\n\t");
	for (i=0,j=0; i<32; i++)
	{
		MREAD_I_32((uint8_t *)(p), i, (r));
		bdmf_session_print(session, "0x%08x ", (unsigned int)r);
	...
	bdmf_session_print(session, "\n");
	bdmf_session_print(session, "\tfree_cnt_done            =\n\t");
	for (i=0,j=0; i<32; i++)
	{
		MREAD_I_32((uint8_t *)(p) + 128, i, (r));
		bdmf_session_print(session, "0x%08x ", (unsigned int)r);
		j++;
		if (j >= 8)
		{
	...
	bdmf_session_print(session, "\n");
	MREAD_32((uint8_t *)(p) + 256, (r));
	bdmf_session_print(session, "\tfree_cnt_req_addr_low    = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_32((uint8_t *)(p) + 260, (r));
	bdmf_session_print(session, "\tfree_cnt_req_addr_high   = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
void dump_RDD_PAUSE_QUANTA_ENTRY(bdmf_session_handle session, unsigned char *p)
{
	...
	RDP_FIELD_MREAD_16((uint8_t *)(p), 0, 15, (r));
	bdmf_session_print(session, "\ttime_unit                = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

}

void dump_RDD_QEMU_DATA(bdmf_session_handle session, unsigned char *p)
{
	unsigned int r;
	bdmf_session_print(session, "  Register QEMU_DATA\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p), 7, 1, (r));
	bdmf_session_print(session, "\tstart_runner_trace       = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p), 6, 1, (r));
	bdmf_session_print(session, "\tstop_runner_trace        = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p), 5, 1, (r));
	bdmf_session_print(session, "\tstart_capture_waves      = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p), 4, 1, (r));
	bdmf_session_print(session, "\tstop_capture_waves       = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p), 3, 1, (r));
	bdmf_session_print(session, "\tstart_send_1_packet_once = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p), 2, 1, (r));
	bdmf_session_print(session, "\tstart_send_infinise_packet= 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_8((uint8_t *)(p), 1, 1, (r));
	bdmf_session_print(session, "\tdata_path_ready          = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
void dump_RDD_PROCESSING_RX_DESCRIPTOR(bdmf_session_handle session, unsigned char *p)
{
	...
	RDP_FIELD_MREAD_8((uint8_t *)(p) + 8, 2, 1, (r));
	bdmf_session_print(session, "\tis_gdx_rx                = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_16((uint8_t *)(p) + 8, 2, 8, (r));
	bdmf_session_print(session, "\tingress_vport_or_flow    = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_32((uint8_t *)(p) + 8, 14, 4, (r));
	bdmf_session_print(session, "\tssid                     = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	RDP_FIELD_MREAD_16((uint8_t *)(p) + 10, 0, 14, (r));
	bdmf_session_print(session, "\tbn1_or_fpm               = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
