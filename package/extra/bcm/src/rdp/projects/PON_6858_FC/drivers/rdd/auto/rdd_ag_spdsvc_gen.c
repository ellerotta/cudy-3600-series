...
int rdd_ag_spdsvc_gen_bcm_spdsvc_stream_rx_ts_table_set(uint32_t ts_first, uint32_t ts_last, bdmf_boolean ts_first_set)
{
...
int rdd_ag_spdsvc_gen_bcm_spdsvc_stream_rx_ts_table_set_core(uint32_t ts_first, uint32_t ts_last, bdmf_boolean ts_first_set, int core_id)
{
...
int rdd_ag_spdsvc_gen_bcm_spdsvc_stream_rx_ts_table_get(uint32_t *ts_first, uint32_t *ts_last, bdmf_boolean *ts_first_set)
{
...
int rdd_ag_spdsvc_gen_bcm_spdsvc_stream_rx_ts_table_get_core(uint32_t *ts_first, uint32_t *ts_last, bdmf_boolean *ts_first_set, int core_id)
{
