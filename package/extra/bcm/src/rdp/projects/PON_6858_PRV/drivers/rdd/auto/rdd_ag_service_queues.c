...
int rdd_ag_service_queues_complex_scheduler_rl_cfg_get_core(rdd_complex_scheduler_rl_cfg_t *complex_scheduler_rl_cfg, int core_id)
{
    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_IS_POSITIVE_BUDGET_READ_CORE(complex_scheduler_rl_cfg->is_positive_budget, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);
    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_RATE_LIMITER_INDEX_READ_CORE(complex_scheduler_rl_cfg->rate_limiter_index, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);
    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_RATE_LIMIT_ENABLE_READ_CORE(complex_scheduler_rl_cfg->rate_limit_enable, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);
    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_DEFICIT_COUNTER_READ_CORE(complex_scheduler_rl_cfg->deficit_counter, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);
    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_QUANTUM_NUMBER_READ_CORE(complex_scheduler_rl_cfg->quantum_number, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);

    return BDMF_ERR_OK;
}

int rdd_ag_service_queues_complex_scheduler_rl_cfg_set_core(rdd_complex_scheduler_rl_cfg_t *complex_scheduler_rl_cfg, int core_id)
{
    if(!complex_scheduler_rl_cfg || complex_scheduler_rl_cfg->rate_limiter_index >= 128)
          return BDMF_ERR_PARM;

    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_IS_POSITIVE_BUDGET_WRITE_CORE(complex_scheduler_rl_cfg->is_positive_budget, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);
    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_RATE_LIMITER_INDEX_WRITE_CORE(complex_scheduler_rl_cfg->rate_limiter_index, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);
    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_RATE_LIMIT_ENABLE_WRITE_CORE(complex_scheduler_rl_cfg->rate_limit_enable, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);
    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_DEFICIT_COUNTER_WRITE_CORE(complex_scheduler_rl_cfg->deficit_counter, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);
    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_QUANTUM_NUMBER_WRITE_CORE(complex_scheduler_rl_cfg->quantum_number, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_scheduling_queue_descriptor_get(uint32_t _entry, rdd_scheduling_queue_descriptor_t *scheduling_queue_descriptor)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_PI2_ENABLE_READ_G(scheduling_queue_descriptor->pi2_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_AQM_ENABLE_READ_G(scheduling_queue_descriptor->aqm_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_LAQM_ENABLE_READ_G(scheduling_queue_descriptor->laqm_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry);
...
int rdd_ag_service_queues_scheduling_queue_descriptor_set(uint32_t _entry, rdd_scheduling_queue_descriptor_t *scheduling_queue_descriptor)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_PI2_ENABLE_WRITE_G(scheduling_queue_descriptor->pi2_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_AQM_ENABLE_WRITE_G(scheduling_queue_descriptor->aqm_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_LAQM_ENABLE_WRITE_G(scheduling_queue_descriptor->laqm_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry);
...
int rdd_ag_service_queues_scheduling_queue_descriptor_get_core(uint32_t _entry, rdd_scheduling_queue_descriptor_t *scheduling_queue_descriptor, int core_id)
{
    if(!scheduling_queue_descriptor || _entry >= RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_SCHEDULING_QUEUE_DESCRIPTOR_BBH_QUEUE_INDEX_READ_CORE(scheduling_queue_descriptor->bbh_queue_index, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_BLOCK_TYPE_READ_CORE(scheduling_queue_descriptor->block_type, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_CODEL_ENABLE_READ_CORE(scheduling_queue_descriptor->codel_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_PI2_ENABLE_READ_CORE(scheduling_queue_descriptor->pi2_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_AQM_ENABLE_READ_CORE(scheduling_queue_descriptor->aqm_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_LAQM_ENABLE_READ_CORE(scheduling_queue_descriptor->laqm_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_CODEL_DROPPING_READ_CORE(scheduling_queue_descriptor->codel_dropping, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_SCHEDULER_INDEX_READ_CORE(scheduling_queue_descriptor->scheduler_index, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_QUEUE_BIT_MASK_READ_CORE(scheduling_queue_descriptor->queue_bit_mask, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);

    return BDMF_ERR_OK;
}

int rdd_ag_service_queues_scheduling_queue_descriptor_set_core(uint32_t _entry, rdd_scheduling_queue_descriptor_t *scheduling_queue_descriptor, int core_id)
{
    if(!scheduling_queue_descriptor || _entry >= RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_SIZE || scheduling_queue_descriptor->bbh_queue_index >= 64 || scheduling_queue_descriptor->scheduler_index >= 128)
          return BDMF_ERR_PARM;

    RDD_SCHEDULING_QUEUE_DESCRIPTOR_BBH_QUEUE_INDEX_WRITE_CORE(scheduling_queue_descriptor->bbh_queue_index, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_BLOCK_TYPE_WRITE_CORE(scheduling_queue_descriptor->block_type, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_CODEL_ENABLE_WRITE_CORE(scheduling_queue_descriptor->codel_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_PI2_ENABLE_WRITE_CORE(scheduling_queue_descriptor->pi2_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_AQM_ENABLE_WRITE_CORE(scheduling_queue_descriptor->aqm_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_LAQM_ENABLE_WRITE_CORE(scheduling_queue_descriptor->laqm_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_CODEL_DROPPING_WRITE_CORE(scheduling_queue_descriptor->codel_dropping, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_SCHEDULER_INDEX_WRITE_CORE(scheduling_queue_descriptor->scheduler_index, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_QUEUE_BIT_MASK_WRITE_CORE(scheduling_queue_descriptor->queue_bit_mask, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);

    return BDMF_ERR_OK;
}

int rdd_ag_service_queues_codel_bias_slope_table_set(uint32_t _entry, uint16_t bias, uint16_t slope)
{
    if(_entry >= RDD_CODEL_BIAS_SLOPE_TABLE_SIZE)
          return BDMF_ERR_PARM;

    RDD_CODEL_BIAS_SLOPE_BIAS_WRITE_G(bias, RDD_CODEL_BIAS_SLOPE_TABLE_ADDRESS_ARR, _entry);
    RDD_CODEL_BIAS_SLOPE_SLOPE_WRITE_G(slope, RDD_CODEL_BIAS_SLOPE_TABLE_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_service_queues_codel_bias_slope_table_set_core(uint32_t _entry, uint16_t bias, uint16_t slope, int core_id)
{
    if(_entry >= RDD_CODEL_BIAS_SLOPE_TABLE_SIZE)
          return BDMF_ERR_PARM;

    RDD_CODEL_BIAS_SLOPE_BIAS_WRITE_CORE(bias, RDD_CODEL_BIAS_SLOPE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_CODEL_BIAS_SLOPE_SLOPE_WRITE_CORE(slope, RDD_CODEL_BIAS_SLOPE_TABLE_ADDRESS_ARR, _entry, core_id);

    return BDMF_ERR_OK;
}

int rdd_ag_service_queues_codel_bias_slope_table_get(uint32_t _entry, uint16_t *bias, uint16_t *slope)
{
    if(_entry >= RDD_CODEL_BIAS_SLOPE_TABLE_SIZE)
          return BDMF_ERR_PARM;

    RDD_CODEL_BIAS_SLOPE_BIAS_READ_G(*bias, RDD_CODEL_BIAS_SLOPE_TABLE_ADDRESS_ARR, _entry);
    RDD_CODEL_BIAS_SLOPE_SLOPE_READ_G(*slope, RDD_CODEL_BIAS_SLOPE_TABLE_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_service_queues_codel_bias_slope_table_get_core(uint32_t _entry, uint16_t *bias, uint16_t *slope, int core_id)
{
    if(_entry >= RDD_CODEL_BIAS_SLOPE_TABLE_SIZE)
          return BDMF_ERR_PARM;

    RDD_CODEL_BIAS_SLOPE_BIAS_READ_CORE(*bias, RDD_CODEL_BIAS_SLOPE_TABLE_ADDRESS_ARR, _entry, core_id);
    RDD_CODEL_BIAS_SLOPE_SLOPE_READ_CORE(*slope, RDD_CODEL_BIAS_SLOPE_TABLE_ADDRESS_ARR, _entry, core_id);

    return BDMF_ERR_OK;
}

int rdd_ag_service_queues_codel_bias_slope_table_bias_set(uint32_t _entry, uint16_t bias)
{
    if(_entry >= RDD_CODEL_BIAS_SLOPE_TABLE_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_service_queues_codel_bias_slope_table_bias_set_core(uint32_t _entry, uint16_t bias, int core_id)
{
    if(_entry >= RDD_CODEL_BIAS_SLOPE_TABLE_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_service_queues_codel_bias_slope_table_bias_get(uint32_t _entry, uint16_t *bias)
{
    if(_entry >= RDD_CODEL_BIAS_SLOPE_TABLE_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_service_queues_codel_bias_slope_table_bias_get_core(uint32_t _entry, uint16_t *bias, int core_id)
{
    if(_entry >= RDD_CODEL_BIAS_SLOPE_TABLE_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_service_queues_codel_bias_slope_table_slope_set(uint32_t _entry, uint16_t slope)
{
    if(_entry >= RDD_CODEL_BIAS_SLOPE_TABLE_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_service_queues_codel_bias_slope_table_slope_set_core(uint32_t _entry, uint16_t slope, int core_id)
{
    if(_entry >= RDD_CODEL_BIAS_SLOPE_TABLE_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_service_queues_codel_bias_slope_table_slope_get(uint32_t _entry, uint16_t *slope)
{
    if(_entry >= RDD_CODEL_BIAS_SLOPE_TABLE_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_service_queues_codel_bias_slope_table_slope_get_core(uint32_t _entry, uint16_t *slope, int core_id)
{
    if(_entry >= RDD_CODEL_BIAS_SLOPE_TABLE_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_service_queues_codel_drop_descriptor_max_seq_drops_set_core(uint16_t max_seq_drops, int core_id)
{
    RDD_CODEL_DROP_DESCRIPTOR_MAX_SEQ_DROPS_WRITE_CORE(max_seq_drops, RDD_SERVICE_QUEUES_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_codel_drop_descriptor_max_seq_drops_get_core(uint16_t *max_seq_drops, int core_id)
{
    RDD_CODEL_DROP_DESCRIPTOR_MAX_SEQ_DROPS_READ_CORE(*max_seq_drops, RDD_SERVICE_QUEUES_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_codel_drop_descriptor_flush_task_wakeup_value_set_core(uint16_t flush_task_wakeup_value, int core_id)
{
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_TASK_WAKEUP_VALUE_WRITE_CORE(flush_task_wakeup_value, RDD_SERVICE_QUEUES_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_codel_drop_descriptor_flush_task_wakeup_value_get_core(uint16_t *flush_task_wakeup_value, int core_id)
{
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_TASK_WAKEUP_VALUE_READ_CORE(*flush_task_wakeup_value, RDD_SERVICE_QUEUES_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_codel_drop_descriptor_flush_cfg_ptr_set_core(uint16_t flush_cfg_ptr, int core_id)
{
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_CFG_PTR_WRITE_CORE(flush_cfg_ptr, RDD_SERVICE_QUEUES_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_codel_drop_descriptor_flush_cfg_ptr_get_core(uint16_t *flush_cfg_ptr, int core_id)
{
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_CFG_PTR_READ_CORE(*flush_cfg_ptr, RDD_SERVICE_QUEUES_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_codel_drop_descriptor_flush_enable_ptr_set_core(uint16_t flush_enable_ptr, int core_id)
{
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_ENABLE_PTR_WRITE_CORE(flush_enable_ptr, RDD_SERVICE_QUEUES_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_codel_drop_descriptor_flush_enable_ptr_get_core(uint16_t *flush_enable_ptr, int core_id)
{
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_ENABLE_PTR_READ_CORE(*flush_enable_ptr, RDD_SERVICE_QUEUES_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_codel_drop_descriptor_flush_enable_set_core(uint8_t flush_enable, int core_id)
{
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_ENABLE_WRITE_CORE(flush_enable, RDD_SERVICE_QUEUES_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_codel_drop_descriptor_flush_enable_get_core(uint8_t *flush_enable, int core_id)
{
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_ENABLE_READ_CORE(*flush_enable, RDD_SERVICE_QUEUES_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_complex_scheduler_table_dwrr_offset_pir_set_core(uint8_t dwrr_offset_pir, int core_id)
{
    if(dwrr_offset_pir >= 8)
          return BDMF_ERR_PARM;

    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_DWRR_OFFSET_PIR_WRITE_CORE(dwrr_offset_pir, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_complex_scheduler_table_dwrr_offset_pir_get_core(uint8_t *dwrr_offset_pir, int core_id)
{
    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_DWRR_OFFSET_PIR_READ_CORE(*dwrr_offset_pir, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_complex_scheduler_table_dwrr_offset_sir_set_core(uint8_t dwrr_offset_sir, int core_id)
{
    if(dwrr_offset_sir >= 8)
          return BDMF_ERR_PARM;

    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_DWRR_OFFSET_SIR_WRITE_CORE(dwrr_offset_sir, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_complex_scheduler_table_dwrr_offset_sir_get_core(uint8_t *dwrr_offset_sir, int core_id)
{
    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_DWRR_OFFSET_SIR_READ_CORE(*dwrr_offset_sir, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_complex_scheduler_table_slot_budget_bit_vector_0_set_core(uint32_t slot_budget_bit_vector_0, int core_id)
{
    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_SLOT_BUDGET_BIT_VECTOR_0_WRITE_CORE(slot_budget_bit_vector_0, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_complex_scheduler_table_slot_budget_bit_vector_0_get_core(uint32_t *slot_budget_bit_vector_0, int core_id)
{
    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_SLOT_BUDGET_BIT_VECTOR_0_READ_CORE(*slot_budget_bit_vector_0, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_complex_scheduler_table_quantum_number_set_core(uint8_t quantum_number, int core_id)
{
    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_QUANTUM_NUMBER_WRITE_CORE(quantum_number, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_complex_scheduler_table_quantum_number_get_core(uint8_t *quantum_number, int core_id)
{
    RDD_COMPLEX_SCHEDULER_DESCRIPTOR_QUANTUM_NUMBER_READ_CORE(*quantum_number, RDD_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS_ARR, 0, core_id);
...
{
    RDD_BYTES_2_BITS_WRITE_G(bits, RDD_SERVICE_QUEUES_FIRST_QUEUE_MAPPING_ADDRESS_ARR, 0);
...
{
    RDD_BYTES_2_BITS_WRITE_CORE(bits, RDD_SERVICE_QUEUES_FIRST_QUEUE_MAPPING_ADDRESS_ARR, 0, core_id);
...
{
    RDD_BYTES_2_BITS_READ_G(*bits, RDD_SERVICE_QUEUES_FIRST_QUEUE_MAPPING_ADDRESS_ARR, 0);
...
{
    RDD_BYTES_2_BITS_READ_CORE(*bits, RDD_SERVICE_QUEUES_FIRST_QUEUE_MAPPING_ADDRESS_ARR, 0, core_id);

    return BDMF_ERR_OK;
}

int rdd_ag_service_queues_flush_aggregation_task_disable_set(uint8_t bits)
{
    RDD_BYTE_1_BITS_WRITE_G(bits, RDD_SERVICE_QUEUES_FLUSH_AGGREGATION_TASK_DISABLE_ADDRESS_ARR, 0);

    return BDMF_ERR_OK;
}

int rdd_ag_service_queues_flush_aggregation_task_disable_set_core(uint8_t bits, int core_id)
{
    RDD_BYTE_1_BITS_WRITE_CORE(bits, RDD_SERVICE_QUEUES_FLUSH_AGGREGATION_TASK_DISABLE_ADDRESS_ARR, 0, core_id);

    return BDMF_ERR_OK;
}

int rdd_ag_service_queues_flush_aggregation_task_disable_get(uint8_t *bits)
{
    RDD_BYTE_1_BITS_READ_G(*bits, RDD_SERVICE_QUEUES_FLUSH_AGGREGATION_TASK_DISABLE_ADDRESS_ARR, 0);

    return BDMF_ERR_OK;
}

int rdd_ag_service_queues_flush_aggregation_task_disable_get_core(uint8_t *bits, int core_id)
{
    RDD_BYTE_1_BITS_READ_CORE(*bits, RDD_SERVICE_QUEUES_FLUSH_AGGREGATION_TASK_DISABLE_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_enable_set_core(uint32_t _entry, bdmf_boolean enable, int core_id)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_ENABLE_WRITE_CORE(enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_enable_get_core(uint32_t _entry, bdmf_boolean *enable, int core_id)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_ENABLE_READ_CORE(*enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_rate_limit_enable_set_core(uint32_t _entry, bdmf_boolean rate_limit_enable, int core_id)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_RATE_LIMIT_ENABLE_WRITE_CORE(rate_limit_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_rate_limit_enable_get_core(uint32_t _entry, bdmf_boolean *rate_limit_enable, int core_id)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_RATE_LIMIT_ENABLE_READ_CORE(*rate_limit_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_codel_enable_set_core(uint32_t _entry, bdmf_boolean codel_enable, int core_id)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_CODEL_ENABLE_WRITE_CORE(codel_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_codel_enable_get_core(uint32_t _entry, bdmf_boolean *codel_enable, int core_id)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_CODEL_ENABLE_READ_CORE(*codel_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_pi2_enable_set(uint32_t _entry, bdmf_boolean pi2_enable)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_PI2_ENABLE_WRITE_G(pi2_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry);
...
int rdd_ag_service_queues_scheduling_queue_table_pi2_enable_set_core(uint32_t _entry, bdmf_boolean pi2_enable, int core_id)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_PI2_ENABLE_WRITE_CORE(pi2_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_pi2_enable_get(uint32_t _entry, bdmf_boolean *pi2_enable)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_PI2_ENABLE_READ_G(*pi2_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry);
...
int rdd_ag_service_queues_scheduling_queue_table_pi2_enable_get_core(uint32_t _entry, bdmf_boolean *pi2_enable, int core_id)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_PI2_ENABLE_READ_CORE(*pi2_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_aqm_enable_set(uint32_t _entry, bdmf_boolean aqm_enable)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_AQM_ENABLE_WRITE_G(aqm_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry);
...
int rdd_ag_service_queues_scheduling_queue_table_aqm_enable_set_core(uint32_t _entry, bdmf_boolean aqm_enable, int core_id)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_AQM_ENABLE_WRITE_CORE(aqm_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_aqm_enable_get(uint32_t _entry, bdmf_boolean *aqm_enable)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_AQM_ENABLE_READ_G(*aqm_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry);
...
int rdd_ag_service_queues_scheduling_queue_table_aqm_enable_get_core(uint32_t _entry, bdmf_boolean *aqm_enable, int core_id)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_AQM_ENABLE_READ_CORE(*aqm_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_laqm_enable_set(uint32_t _entry, bdmf_boolean laqm_enable)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_LAQM_ENABLE_WRITE_G(laqm_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry);
...
int rdd_ag_service_queues_scheduling_queue_table_laqm_enable_set_core(uint32_t _entry, bdmf_boolean laqm_enable, int core_id)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_LAQM_ENABLE_WRITE_CORE(laqm_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_laqm_enable_get(uint32_t _entry, bdmf_boolean *laqm_enable)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_LAQM_ENABLE_READ_G(*laqm_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry);
...
int rdd_ag_service_queues_scheduling_queue_table_laqm_enable_get_core(uint32_t _entry, bdmf_boolean *laqm_enable, int core_id)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_LAQM_ENABLE_READ_CORE(*laqm_enable, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_codel_dropping_set_core(uint32_t _entry, bdmf_boolean codel_dropping, int core_id)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_CODEL_DROPPING_WRITE_CORE(codel_dropping, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_codel_dropping_get_core(uint32_t _entry, bdmf_boolean *codel_dropping, int core_id)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_CODEL_DROPPING_READ_CORE(*codel_dropping, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_rate_limiter_index_set_core(uint32_t _entry, uint8_t rate_limiter_index, int core_id)
{
    if(_entry >= RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_SCHEDULING_QUEUE_DESCRIPTOR_RATE_LIMITER_INDEX_WRITE_CORE(rate_limiter_index, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_rate_limiter_index_get_core(uint32_t _entry, uint8_t *rate_limiter_index, int core_id)
{
    if(_entry >= RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_SCHEDULING_QUEUE_DESCRIPTOR_RATE_LIMITER_INDEX_READ_CORE(*rate_limiter_index, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_quantum_number_set_core(uint32_t _entry, uint8_t quantum_number, int core_id)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_QUANTUM_NUMBER_WRITE_CORE(quantum_number, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_scheduling_queue_table_quantum_number_get_core(uint32_t _entry, uint8_t *quantum_number, int core_id)
{
    ...
    RDD_SCHEDULING_QUEUE_DESCRIPTOR_QUANTUM_NUMBER_READ_CORE(*quantum_number, RDD_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_sq_tx_queue_drop_table_packets_set_core(uint32_t _entry, uint32_t packets, int core_id)
{
    if(_entry >= RDD_SQ_TX_QUEUE_DROP_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_PACKETS_AND_BYTES_PACKETS_WRITE_CORE(packets, RDD_SQ_TX_QUEUE_DROP_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_sq_tx_queue_drop_table_packets_get_core(uint32_t _entry, uint32_t *packets, int core_id)
{
    if(_entry >= RDD_SQ_TX_QUEUE_DROP_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_PACKETS_AND_BYTES_PACKETS_READ_CORE(*packets, RDD_SQ_TX_QUEUE_DROP_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_sq_tx_queue_drop_table_bytes_set_core(uint32_t _entry, uint32_t bytes, int core_id)
{
    if(_entry >= RDD_SQ_TX_QUEUE_DROP_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_PACKETS_AND_BYTES_BYTES_WRITE_CORE(bytes, RDD_SQ_TX_QUEUE_DROP_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_service_queues_sq_tx_queue_drop_table_bytes_get_core(uint32_t _entry, uint32_t *bytes, int core_id)
{
    if(_entry >= RDD_SQ_TX_QUEUE_DROP_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_PACKETS_AND_BYTES_BYTES_READ_CORE(*bytes, RDD_SQ_TX_QUEUE_DROP_TABLE_ADDRESS_ARR, _entry, core_id);
