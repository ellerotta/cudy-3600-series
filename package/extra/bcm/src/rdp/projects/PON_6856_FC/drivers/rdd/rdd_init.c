...
static void image_0_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    /* COMMON_REPROCESSING: thread 6 */
    local_regs[IMAGE_0_DS_TM_COMMON_REPROCESSING_THREAD_NUMBER][reg_id[16]] = (ADDRESS_OF(image_0, common_reprocessing_wakeup_request) << 16) |
        IMAGE_0_COMMON_REPROCESSING_UPDATE_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_0_DS_TM_COMMON_REPROCESSING_THREAD_NUMBER][reg_id[10]] = IMAGE_0_COMMON_REPROCESSING_DISPATCHER_CREDIT_TABLE_ADDRESS |
    ...
    local_regs[IMAGE_0_DS_TM_SPDSVC_GEN_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_0, spdsvc_gen_wakeup_request) << 16;
    local_regs[IMAGE_0_DS_TM_SPDSVC_GEN_THREAD_NUMBER][reg_id[9]] = ((BB_ID_DISPATCHER_REORDER + (DISP_REOR_VIQ_SPDSVC << 6)) << 16);
    local_regs[IMAGE_0_DS_TM_SPDSVC_GEN_THREAD_NUMBER][reg_id[12]] = (IMAGE_0_SPDSVC_GEN_DISPATCHER_CREDIT_TABLE_ADDRESS << 16);

        /* TcpSpdTest + pktgen_tx thread 8*/
    local_regs[IMAGE_0_DS_TM_TCPSPDTEST_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_0, tcpspdtest_wakeup_request) << 16;
    local_regs[IMAGE_0_DS_TM_TCPSPDTEST_THREAD_NUMBER][reg_id[14]] = IMAGE_0_TCPSPDTEST_SCRATCHPAD_ADDRESS;
    local_regs[IMAGE_0_DS_TM_TCPSPDTEST_THREAD_NUMBER][reg_id[13]] = IMAGE_0_TCPSPDTEST_UPDATE_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_0_DS_TM_TCPSPDTEST_THREAD_NUMBER][reg_id[12]] = (IMAGE_0_TCPSPDTEST_PD_FIFO_TABLE_ADDRESS) | (IMAGE_0_TCPSPDTEST_DISPATCHER_CREDIT_TABLE_ADDRESS << 16);
...
static void image_4_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_COMPLETE_0_THREAD_NUMBER][reg_id[13]] = (BB_ID_DISPATCHER_REORDER + (DISP_REOR_VIQ_DHD_TX_COMPLETE_0 << 6));
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_COMPLETE_0_THREAD_NUMBER][reg_id[12]] = (IMAGE_4_DHD_COMPLETE_COMMON_RADIO_DATA_ADDRESS + sizeof(DHD_COMPLETE_COMMON_RADIO_ENTRY_STRUCT)*0) |
                                                                              (IMAGE_4_DHD_TX_COMPLETE_DISPATCHER_CREDIT_TABLE_ADDRESS << 16);
    ...
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_COMPLETE_1_THREAD_NUMBER][reg_id[13]] = (BB_ID_DISPATCHER_REORDER + (DISP_REOR_VIQ_DHD_TX_COMPLETE_1 << 6));
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_COMPLETE_1_THREAD_NUMBER][reg_id[12]] = (IMAGE_4_DHD_COMPLETE_COMMON_RADIO_DATA_ADDRESS + sizeof(DHD_COMPLETE_COMMON_RADIO_ENTRY_STRUCT)*1) |
                                                                              ((IMAGE_4_DHD_TX_COMPLETE_DISPATCHER_CREDIT_TABLE_ADDRESS + 16) << 16);
    ...
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_COMPLETE_2_THREAD_NUMBER][reg_id[13]] = (BB_ID_DISPATCHER_REORDER + (DISP_REOR_VIQ_DHD_TX_COMPLETE_2 << 6));
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_COMPLETE_2_THREAD_NUMBER][reg_id[12]] = (IMAGE_4_DHD_COMPLETE_COMMON_RADIO_DATA_ADDRESS + sizeof(DHD_COMPLETE_COMMON_RADIO_ENTRY_STRUCT)*2) |
                                                                              ((IMAGE_4_DHD_TX_COMPLETE_DISPATCHER_CREDIT_TABLE_ADDRESS + 32) << 16);
    ...
    local_regs[IMAGE_4_IMAGE_4_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[13]] = ((IMAGE_4_DHD_COMPLETE_COMMON_RADIO_DATA_ADDRESS + sizeof(DHD_COMPLETE_COMMON_RADIO_ENTRY_STRUCT)*0));
    ...
    local_regs[IMAGE_4_IMAGE_4_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[9]] =
        IMAGE_4_IMAGE_4_DHD_RX_COMPLETE_0_THREAD_NUMBER | (IMAGE_4_DHD_RX_COMPLETE_DISPATCHER_CREDIT_TABLE_ADDRESS << 16);
    ...
    local_regs[IMAGE_4_IMAGE_4_DHD_RX_COMPLETE_1_THREAD_NUMBER][reg_id[13]] = ((IMAGE_4_DHD_COMPLETE_COMMON_RADIO_DATA_ADDRESS + sizeof(DHD_COMPLETE_COMMON_RADIO_ENTRY_STRUCT)*1));
    ...
    local_regs[IMAGE_4_IMAGE_4_DHD_RX_COMPLETE_1_THREAD_NUMBER][reg_id[9]] =
        IMAGE_4_IMAGE_4_DHD_RX_COMPLETE_1_THREAD_NUMBER | ((IMAGE_4_DHD_RX_COMPLETE_DISPATCHER_CREDIT_TABLE_ADDRESS + 16) << 16);
    ...
    local_regs[IMAGE_4_IMAGE_4_DHD_RX_COMPLETE_2_THREAD_NUMBER][reg_id[13]] = ((IMAGE_4_DHD_COMPLETE_COMMON_RADIO_DATA_ADDRESS + sizeof(DHD_COMPLETE_COMMON_RADIO_ENTRY_STRUCT)*2));
    ...
    local_regs[IMAGE_4_IMAGE_4_DHD_RX_COMPLETE_2_THREAD_NUMBER][reg_id[9]] =
        IMAGE_4_IMAGE_4_DHD_RX_COMPLETE_2_THREAD_NUMBER | ((IMAGE_4_DHD_RX_COMPLETE_DISPATCHER_CREDIT_TABLE_ADDRESS + 32) << 16);
#endif
...
#ifdef CONFIG_DHD_RUNNER
    /* DHD_TIMER_THREAD_NUMBER: thread 0 */
    local_regs[IMAGE_6_IMAGE_6_DHD_TIMER_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_6, dhd_timer_1st_wakeup_request) << 16;

    /* DHD_TX_POST_0: thread 2 */
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_0_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_6, dhd_tx_post_wakeup_request) << 16;
    /* high = post_common_radio_ptr , low =radio_idx */
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_0_THREAD_NUMBER][reg_id[13]] = 0 | ((IMAGE_6_DHD_POST_COMMON_RADIO_DATA_ADDRESS + sizeof(DHD_POST_COMMON_RADIO_ENTRY_STRUCT)*0)) << 16;
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_0_THREAD_NUMBER][reg_id[11]] = IMAGE_6_DHD_TX_POST_PD_FIFO_TABLE_ADDRESS + sizeof(PROCESSING_TX_DESCRIPTOR_STRUCT)*0;

    /* DHD_TX_POST_1: thread 3 */
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_1_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_6, dhd_tx_post_wakeup_request) << 16;
    /* high = post_common_radio_ptr , low =radio_idx */
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_1_THREAD_NUMBER][reg_id[13]] = 1 | ((IMAGE_6_DHD_POST_COMMON_RADIO_DATA_ADDRESS + sizeof(DHD_POST_COMMON_RADIO_ENTRY_STRUCT)*1)) << 16;
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_1_THREAD_NUMBER][reg_id[11]] = IMAGE_6_DHD_TX_POST_PD_FIFO_TABLE_ADDRESS + sizeof(PROCESSING_TX_DESCRIPTOR_STRUCT)*2;

    /* DHD_TX_POST_2: thread 4 */
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_2_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_6, dhd_tx_post_wakeup_request) << 16;
    /* high = post_common_radio_ptr , low =radio_idx */
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_2_THREAD_NUMBER][reg_id[13]] = 2 | ((IMAGE_6_DHD_POST_COMMON_RADIO_DATA_ADDRESS + sizeof(DHD_POST_COMMON_RADIO_ENTRY_STRUCT)*2)) << 16;
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_2_THREAD_NUMBER][reg_id[11]] = IMAGE_6_DHD_TX_POST_PD_FIFO_TABLE_ADDRESS + sizeof(PROCESSING_TX_DESCRIPTOR_STRUCT)*4;

    /* DHD_TX_POST_UPDATE_FIFO_READ: thread 1 */
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_UPDATE_FIFO_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_6, dhd_tx_post_update_fifo_wakeup_request) << 16;
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_UPDATE_FIFO_THREAD_NUMBER][reg_id[12]] = (((IMAGE_6_IMAGE_6_DHD_TX_POST_0_THREAD_NUMBER) << 4) + 9);
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_UPDATE_FIFO_THREAD_NUMBER][reg_id[11]] = IMAGE_6_DHD_TX_POST_UPDATE_FIFO_TABLE_ADDRESS;
...
static void rdd_layer2_header_copy_ptr_init(void)
{
    ...
    LAYER2_HEADER_COPY_ROUTINE_ARRAY(processing4_layer2_header_copy_routine_arr, image_6, processing_layer2_header_copy);
    LAYER2_HEADER_COPY_ROUTINE_ARRAY(processing5_layer2_header_copy_routine_arr, image_7, processing_layer2_header_copy);
    ...
    for (core_index = 0; core_index < NUM_OF_RUNNER_CORES; core_index++)
    {
        ...
        if (rdp_core_to_image_map[core_index] == processing0_runner_image)
        {
            for (i = 0; i < RDD_LAYER2_HEADER_COPY_MAPPING_TABLE_SIZE; i++)
                RDD_LAYER2_HEADER_COPY_MAPPING_ENTRY_ROUTINE_WRITE(processing0_layer2_header_copy_routine_arr[i], (entry + (sizeof(LAYER2_HEADER_COPY_MAPPING_ENTRY_STRUCT) * i)));
        }
        else if (rdp_core_to_image_map[core_index] == processing1_runner_image)
        {
            for (i = 0; i < RDD_LAYER2_HEADER_COPY_MAPPING_TABLE_SIZE; i++)
                RDD_LAYER2_HEADER_COPY_MAPPING_ENTRY_ROUTINE_WRITE(processing1_layer2_header_copy_routine_arr[i], (entry + (sizeof(LAYER2_HEADER_COPY_MAPPING_ENTRY_STRUCT) * i)));
        }
        else if (rdp_core_to_image_map[core_index] == processing2_runner_image)
        {
            for (i = 0; i < RDD_LAYER2_HEADER_COPY_MAPPING_TABLE_SIZE; i++)
                RDD_LAYER2_HEADER_COPY_MAPPING_ENTRY_ROUTINE_WRITE(processing2_layer2_header_copy_routine_arr[i], (entry + (sizeof(LAYER2_HEADER_COPY_MAPPING_ENTRY_STRUCT) * i)));
        }
        else if (rdp_core_to_image_map[core_index] == processing3_runner_image)
        {
            for (i = 0; i < RDD_LAYER2_HEADER_COPY_MAPPING_TABLE_SIZE; i++)
                RDD_LAYER2_HEADER_COPY_MAPPING_ENTRY_ROUTINE_WRITE(processing3_layer2_header_copy_routine_arr[i], (entry + (sizeof(LAYER2_HEADER_COPY_MAPPING_ENTRY_STRUCT) * i)));
        }
        else if (rdp_core_to_image_map[core_index] == processing4_runner_image)
        {
            for (i = 0; i < RDD_LAYER2_HEADER_COPY_MAPPING_TABLE_SIZE; i++)
                RDD_LAYER2_HEADER_COPY_MAPPING_ENTRY_ROUTINE_WRITE(processing4_layer2_header_copy_routine_arr[i], (entry + (sizeof(LAYER2_HEADER_COPY_MAPPING_ENTRY_STRUCT) * i)));
        }
        else if (rdp_core_to_image_map[core_index] == processing5_runner_image)
        {
            for (i = 0; i < RDD_LAYER2_HEADER_COPY_MAPPING_TABLE_SIZE; i++)
                RDD_LAYER2_HEADER_COPY_MAPPING_ENTRY_ROUTINE_WRITE(processing5_layer2_header_copy_routine_arr[i], (entry + (sizeof(LAYER2_HEADER_COPY_MAPPING_ENTRY_STRUCT) * i)));
        }
    }
}
