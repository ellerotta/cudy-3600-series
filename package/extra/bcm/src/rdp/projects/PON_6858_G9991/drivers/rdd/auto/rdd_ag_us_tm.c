...
int rdd_ag_us_tm_bbh_tx_us_wan_1_fifo_bytes_threshold_set_core(uint16_t bits, int core_id)
{
    RDD_BYTES_2_BITS_WRITE_CORE(bits, RDD_BBH_TX_US_WAN_1_FIFO_BYTES_THRESHOLD_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_us_tm_bbh_tx_us_wan_1_fifo_bytes_threshold_get_core(uint16_t *bits, int core_id)
{
    RDD_BYTES_2_BITS_READ_CORE(*bits, RDD_BBH_TX_US_WAN_1_FIFO_BYTES_THRESHOLD_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_us_tm_wan_1_bbh_tx_fifo_size_set_core(uint8_t bits, int core_id)
{
    RDD_BYTE_1_BITS_WRITE_CORE(bits, RDD_WAN_1_BBH_TX_FIFO_SIZE_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_us_tm_wan_1_bbh_tx_fifo_size_get_core(uint8_t *bits, int core_id)
{
    RDD_BYTE_1_BITS_READ_CORE(*bits, RDD_WAN_1_BBH_TX_FIFO_SIZE_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_us_tm_wan_1_bb_destination_table_set_core(uint16_t bits, int core_id)
{
    RDD_BYTES_2_BITS_WRITE_CORE(bits, RDD_US_TM_WAN_1_BB_DESTINATION_TABLE_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_us_tm_wan_1_bb_destination_table_get_core(uint16_t *bits, int core_id)
{
    RDD_BYTES_2_BITS_READ_CORE(*bits, RDD_US_TM_WAN_1_BB_DESTINATION_TABLE_ADDRESS_ARR, 0, core_id);
