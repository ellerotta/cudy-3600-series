...
#define RDD_SYSTEM_VPORT     RDD_VPORT_ID_28
#define RDD_LAN_VPORT_LAST   RDD_SYSTEM_VPORT
#define RDD_WAN0_VPORT       RDD_VPORT_ID_29
#define RDD_PON_WAN_VPORT    RDD_WAN0_VPORT
#define RDD_WAN1_VPORT       RDD_VPORT_ID_30

#define RDD_CPU0_VPORT       RDD_VPORT_ID_31
#define RDD_CPU_VPORT_FIRST  RDD_CPU0_VPORT
#define RDD_CPU_VPORT_LAST   RDD_CPU0_VPORT

#define RDD_VPORT_MAX        RDD_VPORT_LAST /* vports b/w 32-35 used for EMACs to which we connect Shastas */
...
#define TM_OVL_BUDGET_ALLOCATION_US_THREAD_NUMBER   IMAGE_3_US_TM_OVL_BUDGET_ALLOCATION_THREAD_NUMBER
#define DS_TM_BUDGET_ALLOCATION_THREAD_NUMBER       IMAGE_0_DS_TM_BUDGET_ALLOCATION_THREAD_NUMBER

#define SERVICE_QUEUES_UPDATE_FIFO_THREAD_NUMBER  IMAGE_2_CPU_IF_2_SERVICE_QUEUES_UPDATE_FIFO_THREAD_NUMBER
