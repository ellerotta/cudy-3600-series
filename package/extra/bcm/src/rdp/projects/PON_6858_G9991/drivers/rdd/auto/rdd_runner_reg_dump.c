...
void dump_RDD_G9991_NOT_EMPTY_VECTOR_ENTRY(bdmf_session_handle session, unsigned char *p)
{
	unsigned int r;
	bdmf_session_print(session, "  Register G9991_NOT_EMPTY_VECTOR_ENTRY\n");
	...
	MREAD_8((uint8_t *)(p) + 4, (r));
	bdmf_session_print(session, "\tlast_served_sid_0        = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_8((uint8_t *)(p) + 5, (r));
	bdmf_session_print(session, "\tlast_served_sid_1        = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_8((uint8_t *)(p) + 6, (r));
	bdmf_session_print(session, "\tlast_served_sid_2        = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_8((uint8_t *)(p) + 7, (r));
	bdmf_session_print(session, "\tlast_served_sid_3        = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");

	MREAD_8((uint8_t *)(p) + 8, (r));
	bdmf_session_print(session, "\tlast_served_sid_4        = 0x%08x", (unsigned int)r);
	bdmf_session_print(session, "\n");
...
void dump_RDD_PBIT_TO_DSCP_ENTRY(bdmf_session_handle session, unsigned char *p)
{
	...
	bdmf_session_print(session, "  Register PBIT_TO_DSCP_ENTRY\n");
