...
int rdd_ag_ds_tm_bbh_tx_ds_fifo_bytes_threshold_set_core(uint16_t bits, int core_id)
{
    RDD_BYTES_2_BITS_WRITE_CORE(bits, RDD_BBH_TX_DS_FIFO_BYTES_THRESHOLD_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_ds_tm_bbh_tx_ds_fifo_bytes_threshold_get_core(uint16_t *bits, int core_id)
{
    RDD_BYTES_2_BITS_READ_CORE(*bits, RDD_BBH_TX_DS_FIFO_BYTES_THRESHOLD_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_ds_tm_flush_aggregation_task_disable_set_core(uint8_t bits, int core_id)
{
    RDD_BYTE_1_BITS_WRITE_CORE(bits, RDD_DS_TM_FLUSH_AGGREGATION_TASK_DISABLE_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_ds_tm_flush_aggregation_task_disable_get_core(uint8_t *bits, int core_id)
{
    RDD_BYTE_1_BITS_READ_CORE(*bits, RDD_DS_TM_FLUSH_AGGREGATION_TASK_DISABLE_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_ds_tm_tx_exception_dbg_stat_en_set_core(bdmf_boolean dbg_stat_en, int core_id)
{
    RDD_TX_EXCEPTION_ENTRY_DBG_STAT_EN_WRITE_CORE(dbg_stat_en, RDD_TX_EXCEPTION_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_ds_tm_tx_exception_dbg_stat_en_get_core(bdmf_boolean *dbg_stat_en, int core_id)
{
    RDD_TX_EXCEPTION_ENTRY_DBG_STAT_EN_READ_CORE(*dbg_stat_en, RDD_TX_EXCEPTION_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_ds_tm_tx_exception_vlan_cntr_en_set_core(bdmf_boolean vlan_cntr_en, int core_id)
{
    RDD_TX_EXCEPTION_ENTRY_VLAN_CNTR_EN_WRITE_CORE(vlan_cntr_en, RDD_TX_EXCEPTION_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_ds_tm_tx_exception_vlan_cntr_en_get_core(bdmf_boolean *vlan_cntr_en, int core_id)
{
    RDD_TX_EXCEPTION_ENTRY_VLAN_CNTR_EN_READ_CORE(*vlan_cntr_en, RDD_TX_EXCEPTION_ADDRESS_ARR, 0, core_id);
...
int rdd_ag_ds_tm_vlan_tx_counters_packets_set_core(uint32_t _entry, uint32_t packets, int core_id)
{
    if(_entry >= RDD_VLAN_TX_COUNTERS_SIZE)
         return BDMF_ERR_PARM;

    RDD_PACKETS_AND_BYTES_PACKETS_WRITE_CORE(packets, RDD_VLAN_TX_COUNTERS_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_ds_tm_vlan_tx_counters_packets_get_core(uint32_t _entry, uint32_t *packets, int core_id)
{
    if(_entry >= RDD_VLAN_TX_COUNTERS_SIZE)
         return BDMF_ERR_PARM;

    RDD_PACKETS_AND_BYTES_PACKETS_READ_CORE(*packets, RDD_VLAN_TX_COUNTERS_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_ds_tm_vlan_tx_counters_bytes_set_core(uint32_t _entry, uint32_t bytes, int core_id)
{
    if(_entry >= RDD_VLAN_TX_COUNTERS_SIZE)
         return BDMF_ERR_PARM;

    RDD_PACKETS_AND_BYTES_BYTES_WRITE_CORE(bytes, RDD_VLAN_TX_COUNTERS_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_ds_tm_vlan_tx_counters_bytes_get_core(uint32_t _entry, uint32_t *bytes, int core_id)
{
    if(_entry >= RDD_VLAN_TX_COUNTERS_SIZE)
         return BDMF_ERR_PARM;

    RDD_PACKETS_AND_BYTES_BYTES_READ_CORE(*bytes, RDD_VLAN_TX_COUNTERS_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_ds_tm_complex_scheduler_table_us_dwrr_offset_pir_set(uint32_t _entry, uint8_t dwrr_offset_pir)
{
...
int rdd_ag_ds_tm_complex_scheduler_table_us_dwrr_offset_pir_set_core(uint32_t _entry, uint8_t dwrr_offset_pir, int core_id)
{
    if(_entry >= RDD_COMPLEX_SCHEDULER_TABLE_US_SIZE || dwrr_offset_pir >= 8)
          return BDMF_ERR_PARM;
...
int rdd_ag_ds_tm_complex_scheduler_table_us_dwrr_offset_pir_get(uint32_t _entry, uint8_t *dwrr_offset_pir)
{
...
int rdd_ag_ds_tm_complex_scheduler_table_us_dwrr_offset_pir_get_core(uint32_t _entry, uint8_t *dwrr_offset_pir, int core_id)
{
    if(_entry >= RDD_COMPLEX_SCHEDULER_TABLE_US_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_ds_tm_complex_scheduler_table_us_dwrr_offset_sir_set(uint32_t _entry, uint8_t dwrr_offset_sir)
{
...
int rdd_ag_ds_tm_complex_scheduler_table_us_dwrr_offset_sir_set_core(uint32_t _entry, uint8_t dwrr_offset_sir, int core_id)
{
    if(_entry >= RDD_COMPLEX_SCHEDULER_TABLE_US_SIZE || dwrr_offset_sir >= 8)
          return BDMF_ERR_PARM;
...
int rdd_ag_ds_tm_complex_scheduler_table_us_dwrr_offset_sir_get(uint32_t _entry, uint8_t *dwrr_offset_sir)
{
    if(_entry >= RDD_COMPLEX_SCHEDULER_TABLE_US_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_ds_tm_complex_scheduler_table_us_dwrr_offset_sir_get_core(uint32_t _entry, uint8_t *dwrr_offset_sir, int core_id)
{
    if(_entry >= RDD_COMPLEX_SCHEDULER_TABLE_US_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_ds_tm_complex_scheduler_table_us_slot_budget_bit_vector_0_set(uint32_t _entry, uint32_t slot_budget_bit_vector_0)
{
    if(_entry >= RDD_COMPLEX_SCHEDULER_TABLE_US_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_ds_tm_complex_scheduler_table_us_slot_budget_bit_vector_0_set_core(uint32_t _entry, uint32_t slot_budget_bit_vector_0, int core_id)
{
    if(_entry >= RDD_COMPLEX_SCHEDULER_TABLE_US_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_ds_tm_complex_scheduler_table_us_slot_budget_bit_vector_0_get(uint32_t _entry, uint32_t *slot_budget_bit_vector_0)
{
    if(_entry >= RDD_COMPLEX_SCHEDULER_TABLE_US_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_ds_tm_complex_scheduler_table_us_slot_budget_bit_vector_0_get_core(uint32_t _entry, uint32_t *slot_budget_bit_vector_0, int core_id)
{
    if(_entry >= RDD_COMPLEX_SCHEDULER_TABLE_US_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_ds_tm_complex_scheduler_table_us_quantum_number_set(uint32_t _entry, uint8_t quantum_number)
{
    if(_entry >= RDD_COMPLEX_SCHEDULER_TABLE_US_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_ds_tm_complex_scheduler_table_us_quantum_number_set_core(uint32_t _entry, uint8_t quantum_number, int core_id)
{
    if(_entry >= RDD_COMPLEX_SCHEDULER_TABLE_US_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_ds_tm_complex_scheduler_table_us_quantum_number_get(uint32_t _entry, uint8_t *quantum_number)
{
    if(_entry >= RDD_COMPLEX_SCHEDULER_TABLE_US_SIZE)
         return BDMF_ERR_PARM;
...
int rdd_ag_ds_tm_complex_scheduler_table_us_quantum_number_get_core(uint32_t _entry, uint8_t *quantum_number, int core_id)
{
    if(_entry >= RDD_COMPLEX_SCHEDULER_TABLE_US_SIZE)
         return BDMF_ERR_PARM;
